...
Overrides the OpenChamber data directory. The default is `~/.config/ompchamber`.
...
Alternative Git executable override. Prefer `OMPCHAMBER_GIT_BINARY` for OpenChamber-specific configuration.
