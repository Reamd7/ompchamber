...
Перевизначає директорію даних OpenChamber. Типово це `~/.config/ompchamber`.
...
Альтернативний override для Git executable. Для OpenChamber-specific налаштувань краще використовуйте `OMPCHAMBER_GIT_BINARY`.
