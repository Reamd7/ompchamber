...
Integracja to mała wtyczka, która dodaje dostawcę do OMPChamber na podstawie subskrypcji, którą już masz. Zarządzasz nimi w **Settings → Integrations**.
...
Cursor udostępnia w OMPChamber modele zawarte w Twoim planie Cursor.
