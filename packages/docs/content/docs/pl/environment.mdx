...
Nadpisuje katalog danych OpenChamber. Domyślnie jest to `~/.config/ompchamber`.
...
Alternatywny override dla Git executable. Dla konfiguracji specyficznej dla OpenChamber preferuj `OMPCHAMBER_GIT_BINARY`.
