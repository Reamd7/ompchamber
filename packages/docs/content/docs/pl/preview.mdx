...
description: Otwórz działający serwer deweloperski wewnątrz OMPChamber.
---

# Podgląd i serwery deweloperskie

Gdy uruchamiasz serwer deweloperski, OMPChamber może otworzyć go od razu w aplikacji zamiast w osobnej karcie przeglądarki — widzisz swoją stronę obok czatu i możesz wskazywać elementy, żeby o nie zapytać.

## Otwieranie serwera deweloperskiego

Otwórz panel przeglądarki przyciskiem globusa w nagłówku aplikacji. Jeśli serwer już działa, znajdziesz go na liście i otworzysz jednym kliknięciem — OMPChamber rozpoznaje go po tym, co faktycznie nasłuchuje na twoim komputerze, więc działa niezależnie od sposobu uruchomienia.
