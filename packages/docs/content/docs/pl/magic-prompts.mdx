---
title: Magic Prompts
description: Dostosuj wbudowane prompty stojące za automatycznymi przepływami OMPChamber.
---

# Magic Prompts

OMPChamber używa w tle wbudowanych promptów za każdym razem, gdy robi coś automatycznie — pisze komunikat commita, szkicuje PR, przegląda issue, rozwiązuje konflikt, podsumowuje sesję. Magic Prompts to miejsce, w którym czytasz i przepisujesz te prompty. Otwórz je w **Settings → Magic Prompts**.
...
Niektóre prompty mają część widoczną (wiadomość, którą zobaczysz) i część z instrukcjami (ukryte wskazówki dla agenta). Prompty mogą zawierać `{{placeholders}}`, które OMPChamber uzupełnia, jak diff czy tytuł issue — zostaw je na miejscu.
