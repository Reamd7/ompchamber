...
Cambia el directorio de datos de OpenChamber. Por defecto es `~/.config/ompchamber`.
...
Override alternativo para el ejecutable de Git. Para ajustes específicos de OpenChamber, prefiere `OMPCHAMBER_GIT_BINARY`.
