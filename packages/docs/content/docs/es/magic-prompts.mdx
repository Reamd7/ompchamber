---
title: Magic Prompts
description: Personaliza los prompts integrados detrás de los flujos automatizados de OMPChamber.
---

# Magic Prompts

OMPChamber usa prompts integrados en segundo plano cada vez que hace algo automáticamente: escribir un mensaje de commit, redactar un PR, revisar una issue, resolver un conflicto, resumir una sesión. Magic Prompts es donde lees y reescribes esos prompts. Ábrelo en **Settings → Magic Prompts**.
...
Algunos prompts tienen una parte visible (el mensaje que verías) y una parte de instrucciones (guía oculta para el agente). Los prompts pueden incluir `{{placeholders}}` que OMPChamber rellena, como el diff o el título de la issue; mantenlos en su sitio.
