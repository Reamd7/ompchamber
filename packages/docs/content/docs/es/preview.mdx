...
description: Abre un servidor de desarrollo en marcha dentro de OMPChamber.
---

# Vista previa y servidores de desarrollo

Cuando arrancas un servidor de desarrollo, OMPChamber puede abrirlo dentro de la propia aplicación en lugar de en una pestaña aparte — así ves tu sitio junto al chat y puedes señalar elementos para preguntar por ellos.

## Abrir un servidor de desarrollo

Abre el panel del navegador con el botón del globo de la cabecera. Si ya hay un servidor en marcha, aparece en la lista y se abre con un clic: OMPChamber lo encuentra mirando qué está escuchando de verdad en tu máquina, así que funciona sin importar cómo lo hayas arrancado.
