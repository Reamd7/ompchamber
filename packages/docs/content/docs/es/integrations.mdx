...
Una integración es un pequeño plugin que añade un proveedor a OMPChamber usando una suscripción que ya tienes. Las gestionas en **Settings → Integrations**.
...
Cursor hace disponibles en OMPChamber los modelos incluidos en tu plan de Cursor.
