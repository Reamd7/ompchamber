...
Altera o diretório de dados do OpenChamber. O padrão é `~/.config/ompchamber`.
...
Override alternativo para o executável do Git. Para configuração específica do OpenChamber, prefira `OMPCHAMBER_GIT_BINARY`.
