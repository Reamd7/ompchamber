---
title: Magic Prompts
description: Personalize os prompts integrados por trás dos fluxos automatizados do OMPChamber.
---

# Magic Prompts

O OMPChamber usa prompts integrados nos bastidores sempre que faz algo automaticamente — escrever uma mensagem de commit, redigir um PR, revisar uma issue, resolver um conflito, resumir uma sessão. Os Magic Prompts são onde você lê e reescreve esses prompts. Abra-os em **Settings → Magic Prompts**.
...
Alguns prompts têm uma parte visível (a mensagem que você veria) e uma parte de instruções (orientação oculta para o agente). Os prompts podem incluir `{{placeholders}}` que o OMPChamber preenche, como o diff ou o título da issue — mantenha-os no lugar.
