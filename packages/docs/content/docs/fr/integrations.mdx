...
Une intégration est un petit plugin qui ajoute un fournisseur à OMPChamber à partir d'un abonnement que tu possèdes déjà. Tu les gères dans **Settings → Integrations**.
...
Cursor rend disponibles dans OMPChamber les modèles inclus dans ton plan Cursor.
