...
An integration is a small plugin that adds a provider to OMPChamber using a subscription you already have. You manage them at **Settings → Integrations**.
...
Cursor makes the models included in your Cursor plan available in OMPChamber.
