...
description: Installiere die OMPChamber-App auf iOS oder Android und verbinde sie mit deinem Server.
---

# Mobile Apps & PWA

OMPChamber hat native Apps für iPhone und Android, damit du Sitzungen verfolgen, auf Agenten antworten und Arbeiten von deinem Telefon aus verwalten kannst — zu Hause über WLAN oder von überall über das [Private Relay](/private-relay/).

## App installieren

- **iPhone/iPad** — tritt der [TestFlight-Beta](https://testflight.apple.com/join/5ek6GU1E) bei
- **Android** — lade das APK aus dem [latest release](https://github.com/Reamd7/ompchamber/releases/latest) herunter

## Mit deinem Server verbinden

1. Öffne auf dem Computer mit OMPChamber **Settings → Remote Instances → Connect to this server** und drücke **Add a device**.
...
Unter **Settings → OMPChamber** passen ein paar Optionen die mobile und installierte Nutzung an — der Installationsname der App, die Bildschirmausrichtung und das Verhalten der Bildschirmtastatur.
