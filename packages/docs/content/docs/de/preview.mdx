...
description: Öffne einen laufenden Dev-Server direkt in OMPChamber.
---

# Vorschau & Dev-Server

Wenn du einen Dev-Server startest, kann OMPChamber ihn direkt in der App öffnen statt in einem separaten Browser-Tab — so siehst du deine Seite neben dem Chat und kannst auf Elemente zeigen, um danach zu fragen.

## Einen Dev-Server öffnen

Öffne das Browser-Panel über die Globus-Schaltfläche in der Kopfzeile. Läuft bereits ein Dev-Server, steht er dort in der Liste und ein Klick öffnet ihn — OMPChamber findet ihn daran, was auf deinem Rechner tatsächlich lauscht, also unabhängig davon, wie du ihn gestartet hast.
