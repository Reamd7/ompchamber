...
Eine Integration ist ein kleines Plugin, das OMPChamber einen Provider hinzufügt — auf Basis eines Abos, das du bereits hast. Verwalten kannst du sie unter **Settings → Integrations**.
...
Cursor macht die Modelle deines Cursor-Plans in OMPChamber nutzbar.
