...
Überschreibt das OpenChamber-Datenverzeichnis. Standard ist `~/.config/ompchamber`.
...
Alternative Git-Executable-Überschreibung. Bevorzuge `OMPCHAMBER_GIT_BINARY` für OpenChamber-spezifische Konfiguration.
