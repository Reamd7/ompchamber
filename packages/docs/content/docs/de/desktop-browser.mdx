...
**Cookies löschen** und **Zwischengespeicherte Daten löschen** gelten allein für dieses Panel. Deine OMPChamber-Sitzung und andere Fenster bleiben unberührt.
...
Er kann außerdem ein Bild dessen, was er sieht, in `.ompchamber/screenshots/` in deinem Projekt speichern und es dir in seiner Antwort zeigen. Genau das macht ein Vorher-Nachher möglich, und die Datei bleibt danach liegen, um sie an einen Pull Request zu hängen.

Die Browser-Aktionen sind das **OMPChamber-Web-Werkzeug**, das sich unter **Einstellungen → Allgemein → OMPChamber-Werkzeuge** einzeln ein- und ausschalten lässt.
