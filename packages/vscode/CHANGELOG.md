...
- Shared settings now read from `~/.config/ompchamber` (moved from `~/.config/openchamber`, with the folder moved automatically) to match the renamed app data directory.
