...
![VS Code Extension](https://github.com/Reamd7/ompchamber/raw/HEAD/packages/vscode/extension.jpg)

**Like the extension? There's also a [desktop app and web version](https://github.com/Reamd7/ompchamber) with even more features.**
...
Plus everything from the shared OMPChamber UI: branchable timeline, smart tool UIs, voice mode, Git workflows, and more.

## Commands

| Command | Description |
|---------|-------------|
| `OMPChamber: Focus Chat` | Focus the chat panel |
| `OMPChamber: New Session` | Start a new chat session |
| `OMPChamber: Open Sidebar` | Open the OMPChamber sidebar |
...
| `OMPChamber: Restart API Connection` | Restart the engine process |
| `OMPChamber: Show Engine Status` | Debug info for development or bug reports |

### Right-click menu

Select code in the editor, right-click, and find the **OMPChamber** submenu:
