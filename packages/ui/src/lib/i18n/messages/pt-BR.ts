...
"chat.modeSelector.conflict": "Saia primeiro do modo {mode}.",
  ...
  "onboarding.chooser.title": "Boas-vindas ao OMPChamber",
  ...
  "onboarding.localSetup.title": "Configuração do OMPChamber",
  "onboarding.localSetup.description": "Instale a CLI do ompchamber para continuar.",
  "onboarding.localSetup.dialog.selectOpencodeBinary": "Selecionar executável do ompchamber",
  "onboarding.localSetup.errors.cliNotReady": "A CLI do ompchamber ainda não está pronta. Confirme que a instalação está completa e tente novamente.",
  "onboarding.localSetup.errors.detectionFailed": "Erro de detecção",
  "onboarding.localSetup.windows.title": "Configuração no Windows",
  "onboarding.localSetup.windows.stepInstallWsl": "Instale o ompchamber com o comando abaixo.",
  ...
  "onboarding.localSetup.windows.stepSetBinaryPath": "Se o OMPChamber não detectar o ompchamber automaticamente, defina o caminho do executável abaixo.",
  "onboarding.localSetup.intro": "A CLI do ompchamber inicia o seu motor local — instale-a para começar.",
  "onboarding.localSetup.docs.windows": "OMPChamber no GitHub",
  "onboarding.localSetup.docs.default": "OMPChamber no GitHub",
  ...
  "onboarding.localSetup.helper.checkAndContinue": "Clique para verificar se a CLI do ompchamber está disponível. Se a verificação funcionar, você entrará automaticamente na tela principal.",
  "onboarding.localSetup.status.watching": "Aguardando o motor",
  "onboarding.localSetup.status.autoContinue": "Continuaremos automaticamente assim que detectado.",
  "onboarding.localSetup.field.alreadyInstalled": "Já está instalado? Defina o caminho da CLI do ompchamber:",
  ...
  "onboarding.localSetup.helper.saveAndReload": "Salva nas configurações do OMPChamber e recarrega as configurações do motor.",
  ...
  "onboarding.localSetup.windows.hintInstallInWsl": "No Windows, instale e execute o ompchamber nativamente.",
  "onboarding.localSetup.windows.hintDetectionFailed": "Se a detecção falhar, defina um caminho nativo, como ompchamber.cmd ou ompchamber.exe.",
  "onboarding.localSetup.hint.ensurePath": "Já está instalado? Confira se o ompchamber está no seu PATH.",
