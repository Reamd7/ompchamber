...
export const dict: Record<I18nKey, string> = {
  ...
  'terminalView.actions.takeControl': 'Assumir controle do tamanho',
  'terminalView.actions.releaseControl': 'Liberar controle do tamanho',
  'terminalView.status.driving': 'Controlando',
  'terminalView.status.following': 'Seguindo',
  'terminalView.actions.zoomIn': 'Ampliar o terminal',
  'terminalView.actions.zoomOut': 'Reduzir o terminal',
  'terminalView.actions.zoomReset': 'Redefinir o zoom do terminal (100%)',
  'terminalView.driverState.idleHint': 'O tamanho segue a menor janela — clique para assumir o controle',
  'terminalView.driverState.drivingHint': 'Você está controlando o tamanho ({cols}×{rows}) — clique para liberar',
  'terminalView.driverState.followingHint': 'Outro dispositivo está controlando ({cols}×{rows}) — clique para assumir',
  'terminalView.actions.killSession': 'Encerrar sessão (desconecta TODOS os dispositivos)',
  'terminalView.actions.killSessionArmed': 'Clique novamente para encerrar em todos',
  ...
  'pwa.installPrompt.description': 'Instale o OMPChamber para acessar mais rápido',
  'pwa.installPrompt.action': 'Instalar',
  'pwa.installPrompt.dismiss': 'Dispensar',
  'pwa.installPrompt.started': 'Instalação iniciada',
  'pwa.installPrompt.installed': 'OMPChamber instalado',
  ...
  'mobile.connect.password.placeholder': 'Senha do OMPChamber',
  ...
  'mobile.connect.scan.invalid': 'Esse código QR não é um código de conexão do OMPChamber.',
  ...
  'mobile.connect.error.unreachable': 'Não foi possível acessar esse servidor OMPChamber.',
  ...
  'sessions.scheduledTasks.editor.persona.ariaLabel': 'Persona da sessão',
  'sessions.scheduledTasks.editor.persona.standard': 'Padrão',
  'sessions.scheduledTasks.editor.persona.unavailable': 'Indisponível',
  ...
  'sessions.sidebar.footer.actions.aboutOMPChamber': 'Sobre o OMPChamber',
  ...
  'sessions.sidebar.session.status.resident': 'Residente na memória',
  'sessions.sidebar.session.status.residentWithSize': 'Residente na memória · transcript ~{size}',
  'sessions.sidebar.session.status.residentShort': 'Residente na memória',
  ...
  'walkthrough.blocked.serverUnsupported.description': 'O servidor OMPChamber ao qual este app está conectado não respondeu à API de walkthrough, ou seja, é mais antigo que o app. Atualize o servidor para 1.18 ou mais recente e atualize a visualização.',
  ...
  'contextPanel.browser.tunnelFailedHint': '{url} roda na máquina onde o OMPChamber está e não foi possível abrir a conexão com ela. Nada da sua própria máquina é mostrado aqui.',
  ...
  'contextPanel.browser.devServers.remoteOnly': 'Eles rodam na máquina que hospeda o OMPChamber. Abri-los exige o aplicativo desktop.',
  ...
  'contextPanel.browser.trustNotice': 'As páginas abertas aqui são executadas com acesso total ao OMPChamber — necessário para inspeção e capturas de tela. Abra apenas sites confiáveis: uma página maliciosa pode ler seus dados ou agir em seu nome.',
  ...
  'filesView.editor.binaryFileDescription': 'Este arquivo é binário e não pode ser editado no OMPChamber. Baixe-o para abrir em outro aplicativo.',
  ...
  'terminalView.tabs.unreadTitle': 'Saída de comando não lida',
  ...
  'directoryExplorerDialog.browse.permissionDenied': 'OMPChamber precisa acessar esta pasta.',
  ...
  'aboutDialog.openChamberVersionLabel': 'Versão do OMPChamber {version}',
  'aboutDialog.openCodeVersionLabel': 'Versão do motor {version}',
  ...
  'aboutDialog.diagnosticsDescription': 'Inclui o estado do OMPChamber, a integridade do motor, diretórios e projetos.',
  ...
  'helpDialog.description': 'Use estes atalhos de teclado para navegar pelo OMPChamber com eficiência',
  ...
  'header.actions.openAppMenu': 'Menu do OMPChamber',
  'header.actions.openAppMenuAria': 'Abrir menu do OMPChamber',
  ...
  'chat.retry.supersededBadge': 'Substituído por uma nova tentativa',
  'chat.chat.ompDivider.compacted': 'compactado',
  'chat.chat.ompDivider.branchSummary': 'resumo da ramificação',
  'chat.chat.ompDivider.handoff': 'entrega',
  'chat.chat.ompDivider.modelChange': 'Modelo alterado',
  'chat.chat.ompDivider.modeChange': 'Modo',
  'chat.chat.ompDivider.modelChange.role': 'Alterado via função: {role}',
  'chat.chat.ompDivider.modelChange.fallback': 'Modelo reserva de nova tentativa',
  'chat.chat.ompDivider.fromTokens': 'de {tokens} tokens',
  'chat.chat.ompDivider.expand': 'Expandir resumo',
  'chat.chat.ompDivider.collapse': 'Recolher resumo',
  'chat.chat.ompDivider.developerNote': 'nota injetada',
  'chat.omp.ttsrWarning.title': 'Regras de manutenção de rumo acionadas',
  'chat.omp.ttsrWarning.dismissAria': 'Descartar aviso',
  'chat.omp.strippedToolCalls.one': '{count} chamada de ferramenta omitida neste ramo, sem resultado',
  'chat.omp.strippedToolCalls.many': '{count} chamadas de ferramenta omitidas neste ramo, sem resultado',
  'chat.omp.customCard.moreEntries': '+{count} mais',
  'chat.omp.cacheMiss.label': 'falha de cache',
  'chat.omp.cacheMiss.tokens': '{tokens} tokens',
  'toast.ompNotice.title.info': 'Aviso',
  'toast.ompNotice.title.warning': 'Aviso',
  'toast.ompNotice.title.error': 'Erro',
  ...
  'chat.emptyState.opencodeUnreachable': 'O motor não está acessível',
  ...
  'chat.statusRow.todo.status.blockedBy': 'Bloqueado por {reason}',
  'chat.statusRow.todo.status.blockedBare': 'Bloqueado',
  ...
  'chat.message.fallbackTag': 'substituição',
  ...
  'chat.workStatus.goal.status.paused': 'em pausa',
  'chat.workStatus.goal.status.complete': 'concluído',
  'chat.workStatus.goal.status.budgetLimited': 'limite de orçamento',
  'chat.workStatus.goal.status.dropped': 'abandonado',
  ...
  'chat.toast.opencodeRestartInterrupted.description': 'O motor foi reiniciado enquanto uma resposta ainda estava em andamento. Envie uma mensagem para continuar.',
  ...
  'chat.commandAutocomplete.badge.ompOverride': 'substitui o OMPChamber',
  'chat.chatInput.toast.debugRenamed': 'O engine agora usa /debug. O comando de depuração guiada do OMPChamber passou a ser /troubleshoot.',
  'chat.sessionTree.title': 'Ramificações da sessão',
  'chat.sessionTree.description': 'Forks desta sessão. Selecione um ramo para abrir sua linha do tempo.',
  'chat.sessionTree.loading': 'Carregando ramificações…',
  'chat.sessionTree.error': 'Não foi possível carregar a árvore da sessão.',
  'chat.sessionTree.empty': 'Esta sessão não tem forks.',
  'chat.sessionTree.untitled': 'Sem título',
  'chat.sessionTree.current': 'atual',
  'chat.sessionTree.leaf': 'mais recente',
  'chat.sessionTree.openBranch': 'Abrir ramo {title}',
  ...
  'chat.toolPart.askQuestionsCount': '{count} perguntas',
  'chat.toolPart.askNoSelection': 'Sem resposta',
  'chat.toolPart.askCustomAnswer': 'Resposta personalizada',
  'chat.toolPart.askNote': 'Nota',
  'chat.toolPart.askAutoSelected': 'selecionado automaticamente após o tempo limite — não foi uma escolha do usuário',
  'chat.toolPart.askChatRedirect': 'O usuário preferiu conversar sobre isso no chat em vez de responder',
  'chat.toolPart.taskAgent.status.pending': 'Pendente',
  'chat.toolPart.taskAgent.status.running': 'Em andamento',
  'chat.toolPart.taskAgent.status.completed': 'Concluído',
  'chat.toolPart.taskAgent.status.failed': 'Falhou',
  'chat.toolPart.taskAgent.status.aborted': 'Abortado',
  'chat.toolPart.taskAgent.retrying': 'Tentativa {attempt}/{maxAttempts}',
  'chat.toolPart.taskAgent.retriesExhausted': 'Tentativas esgotadas ({attempt})',
  'chat.toolPart.taskAgent.moreAgents': '+{count} mais',
  ...
  'chat.modelControls.roles.sectionTitle': 'Funções de modelo',
  'chat.modelControls.roles.notConfigured': 'Não configurada',
  'chat.modelControls.roles.configure': 'Configurar funções',
  'chat.modelControls.roles.thinking': 'Raciocínio {level}',
  'chat.modelControls.thinkingChangeFailed': 'Não foi possível alterar o nível de pensamento',
  'chat.modelControls.modelChangeFailed': 'Não foi possível alterar o modelo',
  'chat.modelControls.setAsRole': 'Definir como função',
  'chat.modelControls.setAsRole.aria': 'Atribuir este modelo a uma função',
  'chat.modelControls.setAsRole.applied': 'Função {role} atualizada',
  'chat.modelControls.setAsRole.failed': 'Não foi possível atribuir a função',
  'chat.modelControls.setAsRole.rejected.role-already-configured': 'A função já tem um modelo configurado',
  'chat.modelControls.enabledWarning': 'O modelo atual não está em enabledModels',
  'chat.modeSelector.label.default': 'Padrão',
  'chat.modeSelector.label.plan': 'Plano',
  'chat.modeSelector.label.planPaused': 'Plano (pausado)',
  'chat.modeSelector.label.goal': 'Objetivo',
  'chat.modeSelector.label.goalPaused': 'Objetivo (pausado)',
  'chat.modeSelector.label.vibe': 'Vibe',
  'chat.modeSelector.label.loop': 'Loop',
  'chat.modeSelector.ariaLabel': 'Modo da sessão',
  'chat.modeSelector.title': 'Modo',
  'chat.modeSelector.requiresSession': 'Inicie a sessão para alterar o modo dela',
  ...
  'chat.goalIndicator.title': 'Objetivo',
  'chat.goalIndicator.status.active': 'Ativo',
  'chat.goalIndicator.status.paused': 'Pausado',
  'chat.goalIndicator.status.complete': 'Concluído',
  'chat.goalIndicator.status.budgetLimited': 'Limite de orçamento',
  'chat.goalIndicator.status.dropped': 'Abandonado',
  'chat.goalIndicator.noObjective': 'Nenhum objetivo registrado',
  'chat.goalIndicator.budget': '{used}/{budget} tokens',
  'chat.goalIndicator.tokensUsed': '{used} tokens',
  ...
  'commandPalette.item.toggleMemoryDebug': 'Alternar painel de depuração',
  ...
  'openCodeStatusDialog.title': 'Status do motor',
  'openCodeStatusDialog.description': 'Inspecione o status atual do motor e os diagnósticos.',
  ...
  'openCodeStatusDialog.memory.title': 'Memória do motor',
  'openCodeStatusDialog.memory.refreshNote': 'atualiza a cada 5 s enquanto aberto',
  'openCodeStatusDialog.memory.loading': 'Carregando…',
  'openCodeStatusDialog.memory.unavailable': 'Diagnósticos de memória não são suportados por esta versão do motor.',
  'openCodeStatusDialog.memory.error': 'Falha ao carregar diagnósticos de memória.',
  'openCodeStatusDialog.memory.processHeap': 'Heap do processo',
  'openCodeStatusDialog.memory.processRss': 'RSS do processo',
  'openCodeStatusDialog.memory.processExternal': 'Externa + buffers',
  'openCodeStatusDialog.memory.residentEstimate': 'Sessões residentes (est.)',
  'openCodeStatusDialog.memory.sessionsTitle': 'Sessões residentes: {live} ativas · {total} no total',
  'openCodeStatusDialog.memory.sessionsStates': 'materializando {materializing} · despejando {evicting} · com falha {failed}',
  'openCodeStatusDialog.memory.noResident': 'Nenhuma sessão residente.',
  'openCodeStatusDialog.memory.truncated': 'Lista truncada — mostrando as maiores sessões residentes.',
  'openCodeStatusDialog.memory.colSession': 'Sessão',
  'openCodeStatusDialog.memory.colDirectory': 'Diretório',
  'openCodeStatusDialog.memory.colState': 'Estado',
  'openCodeStatusDialog.memory.colSize': '~Tamanho',
  'openCodeStatusDialog.memory.colIdle': 'Ociosa',
  'openCodeStatusDialog.memory.wireBus': 'Buffer de eventos wire',
  'openCodeStatusDialog.memory.ompBus': 'Buffer de eventos OMP',
  'openCodeStatusDialog.memory.busValue': '{entries} entradas · {size} (limite {capacity})',
  'openCodeStatusDialog.memory.wireIdEchoes': 'Ecos de Wire-ID',
  'openCodeStatusDialog.memory.inFlightUnderflow': 'Subfluxos de inFlight',
  'openCodeStatusDialog.memory.estimateNote': 'Os tamanhos de sessão são estimativas baseadas no tamanho do transcript (~1,3× o heap residente), não atribuição medida por sessão.',
  'openCodeStatusDialog.monitor.tabOverview': 'Visão geral',
  'openCodeStatusDialog.monitor.tabSessions': 'Sessões',
  'openCodeStatusDialog.monitor.residentCount': '{total} residentes',
  'openCodeStatusDialog.monitor.catSessions': 'Sessões residentes (est.)',
  'openCodeStatusDialog.monitor.catBuffers': 'Buffers de eventos',
  'openCodeStatusDialog.monitor.catUnattributed': 'Motor não atribuído',
  'openCodeStatusDialog.monitor.processMonitor': 'Monitor de processos',
  'openCodeStatusDialog.monitor.processMonitorValue': '{live} ativos · {windows} chamadas · {failures} amostras com falha',
  'openCodeStatusDialog.monitor.stateLive': 'ativa',
  'openCodeStatusDialog.monitor.stateMaterializing': 'carregando',
  'openCodeStatusDialog.monitor.stateEvicting': 'despejando',
  'openCodeStatusDialog.monitor.stateFailed': 'com falha',
  'openCodeStatusDialog.monitor.largeOnly': 'Somente ≥10 MB',
  'openCodeStatusDialog.monitor.noLarge': 'Nenhuma sessão residente ≥10 MB.',
  'openCodeStatusDialog.monitor.colAction': 'Ação',
  'openCodeStatusDialog.monitor.release': 'Liberar',
  'openCodeStatusDialog.monitor.releaseHint': 'Remover da memória — o transcript permanece em disco',
  'openCodeStatusDialog.monitor.releaseBusy': 'A sessão ainda está ativa — não é possível liberar.',
  'openCodeStatusDialog.monitor.releaseFailed': 'Falha ao liberar a sessão.',
  ...
  'sessionAuth.error.networkDescription': 'Não foi possível verificar a sessão da interface. Se você estiver abrindo o OMPChamber de outro dispositivo na sua rede local, ative o Desktop Network Access no app para desktop e use o endereço LAN mostrado em Configurações.',
  ...
  'sessionAuth.locked.unlockTitle': 'Desbloquear OMPChamber',
  ...
  'desktopHostSwitcher.description': 'Alterne entre Local e o servidor remoto do OMPChamber',
  ...
  'multiRun.window.description': 'Janela do OMPChamber Multi-Run.',
  ...
  'onboarding.remoteConnection.description': 'Digite o endereço de um servidor do OMPChamber para conectar.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'Sugestões: verifique se a URL aponta para um servidor OMPChamber ou entre em contato com o administrador do servidor.',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': 'Esta instância está executando uma versão diferente do OMPChamber. Você pode se conectar, mas atualize os dois apps se algo não funcionar.',
  'onboarding.remoteConnection.probe.incompatibleMessage': 'O servidor está executando OMPChamber, mas não é compatível com esta versão do app. Atualize o OMPChamber no servidor e tente novamente.',
  'onboarding.remoteConnection.probe.wrongServiceMessage': 'O servidor respondeu, mas não está executando OMPChamber. Verifique se o endereço aponta para um servidor OMPChamber.',
  ...
  'onboarding.desktopRecovery.localUnavailable.title': 'Motor local não disponível',
  'onboarding.desktopRecovery.localUnavailable.description': 'O motor local não pôde ser iniciado. Tente a inicialização novamente ou conecte um servidor remoto no lugar.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': 'O servidor em \\"{host}\\" não está executando OMPChamber. Verifique se o endereço aponta para um servidor OMPChamber.',
  'onboarding.desktopRecovery.remoteIncompatible.title': 'Atualização do servidor necessária',
  'onboarding.desktopRecovery.remoteIncompatible.description': 'O servidor OMPChamber em \\"{host}\\" não é compatível com esta versão do app. Atualize o OMPChamber no servidor e tente novamente.',
  ...
  'startup.initRecovery.description': 'O OMPChamber não conseguiu concluir a inicialização. Verifique se o servidor está em execução e tente novamente.',
  ...
  'updateDialog.header.updating': 'Atualizando OMPChamber...',
  ...
  'updateDialog.error.takingLonger': 'A atualização está demorando mais do que o esperado. Aguarde um pouco e atualize, ou execute: ompchamber update',
  'updateDialog.error.signatureRejected': 'A atualização baixada foi rejeitada: a assinatura de código não corresponde a esta instalação. Isso costuma significar que a cópia em execução não foi instalada a partir de uma versão oficial assinada. Instale o OMPChamber a partir de uma versão oficial e atualize novamente.',
  'updateDialog.error.updaterDisabled': 'O atualizador parou após uma instalação com falha. Feche o OMPChamber, abra-o de novo e tente atualizar outra vez.',
  'updateDialog.error.restartFailed': 'Não foi possível reiniciar para instalar a atualização.',
  'updateDialog.error.restartUnavailable': 'Instalar a atualização exige o aplicativo de desktop do OMPChamber.',
  'mobileUpdate.toast.available.title': 'Atualização do OMPChamber disponível',
  ...
  'memoryDebugPanel.resizeHandle': 'Arraste para ajustar a largura do painel',
  'memoryDebugPanel.metricName.sidebarScrollAnchorAdjustment': 'Ajuste de âncora de rolagem da barra lateral',
  'memoryDebugPanel.metricName.sidebarSessionNodeRender': 'Renderização de linha de sessão da barra lateral',
  'memoryDebugPanel.metricName.sidebarSessionNodePropsChanged': 'Props de sessão da barra lateral alteradas',
  'memoryDebugPanel.metricName.globalSessionsEventUpdateDeferred': 'Atualização de evento de sessão adiada',
  'memoryDebugPanel.metricName.globalSessionsEventUpdateImmediate': 'Atualização de evento de sessão imediata',
  'memoryDebugPanel.metricName.globalSessionsEventUpdatePublication': 'Publicação de atualização de evento de sessão',
  'memoryDebugPanel.metricName.sidebarProjectSectionReused': 'Seções de projeto reutilizadas',
  'memoryDebugPanel.metricName.sidebarProjectSectionRebuilt': 'Seções de projeto reconstruídas',
  'memoryDebugPanel.metricName.sidebarProjectSectionRebuiltReason': 'Motivo de reconstrução de seção de projeto',
  'memoryDebugPanel.metricName.sidebarProjectsListRender': 'Renderização de lista de projetos',
  'memoryDebugPanel.metricName.sessionSidebarRender': 'Renderização de barra lateral de sessão',
  'memoryDebugPanel.metricName.sessionSidebarSource': 'Origem da barra lateral de sessão',
  'memoryDebugPanel.metricName.headerRender': 'Renderização de cabeçalho',
  'memoryDebugPanel.metricName.assistantTextRender': 'Renderização de texto do assistente',
  'memoryDebugPanel.metricName.assistantTextDisplayLen': 'Comprimento do texto do assistente exibido',
  'memoryDebugPanel.metricName.messageListEntryRender': 'Renderização de entrada da lista de mensagens',
  'memoryDebugPanel.metricName.messageListRender': 'Renderização de lista de mensagens',
  'memoryDebugPanel.metricName.messageListBaseDisplayMs': 'Exibição base da lista de mensagens (ms)',
  'memoryDebugPanel.metricName.messageListRetryOverlayMs': 'Sobreposição de nova tentativa da lista de mensagens (ms)',
  'memoryDebugPanel.metricName.messageListRenderEntriesMs': 'Renderização de entradas da lista de mensagens (ms)',
  'memoryDebugPanel.metricName.markdownRender': 'Renderização de Markdown',
  'memoryDebugPanel.metricName.markdownContentLen': 'Comprimento do conteúdo Markdown',
  'memoryDebugPanel.metricName.markdownDomCache': 'Cache DOM de Markdown',
  'memoryDebugPanel.metricName.markdownSettledPaintReused': 'Pintura estável de Markdown reutilizada',
  'memoryDebugPanel.metricName.chatMessageRender': 'Renderização de mensagem de chat',
  'memoryDebugPanel.metricName.turnsProjectionMs': 'Projeção de turno (ms)',
  'memoryDebugPanel.metricName.vscodeWebviewSseChunk': 'Chunk SSE do webview',
  'memoryDebugPanel.metricName.vscodeWebviewSseChunkBytes': 'Bytes de chunk SSE do webview',
  'memoryDebugPanel.metricName.vscodeWebviewSseEnd': 'Fim de SSE do webview',
  'memoryDebugPanel.metricName.vscodeWebviewSseStartMs': 'Início de SSE do webview (ms)',
  ...
  'openChamberLogo.aria.logo': 'Logo do OMPChamber',
  ...
  'chat.workStatus.section.processes': 'Processos',
  'chat.workStatus.processes.running': 'em execução',
  'chat.workStatus.processes.exited': 'finalizado',
  'chat.workStatus.processes.killed': 'encerrado',
  'chat.workStatus.processes.failed': 'falhou',
  'chat.workStatus.processes.uncertain': 'atribuição incerta',
  'chat.workStatus.processes.kill': 'Matar',
  'chat.workStatus.processes.killAll': 'Matar todos',
  'chat.workStatus.processes.killConfirm': 'Tem certeza?',
  'chat.workStatus.processes.view': 'Ver {command}',
  'chat.workStatus.processes.viewAll': 'Ver todos os processos',
  'chat.workStatus.processes.output': 'Saída',
  'chat.workStatus.processes.command': 'Comando',
  'chat.workStatus.processes.cpu': 'CPU',
  'chat.workStatus.processes.memory': 'Memória',
  'chat.workStatus.processes.liveCount': '{count} ativos',
  'chat.workStatus.processes.endedCount': '{count} finalizados',
  'chat.workStatus.processes.statsStale': 'dados desatualizados',
  ...
  'chat.workStatus.section.localFiles': 'Arquivos locais da sessão',
  ...
  'chat.toolPart.taskAgent.openArtifact': 'Abrir artefato de saída',
  ...
  'dialogs.omp.approval.title': 'Aprovação necessária',
  'dialogs.omp.planReview.choice.approveExecute': 'Aprovar e executar',
  'dialogs.omp.planReview.choice.approveCompact': 'Aprovar e compactar o contexto',
  'dialogs.omp.planReview.choice.approveKeep': 'Aprovar e manter o contexto',
  'dialogs.omp.planReview.choice.refine': 'Refinar o plano',
  'dialogs.omp.planReview.planReady': 'Plano pronto para revisão.',
  'dialogs.omp.planReview.planMissing': 'Arquivo do plano não encontrado. Você ainda pode revisar a proposta.',
  'dialogs.omp.planReview.loadingPlan': 'Carregando o plano…',
  'dialogs.omp.planReview.contentUnavailable': 'O conteúdo do plano está indisponível. Você ainda pode decidir.',
  'dialogs.omp.planReview.editMode': 'Editar o plano',
  'dialogs.omp.planReview.previewMode': 'Pré-visualizar',
  'dialogs.omp.planReview.editAreaLabel': 'Conteúdo editado do plano',
  'dialogs.omp.planReview.feedbackLabel': 'Feedback de refinamento',
  'dialogs.omp.planReview.feedbackPlaceholder': 'O que deve mudar no plano?',
  'dialogs.omp.planReview.refineCancel': 'Cancelar',
  'dialogs.omp.planReview.refineSubmit': 'Enviar feedback',
  'dialogs.omp.planReview.refineSubmitted': 'Feedback enviado. O plano será revisto.',
  'dialogs.omp.planReview.submitting': 'Processando…',
  'dialogs.omp.planReview.decisionFailed': 'Não foi possível enviar a decisão de revisão.',
  'dialogs.omp.planReview.unavailable': 'A revisão do plano está indisponível.',
  'dialogs.omp.approval.bodyAria': 'Solicitação de aprovação de ferramenta',
  'dialogs.omp.approval.approve': 'Aprovar',
  'dialogs.omp.approval.deny': 'Negar',
  'dialogs.omp.approval.alwaysAllow': 'Sempre permitir esta ferramenta (grava nas configurações) e aprovar',
  'dialogs.omp.approval.alwaysAllowConfirm': 'Gravar configuração e aprovar',
  'dialogs.omp.approval.alwaysAllowConfirmBody': 'Grava tools.approval.{tool} = allow nas suas configurações globais do omp e então aprova esta solicitação.',
  'dialogs.omp.approval.alwaysAllowCancel': 'Voltar',
  'dialogs.omp.approval.alwaysAllowFailed': 'Não foi possível gravar a configuração. Nada foi aprovado — o diálogo continua aberto.',
  'dialogs.omp.approval.respondFailed': 'Falha ao responder',
  'dialogs.omp.ask.title': 'Perguntas',
  'dialogs.omp.ask.summaryTab': 'Resumo',
  'dialogs.omp.ask.noAnswer': 'Sem resposta',
  'dialogs.omp.ask.recommended': 'Recomendado',
  'dialogs.omp.ask.other': 'Outro (digite o seu)',
  'dialogs.omp.ask.otherPlaceholder': 'Digite sua resposta…',
  'dialogs.omp.ask.note': 'Nota (opcional)',
  'dialogs.omp.ask.chatAboutThis': 'Conversar sobre isso',
  'dialogs.omp.ask.next': 'Avançar',
  'dialogs.omp.ask.submit': 'Enviar',
  'dialogs.omp.ask.respondFailed': 'Falha ao responder',
  'dialogs.omp.queue.moreWaiting': '{count} aguardando',
  'dialogs.omp.select.title': 'Escolha uma opção',
  'dialogs.omp.confirm.yes': 'Sim',
  'dialogs.omp.confirm.no': 'Não',
  'dialogs.omp.generic.cancel': 'Cancelar',
  'dialogs.omp.input.submit': 'Enviar',
  'dialogs.omp.notify.backgroundTitle': 'A sessão aguarda sua resposta',
  'dialogs.omp.notify.backgroundBody': 'A sessão {session} está aguardando uma resposta',
  'dialogs.omp.tray.approvalRow': 'Sessão {session} — aprovação necessária',
  'dialogs.omp.tray.approvalRowWithTool': 'Sessão {session} — {tool} precisa de aprovação',
  'dialogs.omp.tray.askRow': 'Sessão {session} — perguntas aguardando',
  'dialogs.omp.workStatus.waitingAnswer': 'aguardando sua resposta',
  'dialogs.internalUri.dialogDescription': 'Conteúdo do recurso interno',
  'dialogs.internalUri.linkTitle': 'Abrir recurso interno',
  'dialogs.internalUri.copyUrl': 'Copiar link',
  'dialogs.internalUri.copied': 'Link copiado',
  'dialogs.internalUri.copyFailed': 'Não foi possível copiar o link',
  'dialogs.internalUri.loading': 'Resolvendo recurso…',
  'dialogs.internalUri.immutableBadge': 'Somente leitura',
  'dialogs.internalUri.error.unavailable': 'Este servidor não expõe recursos internos.',
  'dialogs.internalUri.error.tooLarge': 'O recurso é grande demais para exibir ({size}).',
  'dialogs.internalUri.error.resolveFailed': 'Não foi possível resolver este recurso.',
  'dialogs.internalUri.error.binaryFailed': 'Não foi possível carregar este arquivo para visualização.',
  'contextPanel.localFiles.title': 'Arquivos locais da sessão',
  'contextPanel.localFiles.description': 'Navegação somente leitura dos arquivos local:// privados desta sessão.',
  'contextPanel.localFiles.noDirectory': 'Nenhum diretório de projeto ativo.',
  'contextPanel.localFiles.noSession': 'Nenhuma sessão selecionada.',
  'contextPanel.localFiles.filesLoading': 'Carregando arquivos…',
  'contextPanel.localFiles.filesError': 'Não foi possível carregar os arquivos.',
  'contextPanel.localFiles.emptyFiles': 'Esta sessão não tem arquivos local://.',
  'contextPanel.localFiles.openFile': 'Abrir {ref}',
  'contextPanel.localFiles.truncated': 'Lista truncada — há mais arquivos.',
  'contextPanel.localFiles.backToFiles': 'Arquivos do workspace',
  'contextPanel.localFiles.scopeAria': 'Alternar escopo da árvore de arquivos',
  'contextPanel.localFiles.browseHint': 'Escolha um arquivo da árvore desta sessão.',
  'contextPanel.localFiles.previewFailed': 'Não foi possível carregar este arquivo para visualização.',
  'contextPanel.mode.timeline': 'Linha do tempo',
  'contextRail.surface.timeline.description': 'Eventos estruturados da sessão ativa',
  'contextPanel.timeline.empty': 'Nenhum evento',
  'contextPanel.timeline.emptyNoSession': 'Nenhuma sessão ativa',
  'contextPanel.timeline.loading': 'Carregando…',
  'contextPanel.timeline.kind.compaction': 'Compactação',
  'contextPanel.timeline.kind.branch_summary': 'Ramificação',
  'contextPanel.timeline.kind.model_change': 'Mudança de modelo',
  'contextPanel.timeline.kind.mode_change': 'Mudança de modo',
  'contextPanel.timeline.kind.ttsr_injection': 'Injeção de regras',
  'contextPanel.timeline.kind.retry_recovery': 'Nova tentativa',
};
