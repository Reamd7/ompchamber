...
export const dict: Record<I18nKey, string> = {
  ...
  "aboutDialog.diagnosticsDescription": "Inclui o estado do OMPChamber, a integridade do OpenCode, diretórios e projetos.",
...
"chat.modeSelector.conflict": "Saia primeiro do modo {mode}.",
  ...
  "onboarding.localSetup.windows.stepSetBinaryPath": "Se o OMPChamber não detectar o OpenCode automaticamente, defina o caminho do executável a seguir.",
  "onboarding.localSetup.intro": "OpenCode é o coração do OMPChamber. Instale-o para começar.",
  ...
  "onboarding.localSetup.helper.saveAndReload": "Salve nas configurações do OMPChamber e recarregue configurações do OpenCode.",
