...
export const dict: Record<I18nKey, string> = {
  ...
  'contextPanel.mode.agentRun': 'Execução de agente',
  'contextRail.surface.agentRun.description': 'Transcrição somente leitura de uma execução de subagente',
  'contextPanel.agentRun.loading': 'Carregando…',
  'contextPanel.agentRun.empty': 'Nenhuma conversa registrada para esta execução',
  'contextPanel.agentRun.openArtifact': 'Abrir artefato de saída',
  'contextPanel.agentRun.artifactFailed': 'Não foi possível abrir o artefato',
