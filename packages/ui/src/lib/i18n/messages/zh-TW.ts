...
export const dict: Record<I18nKey, string> = {
  ...
  'aboutDialog.diagnosticsDescription': '包含 OMPChamber 狀態、OpenCode 健康資訊、目錄和專案。',
...
'chat.modeSelector.conflict': '請先結束 {mode} 模式。',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': '如果 OMPChamber 未自動偵測到 OpenCode，請在下方設定執行檔路徑。',
  'onboarding.localSetup.intro': 'OpenCode 是 OMPChamber 的核心，先安裝它即可開始。',
  ...
  'onboarding.localSetup.helper.saveAndReload': '將儲存到 OMPChamber 設定並重新載入 OpenCode 設定。',
