...
'chat.modeSelector.conflict': '請先結束 {mode} 模式。',
  ...
  'onboarding.chooser.title': '歡迎使用 OMPChamber',
  ...
  'onboarding.localSetup.title': '設定 OMPChamber',
  'onboarding.localSetup.description': '安裝 ompchamber CLI 以繼續。',
  'onboarding.localSetup.dialog.selectOpencodeBinary': '選擇 ompchamber 執行檔',
  'onboarding.localSetup.errors.cliNotReady': 'ompchamber CLI 尚未就緒。請確認安裝完成後重試。',
  'onboarding.localSetup.errors.detectionFailed': '偵測失敗',
  'onboarding.localSetup.windows.title': 'Windows 設定',
  'onboarding.localSetup.windows.stepInstallWsl': '使用下方命令安裝 ompchamber。',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': '如果 OMPChamber 未自動偵測到 ompchamber，請在下方設定執行檔路徑。',
  'onboarding.localSetup.intro': 'ompchamber CLI 會啟動你的本機引擎——先安裝它即可開始。',
  'onboarding.localSetup.docs.windows': 'GitHub 上的 OMPChamber',
  'onboarding.localSetup.docs.default': 'GitHub 上的 OMPChamber',
  ...
  'onboarding.localSetup.helper.checkAndContinue': '點擊偵測 ompchamber CLI 是否可用。成功後將自動進入主介面。',
  'onboarding.localSetup.status.watching': '正在等待引擎',
  'onboarding.localSetup.status.autoContinue': '偵測到後將自動繼續。',
  'onboarding.localSetup.field.alreadyInstalled': '已安裝？設定 ompchamber CLI 路徑：',
  ...
  'onboarding.localSetup.helper.saveAndReload': '將儲存到 OMPChamber 設定並重新載入引擎設定。',
  'onboarding.localSetup.remotePreference': '更希望使用遠端伺服器？',
  'onboarding.localSetup.actions.connectRemoteServer': '連接遠端伺服器 →',
  'onboarding.localSetup.windows.hintInstallInWsl': '在 Windows 上，請原生安裝並執行 ompchamber。',
  'onboarding.localSetup.windows.hintDetectionFailed': '若偵測失敗，請設定原生路徑，例如 ompchamber.cmd 或 ompchamber.exe。',
  'onboarding.localSetup.hint.ensurePath': '已安裝？請確認 ompchamber 在你的 PATH 中。',
