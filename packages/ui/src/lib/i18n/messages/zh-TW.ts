...
export const dict: Record<I18nKey, string> = {
  ...
  'contextPanel.mode.agentRun': '子代理執行',
  'contextRail.surface.agentRun.description': '單條子代理執行的唯讀對話記錄',
  'contextPanel.agentRun.loading': '載入中…',
  'contextPanel.agentRun.empty': '該執行沒有記錄對話',
  'contextPanel.agentRun.openArtifact': '開啟輸出產物',
  'contextPanel.agentRun.artifactFailed': '無法開啟產物',
