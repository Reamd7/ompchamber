...
export const dict: Record<I18nKey, string> = {
  ...
  'terminalView.actions.releaseControl': '釋放尺寸控制',
  'terminalView.status.driving': '控制中',
  'terminalView.status.following': '跟隨中',
  'terminalView.actions.zoomIn': '放大終端',
  'terminalView.actions.zoomOut': '縮小終端',
  'terminalView.actions.zoomReset': '重設終端縮放 (100%)',
  'terminalView.driverState.idleHint': '尺寸跟隨最小視窗 — 點擊接管控制',
  'terminalView.driverState.drivingHint': '你正在控制尺寸（{cols}×{rows}）— 點擊釋放',
  'terminalView.driverState.followingHint': '其他裝置正在控制（{cols}×{rows}）— 點擊搶佔',
  'terminalView.actions.killSession': '關閉工作階段（中斷所有裝置）',
  'terminalView.actions.killSessionArmed': '再點一次將對所有裝置關閉',
  ...
  'pwa.installPrompt.description': '安裝 OMPChamber 以便更快存取',
  'pwa.installPrompt.action': '安裝',
  'pwa.installPrompt.dismiss': '忽略',
  'pwa.installPrompt.started': '已開始安裝',
  'pwa.installPrompt.installed': 'OMPChamber 已安裝',
  ...
  'mobile.connect.password.placeholder': 'OMPChamber 密碼',
  ...
  'mobile.connect.scan.invalid': '此 QR code 不是 OMPChamber 連線代碼。',
  ...
  'mobile.connect.relay.badge': '透過 OMPChamber Relay 連線',
  ...
  'mobile.connect.error.unreachable': '無法連線至該 OMPChamber 伺服器。',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': '此實例正在執行不同版本的 OMPChamber。你可以連線；如果功能異常，請更新兩端應用程式。',
  'onboarding.remoteConnection.probe.incompatibleMessage': '伺服器正在執行 OMPChamber，但與此應用程式版本不相容。請更新伺服器上的 OMPChamber 後重試。',
  'onboarding.desktopRecovery.remoteIncompatible.title': '需要更新伺服器',
  'onboarding.desktopRecovery.remoteIncompatible.description': '「{host}」上的 OMPChamber 伺服器與此應用程式版本不相容。請更新伺服器上的 OMPChamber 後重試。',
  ...
  'sessions.scheduledTasks.editor.persona.ariaLabel': '工作階段化身',
  'sessions.scheduledTasks.editor.persona.standard': '標準',
  'sessions.scheduledTasks.editor.persona.unavailable': '無法使用',
  ...
  'sessions.sidebar.footer.actions.aboutOMPChamber': '關於 OMPChamber',
  ...
  'sessions.sidebar.session.moveToWorktree.confirm.ownership': '引擎依目錄而非工作階段追蹤這些變更。',
  ...
  'sessions.sidebar.session.status.resident': '常駐記憶體',
  'sessions.sidebar.session.status.residentWithSize': '常駐記憶體 · transcript ~{size}',
  'sessions.sidebar.session.status.residentShort': '常駐記憶體',
  ...
  'walkthrough.blocked.serverUnsupported.description': '此應用程式連線的 OMPChamber 伺服器沒有回應 walkthrough API，代表它比應用程式更舊。請將伺服器升級到 1.18 或更新版本後重新整理。',
  ...
  'contextPanel.browser.tunnelFailedHint': '{url} 執行在 OMPChamber 所在的機器上，無法與其建立連線。這裡不會顯示你本機上的任何內容。',
  ...
  'contextPanel.browser.devServers.remoteOnly': '它們執行在託管 OMPChamber 的那台機器上。要開啟它們需要桌面應用程式。',
  ...
  'contextPanel.browser.trustNotice': '在此開啟的頁面以對 OMPChamber 的完整存取權限執行 — 檢查與截圖需要此權限。僅開啟你信任的網站：惡意頁面可能讀取你的資料或以你的身分執行操作。',
  ...
  'filesView.editor.binaryFileDescription': '此檔案為二進位檔案，無法在 OMPChamber 中編輯。請下載後使用其他應用程式開啟。',
  ...
  'chat.recap.label': '回顧：',
  'chat.sessionError.title': '引擎停止了本次回覆',
  'chat.sessionError.noDetails': '引擎未回報任何詳情。開啟狀態報告（Ctrl/Cmd+Shift+L）查看最近的錯誤。',
  'chat.sessionError.noReply': '引擎沒有開始回覆這則訊息。',
  ...
  'terminalView.tabs.unreadTitle': '未讀的指令輸出',
  ...
  'directoryExplorerDialog.browse.permissionDenied': 'OMPChamber 需要存取此資料夾。',
  ...
  'aboutDialog.diagnosticsDescription': '包含 OMPChamber 狀態、引擎健康資訊、目錄和專案。',
  ...
  'helpDialog.description': '使用這些快速鍵可更有效率地導覽 OMPChamber',
  ...
  'header.actions.openAppMenu': 'OMPChamber 選單',
  'header.actions.openAppMenuAria': '開啟 OMPChamber 選單',
  ...
  'chat.retry.supersededBadge': '已被重試取代',
  ...
  'chat.chat.ompDivider.developerNote': '注入備註',
  'chat.omp.ttsrWarning.title': '已觸發糾偏規則',
  'chat.omp.ttsrWarning.dismissAria': '關閉提醒',
  'chat.omp.strippedToolCalls.one': '本分支省略了 {count} 個工具呼叫，無結果',
  'chat.omp.strippedToolCalls.many': '本分支省略了 {count} 個工具呼叫，無結果',
  'chat.omp.customCard.moreEntries': '還有 {count} 個',
  'chat.omp.cacheMiss.label': '快取未命中',
  'chat.omp.cacheMiss.tokens': '{tokens} 權杖',
  'toast.ompNotice.title.info': '提示',
  'toast.ompNotice.title.warning': '警告',
  'toast.ompNotice.title.error': '錯誤',
  ...
  'chat.emptyState.opencodeUnreachable': '無法連線引擎',
  ...
  'chat.statusRow.todo.status.blocked': '已封鎖',

  'chat.statusRow.todo.status.blockedBy': '被 {reason} 封鎖',
  'chat.statusRow.todo.status.blockedBare': '已封鎖',
  'chat.statusRow.todo.status.abandoned': '已放棄',
  ...
  'chat.workStatus.goal.status.paused': '已暫停',
  'chat.workStatus.goal.status.complete': '已完成',
  'chat.workStatus.goal.status.budgetLimited': '已達預算',
  'chat.workStatus.goal.status.dropped': '已放棄',
  'chat.revert.toast.redo': '已重做',
  'chat.revert.toast.restored': '已恢復全部訊息',
  'chat.toast.opencodeRestartInterrupted.title': '聊天已中斷',
  'chat.toast.opencodeRestartInterrupted.description': '引擎在回覆仍在產生時重新啟動。傳送訊息以繼續。',
  ...
  'chat.commandAutocomplete.badge.ompOverride': '覆蓋 OMPChamber',
  'chat.chatInput.toast.debugRenamed': '引擎現已占用 /debug。OMPChamber 的引導式除錯命令已遷移到 /troubleshoot。',
  'chat.sessionTree.title': '工作階段分支',
  'chat.sessionTree.description': '此工作階段的分叉。選擇一個分支即可開啟其時間軸。',
  'chat.sessionTree.loading': '正在載入分支…',
  'chat.sessionTree.error': '無法載入工作階段樹。',
  'chat.sessionTree.empty': '此工作階段沒有任何分叉。',
  'chat.sessionTree.untitled': '未命名',
  'chat.sessionTree.current': '目前',
  'chat.sessionTree.leaf': '最新',
  'chat.sessionTree.openBranch': '開啟分支 {title}',
  ...
  'chat.toolPart.askQuestionsCount': '{count} 個問題',
  'chat.toolPart.askNoSelection': '未作答',
  'chat.toolPart.askCustomAnswer': '自訂回答',
  'chat.toolPart.askNote': '備註',
  'chat.toolPart.askAutoSelected': '逾時後自動選擇——並非使用者選擇',
  'chat.toolPart.askChatRedirect': '使用者選擇改為在對話中討論，而非作答',
  'chat.toolPart.taskAgent.status.pending': '等待中',
  'chat.toolPart.taskAgent.status.running': '執行中',
  ...
  'chat.toolPart.taskAgent.retrying': '重試 {attempt}/{maxAttempts}',
  'chat.toolPart.taskAgent.retriesExhausted': '重試已耗盡（{attempt}）',
  'chat.toolPart.taskAgent.moreAgents': '還有 {count} 個',
  'chat.todo.total': '總計',
  ...
  'chat.modelControls.roles.configure': '設定角色',
  'chat.modelControls.roles.thinking': '思考 {level}',
  'chat.modelControls.thinkingChangeFailed': '無法變更思考級別',
  'chat.modelControls.modelChangeFailed': '無法變更模型',
  'chat.modelControls.setAsRole': '設為角色',
  'chat.modelControls.setAsRole.aria': '將此模型指派給角色',
  'chat.modelControls.setAsRole.applied': '角色 {role} 已更新',
  'chat.modelControls.setAsRole.failed': '無法指派角色',
  'chat.modelControls.setAsRole.rejected.role-already-configured': '該角色已設定模型',
  'chat.modelControls.enabledWarning': '目前模型不在 enabledModels 中',
  'chat.modeSelector.label.default': '預設',
  'chat.modeSelector.label.plan': '規劃',
  'chat.modeSelector.label.planPaused': '規劃（已暫停）',
  'chat.modeSelector.label.goal': '目標',
  'chat.modeSelector.label.goalPaused': '目標（已暫停）',
  'chat.modeSelector.label.vibe': '隨性',
  'chat.modeSelector.label.loop': '循環',
  'chat.modeSelector.ariaLabel': '工作階段模式',
  'chat.modeSelector.title': '模式',
  'chat.modeSelector.requiresSession': '開始工作階段後才能切換模式',
  ...
  'chat.goalIndicator.title': '目標',
  'chat.goalIndicator.status.active': '進行中',
  'chat.goalIndicator.status.paused': '已暫停',
  'chat.goalIndicator.status.complete': '已完成',
  'chat.goalIndicator.status.budgetLimited': '預算已達上限',
  'chat.goalIndicator.status.dropped': '已放棄',
  'chat.goalIndicator.noObjective': '未記錄目標內容',
  ...
  'commandPalette.item.showOpenCodeStatus': '顯示引擎狀態',
  'commandPalette.item.toggleMemoryDebug': '切換偵錯面板',
  ...
  'openCodeStatusDialog.title': '引擎狀態',
  'openCodeStatusDialog.description': '檢視目前引擎狀態與診斷資訊。',
  ...
  'openCodeStatusDialog.memory.title': '引擎記憶體',
  'openCodeStatusDialog.memory.refreshNote': '開啟期間每 5 秒重新整理',
  'openCodeStatusDialog.memory.loading': '載入中…',
  'openCodeStatusDialog.memory.unavailable': '目前的引擎版本不支援記憶體診斷。',
  'openCodeStatusDialog.memory.error': '記憶體診斷載入失敗。',
  'openCodeStatusDialog.memory.processHeap': '處理程序堆積',
  'openCodeStatusDialog.memory.processRss': '處理程序 RSS',
  'openCodeStatusDialog.memory.processExternal': '外部記憶體 + 緩衝',
  'openCodeStatusDialog.memory.residentEstimate': '常駐工作階段（估算）',
  'openCodeStatusDialog.memory.sessionsTitle': '常駐工作階段：{live} 個使用中 · 共 {total} 個',
  'openCodeStatusDialog.memory.sessionsStates': '載入中 {materializing} · 移除中 {evicting} · 失敗 {failed}',
  'openCodeStatusDialog.memory.noResident': '沒有常駐記憶體的工作階段。',
  'openCodeStatusDialog.memory.truncated': '清單已截斷 — 僅顯示最大的常駐工作階段。',
  'openCodeStatusDialog.memory.colSession': '工作階段',
  'openCodeStatusDialog.memory.colDirectory': '目錄',
  'openCodeStatusDialog.memory.colState': '狀態',
  'openCodeStatusDialog.memory.colSize': '~大小',
  'openCodeStatusDialog.memory.colIdle': '閒置',
  'openCodeStatusDialog.memory.wireBus': 'Wire 事件緩衝',
  'openCodeStatusDialog.memory.ompBus': 'OMP 事件緩衝',
  'openCodeStatusDialog.memory.busValue': '{entries} 筆 · {size}（上限 {capacity}）',
  'openCodeStatusDialog.memory.wireIdEchoes': 'Wire-ID 回聲',
  'openCodeStatusDialog.memory.inFlightUnderflow': 'inFlight 下溢',
  'openCodeStatusDialog.memory.estimateNote': '工作階段大小為 transcript 體積估算值（約為常駐堆積的 1.3 倍），不是逐工作階段實測歸因。',
  'openCodeStatusDialog.monitor.tabOverview': '概覽',
  'openCodeStatusDialog.monitor.tabSessions': '工作階段',
  'openCodeStatusDialog.monitor.residentCount': '{total} 個常駐',
  'openCodeStatusDialog.monitor.catSessions': '常駐工作階段（估算）',
  'openCodeStatusDialog.monitor.catBuffers': '事件緩衝',
  'openCodeStatusDialog.monitor.catUnattributed': '未歸因引擎記憶體',
  'openCodeStatusDialog.monitor.processMonitor': '進程監控',
  'openCodeStatusDialog.monitor.processMonitorValue': '{live} 個存活 · {windows} 個呼叫 · {failures} 次取樣失敗',
  'openCodeStatusDialog.monitor.stateLive': '常駐',
  'openCodeStatusDialog.monitor.stateMaterializing': '載入中',
  'openCodeStatusDialog.monitor.stateEvicting': '移除中',
  'openCodeStatusDialog.monitor.stateFailed': '失敗',
  'openCodeStatusDialog.monitor.largeOnly': '僅顯示 ≥10MB',
  'openCodeStatusDialog.monitor.noLarge': '沒有 ≥10MB 的常駐工作階段。',
  'openCodeStatusDialog.monitor.colAction': '操作',
  'openCodeStatusDialog.monitor.release': '釋放',
  'openCodeStatusDialog.monitor.releaseHint': '從記憶體移除 — transcript 保留在磁碟上',
  'openCodeStatusDialog.monitor.releaseBusy': '工作階段仍在使用中 — 無法釋放。',
  'openCodeStatusDialog.monitor.releaseFailed': '釋放工作階段失敗。',
  ...
  'sessionAuth.error.networkDescription': '無法驗證 UI 會話。如果你是從本機網路中的其他裝置開啟 OMPChamber，請在桌面應用程式中啟用 Desktop Network Access，並使用設定中顯示的 LAN 位址。',
  ...
  'sessionAuth.locked.unlockTitle': '解鎖 OMPChamber',
  ...
  'desktopHostSwitcher.description': '在 Local 與遠端 OMPChamber 伺服器之間切換',
  ...
  'multiRun.window.description': 'OMPChamber 多執行視窗。',
  ...
  'onboarding.remoteConnection.description': '輸入要連接的 OMPChamber 伺服器位址。',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': '建議：確認 URL 指向 OMPChamber 伺服器，或聯絡伺服器管理員。',
  ...
  'onboarding.remoteConnection.probe.wrongServiceMessage': '伺服器有回應，但未執行 OMPChamber。請確認位址是否指向 OMPChamber 伺服器。',
  'onboarding.remoteConnection.probe.unreachableMessage': '伺服器無法連線。請檢查網路連線並確認伺服器位址。',
  'onboarding.desktopRecovery.localUnavailable.title': '本機引擎無法使用',
  'onboarding.desktopRecovery.localUnavailable.description': '本機引擎無法啟動。請重試啟動，或改為連線遠端伺服器。',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': '「{host}」上的伺服器未執行 OMPChamber。請確認位址是否指向 OMPChamber 伺服器。',
  ...
  'startup.initRecovery.description': 'OMPChamber 未能完成初始化。請檢查伺服器是否正在執行，然後重試。',
  ...
  'updateDialog.error.takingLonger': '更新耗時超出預期。請稍等後重新整理，或執行：ompchamber update',
  'updateDialog.error.signatureRejected': '下載的更新遭到拒絕：其程式碼簽章與目前的安裝不符。這通常表示執行中的副本不是從官方簽章版本安裝的。請從官方版本安裝 OMPChamber，再重新更新。',
  'updateDialog.error.updaterDisabled': '一次安裝失敗後，更新程式已停止。請結束 OMPChamber，重新開啟後再試一次更新。',
  'updateDialog.error.restartFailed': '無法重新啟動以安裝更新。',
  'updateDialog.error.restartUnavailable': '安裝更新需要 OMPChamber 桌面應用程式。',
  ...
  'memoryDebugPanel.resizeHandle': '拖曳調整面板寬度',
  'memoryDebugPanel.metricName.sidebarScrollAnchorAdjustment': '側欄捲動錨點調整',
  'memoryDebugPanel.metricName.sidebarSessionNodeRender': '側欄會話列渲染',
  'memoryDebugPanel.metricName.sidebarSessionNodePropsChanged': '側欄會話屬性變更',
  'memoryDebugPanel.metricName.globalSessionsEventUpdateDeferred': '會話事件更新延遲',
  'memoryDebugPanel.metricName.globalSessionsEventUpdateImmediate': '會話事件即時更新',
  'memoryDebugPanel.metricName.globalSessionsEventUpdatePublication': '會話事件更新發布',
  'memoryDebugPanel.metricName.sidebarProjectSectionReused': '專案分區複用',
  'memoryDebugPanel.metricName.sidebarProjectSectionRebuilt': '專案分區重建',
  'memoryDebugPanel.metricName.sidebarProjectSectionRebuiltReason': '專案分區重建原因',
  'memoryDebugPanel.metricName.sidebarProjectsListRender': '專案列表渲染',
  'memoryDebugPanel.metricName.sessionSidebarRender': '會話側欄渲染',
  'memoryDebugPanel.metricName.sessionSidebarSource': '會話側欄來源',
  'memoryDebugPanel.metricName.headerRender': '標頭渲染',
  'memoryDebugPanel.metricName.assistantTextRender': '助理文字渲染',
  'memoryDebugPanel.metricName.assistantTextDisplayLen': '助理文字顯示長度',
  'memoryDebugPanel.metricName.messageListEntryRender': '訊息列表項目渲染',
  'memoryDebugPanel.metricName.messageListRender': '訊息列表渲染',
  'memoryDebugPanel.metricName.messageListBaseDisplayMs': '訊息列表基礎顯示（ms）',
  'memoryDebugPanel.metricName.messageListRetryOverlayMs': '訊息列表重試覆疊（ms）',
  'memoryDebugPanel.metricName.messageListRenderEntriesMs': '訊息列表項目渲染（ms）',
  'memoryDebugPanel.metricName.markdownRender': 'Markdown 渲染',
  'memoryDebugPanel.metricName.markdownContentLen': 'Markdown 內容長度',
  'memoryDebugPanel.metricName.markdownDomCache': 'Markdown DOM 快取',
  'memoryDebugPanel.metricName.markdownSettledPaintReused': 'Markdown 穩定繪製複用',
  'memoryDebugPanel.metricName.chatMessageRender': '聊天訊息渲染',
  'memoryDebugPanel.metricName.turnsProjectionMs': '回合投影（ms）',
  'memoryDebugPanel.metricName.vscodeWebviewSseChunk': 'Webview SSE 區塊',
  'memoryDebugPanel.metricName.vscodeWebviewSseChunkBytes': 'Webview SSE 區塊位元組',
  'memoryDebugPanel.metricName.vscodeWebviewSseEnd': 'Webview SSE 結束',
  'memoryDebugPanel.metricName.vscodeWebviewSseStartMs': 'Webview SSE 啟動（ms）',
  ...
  'openChamberLogo.aria.logo': 'OMPChamber 標誌',
  ...
  'chat.workStatus.section.processes': '行程',
  'chat.workStatus.processes.running': '執行中',
  'chat.workStatus.processes.exited': '已退出',
  'chat.workStatus.processes.killed': '已終止',
  'chat.workStatus.processes.failed': '失敗',
  'chat.workStatus.processes.uncertain': '歸屬不確定',
  'chat.workStatus.processes.kill': '終止',
  'chat.workStatus.processes.killAll': '全部終止',
  'chat.workStatus.processes.killConfirm': '確定？',
  'chat.workStatus.processes.view': '檢視 {command}',
  'chat.workStatus.processes.viewAll': '檢視所有行程',
  'chat.workStatus.processes.output': '輸出',
  'chat.workStatus.processes.command': '命令',
  'chat.workStatus.processes.cpu': 'CPU',
  'chat.workStatus.processes.memory': '記憶體',
  'chat.workStatus.processes.liveCount': '{count} 個存活',
  'chat.workStatus.processes.endedCount': '{count} 個已結束',
  'chat.workStatus.processes.statsStale': '統計已過期',
  ...
  'chat.workStatus.section.localFiles': '工作階段 local 檔案',
  ...
  'dialogs.omp.approval.title': '需要核准',
  'dialogs.omp.planReview.choice.approveExecute': '核准並執行',
  'dialogs.omp.planReview.choice.approveCompact': '核准並壓縮情境',
  'dialogs.omp.planReview.choice.approveKeep': '核准並保留情境',
  'dialogs.omp.planReview.choice.refine': '精煉計畫',
  'dialogs.omp.planReview.planReady': '計畫已就緒,等待檢閱。',
  'dialogs.omp.planReview.planMissing': '找不到計畫檔案。仍可檢閱該提案。',
  'dialogs.omp.planReview.loadingPlan': '正在載入計畫…',
  'dialogs.omp.planReview.contentUnavailable': '計畫內容暫時無法使用。你仍可做出決定。',
  'dialogs.omp.planReview.editMode': '編輯計畫',
  'dialogs.omp.planReview.previewMode': '預覽',
  'dialogs.omp.planReview.editAreaLabel': '編輯後的計畫內容',
  'dialogs.omp.planReview.feedbackLabel': '精煉意見',
  'dialogs.omp.planReview.feedbackPlaceholder': '計畫需要修改哪些地方?',
  'dialogs.omp.planReview.refineCancel': '取消',
  'dialogs.omp.planReview.refineSubmit': '送出意見',
  'dialogs.omp.planReview.refineSubmitted': '意見已送出,計畫將進行修正。',
  'dialogs.omp.planReview.submitting': '處理中…',
  'dialogs.omp.planReview.decisionFailed': '無法送出檢閱決定。',
  'dialogs.omp.planReview.unavailable': '計畫檢閱目前無法使用。',
  'dialogs.omp.approval.bodyAria': '工具核准請求',
  'dialogs.omp.approval.approve': '核准',
  'dialogs.omp.approval.deny': '拒絕',
  'dialogs.omp.approval.alwaysAllow': '一律允許此工具(寫入設定)並核准',
  'dialogs.omp.approval.alwaysAllowConfirm': '寫入設定並核准',
  'dialogs.omp.approval.alwaysAllowConfirmBody': '將 tools.approval.{tool} = allow 寫入全域 omp 設定,然後核准本次請求。',
  'dialogs.omp.approval.alwaysAllowCancel': '返回',
  'dialogs.omp.approval.alwaysAllowFailed': '設定寫入失敗。未核准任何操作,對話框保持開啟。',
  'dialogs.omp.approval.respondFailed': '應答失敗',
  'dialogs.omp.ask.title': '提問',
  'dialogs.omp.ask.summaryTab': '總覽',
  'dialogs.omp.ask.noAnswer': '未作答',
  'dialogs.omp.ask.recommended': '建議',
  'dialogs.omp.ask.other': '其他(自訂輸入)',
  'dialogs.omp.ask.otherPlaceholder': '輸入你的回答…',
  'dialogs.omp.ask.note': '備註(可選)',
  'dialogs.omp.ask.chatAboutThis': '改為討論',
  'dialogs.omp.ask.next': '下一題',
  'dialogs.omp.ask.submit': '送出',
  'dialogs.omp.ask.respondFailed': '應答失敗',
  'dialogs.omp.queue.moreWaiting': '還有 {count} 個等待中',
  'dialogs.omp.select.title': '選擇一個選項',
  'dialogs.omp.confirm.yes': '是',
  'dialogs.omp.confirm.no': '否',
  'dialogs.omp.generic.cancel': '取消',
  'dialogs.omp.input.submit': '送出',
  'dialogs.omp.notify.backgroundTitle': '工作階段等待你的輸入',
  'dialogs.omp.notify.backgroundBody': '工作階段 {session} 正在等待應答',
  'dialogs.omp.tray.approvalRow': '工作階段 {session} — 等待批准',
  'dialogs.omp.tray.approvalRowWithTool': '工作階段 {session} — {tool} 等待批准',
  'dialogs.omp.tray.askRow': '工作階段 {session} — 有問題待答',
  'dialogs.omp.workStatus.waitingAnswer': '正在等待應答',
  'dialogs.internalUri.dialogDescription': '內部資源內容',
  'dialogs.internalUri.linkTitle': '開啟內部資源',
  'dialogs.internalUri.copyUrl': '複製連結',
  'dialogs.internalUri.copied': '連結已複製',
  'dialogs.internalUri.copyFailed': '無法複製連結',
  'dialogs.internalUri.loading': '正在解析資源…',
  'dialogs.internalUri.immutableBadge': '唯讀',
  'dialogs.internalUri.error.unavailable': '此伺服器未開放內部資源。',
  'dialogs.internalUri.error.tooLarge': '資源過大，無法顯示（{size}）。',
  'dialogs.internalUri.error.resolveFailed': '無法解析此資源。',
  'dialogs.internalUri.error.binaryFailed': '無法載入此檔案進行預覽。',
  'contextPanel.localFiles.title': '工作階段 local 檔案',
  'contextPanel.localFiles.description': '唯讀瀏覽此工作階段私有的 local:// 檔案。',
  'contextPanel.localFiles.noDirectory': '目前沒有作用中的專案目錄。',
  'contextPanel.localFiles.noSession': '未選擇工作階段。',
  'contextPanel.localFiles.filesLoading': '正在載入檔案…',
  'contextPanel.localFiles.filesError': '無法載入檔案。',
  'contextPanel.localFiles.emptyFiles': '此工作階段沒有 local:// 檔案。',
  'contextPanel.localFiles.openFile': '開啟 {ref}',
  'contextPanel.localFiles.truncated': '清單已截斷，還有更多檔案。',
  'contextPanel.localFiles.backToFiles': '工作區檔案',
  'contextPanel.localFiles.scopeAria': '切換檔案樹範圍',
  'contextPanel.localFiles.browseHint': '從該工作階段的檔案樹中選擇一個檔案。',
  'contextPanel.localFiles.previewFailed': '無法載入此檔案進行預覽。',
  'contextPanel.mode.timeline': '時間線',
  'contextRail.surface.timeline.description': '目前工作階段的結構化事件',
  'contextPanel.timeline.empty': '暫無事件',
  'contextPanel.timeline.emptyNoSession': '無活動工作階段',
  'contextPanel.timeline.loading': '載入時間線…',
  'contextPanel.timeline.kind.compaction': '壓縮',
  'contextPanel.timeline.kind.branch_summary': '分支',
  'contextPanel.timeline.kind.model_change': '模型切換',
  'contextPanel.timeline.kind.mode_change': '模式切換',
  'contextPanel.timeline.kind.ttsr_injection': '規則注入',
  'contextPanel.timeline.kind.retry_recovery': '重試',
};
