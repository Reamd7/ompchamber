...
export const dict: Record<I18nKey, string> = {
  ...
  'onboarding.chooser.title': 'Witaj w OMPChamber',
  ...
  'onboarding.localSetup.title': 'Konfiguracja OMPChamber',
  'onboarding.localSetup.description': 'Zainstaluj CLI ompchamber, aby kontynuować.',
  'onboarding.localSetup.dialog.selectOpencodeBinary': 'Wybierz binarkę ompchamber',
  'onboarding.localSetup.errors.cliNotReady': 'CLI ompchamber nie jest jeszcze gotowy. Potwierdź, że instalacja jest kompletna i spróbuj ponownie.',
  ...
  'onboarding.localSetup.windows.stepInstallWsl': 'Zainstaluj ompchamber za pomocą poniższego polecenia.',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'Jeśli OMPChamber nie wykryje ompchamber automatycznie, ustaw ścieżkę binarki poniżej.',
  'onboarding.localSetup.docs.windows': 'OMPChamber na GitHub',
  'onboarding.localSetup.docs.default': 'OMPChamber na GitHub',
  'onboarding.localSetup.actions.checking': 'Sprawdzanie...',
  'onboarding.localSetup.helper.checkAndContinue': 'Kliknij, aby sprawdzić, czy CLI ompchamber jest dostępny. Jeśli się uda, automatycznie przejdziesz do głównego ekranu.',
  'onboarding.localSetup.field.alreadyInstalled': 'Już zainstalowane? Ustaw ścieżkę CLI ompchamber:',
  'onboarding.localSetup.actions.browse': 'Przeglądaj',
  'onboarding.localSetup.actions.apply': 'Zastosuj',
  'onboarding.localSetup.helper.saveAndReload': 'Zapisuje do ustawień OMPChamber i przeładowuje konfigurację silnika.',
  ...
  'onboarding.localSetup.windows.hintInstallInWsl': 'W Windows zainstaluj i uruchom ompchamber natywnie.',
  'onboarding.localSetup.windows.hintDetectionFailed': 'Jeśli wykrywanie nie powiedzie się, ustaw natywną ścieżkę, np. ompchamber.cmd lub ompchamber.exe.',
  'onboarding.localSetup.hint.ensurePath': 'Już zainstalowane? Upewnij się, że ompchamber jest w twoim PATH.',
...
'chat.modeSelector.conflict': 'Najpierw zakończ tryb {mode}.',
  ...
  'onboarding.localSetup.intro': 'CLI ompchamber uruchamia twój lokalny silnik — zainstaluj je, aby zacząć.',
  'onboarding.localSetup.actions.checkNow': 'Sprawdź teraz',
  'onboarding.localSetup.status.watching': 'Czekanie na silnik',
