...
export const dict: Record<I18nKey, string> = {
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'Jeśli OMPChamber nie wykryje OpenCode automatycznie, ustaw ścieżkę binarki poniżej.',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'Zapisuje do ustawień OMPChamber i przeładowuje konfigurację OpenCode.',
  ...
  'aboutDialog.diagnosticsDescription': 'Zawiera stan OMPChamber, kondycję OpenCode, katalogi i projekty.',
...
'chat.modeSelector.conflict': 'Najpierw zakończ tryb {mode}.',
  ...
  'onboarding.localSetup.intro': 'OpenCode to serce OMPChamber — zainstaluj je, aby zacząć.',
