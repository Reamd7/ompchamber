...
export const dict: Record<I18nKey, string> = {
  ...
  'terminalView.actions.takeControl': 'Przejmij kontrolę rozmiaru',
  'terminalView.actions.releaseControl': 'Zwolnij kontrolę rozmiaru',
  'terminalView.status.driving': 'Sterowanie',
  'terminalView.status.following': 'Śledzenie',
  'terminalView.actions.zoomIn': 'Powiększ terminal',
  'terminalView.actions.zoomOut': 'Pomniejsz terminal',
  'terminalView.actions.zoomReset': 'Resetuj powiększenie terminala (100%)',
  'terminalView.driverState.idleHint': 'Rozmiar podąża za najmniejszym oknem — kliknij, aby przejąć kontrolę',
  'terminalView.driverState.drivingHint': 'Sterujesz rozmiarem ({cols}×{rows}) — kliknij, aby zwolnić',
  'terminalView.driverState.followingHint': 'Inne urządzenie steruje ({cols}×{rows}) — kliknij, aby przejąć',
  'terminalView.actions.killSession': 'Zamknij sesję (odłącza WSZYSTKIE urządzenia)',
  'terminalView.actions.killSessionArmed': 'Kliknij ponownie, aby zamknąć wszędzie',
  ...
  'pwa.installPrompt.description': 'Zainstaluj OMPChamber, aby mieć szybszy dostęp',
  'pwa.installPrompt.action': 'Zainstaluj',
  'pwa.installPrompt.dismiss': 'Odrzuć',
  'pwa.installPrompt.started': 'Instalacja rozpoczęta',
  'pwa.installPrompt.installed': 'OMPChamber został zainstalowany',
  ...
  'layout.header.subagentsRunning': 'W toku: {count}',
  'mobile.nav.aria': 'Nawigacja mobilna',
  'mobile.connect.welcome.title': 'Połącz z OMPChamber',
  ...
  'mobile.connect.password.placeholder': 'Hasło OMPChamber',
  ...
  'mobile.connect.scan.invalid': 'Ten kod QR nie jest kodem połączenia OMPChamber.',
  ...
  'mobile.connect.relay.badge': 'przez OMPChamber Relay',
  ...
  'mobile.connect.error.unreachable': 'Nie udało się połączyć z tym serwerem OMPChamber.',
  ...
  'sessions.sidebar.footer.actions.aboutOMPChamber': 'O OMPChamber',
  ...
  'sessions.scheduledTasks.editor.persona.ariaLabel': 'Persono sesji',
  'sessions.scheduledTasks.editor.persona.standard': 'Standardowa',
  'sessions.scheduledTasks.editor.persona.unavailable': 'Niedostępna',
  ...
  'sessions.sidebar.session.status.resident': 'Rezydentna w pamięci',
  'sessions.sidebar.session.status.residentWithSize': 'Rezydentna w pamięci · transkrypt ~{size}',
  'sessions.sidebar.session.status.residentShort': 'Rezydentna w pamięci',
  ...
  'chat.retry.supersededBadge': 'Zastąpione przez ponowną próbę',
  ...
  'chat.chat.ompDivider.developerNote': 'wstrzyknięta notatka',
  'chat.omp.ttsrWarning.title': 'Wyzwolono reguły pilnowania kursu',
  'chat.omp.ttsrWarning.dismissAria': 'Zamknij ostrzeżenie',
  'chat.omp.strippedToolCalls.one': '{count} wywołanie narzędzia pominięto w tej gałęzi, bez wyniku',
  'chat.omp.strippedToolCalls.many': '{count} wywołań narzędzia pominięto w tej gałęzi, bez wyniku',
  'chat.omp.customCard.moreEntries': '+{count} więcej',
  'chat.omp.cacheMiss.label': 'utrata pamięci podręcznej',
  'chat.omp.cacheMiss.tokens': '{tokens} tokenów',
  'toast.ompNotice.title.info': 'Powiadomienie',
  'toast.ompNotice.title.warning': 'Ostrzeżenie',
  'toast.ompNotice.title.error': 'Błąd',
  ...
  'chat.emptyState.opencodeUnreachable': 'Silnik jest nieosiągalny',
  ...
  'chat.message.fallbackTag': 'awaria',
  ...
  'chat.workStatus.goal.status.paused': 'wstrzymany',
  'chat.workStatus.goal.status.complete': 'ukończony',
  'chat.workStatus.goal.status.budgetLimited': 'limit budżetu',
  'chat.workStatus.goal.status.dropped': 'porzucony',
  ...
  'chat.toast.opencodeRestartInterrupted.description': 'Silnik uruchomił się ponownie podczas generowania odpowiedzi. Wyślij wiadomość, aby kontynuować.',
  ...
  'chat.commandAutocomplete.badge.ompOverride': 'nadpisuje OMPChamber',
  'chat.chatInput.toast.debugRenamed': 'Silnik przejął /debug. Prowadzone debugowanie OMPChamber przeniosło się do /troubleshoot.',
  'chat.sessionTree.title': 'Gałęzie sesji',
  'chat.sessionTree.description': 'Forki tej sesji. Wybierz gałąź, aby otworzyć jej oś czasu.',
  'chat.sessionTree.loading': 'Wczytywanie gałęzi…',
  'chat.sessionTree.error': 'Nie udało się wczytać drzewa sesji.',
  'chat.sessionTree.empty': 'Ta sesja nie ma forków.',
  'chat.sessionTree.untitled': 'Bez tytułu',
  'chat.sessionTree.current': 'bieżąca',
  'chat.sessionTree.leaf': 'najnowsza',
  'chat.sessionTree.openBranch': 'Otwórz gałąź {title}',
  ...
  'multiRun.window.description': 'Okno wielokrotnego uruchomienia OMPChamber.',
  ...
  'onboarding.remoteConnection.description': 'Wpisz adres serwera OMPChamber aby się połączyć.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'Sugestie: Zweryfikuj czy URL wskazuje na serwer OMPChamber, lub skontaktuj się z administratorem serwera.',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': 'Ta instancja używa innej wersji OMPChamber. Możesz się połączyć, ale zaktualizuj obie aplikacje, jeśli coś nie działa.',
  'onboarding.remoteConnection.probe.incompatibleMessage': 'Serwer uruchamia OMPChamber, ale nie jest zgodny z tą wersją aplikacji. Zaktualizuj OMPChamber na serwerze i spróbuj ponownie.',
  'onboarding.remoteConnection.probe.wrongServiceMessage': 'Serwer odpowiedział, ale nie uruchomiono na nim OMPChamber. Zweryfikuj czy adres wskazuje na serwer OMPChamber.',
  ...
  'onboarding.desktopRecovery.localUnavailable.title': 'Lokalny silnik niedostępny',
  'onboarding.desktopRecovery.localUnavailable.description': 'Nie udało się uruchomić lokalnego silnika. Ponów próbę uruchomienia lub połącz się z serwerem zdalnym.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': 'Serwer pod adresem "{host}" nie uruchamia OMPChamber. Zweryfikuj czy adres wskazuje na serwer OMPChamber.',
  'onboarding.desktopRecovery.remoteIncompatible.title': 'Wymagana aktualizacja serwera',
  'onboarding.desktopRecovery.remoteIncompatible.description': 'Serwer OMPChamber pod adresem "{host}" nie jest zgodny z tą wersją aplikacji. Zaktualizuj OMPChamber na serwerze i spróbuj ponownie.',
  ...
  'startup.initRecovery.description': 'OMPChamber nie mógł dokończyć inicjalizacji. Sprawdź czy serwer działa, następnie spróbuj ponownie.',
  ...
  'aboutDialog.diagnosticsDescription': 'Zawiera stan OMPChamber, kondycję silnika, katalogi i projekty.',
  ...
  'aboutDialog.openChamberVersionLabel': 'Wersja OMPChamber {version}',
  'aboutDialog.openCodeVersionLabel': 'Wersja silnika {version}',
  ...
  'chat.modelControls.roles.sectionTitle': 'Role modeli',
  'chat.modelControls.roles.notConfigured': 'Nie skonfigurowano',
  'chat.modelControls.roles.configure': 'Konfiguruj role',
  'chat.modelControls.roles.thinking': 'Rozumowanie {level}',
  'chat.modelControls.thinkingChangeFailed': 'Nie udało się zmienić poziomu myślenia',
  'chat.modelControls.modelChangeFailed': 'Nie udało się zmienić modelu',
  'chat.modelControls.setAsRole': 'Ustaw jako rolę',
  'chat.modelControls.setAsRole.aria': 'Przypisz ten model do roli',
  'chat.modelControls.setAsRole.applied': 'Rola {role} zaktualizowana',
  'chat.modelControls.setAsRole.failed': 'Nie udało się przypisać roli',
  'chat.modelControls.setAsRole.rejected.role-already-configured': 'Rola ma już skonfigurowany model',
  'chat.modelControls.enabledWarning': 'Bieżący model nie jest w enabledModels',
  'chat.modeSelector.label.default': 'Domyślny',
  'chat.modeSelector.label.plan': 'Plan',
  'chat.modeSelector.label.planPaused': 'Plan (wstrzymany)',
  'chat.modeSelector.label.goal': 'Cel',
  'chat.modeSelector.label.goalPaused': 'Cel (wstrzymany)',
  'chat.modeSelector.label.vibe': 'Vibe',
  'chat.modeSelector.label.loop': 'Pętla',
  'chat.modeSelector.ariaLabel': 'Tryb sesji',
  'chat.modeSelector.title': 'Tryb',
  'chat.modeSelector.requiresSession': 'Rozpocznij sesję, aby zmienić jej tryb',
  'chat.modeSelector.changeFailed': 'Nie udało się zmienić trybu sesji.',
  'chat.modeSelector.conflict': 'Najpierw zakończ tryb {mode}.',
  'chat.personaSelector.ariaLabel': 'Persona sesji',
  'chat.extensionWidgets.ariaLabel': 'Widżety rozszerzeń',
  'chat.personaSelector.title': 'Persona',
  'chat.personaSelector.standard': 'Standardowa',
  'chat.personaSelector.sectionTitle': 'Persona sesji',
  'chat.goalIndicator.title': 'Cel',
  'chat.goalIndicator.status.active': 'Aktywny',
  'chat.goalIndicator.status.paused': 'Wstrzymany',
  'chat.goalIndicator.status.complete': 'Ukończony',
  'chat.goalIndicator.status.budgetLimited': 'Osiągnięto limit budżetu',
  'chat.goalIndicator.status.dropped': 'Porzucony',
  'chat.goalIndicator.noObjective': 'Brak zapisanego celu',
  'chat.goalIndicator.budget': '{used}/{budget} tokenów',
  'chat.goalIndicator.tokensUsed': '{used} tokenów',
  ...
  'chat.toolPart.askQuestionsCount': 'Pytania: {count}',
  'chat.toolPart.askNoSelection': 'Brak odpowiedzi',
  'chat.toolPart.askCustomAnswer': 'Własna odpowiedź',
  'chat.toolPart.askNote': 'Notatka',
  'chat.toolPart.askAutoSelected': 'wybrano automatycznie po przekroczeniu czasu — to nie wybór użytkownika',
  'chat.toolPart.askChatRedirect': 'Użytkownik zamiast odpowiedzieć postanowił porozmawiać o tym na czacie',
  'chat.toolPart.taskAgent.status.pending': 'Oczekuje',
  'chat.toolPart.taskAgent.status.running': 'W toku',
  'chat.toolPart.taskAgent.status.completed': 'Ukończono',
  'chat.toolPart.taskAgent.status.failed': 'Niepowodzenie',
  'chat.toolPart.taskAgent.status.aborted': 'Przerwano',
  'chat.toolPart.taskAgent.retrying': 'Ponowna próba {attempt}/{maxAttempts}',
  'chat.toolPart.taskAgent.retriesExhausted': 'Wyczerpane ponowienia ({attempt})',
  'chat.toolPart.taskAgent.moreAgents': '+{count} więcej',
  ...
  'commandPalette.item.toggleMemoryDebug': 'Przełącz panel debugowania',
  ...
  'walkthrough.blocked.serverUnsupported.description': 'Serwer OMPChamber, z którym połączona jest ta aplikacja, nie odpowiedział na API walkthroughu — jest więc starszy niż aplikacja. Zaktualizuj serwer do wersji 1.18 lub nowszej i odśwież.',
  ...
  'contextPanel.browser.tunnelFailedHint': '{url} działa na maszynie, na której jest OMPChamber, i nie udało się otworzyć do niej połączenia. Nic z twojej własnej maszyny nie jest tu pokazywane.',
  ...
  'contextPanel.browser.devServers.remoteOnly': 'Działają na komputerze, na którym uruchomiony jest OMPChamber. Do ich otwarcia potrzebna jest aplikacja desktopowa.',
  ...
  'contextPanel.browser.trustNotice': 'Strony otwierane tutaj działają z pełnym dostępem do OMPChamber — jest to wymagane do inspekcji i zrzutów ekranu. Otwieraj tylko zaufane witryny: złośliwa strona może odczytać Twoje dane lub działać w Twoim imieniu.',
  ...
  'desktopHostSwitcher.description': 'Przełączaj między lokalnymi i zdalnymi serwerami OMPChamber',
  ...
  'directoryExplorerDialog.browse.permissionDenied': 'OMPChamber potrzebuje dostępu do tego folderu.',
  ...
  'filesView.editor.binaryFileDescription': 'Ten plik jest binarny i nie można go edytować w OMPChamber. Pobierz go, aby otworzyć w innej aplikacji.',
  ...
  'header.actions.openAppMenu': 'Menu OMPChamber',
  'header.actions.openAppMenuAria': 'Otwórz menu OMPChamber',
  ...
  'helpDialog.description': 'Użyj tych skrótów klawiaturowych, aby sprawnie poruszać się po OMPChamber.',
  ...
  'memoryDebugPanel.resizeHandle': 'Przeciągnij, aby zmienić szerokość panelu',
  'memoryDebugPanel.metricName.sidebarScrollAnchorAdjustment': 'Korekta kotwicy przewijania paska bocznego',
  'memoryDebugPanel.metricName.sidebarSessionNodeRender': 'Renderowanie wiersza sesji paska bocznego',
  'memoryDebugPanel.metricName.sidebarSessionNodePropsChanged': 'Zmienione propsy sesji paska bocznego',
  'memoryDebugPanel.metricName.globalSessionsEventUpdateDeferred': 'Odroczona aktualizacja zdarzenia sesji',
  'memoryDebugPanel.metricName.globalSessionsEventUpdateImmediate': 'Natychmiastowa aktualizacja zdarzenia sesji',
  'memoryDebugPanel.metricName.globalSessionsEventUpdatePublication': 'Publikacja aktualizacji zdarzenia sesji',
  'memoryDebugPanel.metricName.sidebarProjectSectionReused': 'Ponownie użyte sekcje projektu',
  'memoryDebugPanel.metricName.sidebarProjectSectionRebuilt': 'Przebudowane sekcje projektu',
  'memoryDebugPanel.metricName.sidebarProjectSectionRebuiltReason': 'Powód przebudowy sekcji projektu',
  'memoryDebugPanel.metricName.sidebarProjectsListRender': 'Renderowanie listy projektów',
  'memoryDebugPanel.metricName.sessionSidebarRender': 'Renderowanie paska bocznego sesji',
  'memoryDebugPanel.metricName.sessionSidebarSource': 'Źródło paska bocznego sesji',
  'memoryDebugPanel.metricName.headerRender': 'Renderowanie nagłówka',
  'memoryDebugPanel.metricName.assistantTextRender': 'Renderowanie tekstu asystenta',
  'memoryDebugPanel.metricName.assistantTextDisplayLen': 'Długość wyświetlanego tekstu asystenta',
  'memoryDebugPanel.metricName.messageListEntryRender': 'Renderowanie wpisu listy wiadomości',
  'memoryDebugPanel.metricName.messageListRender': 'Renderowanie listy wiadomości',
  'memoryDebugPanel.metricName.messageListBaseDisplayMs': 'Bazowe wyświetlenie listy wiadomości (ms)',
  'memoryDebugPanel.metricName.messageListRetryOverlayMs': 'Nakładka ponowienia listy wiadomości (ms)',
  'memoryDebugPanel.metricName.messageListRenderEntriesMs': 'Renderowanie wpisów listy wiadomości (ms)',
  'memoryDebugPanel.metricName.markdownRender': 'Renderowanie Markdown',
  'memoryDebugPanel.metricName.markdownContentLen': 'Długość treści Markdown',
  'memoryDebugPanel.metricName.markdownDomCache': 'Pamięć podręczna DOM Markdown',
  'memoryDebugPanel.metricName.markdownSettledPaintReused': 'Ponownie użyte stabilne malowanie Markdown',
  'memoryDebugPanel.metricName.chatMessageRender': 'Renderowanie wiadomości czatu',
  'memoryDebugPanel.metricName.turnsProjectionMs': 'Projekcja tury (ms)',
  'memoryDebugPanel.metricName.vscodeWebviewSseChunk': 'Fragment SSE webview',
  'memoryDebugPanel.metricName.vscodeWebviewSseChunkBytes': 'Bajty fragmentu SSE webview',
  'memoryDebugPanel.metricName.vscodeWebviewSseEnd': 'Koniec SSE webview',
  'memoryDebugPanel.metricName.vscodeWebviewSseStartMs': 'Start SSE webview (ms)',
  ...
  'memoryDebugPanel.section.sessionsInMemory': 'Sesje w pamięci UI',
  ...
  'memoryDebugPanel.tabs.memory': 'Pamięć UI',
  'memoryDebugPanel.tabs.engine': 'Silnik',
  ...
  'openCodeStatusDialog.description': 'Sprawdź bieżący status i diagnostykę silnika.',
  'openCodeStatusDialog.empty.noData': 'Brak danych.',
  'openCodeStatusDialog.title': 'Status silnika',
  ...
  'openCodeStatusDialog.memory.title': 'Pamięć silnika',
  'openCodeStatusDialog.memory.refreshNote': 'odświeżane co 5 s, gdy otwarte',
  'openCodeStatusDialog.memory.loading': 'Ładowanie…',
  'openCodeStatusDialog.memory.unavailable': 'Diagnostyka pamięci nie jest obsługiwana przez tę wersję silnika.',
  'openCodeStatusDialog.memory.error': 'Nie udało się wczytać diagnostyki pamięci.',
  'openCodeStatusDialog.memory.processHeap': 'Sterta procesu',
  'openCodeStatusDialog.memory.processRss': 'RSS procesu',
  'openCodeStatusDialog.memory.processExternal': 'Zewnętrzna + bufory',
  'openCodeStatusDialog.memory.residentEstimate': 'Sesje rezydentne (szac.)',
  'openCodeStatusDialog.memory.sessionsTitle': 'Sesje rezydentne: {live} aktywne · {total} łącznie',
  'openCodeStatusDialog.memory.sessionsStates': 'materializacja {materializing} · eksmisja {evicting} · błąd {failed}',
  'openCodeStatusDialog.memory.noResident': 'Brak sesji rezydentnych.',
  'openCodeStatusDialog.memory.truncated': 'Lista obcięta — pokazano największe sesje rezydentne.',
  'openCodeStatusDialog.memory.colSession': 'Sesja',
  'openCodeStatusDialog.memory.colDirectory': 'Katalog',
  'openCodeStatusDialog.memory.colState': 'Stan',
  'openCodeStatusDialog.memory.colSize': '~Rozmiar',
  'openCodeStatusDialog.memory.colIdle': 'Bezczynna',
  'openCodeStatusDialog.memory.wireBus': 'Bufor zdarzeń wire',
  'openCodeStatusDialog.memory.ompBus': 'Bufor zdarzeń OMP',
  'openCodeStatusDialog.memory.busValue': '{entries} wpisów · {size} (limit {capacity})',
  'openCodeStatusDialog.memory.wireIdEchoes': 'Echa Wire-ID',
  'openCodeStatusDialog.memory.inFlightUnderflow': 'Niedomiary inFlight',
  'openCodeStatusDialog.memory.estimateNote': 'Rozmiary sesji są szacowane na podstawie rozmiaru transkryptu (~1,3× rezydentnej sterty), a nie mierzone przypisanie na sesję.',
  'openCodeStatusDialog.monitor.tabOverview': 'Przegląd',
  'openCodeStatusDialog.monitor.tabSessions': 'Sesje',
  'openCodeStatusDialog.monitor.residentCount': '{total} rezydentnych',
  'openCodeStatusDialog.monitor.catSessions': 'Sesje rezydentne (szac.)',
  'openCodeStatusDialog.monitor.catBuffers': 'Bufory zdarzeń',
  'openCodeStatusDialog.monitor.catUnattributed': 'Silnik bez przypisania',
  'openCodeStatusDialog.monitor.processMonitor': 'Monitor procesów',
  'openCodeStatusDialog.monitor.processMonitorValue': '{live} aktywnych · {windows} wywołań · {failures} nieudanych prób',
  'openCodeStatusDialog.monitor.stateLive': 'aktywna',
  'openCodeStatusDialog.monitor.stateMaterializing': 'ładowanie',
  'openCodeStatusDialog.monitor.stateEvicting': 'eksmisja',
  'openCodeStatusDialog.monitor.stateFailed': 'błąd',
  'openCodeStatusDialog.monitor.largeOnly': 'Tylko ≥10 MB',
  'openCodeStatusDialog.monitor.noLarge': 'Brak sesji rezydentnych ≥10 MB.',
  'openCodeStatusDialog.monitor.colAction': 'Akcja',
  'openCodeStatusDialog.monitor.release': 'Zwolnij',
  'openCodeStatusDialog.monitor.releaseHint': 'Usuń z pamięci — transkrypt pozostaje na dysku',
  'openCodeStatusDialog.monitor.releaseBusy': 'Sesja jest nadal aktywna — nie można zwolnić.',
  'openCodeStatusDialog.monitor.releaseFailed': 'Nie udało się zwolnić sesji.',
  ...
  'sessionAuth.error.networkDescription': 'Nie udało się zweryfikować sesji UI. Jeśli otwierasz OMPChamber z innego urządzenia w sieci lokalnej, włącz Desktop Network Access w aplikacji desktopowej i użyj adresu LAN widocznego w Ustawieniach.',
  ...
  'sessionAuth.locked.unlockTitle': 'Odblokuj OMPChamber',
  ...
  'terminalView.tabs.unreadTitle': 'Nieprzeczytane dane wyjściowe poleceń',
  ...
  'updateDialog.error.takingLonger': 'Aktualizacja trwa dłużej niż oczekiwano. Poczekaj chwilę i odśwież albo uruchom: ompchamber update',
  'updateDialog.error.signatureRejected': 'Pobrana aktualizacja została odrzucona: jej podpis kodu nie pasuje do tej instalacji. Zwykle oznacza to, że uruchomiona kopia nie pochodzi z oficjalnego podpisanego wydania. Zainstaluj OMPChamber z oficjalnego wydania i zaktualizuj ponownie.',
  'updateDialog.error.updaterDisabled': 'Aktualizator zatrzymał się po nieudanej instalacji. Zamknij OMPChamber, otwórz go ponownie i spróbuj zaktualizować jeszcze raz.',
  'updateDialog.error.restartFailed': 'Nie udało się uruchomić ponownie, aby zainstalować aktualizację.',
  'updateDialog.error.restartUnavailable': 'Instalacja aktualizacji wymaga aplikacji desktopowej OMPChamber.',
  'updateDialog.error.updateFailed': 'Aktualizacja nie powiodła się',
  'mobileUpdate.toast.available.title': 'Dostępna aktualizacja OMPChamber',
  ...
  'updateDialog.header.updating': 'Aktualizowanie OMPChamber...',
  ...
  'chat.workStatus.section.processes': 'Procesy',
  'chat.workStatus.processes.running': 'działa',
  'chat.workStatus.processes.exited': 'zakończony',
  'chat.workStatus.processes.killed': 'zabity',
  'chat.workStatus.processes.failed': 'nieudany',
  'chat.workStatus.processes.uncertain': 'przypisanie niepewne',
  'chat.workStatus.processes.kill': 'Zabij',
  'chat.workStatus.processes.killAll': 'Zabij wszystkie',
  'chat.workStatus.processes.killConfirm': 'Na pewno?',
  'chat.workStatus.processes.view': 'Wyświetl {command}',
  'chat.workStatus.processes.viewAll': 'Pokaż wszystkie procesy',
  'chat.workStatus.processes.output': 'Wyjście',
  'chat.workStatus.processes.command': 'Polecenie',
  'chat.workStatus.processes.cpu': 'CPU',
  'chat.workStatus.processes.memory': 'Pamięć',
  'chat.workStatus.processes.liveCount': '{count} aktywnych',
  'chat.workStatus.processes.endedCount': '{count} zakończonych',
  'chat.workStatus.processes.statsStale': 'nieaktualne statystyki',
  ...
  'chat.workStatus.section.localFiles': 'Lokalne pliki sesji',
  ...
  'dialogs.omp.approval.title': 'Wymagane zatwierdzenie',
  'dialogs.omp.planReview.choice.approveExecute': 'Zatwierdź i wykonaj',
  'dialogs.omp.planReview.choice.approveCompact': 'Zatwierdź i skompaktuj kontekst',
  'dialogs.omp.planReview.choice.approveKeep': 'Zatwierdź i zachowaj kontekst',
  'dialogs.omp.planReview.choice.refine': 'Popraw plan',
  'dialogs.omp.planReview.planReady': 'Plan gotowy do przeglądu.',
  'dialogs.omp.planReview.planMissing': 'Nie znaleziono pliku planu. Możesz jeszcze przejrzeć propozycję.',
  'dialogs.omp.planReview.loadingPlan': 'Ładowanie planu…',
  'dialogs.omp.planReview.contentUnavailable': 'Treść planu jest niedostępna. Nadal możesz podjąć decyzję.',
  'dialogs.omp.planReview.editMode': 'Edytuj plan',
  'dialogs.omp.planReview.previewMode': 'Podgląd',
  'dialogs.omp.planReview.editAreaLabel': 'Zmodyfikowana treść planu',
  'dialogs.omp.planReview.feedbackLabel': 'Uwagi do poprawek',
  'dialogs.omp.planReview.feedbackPlaceholder': 'Co powinno się zmienić w planie?',
  'dialogs.omp.planReview.refineCancel': 'Anuluj',
  'dialogs.omp.planReview.refineSubmit': 'Wyślij uwagi',
  'dialogs.omp.planReview.refineSubmitted': 'Uwagi wysłane. Plan zostanie poprawiony.',
  'dialogs.omp.planReview.submitting': 'Przetwarzanie…',
  'dialogs.omp.planReview.decisionFailed': 'Nie udało się przesłać decyzji przeglądu.',
  'dialogs.omp.planReview.unavailable': 'Przegląd planu jest niedostępny.',
  'dialogs.omp.approval.bodyAria': 'Żądanie zatwierdzenia narzędzia',
  'dialogs.omp.approval.approve': 'Zatwierdź',
  'dialogs.omp.approval.deny': 'Odrzuć',
  'dialogs.omp.approval.alwaysAllow': 'Zawsze pozwalaj na to narzędzie (zapisuje ustawienia) i zatwierdź',
  'dialogs.omp.approval.alwaysAllowConfirm': 'Zapisz ustawienie i zatwierdź',
  'dialogs.omp.approval.alwaysAllowConfirmBody': 'Zapisuje tools.approval.{tool} = allow w globalnych ustawieniach omp, a następnie zatwierdza to żądanie.',
  'dialogs.omp.approval.alwaysAllowCancel': 'Wstecz',
  'dialogs.omp.approval.alwaysAllowFailed': 'Nie udało się zapisać ustawienia. Nic nie zatwierdzono — okno pozostaje otwarte.',
  'dialogs.omp.approval.respondFailed': 'Nie udało się odpowiedzieć',
  'dialogs.omp.ask.title': 'Pytania',
  'dialogs.omp.ask.summaryTab': 'Podsumowanie',
  'dialogs.omp.ask.noAnswer': 'Brak odpowiedzi',
  'dialogs.omp.ask.recommended': 'Zalecane',
  'dialogs.omp.ask.other': 'Inna (wpisz własną)',
  'dialogs.omp.ask.otherPlaceholder': 'Wpisz odpowiedź…',
  'dialogs.omp.ask.note': 'Notatka (opcjonalnie)',
  'dialogs.omp.ask.chatAboutThis': 'Porozmawiaj o tym',
  'dialogs.omp.ask.next': 'Dalej',
  'dialogs.omp.ask.submit': 'Wyślij',
  'dialogs.omp.ask.respondFailed': 'Nie udało się odpowiedzieć',
  'dialogs.omp.queue.moreWaiting': '{count} kolejnych oczekuje',
  'dialogs.omp.select.title': 'Wybierz opcję',
  'dialogs.omp.confirm.yes': 'Tak',
  'dialogs.omp.confirm.no': 'Nie',
  'dialogs.omp.generic.cancel': 'Anuluj',
  'dialogs.omp.input.submit': 'Wyślij',
  'dialogs.omp.notify.backgroundTitle': 'Sesja czeka na odpowiedź',
  'dialogs.omp.notify.backgroundBody': 'Sesja {session} czeka na odpowiedź',
  'dialogs.omp.tray.approvalRow': 'Sesja {session} — wymagane zatwierdzenie',
  'dialogs.omp.tray.approvalRowWithTool': 'Sesja {session} — {tool} wymaga zatwierdzenia',
  'dialogs.omp.tray.askRow': 'Sesja {session} — pytania oczekują',
  'dialogs.omp.workStatus.waitingAnswer': 'czeka na odpowiedź',
  'dialogs.internalUri.dialogDescription': 'Zawartość zasobu wewnętrznego',
  'dialogs.internalUri.linkTitle': 'Otwórz zasób wewnętrzny',
  'dialogs.internalUri.copyUrl': 'Kopiuj link',
  'dialogs.internalUri.copied': 'Link skopiowany',
  'dialogs.internalUri.copyFailed': 'Nie udało się skopiować linku',
  'dialogs.internalUri.loading': 'Rozwiązywanie zasobu…',
  'dialogs.internalUri.immutableBadge': 'Tylko do odczytu',
  'dialogs.internalUri.error.unavailable': 'Ten serwer nie udostępnia zasobów wewnętrznych.',
  'dialogs.internalUri.error.tooLarge': 'Zasób jest zbyt duży do wyświetlenia ({size}).',
  'dialogs.internalUri.error.resolveFailed': 'Nie udało się rozwiązać tego zasobu.',
  'dialogs.internalUri.error.binaryFailed': 'Nie udało się wczytać tego pliku do podglądu.',
  'contextPanel.localFiles.title': 'Lokalne pliki sesji',
  'contextPanel.localFiles.description': 'Przeglądanie w trybie tylko do odczytu prywatnych plików local:// tej sesji.',
  'contextPanel.localFiles.noDirectory': 'Brak aktywnego katalogu projektu.',
  'contextPanel.localFiles.noSession': 'Nie wybrano sesji.',
  'contextPanel.localFiles.filesLoading': 'Ładowanie plików…',
  'contextPanel.localFiles.filesError': 'Nie udało się załadować plików.',
  'contextPanel.localFiles.emptyFiles': 'Ta sesja nie ma plików local://.',
  'contextPanel.localFiles.openFile': 'Otwórz {ref}',
  'contextPanel.localFiles.truncated': 'Lista skrócona — istnieją kolejne pliki.',
  'contextPanel.localFiles.backToFiles': 'Pliki obszaru roboczego',
  'contextPanel.localFiles.scopeAria': 'Przełącz zakres drzewa plików',
  'contextPanel.localFiles.browseHint': 'Wybierz plik z drzewa tej sesji.',
  'contextPanel.localFiles.previewFailed': 'Nie udało się wczytać tego pliku do podglądu.',
  'contextPanel.mode.timeline': 'Oś czasu',
  'contextRail.surface.timeline.description': 'Zdarzenia strukturalne aktywnej sesji',
  'contextPanel.timeline.empty': 'Brak zdarzeń',
  'contextPanel.timeline.emptyNoSession': 'Brak aktywnej sesji',
  'contextPanel.timeline.loading': 'Ładowanie…',
  'contextPanel.timeline.kind.compaction': 'Kompaktowanie',
  'contextPanel.timeline.kind.branch_summary': 'Gałąź',
  'contextPanel.timeline.kind.model_change': 'Zmiana modelu',
  'contextPanel.timeline.kind.mode_change': 'Zmiana trybu',
  'contextPanel.timeline.kind.ttsr_injection': 'Wstrzykiwanie reguł',
  'contextPanel.timeline.kind.retry_recovery': 'Ponowna próba',
} as const;
