...
'chat.modeSelector.conflict': 'Najpierw zakończ tryb {mode}.',
  ...
  'settings.ompchamber.keyboardShortcuts.action.open_timeline_dialog.label': 'Otwórz oś czasu',
  ...
  'settings.ompchamber.visual.field.mobileKeyboardModeAria': 'Tryb klawiatury mobilnej',
  'settings.ompchamber.visual.field.selectMobileKeyboardModePlaceholder': 'Wybierz tryb klawiatury mobilnej',
  'settings.ompchamber.visual.actions.resetMobileKeyboardModeAria': 'Resetuj tryb klawiatury mobilnej',
  'settings.ompchamber.visual.option.mobileKeyboardMode.native.label': 'Natywny',
  'settings.ompchamber.visual.option.mobileKeyboardMode.native.description': 'Użyj domyślnego zachowania przeglądarki/systemu.',
  'settings.ompchamber.visual.option.mobileKeyboardMode.resizeContent.label': 'Zmień rozmiar zawartości',
  'settings.ompchamber.visual.option.mobileKeyboardMode.resizeContent.description': 'Dopasuj układ tak, aby zawartość pozostała widoczna ponad klawiaturą.',
