...
export const dict: Record<I18nKey, string> = {
  ...
  'contextPanel.mode.agentRun': 'Uruchomienie agenta',
  'contextRail.surface.agentRun.description': 'Transkrypt tylko do odczytu jednego uruchomienia subagenta',
  'contextPanel.agentRun.loading': 'Ładowanie…',
  'contextPanel.agentRun.empty': 'Brak zapisanej rozmowy dla tego uruchomienia',
  'contextPanel.agentRun.openArtifact': 'Otwórz artefakt wyjściowy',
  'contextPanel.agentRun.artifactFailed': 'Nie udało się otworzyć artefaktu',
