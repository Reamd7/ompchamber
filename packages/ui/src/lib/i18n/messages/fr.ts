...
export const dict = {
  ...
  'sessions.sidebar.footer.actions.aboutOpenChamber': 'À propos de OMPChamber',
  ...
  'chat.chatInput.toast.debugRenamed': "Le moteur réserve désormais /debug. La commande de débogage guidée d'OpenChamber devient /troubleshoot.",
