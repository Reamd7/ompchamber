...
export const dict = {
  ...
  'terminalView.actions.takeControl': 'Prendre le contrôle de la taille',
  'terminalView.actions.releaseControl': 'Libérer le contrôle de la taille',
  'terminalView.status.driving': 'Contrôle actif',
  'terminalView.status.following': 'Suivi',
  'terminalView.actions.zoomIn': 'Agrandir le terminal',
  'terminalView.actions.zoomOut': 'Réduire le terminal',
  'terminalView.actions.zoomReset': 'Réinitialiser le zoom du terminal (100 %)',
  'terminalView.driverState.idleHint': 'La taille suit la fenêtre la plus petite — cliquer pour prendre le contrôle',
  'terminalView.driverState.drivingHint': 'Vous contrôlez la taille ({cols}×{rows}) — cliquer pour libérer',
  'terminalView.driverState.followingHint': 'Un autre appareil contrôle ({cols}×{rows}) — cliquer pour prendre le contrôle',
  'terminalView.actions.killSession': 'Fermer la session (déconnecte TOUS les appareils)',
  'terminalView.actions.killSessionArmed': 'Cliquez à nouveau pour fermer partout',
  ...
  'pwa.installPrompt.description': 'Installez OMPChamber pour un accès plus rapide',
  'pwa.installPrompt.action': 'Installer',
  'pwa.installPrompt.dismiss': 'Ignorer',
  'pwa.installPrompt.started': 'Installation démarrée',
  'pwa.installPrompt.installed': 'OMPChamber installé',
  ...
  'sessions.scheduledTasks.editor.persona.ariaLabel': 'Persona de session',
  'sessions.scheduledTasks.editor.persona.standard': 'Standard',
  'sessions.scheduledTasks.editor.persona.unavailable': 'Indisponible',
  ...
  'sessions.sidebar.footer.actions.aboutOMPChamber': 'À propos de OMPChamber',
  ...
  'sessions.sidebar.session.status.resident': 'Résidente en mémoire',
  'sessions.sidebar.session.status.residentWithSize': 'Résidente en mémoire · transcript ~{size}',
  'sessions.sidebar.session.status.residentShort': 'Résidente en mémoire',
  ...
  'walkthrough.blocked.serverUnsupported.description': 'Le serveur OMPChamber auquel cette application est connectée n\'a pas répondu à l\'API walkthrough : il est donc plus ancien que l\'application. Mettez le serveur à jour en 1.18 ou plus récent, puis actualisez.',
  ...
  'filesView.editor.binaryFileDescription': 'Ce fichier est binaire et ne peut pas être modifié dans OMPChamber. Téléchargez-le pour l’ouvrir avec une autre application.',
  ...
  'terminalView.tabs.unreadTitle': 'Sortie de commandes non lue',
  ...
  'directoryExplorerDialog.browse.permissionDenied': 'OMPChamber doit accéder à ce dossier.',
  ...
  'aboutDialog.openChamberVersionLabel': 'Version OMPChamber {version}',
  'aboutDialog.openCodeVersionLabel': 'Version du moteur {version}',
  ...
  'aboutDialog.diagnosticsDescription': 'Inclut l’état d’OMPChamber, l’état de santé du moteur, les répertoires et les projets.',
  ...
  'helpDialog.description': 'Utilisez ces raccourcis clavier pour naviguer efficacement dans OMPChamber',
  ...
  'header.actions.openAppMenu': 'Menu de OMPChamber',
  'header.actions.openAppMenuAria': 'Ouvrir le menu OMPChamber',
  ...
  'chat.retry.supersededBadge': 'Remplacé par une nouvelle tentative',
  ...
  'chat.chat.ompDivider.developerNote': 'note injectée',
  'chat.omp.ttsrWarning.title': 'Règles de pilotage déclenchées',
  'chat.omp.ttsrWarning.dismissAria': 'Fermer l’avertissement',
  'chat.omp.strippedToolCalls.one': '{count} appel d’outil éludé dans cette branche, sans résultat',
  'chat.omp.strippedToolCalls.many': '{count} appels d’outil éludés dans cette branche, sans résultat',
  'chat.omp.customCard.moreEntries': '+{count} autres',
  'chat.omp.cacheMiss.label': 'échec de cache',
  'chat.omp.cacheMiss.tokens': '{tokens} jetons',
  'toast.ompNotice.title.info': 'Information',
  'toast.ompNotice.title.warning': 'Avertissement',
  'toast.ompNotice.title.error': 'Erreur',
  ...
  'chat.emptyState.opencodeUnreachable': 'Le moteur n’est pas accessible',
  ...
  'chat.statusRow.todo.status.blocked': 'Bloqué',

  'chat.statusRow.todo.status.blockedBy': 'Bloqué par {reason}',
  'chat.statusRow.todo.status.blockedBare': 'Bloqué',
  'chat.statusRow.todo.status.abandoned': 'Abandonné',
  ...
  'chat.message.fallbackTag': 'repli',
  ...
  'chat.workStatus.goal.status.paused': 'en pause',
  'chat.workStatus.goal.status.complete': 'terminé',
  'chat.workStatus.goal.status.budgetLimited': 'budget atteint',
  'chat.workStatus.goal.status.dropped': 'abandonné',
  ...
  'chat.toast.opencodeRestartInterrupted.description': 'Le moteur a redémarré alors qu’une réponse était encore en cours. Envoyez un message pour continuer.',
  ...
  'chat.commandAutocomplete.badge.ompOverride': 'remplace OMPChamber',
  'chat.chatInput.toast.debugRenamed': 'Le moteur réserve désormais /debug. La commande de débogage guidée d\'OMPChamber devient /troubleshoot.',
  'chat.sessionTree.title': 'Branches de la session',
  'chat.sessionTree.description': 'Bifurcations de cette session. Sélectionnez une branche pour ouvrir sa chronologie.',
  'chat.sessionTree.loading': 'Chargement des branches…',
  'chat.sessionTree.error': 'Impossible de charger l\'arborescence de la session.',
  'chat.sessionTree.empty': 'Cette session n\'a pas de bifurcations.',
  'chat.sessionTree.untitled': 'Sans titre',
  'chat.sessionTree.current': 'actuelle',
  'chat.sessionTree.leaf': 'dernière',
  'chat.sessionTree.openBranch': 'Ouvrir la branche {title}',
  ...
  'chat.toolPart.askQuestionsCount': '{count} questions',
  'chat.toolPart.askNoSelection': 'Aucune réponse',
  'chat.toolPart.askCustomAnswer': 'Réponse personnalisée',
  'chat.toolPart.askNote': 'Remarque',
  'chat.toolPart.askAutoSelected': 'sélectionné automatiquement après expiration du délai — ce n’est pas un choix de l’utilisateur',
  'chat.toolPart.askChatRedirect': 'L’utilisateur a préféré en discuter dans le chat plutôt que de répondre',
  'chat.toolPart.taskAgent.status.pending': 'En attente',
  'chat.toolPart.taskAgent.status.running': 'En cours',
  'chat.toolPart.taskAgent.status.completed': 'Terminé',
  'chat.toolPart.taskAgent.status.failed': 'Échoué',
  'chat.toolPart.taskAgent.status.aborted': 'Interrompu',
  'chat.toolPart.taskAgent.retrying': 'Nouvel essai {attempt}/{maxAttempts}',
  'chat.toolPart.taskAgent.retriesExhausted': 'Essais épuisés ({attempt})',
  'chat.toolPart.taskAgent.moreAgents': '+{count} autres',
  ...
  'chat.modelControls.roles.sectionTitle': 'Rôles de modèle',
  'chat.modelControls.roles.notConfigured': 'Non configuré',
  'chat.modelControls.roles.configure': 'Configurer les rôles',
  'chat.modelControls.roles.thinking': 'Réflexion {level}',
  'chat.modelControls.thinkingChangeFailed': 'Impossible de modifier le niveau de réflexion',
  'chat.modelControls.modelChangeFailed': 'Impossible de changer le modèle',
  'chat.modelControls.setAsRole': 'Définir comme rôle',
  'chat.modelControls.setAsRole.aria': 'Affecter ce modèle à un rôle',
  'chat.modelControls.setAsRole.applied': 'Rôle {role} mis à jour',
  'chat.modelControls.setAsRole.failed': 'Impossible d\'affecter le rôle',
  'chat.modelControls.setAsRole.rejected.role-already-configured': 'Le rôle a déjà un modèle configuré',
  'chat.modelControls.enabledWarning': 'Le modèle actuel n\'est pas dans enabledModels',
  'chat.modeSelector.label.default': 'Par défaut',
  'chat.modeSelector.label.plan': 'Plan',
  'chat.modeSelector.label.planPaused': 'Plan (en pause)',
  'chat.modeSelector.label.goal': 'Objectif',
  'chat.modeSelector.label.goalPaused': 'Objectif (en pause)',
  'chat.modeSelector.label.vibe': 'Vibe',
  'chat.modeSelector.label.loop': 'Boucle',
  'chat.modeSelector.ariaLabel': 'Mode de session',
  'chat.modeSelector.title': 'Mode',
  'chat.modeSelector.requiresSession': 'Démarrez la session pour changer son mode',
  ...
  'chat.goalIndicator.title': 'Objectif',
  'chat.goalIndicator.status.active': 'Actif',
  'chat.goalIndicator.status.paused': 'En pause',
  'chat.goalIndicator.status.complete': 'Terminé',
  'chat.goalIndicator.status.budgetLimited': 'Limite de budget atteinte',
  'chat.goalIndicator.status.dropped': 'Abandonné',
  'chat.goalIndicator.noObjective': 'Aucun objectif enregistré',
  'chat.goalIndicator.budget': '{used}/{budget} jetons',
  'chat.goalIndicator.tokensUsed': '{used} jetons',
  ...
  'commandPalette.item.toggleMemoryDebug': 'Basculer le panneau de débogage',
  ...
  'openCodeStatusDialog.title': 'Statut du moteur',
  'openCodeStatusDialog.description': 'Inspectez l’état et les diagnostics actuels du moteur.',
  ...
  'openCodeStatusDialog.memory.title': 'Mémoire du moteur',
  'openCodeStatusDialog.memory.refreshNote': 'actualisé toutes les 5 s tant que la fenêtre est ouverte',
  'openCodeStatusDialog.memory.loading': 'Chargement…',
  'openCodeStatusDialog.memory.unavailable': 'Les diagnostics mémoire ne sont pas pris en charge par cette version du moteur.',
  'openCodeStatusDialog.memory.error': 'Échec du chargement des diagnostics mémoire.',
  'openCodeStatusDialog.memory.processHeap': 'Tas du processus',
  'openCodeStatusDialog.memory.processRss': 'RSS du processus',
  'openCodeStatusDialog.memory.processExternal': 'Externe + tampons',
  'openCodeStatusDialog.memory.residentEstimate': 'Sessions résidentes (est.)',
  'openCodeStatusDialog.memory.sessionsTitle': 'Sessions résidentes : {live} actives · {total} au total',
  'openCodeStatusDialog.memory.sessionsStates': 'matérialisation {materializing} · éviction {evicting} · échec {failed}',
  'openCodeStatusDialog.memory.noResident': 'Aucune session résidente.',
  'openCodeStatusDialog.memory.truncated': 'Liste tronquée — les sessions résidentes les plus volumineuses sont affichées.',
  'openCodeStatusDialog.memory.colSession': 'Session',
  'openCodeStatusDialog.memory.colDirectory': 'Dossier',
  'openCodeStatusDialog.memory.colState': 'État',
  'openCodeStatusDialog.memory.colSize': '~Taille',
  'openCodeStatusDialog.memory.colIdle': 'Inactive',
  'openCodeStatusDialog.memory.wireBus': 'Tampon d’événements wire',
  'openCodeStatusDialog.memory.ompBus': 'Tampon d’événements OMP',
  'openCodeStatusDialog.memory.busValue': '{entries} entrées · {size} (limite {capacity})',
  'openCodeStatusDialog.memory.wireIdEchoes': 'Échos d’ID wire',
  'openCodeStatusDialog.memory.inFlightUnderflow': 'Sous-dépassements inFlight',
  'openCodeStatusDialog.memory.estimateNote': 'Les tailles de session sont des estimations basées sur la taille du transcript (~1,3× du tas résident), pas une attribution mesurée par session.',
  'openCodeStatusDialog.monitor.tabOverview': 'Vue d’ensemble',
  'openCodeStatusDialog.monitor.tabSessions': 'Sessions',
  'openCodeStatusDialog.monitor.residentCount': '{total} résidentes',
  'openCodeStatusDialog.monitor.catSessions': 'Sessions résidentes (est.)',
  'openCodeStatusDialog.monitor.catBuffers': 'Tampons d’événements',
  'openCodeStatusDialog.monitor.catUnattributed': 'Moteur non attribué',
  'openCodeStatusDialog.monitor.processMonitor': 'Moniteur de processus',
  'openCodeStatusDialog.monitor.processMonitorValue': '{live} actifs · {windows} appels · {failures} échantillons en échec',
  'openCodeStatusDialog.monitor.stateLive': 'active',
  'openCodeStatusDialog.monitor.stateMaterializing': 'chargement',
  'openCodeStatusDialog.monitor.stateEvicting': 'éviction',
  'openCodeStatusDialog.monitor.stateFailed': 'échec',
  'openCodeStatusDialog.monitor.largeOnly': 'Seulement ≥10 Mo',
  'openCodeStatusDialog.monitor.noLarge': 'Aucune session résidente ≥10 Mo.',
  'openCodeStatusDialog.monitor.colAction': 'Action',
  'openCodeStatusDialog.monitor.release': 'Libérer',
  'openCodeStatusDialog.monitor.releaseHint': 'Évincer de la mémoire — le transcript reste sur le disque',
  'openCodeStatusDialog.monitor.releaseBusy': 'La session est encore active — libération impossible.',
  'openCodeStatusDialog.monitor.releaseFailed': 'Échec de la libération de la session.',
  ...
  'mcpDropdown.empty.configureInConfig': 'Configurez les serveurs MCP dans les paramètres.',
  ...
  'sessionAuth.error.networkDescription': 'Nous n\\\'avons pas pu vérifier la session d\\\'interface utilisateur. Si vous ouvrez OMPChamber depuis un autre appareil sur votre réseau local, activez l\\\'accès au réseau du bureau dans l\\\'application de bureau et utilisez l\\\'adresse LAN indiquée dans les paramètres.',
  ...
  'sessionAuth.locked.unlockTitle': 'Débloquez OMPChamber',
  ...
  'desktopHostSwitcher.description': 'Basculer entre les serveurs OMPChamber locaux et distants',
  ...
  'multiRun.window.description': 'Fenêtre multi-exécution OMPChamber.',
  ...
  'onboarding.remoteConnection.description': 'Saisissez l\\\'adresse d\\\'un serveur OMPChamber auquel vous connecter.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'Suggestions : vérifiez que l’URL pointe vers un serveur OMPChamber ou contactez l\\\'administrateur du serveur.',
  ...
  'onboarding.remoteConnection.probe.wrongServiceMessage': 'Le serveur a répondu mais n\\\'exécute pas OMPChamber. Vérifiez que l\\\'adresse pointe vers un serveur OMPChamber.',
  ...
  'onboarding.desktopRecovery.localUnavailable.title': 'Moteur local indisponible',
  'onboarding.desktopRecovery.localUnavailable.description': 'Le moteur local n’a pas pu être démarré. Réessayez le lancement ou connectez-vous plutôt à un serveur distant.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': 'Le serveur « {host} » n\\\'exécute pas OMPChamber. Vérifiez que l\\\'adresse pointe vers un serveur OMPChamber.',
  ...
  'startup.initRecovery.description': 'OMPChamber n\\\'a pas pu terminer l\\\'initialisation. Vérifiez que le serveur est en cours d\\\'exécution, puis réessayez.',
  ...
  'updateDialog.header.updating': 'Mise à jour de OMPChamber...',
  ...
  'updateDialog.error.takingLonger': 'La mise à jour prend plus de temps que prévu. Attendez un peu et actualisez, ou exécutez : ompchamber update',
  'updateDialog.error.signatureRejected': 'La mise à jour téléchargée a été rejetée : sa signature de code ne correspond pas à cette installation. Cela signifie généralement que la copie en cours n’a pas été installée depuis une version officielle signée. Installez OMPChamber depuis une version officielle, puis relancez la mise à jour.',
  'updateDialog.error.updaterDisabled': 'Le programme de mise à jour s’est arrêté après une installation échouée. Quittez OMPChamber, rouvrez-le, puis réessayez la mise à jour.',
  'updateDialog.error.restartFailed': 'Impossible de redémarrer pour installer la mise à jour.',
  'updateDialog.error.restartUnavailable': 'L’installation de la mise à jour nécessite l’application de bureau OMPChamber.',
  'mobileUpdate.toast.available.title': 'Mise à jour OMPChamber disponible',
  ...
  'memoryDebugPanel.tabs.memory': 'Mémoire UI',
  'memoryDebugPanel.tabs.engine': 'Moteur',
  'memoryDebugPanel.tabs.streaming': 'Streaming',
  'memoryDebugPanel.tabs.requests': 'Requêtes',
  'memoryDebugPanel.section.sessionsInMemory': 'Sessions en mémoire UI',
  ...
  'memoryDebugPanel.resizeHandle': 'Glisser pour redimensionner le panneau',
  'memoryDebugPanel.metricName.sidebarScrollAnchorAdjustment': 'Ajustement d\\\'ancre de défilement de la barre latérale',
  'memoryDebugPanel.metricName.sidebarSessionNodeRender': 'Rendu de ligne de session de la barre latérale',
  'memoryDebugPanel.metricName.sidebarSessionNodePropsChanged': 'Props de session de barre latérale modifiées',
  'memoryDebugPanel.metricName.globalSessionsEventUpdateDeferred': 'Mise à jour d\\\'événement de session différée',
  'memoryDebugPanel.metricName.globalSessionsEventUpdateImmediate': 'Mise à jour d\\\'événement de session immédiate',
  'memoryDebugPanel.metricName.globalSessionsEventUpdatePublication': 'Publication de mise à jour d\\\'événement de session',
  'memoryDebugPanel.metricName.sidebarProjectSectionReused': 'Sections de projet réutilisées',
  'memoryDebugPanel.metricName.sidebarProjectSectionRebuilt': 'Sections de projet reconstruites',
  'memoryDebugPanel.metricName.sidebarProjectSectionRebuiltReason': 'Raison de reconstruction de section de projet',
  'memoryDebugPanel.metricName.sidebarProjectsListRender': 'Rendu de liste de projets',
  'memoryDebugPanel.metricName.sessionSidebarRender': 'Rendu de barre latérale de session',
  'memoryDebugPanel.metricName.sessionSidebarSource': 'Source de barre latérale de session',
  'memoryDebugPanel.metricName.headerRender': 'Rendu d\\\'en-tête',
  'memoryDebugPanel.metricName.assistantTextRender': 'Rendu de texte de l\\\'assistant',
  'memoryDebugPanel.metricName.assistantTextDisplayLen': 'Longueur de texte de l\\\'assistant affiché',
  'memoryDebugPanel.metricName.messageListEntryRender': 'Rendu d\\\'entrée de liste de messages',
  'memoryDebugPanel.metricName.messageListRender': 'Rendu de liste de messages',
  'memoryDebugPanel.metricName.messageListBaseDisplayMs': 'Affichage de base de liste de messages (ms)',
  'memoryDebugPanel.metricName.messageListRetryOverlayMs': 'Superposition de nouvelle tentative de liste de messages (ms)',
  'memoryDebugPanel.metricName.messageListRenderEntriesMs': 'Rendu d\\\'entrées de liste de messages (ms)',
  'memoryDebugPanel.metricName.markdownRender': 'Rendu Markdown',
  'memoryDebugPanel.metricName.markdownContentLen': 'Longueur de contenu Markdown',
  'memoryDebugPanel.metricName.markdownDomCache': 'Cache DOM Markdown',
  'memoryDebugPanel.metricName.markdownSettledPaintReused': 'Rendu stabilisé Markdown réutilisé',
  'memoryDebugPanel.metricName.chatMessageRender': 'Rendu de message de chat',
  'memoryDebugPanel.metricName.turnsProjectionMs': 'Projection de tour (ms)',
  'memoryDebugPanel.metricName.vscodeWebviewSseChunk': 'Fragment SSE du webview',
  'memoryDebugPanel.metricName.vscodeWebviewSseChunkBytes': 'Octets de fragment SSE du webview',
  'memoryDebugPanel.metricName.vscodeWebviewSseEnd': 'Fin SSE du webview',
  'memoryDebugPanel.metricName.vscodeWebviewSseStartMs': 'Démarrage SSE du webview (ms)',
  ...
  'openChamberLogo.aria.logo': 'Logo OMPChamber',
  ...
  'mobile.connect.welcome.title': 'Se connecter à OMPChamber',
  ...
  'mobile.connect.password.placeholder': 'Mot de passe OMPChamber',
  ...
  'mobile.connect.scan.invalid': 'Ce code QR n\\\'est pas un code de connexion OMPChamber.',
  ...
  'mobile.connect.relay.badge': 'via OMPChamber Relay',
  ...
  'mobile.connect.error.unreachable': 'Impossible de joindre ce serveur OMPChamber.',
  ...
  'contextPanel.browser.tunnelFailedHint': '{url} tourne sur la machine où se trouve OMPChamber, et la connexion vers elle n’a pas pu être ouverte. Rien de votre propre machine n’est affiché ici.',
  ...
  'contextPanel.browser.devServers.remoteOnly': 'Ils tournent sur la machine qui héberge OMPChamber. Les ouvrir nécessite l’application de bureau.',
  ...
  'contextPanel.browser.trustNotice': 'Les pages ouvertes ici s’exécutent avec un accès complet à OMPChamber — nécessaire pour l’inspection et les captures d’écran. N’ouvrez que des sites de confiance : une page malveillante pourrait lire vos données ou agir en votre nom.',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': 'Cette instance utilise une version différente d’OMPChamber. Vous pouvez vous connecter, mais mettez les deux applications à jour si quelque chose ne fonctionne pas.',
  'onboarding.remoteConnection.probe.incompatibleMessage': 'Le serveur exécute OMPChamber mais n’est pas compatible avec cette version de l’application. Mettez OMPChamber à jour sur le serveur, puis réessayez.',
  'onboarding.desktopRecovery.remoteIncompatible.title': 'Mise à jour du serveur requise',
  'onboarding.desktopRecovery.remoteIncompatible.description': 'Le serveur OMPChamber à l’adresse « {host} » n’est pas compatible avec cette version de l’application. Mettez OMPChamber à jour sur le serveur, puis réessayez.',
  ...
  'chat.workStatus.section.processes': 'Processus',
  'chat.workStatus.processes.running': 'en cours',
  'chat.workStatus.processes.exited': 'terminé',
  'chat.workStatus.processes.killed': 'tué',
  'chat.workStatus.processes.failed': 'échoué',
  'chat.workStatus.processes.uncertain': 'attribution incertaine',
  'chat.workStatus.processes.kill': 'Tuer',
  'chat.workStatus.processes.killAll': 'Tout tuer',
  'chat.workStatus.processes.killConfirm': 'Sûr ?',
  'chat.workStatus.processes.view': 'Voir {command}',
  'chat.workStatus.processes.viewAll': 'Voir tous les processus',
  'chat.workStatus.processes.output': 'Sortie',
  'chat.workStatus.processes.command': 'Commande',
  'chat.workStatus.processes.cpu': 'CPU',
  'chat.workStatus.processes.memory': 'Mémoire',
  'chat.workStatus.processes.liveCount': '{count} actifs',
  'chat.workStatus.processes.endedCount': '{count} terminés',
  'chat.workStatus.processes.statsStale': 'données obsolètes',
  ...
  'chat.workStatus.section.localFiles': 'Fichiers locaux de session',
  ...
  'chat.workStatus.action.openAgentRun': 'Ouvrir l’exécution {name}',
  'chat.toolPart.taskAgent.openArtifact': 'Ouvrir l’artefact de sortie',
  'chat.toolPart.taskAgent.openRun': 'Ouvrir l’exécution',
  ...
  // omp dialogs (approval/ask bridge, spec 03)
  'dialogs.omp.approval.title': 'Approbation requise',
  'dialogs.omp.planReview.choice.approveExecute': 'Approuver et exécuter',
  'dialogs.omp.planReview.choice.approveCompact': 'Approuver et compacter le contexte',
  'dialogs.omp.planReview.choice.approveKeep': 'Approuver et conserver le contexte',
  'dialogs.omp.planReview.choice.refine': 'Affiner le plan',
  'dialogs.omp.planReview.planReady': 'Plan prêt pour révision.',
  'dialogs.omp.planReview.planMissing': 'Fichier de plan introuvable. Vous pouvez quand même examiner la proposition.',
  'dialogs.omp.planReview.loadingPlan': 'Chargement du plan…',
  'dialogs.omp.planReview.contentUnavailable': 'Le contenu du plan est indisponible. Vous pouvez quand même décider.',
  'dialogs.omp.planReview.editMode': 'Modifier le plan',
  'dialogs.omp.planReview.previewMode': 'Aperçu',
  'dialogs.omp.planReview.editAreaLabel': 'Contenu du plan modifié',
  'dialogs.omp.planReview.feedbackLabel': 'Retours d’affinage',
  'dialogs.omp.planReview.feedbackPlaceholder': 'Que faut-il changer dans le plan ?',
  'dialogs.omp.planReview.refineCancel': 'Annuler',
  'dialogs.omp.planReview.refineSubmit': 'Envoyer le retour',
  'dialogs.omp.planReview.refineSubmitted': 'Retour envoyé. Le plan sera révisé.',
  'dialogs.omp.planReview.submitting': 'En cours…',
  'dialogs.omp.planReview.decisionFailed': 'Impossible d’envoyer la décision de révision.',
  'dialogs.omp.planReview.unavailable': 'La révision du plan est indisponible.',
  'dialogs.omp.approval.bodyAria': 'Demande d’approbation d’outil',
  'dialogs.omp.approval.approve': 'Approuver',
  'dialogs.omp.approval.deny': 'Refuser',
  'dialogs.omp.approval.alwaysAllow': 'Toujours autoriser cet outil (écrit les paramètres) et approuver',
  'dialogs.omp.approval.alwaysAllowConfirm': 'Écrire le paramètre et approuver',
  'dialogs.omp.approval.alwaysAllowConfirmBody': 'Écrit tools.approval.{tool} = allow dans vos paramètres omp globaux, puis approuve cette demande.',
  'dialogs.omp.approval.alwaysAllowCancel': 'Retour',
  'dialogs.omp.approval.alwaysAllowFailed': 'Impossible d’écrire le paramètre. Rien n’a été approuvé — la boîte de dialogue reste ouverte.',
  'dialogs.omp.approval.respondFailed': 'Échec de la réponse',
  'dialogs.omp.ask.title': 'Questions',
  'dialogs.omp.ask.summaryTab': 'Résumé',
  'dialogs.omp.ask.noAnswer': 'Pas de réponse',
  'dialogs.omp.ask.recommended': 'Recommandé',
  'dialogs.omp.ask.other': 'Autre (saisir la vôtre)',
  'dialogs.omp.ask.otherPlaceholder': 'Saisissez votre réponse…',
  'dialogs.omp.ask.note': 'Note (facultatif)',
  'dialogs.omp.ask.chatAboutThis': 'En discuter',
  'dialogs.omp.ask.next': 'Suivant',
  'dialogs.omp.ask.submit': 'Envoyer',
  'dialogs.omp.ask.respondFailed': 'Échec de la réponse',
  'dialogs.omp.queue.moreWaiting': '{count} en attente',
  'dialogs.omp.select.title': 'Choisir une option',
  'dialogs.omp.confirm.yes': 'Oui',
  'dialogs.omp.confirm.no': 'Non',
  'dialogs.omp.generic.cancel': 'Annuler',
  'dialogs.omp.input.submit': 'Envoyer',
  'dialogs.omp.notify.backgroundTitle': 'La session attend votre réponse',
  'dialogs.omp.notify.backgroundBody': 'La session {session} attend une réponse',
  'dialogs.omp.tray.approvalRow': 'Session {session} — approbation requise',
  'dialogs.omp.tray.approvalRowWithTool': 'Session {session} — {tool} nécessite une approbation',
  'dialogs.omp.tray.askRow': 'Session {session} — questions en attente',
  'dialogs.omp.workStatus.waitingAnswer': 'attend votre réponse',
  'dialogs.internalUri.dialogDescription': 'Contenu de la ressource interne',
  'dialogs.internalUri.linkTitle': 'Ouvrir la ressource interne',
  'dialogs.internalUri.copyUrl': 'Copier le lien',
  'dialogs.internalUri.copied': 'Lien copié',
  'dialogs.internalUri.copyFailed': 'Impossible de copier le lien',
  'dialogs.internalUri.loading': 'Résolution de la ressource…',
  'dialogs.internalUri.immutableBadge': 'Lecture seule',
  'dialogs.internalUri.error.unavailable': 'Ce serveur n’expose pas de ressources internes.',
  'dialogs.internalUri.error.tooLarge': 'La ressource est trop volumineuse pour être affichée ({size}).',
  'dialogs.internalUri.error.resolveFailed': 'Impossible de résoudre cette ressource.',
  'dialogs.internalUri.error.binaryFailed': 'Impossible de charger ce fichier pour l’aperçu.',
  'contextPanel.localFiles.title': 'Fichiers locaux de session',
  'contextPanel.localFiles.description': 'Parcours en lecture seule des fichiers local:// privés de cette session.',
  'contextPanel.localFiles.noDirectory': 'Aucun répertoire de projet actif.',
  'contextPanel.localFiles.noSession': 'Aucune session sélectionnée.',
  'contextPanel.localFiles.filesLoading': 'Chargement des fichiers…',
  'contextPanel.localFiles.filesError': 'Impossible de charger les fichiers.',
  'contextPanel.localFiles.emptyFiles': 'Cette session n’a pas de fichiers local://.',
  'contextPanel.localFiles.openFile': 'Ouvrir {ref}',
  'contextPanel.localFiles.truncated': 'Liste tronquée — d’autres fichiers existent.',
  'contextPanel.localFiles.backToFiles': 'Fichiers de l’espace',
  'contextPanel.localFiles.scopeAria': 'Changer la portée de l\'arborescence',
  'contextPanel.localFiles.browseHint': 'Choisissez un fichier dans l’arbre de cette session.',
  'contextPanel.localFiles.previewFailed': 'Impossible de charger ce fichier pour l’aperçu.',
  'contextPanel.mode.timeline': 'Chronologie',
  'contextRail.surface.timeline.description': 'Événements structurés de la session active',
  'contextPanel.timeline.empty': 'Aucun événement',
  'contextPanel.timeline.emptyNoSession': 'Aucune session active',
  'contextPanel.timeline.loading': 'Chargement…',
  'contextPanel.timeline.kind.compaction': 'Compaction',
  'contextPanel.timeline.kind.branch_summary': 'Branche',
  'contextPanel.timeline.kind.model_change': 'Changement de modèle',
  'contextPanel.timeline.kind.mode_change': 'Changement de mode',
  'contextPanel.timeline.kind.ttsr_injection': 'Injection de règles',
  'contextPanel.timeline.kind.retry_recovery': 'Nouvelle tentative',
} as const;
