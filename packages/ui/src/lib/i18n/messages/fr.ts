...
'chat.modeSelector.conflict': 'Quittez d’abord le mode {mode}.',
  ...
  'onboarding.chooser.title': 'Bienvenue sur OMPChamber',
  ...
  'onboarding.localSetup.title': 'Configuration d’OMPChamber',
  'onboarding.localSetup.description': 'Installez le CLI ompchamber pour continuer.',
  'onboarding.localSetup.dialog.selectOpencodeBinary': 'Sélectionnez le binaire ompchamber',
  'onboarding.localSetup.errors.cliNotReady': 'Le CLI ompchamber n’est pas encore prêt. Veuillez confirmer que l’installation est terminée et réessayer.',
  ...
  'onboarding.localSetup.windows.stepInstallWsl': 'Installez ompchamber avec la commande ci-dessous.',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'Si OMPChamber ne détecte pas automatiquement ompchamber, définissez le chemin du binaire ci-dessous.',
  'onboarding.localSetup.intro': 'Le CLI ompchamber démarre votre moteur local — installez-le pour commencer.',
  'onboarding.localSetup.docs.windows': 'OMPChamber sur GitHub',
  'onboarding.localSetup.docs.default': 'OMPChamber sur GitHub',
  ...
  'onboarding.localSetup.helper.checkAndContinue': 'Cliquez pour vérifier si le CLI ompchamber est disponible. En cas de succès, vous entrerez automatiquement dans l’écran principal.',
  'onboarding.localSetup.status.watching': 'En attente du moteur',
  'onboarding.localSetup.status.autoContinue': 'Nous continuerons automatiquement une fois qu’il sera détecté.',
  'onboarding.localSetup.field.alreadyInstalled': 'Déjà installé ? Définissez le chemin du CLI ompchamber :',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'Enregistre dans les paramètres d’OMPChamber et recharge la configuration du moteur.',
  ...
  'onboarding.localSetup.windows.hintInstallInWsl': 'Sous Windows, installez et exécutez ompchamber en natif.',
  'onboarding.localSetup.windows.hintDetectionFailed': 'Si la détection échoue, définissez un chemin natif tel que ompchamber.cmd ou ompchamber.exe.',
  'onboarding.localSetup.hint.ensurePath': 'Déjà installé ? Assurez-vous qu’ompchamber est dans votre PATH.',
