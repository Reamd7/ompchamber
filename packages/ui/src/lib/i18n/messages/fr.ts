...
export const dict = {
  ...
  'contextPanel.mode.agentRun': 'Exécution d’agent',
  'contextRail.surface.agentRun.description': 'Transcription en lecture seule d’une exécution de sous-agent',
  'contextPanel.agentRun.loading': 'Chargement…',
  'contextPanel.agentRun.empty': 'Aucune conversation enregistrée pour cette exécution',
  'contextPanel.agentRun.openArtifact': 'Ouvrir l’artefact de sortie',
  'contextPanel.agentRun.artifactFailed': 'Impossible d’ouvrir l’artefact',
