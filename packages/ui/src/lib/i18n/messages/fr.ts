...
export const dict = {
  ...
  'aboutDialog.diagnosticsDescription': 'Comprend l’état OMPChamber, l’état de santé OpenCode, les répertoires et les projets.',
...
'chat.modeSelector.conflict': 'Quittez d’abord le mode {mode}.',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'Si OMPChamber ne détecte pas automatiquement OpenCode, définissez le chemin binaire ci-dessous.',
  'onboarding.localSetup.intro': 'OpenCode est le cœur de OMPChamber — installez-le pour commencer.',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'Enregistre dans les paramètres OMPChamber et recharge la configuration OpenCode.',
