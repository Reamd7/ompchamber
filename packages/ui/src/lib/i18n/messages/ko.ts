...
'chat.modeSelector.conflict': '먼저 {mode} 모드를 종료하세요.',
  ...
  'onboarding.chooser.title': 'OMPChamber에 오신 것을 환영합니다',
  ...
  'onboarding.localSetup.title': 'OMPChamber 설정',
  'onboarding.localSetup.description': '계속하려면 ompchamber CLI를 설치하세요.',
  'onboarding.localSetup.dialog.selectOpencodeBinary': 'ompchamber 바이너리 선택',
  'onboarding.localSetup.errors.cliNotReady': 'ompchamber CLI가 아직 준비되지 않았습니다. 설치가 완료되었는지 확인하고 다시 시도하세요.',
  'onboarding.localSetup.errors.detectionFailed': '감지에 실패했습니다',
  'onboarding.localSetup.windows.title': 'Windows 설정',
  'onboarding.localSetup.windows.stepInstallWsl': '아래 명령으로 ompchamber를 설치하세요.',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'OMPChamber가 ompchamber를 자동으로 찾지 못하면 아래에 바이너리 경로를 설정하세요.',
  'onboarding.localSetup.intro': 'ompchamber CLI가 로컬 엔진을 시작합니다. 시작하려면 설치하세요.',
  'onboarding.localSetup.docs.windows': 'GitHub의 OMPChamber',
  'onboarding.localSetup.docs.default': 'GitHub의 OMPChamber',
  ...
  'onboarding.localSetup.helper.checkAndContinue': 'ompchamber CLI를 사용할 수 있는지 확인하려면 클릭하세요. 성공하면 자동으로 메인 화면으로 이동합니다.',
  'onboarding.localSetup.status.watching': '엔진 대기 중',
  'onboarding.localSetup.status.autoContinue': '감지되면 자동으로 계속됩니다.',
  'onboarding.localSetup.field.alreadyInstalled': '이미 설치되어 있나요? ompchamber CLI 경로를 설정하세요:',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'OMPChamber 설정에 저장하고 엔진 구성을 다시 로드합니다.',
  'onboarding.localSetup.remotePreference': '원격 서버를 사용하시겠어요?',
  'onboarding.localSetup.actions.connectRemoteServer': '리모트 서버 연결 →',
  'onboarding.localSetup.windows.hintInstallInWsl': 'Windows에서는 ompchamber를 네이티브로 설치하고 실행하세요.',
  'onboarding.localSetup.windows.hintDetectionFailed': '감지에 실패하면 ompchamber.cmd 또는 ompchamber.exe 같은 네이티브 경로를 설정하세요.',
  'onboarding.localSetup.hint.ensurePath': '이미 설치되어 있나요? ompchamber가 PATH에 있는지 확인하세요.',
