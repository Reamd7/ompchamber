...
export const dict: Record<I18nKey, string> = {
  ...
  'contextPanel.mode.agentRun': '에이전트 실행',
  'contextRail.surface.agentRun.description': '서브에이전트 실행의 읽기 전용 기록',
  'contextPanel.agentRun.loading': '불러오는 중…',
  'contextPanel.agentRun.empty': '이 실행에는 기록된 대화가 없습니다',
  'contextPanel.agentRun.openArtifact': '출력 아티팩트 열기',
  'contextPanel.agentRun.artifactFailed': '아티팩트를 열 수 없습니다',
