...
export const dict: Record<I18nKey, string> = {
  ...
  'terminalView.actions.takeControl': '크기 제어 가져오기',
  'terminalView.actions.releaseControl': '크기 제어 해제',
  'terminalView.status.driving': '제어 중',
  'terminalView.status.following': '따르는 중',
  'terminalView.actions.zoomIn': '터미널 확대',
  'terminalView.actions.zoomOut': '터미널 축소',
  'terminalView.actions.zoomReset': '터미널 확대/축소 초기화 (100%)',
  'terminalView.driverState.idleHint': '크기는 가장 작은 창을 따름 — 클릭하여 제어 권한 가져오기',
  'terminalView.driverState.drivingHint': '내가 크기를 제어 중 ({cols}×{rows}) — 클릭하여 해제',
  'terminalView.driverState.followingHint': '다른 기기가 제어 중 ({cols}×{rows}) — 클릭하여 가져오기',
  'terminalView.actions.killSession': '세션 종료(모든 기기 연결 해제)',
  'terminalView.actions.killSessionArmed': '다시 클릭하면 모든 기기에서 종료',
  ...
  'pwa.installPrompt.description': '더 빠르게 접근하려면 OMPChamber를 설치하세요',
  'pwa.installPrompt.action': '설치',
  'pwa.installPrompt.dismiss': '닫기',
  'pwa.installPrompt.started': '설치가 시작되었습니다',
  'pwa.installPrompt.installed': 'OMPChamber가 설치되었습니다',
  ...
  'layout.header.subagentsRunning': '실행 중: {count}',
  'mobile.nav.aria': '모바일 내비게이션',
  'mobile.connect.welcome.title': 'OMPChamber에 연결',
  ...
  'mobile.connect.password.placeholder': 'OMPChamber 비밀번호',
  ...
  'mobile.connect.scan.invalid': '이 QR 코드는 OMPChamber 연결 코드가 아닙니다.',
  ...
  'mobile.connect.relay.badge': 'OMPChamber Relay 경유',
  ...
  'mobile.connect.error.unreachable': '해당 OMPChamber 서버에 연결할 수 없습니다.',
  ...
  'sessions.scheduledTasks.editor.persona.label': '페르소나',
  'sessions.scheduledTasks.editor.persona.ariaLabel': '세션 페르소나',
  'sessions.scheduledTasks.editor.persona.standard': '표준',
  'sessions.scheduledTasks.editor.persona.unavailable': '사용할 수 없음',
  ...
  'sessions.sidebar.footer.actions.aboutOMPChamber': 'OMPChamber 정보',
  ...
  'sessions.sidebar.session.status.resident': '메모리에 상주',
  'sessions.sidebar.session.status.residentWithSize': '메모리에 상주 · 트랜스크립트 ~{size}',
  'sessions.sidebar.session.status.residentShort': '메모리에 상주',
  ...
  'walkthrough.blocked.serverUnsupported.description': '이 앱이 연결된 OMPChamber 서버가 워크스루 API에 응답하지 않았습니다. 즉 앱보다 오래된 버전입니다. 서버를 1.18 이상으로 업데이트한 뒤 새로 고치세요.',
  ...
  'contextPanel.browser.tunnelFailedHint': '{url} 은(는) OMPChamber가 실행 중인 컴퓨터에 있으며, 그곳으로의 연결을 열지 못했습니다. 이 화면에는 사용자 컴퓨터의 내용이 표시되지 않습니다.',
  ...
  'contextPanel.browser.devServers.remoteOnly': '이 서버들은 OMPChamber가 실행 중인 컴퓨터에 있습니다. 열려면 데스크톱 앱이 필요합니다.',
  ...
  'contextPanel.browser.trustNotice': '여기서 여는 페이지는 OMPChamber에 대한 전체 액세스 권한으로 실행됩니다 — 검사와 스크린샷에 필요합니다. 신뢰하는 사이트만 여세요: 악성 페이지가 데이터를 읽거나 사용자를 대신해 동작할 수 있습니다.',
  ...
  'filesView.editor.binaryFileDescription': '이 파일은 바이너리이므로 OMPChamber에서 편집할 수 없습니다. 다른 앱으로 열려면 다운로드하세요.',
  ...
  'terminalView.tabs.unreadTitle': '읽지 않은 명령 출력',
  ...
  'directoryExplorerDialog.browse.permissionDenied': 'OMPChamber에서 이 폴더에 접근해야 합니다.',
  ...
  'aboutDialog.openChamberVersionLabel': 'OMPChamber 버전 {version}',
  'aboutDialog.openCodeVersionLabel': '엔진 버전 {version}',
  ...
  'aboutDialog.diagnosticsDescription': 'OMPChamber 상태, 엔진 상태, 디렉터리 및 프로젝트를 포함합니다.',
  ...
  'helpDialog.description': '이 단축키로 OMPChamber를 빠르게 탐색하세요',
  ...
  'header.actions.openAppMenu': 'OMPChamber 메뉴',
  'header.actions.openAppMenuAria': 'OMPChamber 메뉴 열기',
  ...
  'chat.retry.supersededBadge': '재시도로 대체됨',
  'chat.chat.ompDivider.compacted': '압축됨',
  'chat.chat.ompDivider.branchSummary': '브랜치 요약',
  ...
  'chat.chat.ompDivider.developerNote': '주입된 메모',
  'chat.omp.ttsrWarning.title': '궤도 유지 규칙이 트리거되었습니다',
  'chat.omp.ttsrWarning.dismissAria': '경고 닫기',
  'chat.omp.strippedToolCalls.one': '이 브랜치에서 {count}개의 도구 호출이 생략되었습니다 (결과 없음)',
  'chat.omp.strippedToolCalls.many': '이 브랜치에서 {count}개의 도구 호출이 생략되었습니다 (결과 없음)',
  'chat.omp.customCard.moreEntries': '외 {count}개',
  'chat.omp.cacheMiss.label': '캐시 미스',
  'chat.omp.cacheMiss.tokens': '{tokens} 토큰',
  'toast.ompNotice.title.info': '알림',
  'toast.ompNotice.title.warning': '경고',
  'toast.ompNotice.title.error': '오류',
  ...
  'chat.emptyState.opencodeUnreachable': '엔진에 연결할 수 없음',
  ...
  'chat.statusRow.todo.status.blockedBy': '차단 사유: {reason}',
  'chat.statusRow.todo.status.blockedBare': '차단됨',
  ...
  'chat.message.fallbackTag': '폴백',
  'chat.statusRow.compacting': '컨텍스트 압축 중…',
  ...
  'chat.workStatus.goal.status.paused': '일시중지',
  'chat.workStatus.goal.status.complete': '완료',
  'chat.workStatus.goal.status.budgetLimited': '예산 도달',
  'chat.workStatus.goal.status.dropped': '중단',
  'chat.revert.toast.redo': '다시 실행',
  'chat.revert.toast.restored': '모든 메시지 복원됨',
  'chat.toast.opencodeRestartInterrupted.title': '채팅이 중단되었습니다',
  'chat.toast.opencodeRestartInterrupted.description': '응답이 진행 중인 동안 엔진이 다시 시작되었습니다. 계속하려면 메시지를 보내세요.',
  ...
  'chat.commandAutocomplete.badge.ompOverride': 'OMPChamber 대체',
  'chat.chatInput.toast.debugRenamed': '엔진이 이제 /debug를 사용합니다. OMPChamber의 안내형 디버그 명령은 /troubleshoot로 이동했습니다.',
  'chat.sessionTree.title': '세션 브랜치',
  'chat.sessionTree.description': '이 세션의 포크입니다. 브랜치를 선택하면 해당 타임라인이 열립니다.',
  'chat.sessionTree.loading': '브랜치 불러오는 중…',
  'chat.sessionTree.error': '세션 트리를 불러오지 못했습니다.',
  'chat.sessionTree.empty': '이 세션에는 포크가 없습니다.',
  'chat.sessionTree.untitled': '제목 없음',
  'chat.sessionTree.current': '현재',
  'chat.sessionTree.leaf': '최신',
  'chat.sessionTree.openBranch': '브랜치 {title} 열기',
  ...
  'chat.toolPart.askQuestionsCount': '질문 {count}개',
  'chat.toolPart.askNoSelection': '답변 없음',
  'chat.toolPart.askCustomAnswer': '직접 입력한 답변',
  'chat.toolPart.askNote': '메모',
  'chat.toolPart.askAutoSelected': '시간 초과로 자동 선택됨 — 사용자가 선택한 것이 아님',
  'chat.toolPart.askChatRedirect': '사용자가 답변 대신 채팅으로 논의하기로 했습니다',
  'chat.toolPart.taskAgent.status.pending': '대기 중',
  'chat.toolPart.taskAgent.status.running': '실행 중',
  'chat.toolPart.taskAgent.status.completed': '완료',
  'chat.toolPart.taskAgent.status.failed': '실패',
  'chat.toolPart.taskAgent.status.aborted': '중단됨',
  'chat.toolPart.taskAgent.retrying': '재시도 {attempt}/{maxAttempts}',
  'chat.toolPart.taskAgent.retriesExhausted': '재시도 소진 ({attempt})',
  'chat.toolPart.taskAgent.moreAgents': '+{count}개 더보기',
  'chat.todo.total': '전체',
  ...
  'chat.modelControls.roles.sectionTitle': '모델 역할',
  'chat.modelControls.roles.notConfigured': '구성되지 않음',
  ...
  'chat.modelControls.setAsRole.failed': '역할을 할당하지 못했습니다',
  'chat.modelControls.setAsRole.rejected.role-already-configured': '역할에 이미 모델이 구성되어 있습니다',
  'chat.modelControls.enabledWarning': '현재 모델이 enabledModels에 없습니다',
  'chat.modeSelector.label.default': '기본',
  'chat.modeSelector.label.plan': '플랜',
  'chat.modeSelector.label.planPaused': '플랜 (일시중지)',
  'chat.modeSelector.label.goal': '골',
  'chat.modeSelector.label.goalPaused': '골 (일시중지)',
  'chat.modeSelector.label.vibe': '바이브',
  'chat.modeSelector.label.loop': '루프',
  'chat.modeSelector.ariaLabel': '세션 모드',
  'chat.modeSelector.title': '모드',
  'chat.modeSelector.requiresSession': '모드를 변경하려면 세션을 시작하세요',
  ...
  'chat.goalIndicator.title': '목표',
  'chat.goalIndicator.status.active': '진행 중',
  'chat.goalIndicator.status.paused': '일시중지',
  'chat.goalIndicator.status.complete': '완료',
  'chat.goalIndicator.status.budgetLimited': '예산 한도 도달',
  'chat.goalIndicator.status.dropped': '중단됨',
  'chat.goalIndicator.noObjective': '기록된 목표 없음',
  'chat.goalIndicator.budget': '{used}/{budget} 토큰',
  'chat.goalIndicator.tokensUsed': '{used} 토큰',
  ...
  'commandPalette.item.toggleMemoryDebug': '디버그 패널 토글',
  ...
  'openCodeStatusDialog.title': '엔진 상태',
  'openCodeStatusDialog.description': '현재 엔진 상태와 진단 정보를 확인합니다.',
  ...
  'openCodeStatusDialog.memory.title': '엔진 메모리',
  'openCodeStatusDialog.memory.refreshNote': '열린 동안 5초마다 새로고침',
  'openCodeStatusDialog.memory.loading': '로드 중…',
  'openCodeStatusDialog.memory.unavailable': '이 엔진 빌드는 메모리 진단을 지원하지 않습니다.',
  'openCodeStatusDialog.memory.error': '메모리 진단을 불러오지 못했습니다.',
  'openCodeStatusDialog.memory.processHeap': '프로세스 힙',
  'openCodeStatusDialog.memory.processRss': '프로세스 RSS',
  'openCodeStatusDialog.memory.processExternal': '외부 + 버퍼',
  'openCodeStatusDialog.memory.residentEstimate': '상주 세션(추정)',
  'openCodeStatusDialog.memory.sessionsTitle': '상주 세션: 라이브 {live}개 · 전체 {total}개',
  'openCodeStatusDialog.memory.sessionsStates': '로드 중 {materializing} · 제거 중 {evicting} · 실패 {failed}',
  'openCodeStatusDialog.memory.noResident': '상주 세션이 없습니다.',
  'openCodeStatusDialog.memory.truncated': '목록이 잘렸습니다 — 가장 큰 상주 세션을 표시합니다.',
  'openCodeStatusDialog.memory.colSession': '세션',
  'openCodeStatusDialog.memory.colDirectory': '디렉터리',
  'openCodeStatusDialog.memory.colState': '상태',
  'openCodeStatusDialog.memory.colSize': '~크기',
  'openCodeStatusDialog.memory.colIdle': '유휴',
  'openCodeStatusDialog.memory.wireBus': 'Wire 이벤트 버퍼',
  'openCodeStatusDialog.memory.ompBus': 'OMP 이벤트 버퍼',
  'openCodeStatusDialog.memory.busValue': '{entries}개 항목 · {size}(한도 {capacity})',
  'openCodeStatusDialog.memory.wireIdEchoes': 'Wire-ID 에코',
  'openCodeStatusDialog.memory.inFlightUnderflow': 'inFlight 언더플로',
  'openCodeStatusDialog.memory.estimateNote': '세션 크기는 트랜스크립트 크기 기반 추정치(상주 힙의 약 1.3배)이며, 세션별 실측값이 아닙니다.',
  'openCodeStatusDialog.monitor.tabOverview': '개요',
  'openCodeStatusDialog.monitor.tabSessions': '세션',
  'openCodeStatusDialog.monitor.residentCount': '상주 {total}개',
  'openCodeStatusDialog.monitor.catSessions': '상주 세션(추정)',
  'openCodeStatusDialog.monitor.catBuffers': '이벤트 버퍼',
  'openCodeStatusDialog.monitor.catUnattributed': '미귀속 엔진',
  'openCodeStatusDialog.monitor.processMonitor': '프로세스 모니터',
  'openCodeStatusDialog.monitor.processMonitorValue': '실행 {live}개 · 호출 {windows}개 · 샘플 실패 {failures}회',
  'openCodeStatusDialog.monitor.stateLive': '라이브',
  'openCodeStatusDialog.monitor.stateMaterializing': '로드 중',
  'openCodeStatusDialog.monitor.stateEvicting': '제거 중',
  'openCodeStatusDialog.monitor.stateFailed': '실패',
  'openCodeStatusDialog.monitor.largeOnly': '≥10MB만',
  'openCodeStatusDialog.monitor.noLarge': '≥10MB 상주 세션이 없습니다.',
  'openCodeStatusDialog.monitor.colAction': '작업',
  'openCodeStatusDialog.monitor.release': '해제',
  'openCodeStatusDialog.monitor.releaseHint': '메모리에서 제거 — 트랜스크립트는 디스크에 남습니다',
  'openCodeStatusDialog.monitor.releaseBusy': '세션이 아직 활성 상태입니다 — 해제할 수 없습니다.',
  'openCodeStatusDialog.monitor.releaseFailed': '세션을 해제하지 못했습니다.',
  ...
  'sessionAuth.error.networkDescription': 'UI 세션을 확인할 수 없습니다. 로컬 네트워크의 다른 기기에서 OMPChamber를 열고 있다면 데스크톱 앱에서 Desktop Network Access를 활성화하고 설정에 표시되는 LAN 주소를 사용하세요.',
  ...
  'sessionAuth.locked.unlockTitle': 'OMPChamber 잠금 해제',
  ...
  'desktopHostSwitcher.description': '로컬과 원격 OMPChamber 서버 간에 전환합니다',
  ...
  'multiRun.window.description': 'OMPChamber 멀티런 창.',
  ...
  'onboarding.remoteConnection.description': '연결할 OMPChamber 서버 주소를 입력하세요.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'URL이 OMPChamber 서버를 가리키는지 확인하거나 서버 관리자에게 문의하세요.',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': '이 인스턴스는 다른 OMPChamber 버전을 실행 중입니다. 연결할 수 있지만 문제가 있으면 양쪽 앱을 업데이트하세요.',
  'onboarding.remoteConnection.probe.incompatibleMessage': '서버에서 OMPChamber가 실행 중이지만 이 앱 버전과 호환되지 않습니다. 서버의 OMPChamber를 업데이트한 후 다시 시도하세요.',
  'onboarding.remoteConnection.probe.wrongServiceMessage': '서버가 응답했지만 OMPChamber가 실행 중이 아닙니다. 주소가 OMPChamber 서버를 가리키는지 확인하세요.',
  'onboarding.remoteConnection.probe.unreachableMessage': '서버에 연결할 수 없습니다. 네트워크 연결과 서버 주소를 확인하세요.',
  'onboarding.desktopRecovery.localUnavailable.title': '로컬 엔진을 사용할 수 없음',
  'onboarding.desktopRecovery.localUnavailable.description': '로컬 엔진을 시작할 수 없습니다. 다시 시도하거나 원격 서버에 연결하세요.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': '"{host}"의 서버에서 OMPChamber가 실행 중이 아닙니다. 주소가 OMPChamber 서버를 가리키는지 확인하세요.',
  'onboarding.desktopRecovery.remoteIncompatible.title': '서버 업데이트 필요',
  'onboarding.desktopRecovery.remoteIncompatible.description': '"{host}"의 OMPChamber 서버가 이 앱 버전과 호환되지 않습니다. 서버의 OMPChamber를 업데이트한 후 다시 시도하세요.',
  ...
  'startup.initRecovery.description': 'OMPChamber 초기화를 완료할 수 없습니다. 서버가 실행 중인지 확인한 뒤 다시 시도하세요.',
  ...
  'updateDialog.header.updating': 'OMPChamber 업데이트 중…',
  ...
  'updateDialog.error.takingLonger': '업데이트가 예상보다 오래 걸립니다. 잠시 기다린 뒤 새로고침하거나 `ompchamber update`를 실행하세요.',
  'updateDialog.error.signatureRejected': '다운로드한 업데이트가 거부되었습니다. 코드 서명이 이 설치본과 일치하지 않습니다. 보통 실행 중인 복사본이 공식 서명 릴리스에서 설치되지 않았다는 뜻입니다. 공식 릴리스에서 OMPChamber를 설치한 뒤 다시 업데이트하세요.',
  'updateDialog.error.updaterDisabled': '설치에 실패하여 업데이터가 중지되었습니다. OMPChamber를 종료했다가 다시 열고 업데이트를 재시도하세요.',
  'updateDialog.error.restartFailed': '업데이트를 설치하기 위한 재시작에 실패했습니다.',
  'updateDialog.error.restartUnavailable': '업데이트 설치에는 OMPChamber 데스크톱 앱이 필요합니다.',
  'mobileUpdate.toast.available.title': 'OMPChamber 업데이트 사용 가능',
  ...
  'memoryDebugPanel.tabs.memory': 'UI 메모리',
  'memoryDebugPanel.tabs.engine': '엔진',
  'memoryDebugPanel.tabs.streaming': '스트리밍',
  'memoryDebugPanel.tabs.requests': '요청',
  'memoryDebugPanel.section.sessionsInMemory': 'UI 메모리 내 세션',
  ...
  'memoryDebugPanel.resizeHandle': '드래그하여 패널 너비 조절',
  'memoryDebugPanel.metricName.sidebarScrollAnchorAdjustment': '사이드바 스크롤 앵커 조정',
  'memoryDebugPanel.metricName.sidebarSessionNodeRender': '사이드바 세션 행 렌더',
  'memoryDebugPanel.metricName.sidebarSessionNodePropsChanged': '사이드바 세션 props 변경',
  'memoryDebugPanel.metricName.globalSessionsEventUpdateDeferred': '세션 이벤트 업데이트 지연',
  'memoryDebugPanel.metricName.globalSessionsEventUpdateImmediate': '세션 이벤트 업데이트 즉시',
  'memoryDebugPanel.metricName.globalSessionsEventUpdatePublication': '세션 이벤트 업데이트 게시',
  'memoryDebugPanel.metricName.sidebarProjectSectionReused': '프로젝트 섹션 재사용',
  'memoryDebugPanel.metricName.sidebarProjectSectionRebuilt': '프로젝트 섹션 재구성',
  'memoryDebugPanel.metricName.sidebarProjectSectionRebuiltReason': '프로젝트 섹션 재구성 이유',
  'memoryDebugPanel.metricName.sidebarProjectsListRender': '프로젝트 목록 렌더',
  'memoryDebugPanel.metricName.sessionSidebarRender': '세션 사이드바 렌더',
  'memoryDebugPanel.metricName.sessionSidebarSource': '세션 사이드바 소스',
  'memoryDebugPanel.metricName.headerRender': '헤더 렌더',
  'memoryDebugPanel.metricName.assistantTextRender': '어시스턴트 텍스트 렌더',
  'memoryDebugPanel.metricName.assistantTextDisplayLen': '어시스턴트 텍스트 표시 길이',
  'memoryDebugPanel.metricName.messageListEntryRender': '메시지 목록 항목 렌더',
  'memoryDebugPanel.metricName.messageListRender': '메시지 목록 렌더',
  'memoryDebugPanel.metricName.messageListBaseDisplayMs': '메시지 목록 기본 표시(ms)',
  'memoryDebugPanel.metricName.messageListRetryOverlayMs': '메시지 목록 재시도 오버레이(ms)',
  'memoryDebugPanel.metricName.messageListRenderEntriesMs': '메시지 목록 항목 렌더(ms)',
  'memoryDebugPanel.metricName.markdownRender': 'Markdown 렌더',
  'memoryDebugPanel.metricName.markdownContentLen': 'Markdown 콘텐츠 길이',
  'memoryDebugPanel.metricName.markdownDomCache': 'Markdown DOM 캐시',
  'memoryDebugPanel.metricName.markdownSettledPaintReused': 'Markdown 안정 페인트 재사용',
  'memoryDebugPanel.metricName.chatMessageRender': '채팅 메시지 렌더',
  'memoryDebugPanel.metricName.turnsProjectionMs': '턴 프로젝션(ms)',
  'memoryDebugPanel.metricName.vscodeWebviewSseChunk': 'Webview SSE 청크',
  'memoryDebugPanel.metricName.vscodeWebviewSseChunkBytes': 'Webview SSE 청크 바이트',
  'memoryDebugPanel.metricName.vscodeWebviewSseEnd': 'Webview SSE 종료',
  'memoryDebugPanel.metricName.vscodeWebviewSseStartMs': 'Webview SSE 시작(ms)',
  ...
  'openChamberLogo.aria.logo': 'OMPChamber 로고',
  ...
  'chat.workStatus.section.processes': '프로세스',
  'chat.workStatus.processes.running': '실행 중',
  'chat.workStatus.processes.exited': '종료됨',
  'chat.workStatus.processes.killed': '강제 종료됨',
  'chat.workStatus.processes.failed': '실패',
  'chat.workStatus.processes.uncertain': '귀속 불확실',
  'chat.workStatus.processes.kill': '종료',
  'chat.workStatus.processes.killAll': '모두 종료',
  'chat.workStatus.processes.killConfirm': '확실합니까?',
  'chat.workStatus.processes.view': '{command} 보기',
  'chat.workStatus.processes.viewAll': '모든 프로세스 보기',
  'chat.workStatus.processes.output': '출력',
  'chat.workStatus.processes.command': '명령',
  'chat.workStatus.processes.cpu': 'CPU',
  'chat.workStatus.processes.memory': '메모리',
  'chat.workStatus.processes.liveCount': '{count}개 실행 중',
  'chat.workStatus.processes.endedCount': '{count}개 종료됨',
  'chat.workStatus.processes.statsStale': '오래된 통계',
  ...
  'chat.workStatus.section.localFiles': '세션 local 파일',
  ...
  'dialogs.omp.approval.title': '승인 필요',
  'dialogs.omp.planReview.choice.approveExecute': '승인하고 실행',
  'dialogs.omp.planReview.choice.approveCompact': '승인하고 컨텍스트 압축',
  'dialogs.omp.planReview.choice.approveKeep': '승인하고 컨텍스트 유지',
  'dialogs.omp.planReview.choice.refine': '계획 다듬기',
  'dialogs.omp.planReview.planReady': '계획 검토 준비가 완료되었습니다.',
  'dialogs.omp.planReview.planMissing': '계획 파일을 찾을 수 없습니다. 제안 자체는 검토할 수 있습니다.',
  'dialogs.omp.planReview.loadingPlan': '계획 불러오는 중…',
  'dialogs.omp.planReview.contentUnavailable': '계획 내용을 사용할 수 없습니다. 결정 자체는 가능합니다.',
  'dialogs.omp.planReview.editMode': '계획 편집',
  'dialogs.omp.planReview.previewMode': '미리보기',
  'dialogs.omp.planReview.editAreaLabel': '편집된 계획 내용',
  'dialogs.omp.planReview.feedbackLabel': '수정 피드백',
  'dialogs.omp.planReview.feedbackPlaceholder': '계획에서 무엇을 바꿔야 할까요?',
  'dialogs.omp.planReview.refineCancel': '취소',
  'dialogs.omp.planReview.refineSubmit': '피드백 보내기',
  'dialogs.omp.planReview.refineSubmitted': '피드백을 보냈습니다. 계획이 수정됩니다.',
  'dialogs.omp.planReview.submitting': '처리 중…',
  'dialogs.omp.planReview.decisionFailed': '검토 결정을 제출하지 못했습니다.',
  'dialogs.omp.planReview.unavailable': '계획 검토를 사용할 수 없습니다.',
  'dialogs.omp.approval.bodyAria': '도구 승인 요청',
  'dialogs.omp.approval.approve': '승인',
  'dialogs.omp.approval.deny': '거부',
  'dialogs.omp.approval.alwaysAllow': '이 도구 항상 허용(설정에 기록)하고 승인',
  'dialogs.omp.approval.alwaysAllowConfirm': '설정 기록 후 승인',
  'dialogs.omp.approval.alwaysAllowConfirmBody': '전역 omp 설정에 tools.approval.{tool} = allow를 기록한 뒤 이 요청을 승인합니다.',
  'dialogs.omp.approval.alwaysAllowCancel': '뒤로',
  'dialogs.omp.approval.alwaysAllowFailed': '설정을 기록하지 못했습니다. 아무것도 승인되지 않았으며 대화상자는 열려 있습니다.',
  'dialogs.omp.approval.respondFailed': '응답 실패',
  'dialogs.omp.ask.title': '질문',
  'dialogs.omp.ask.summaryTab': '요약',
  'dialogs.omp.ask.noAnswer': '답변 없음',
  'dialogs.omp.ask.recommended': '권장',
  'dialogs.omp.ask.other': '직접 입력',
  'dialogs.omp.ask.otherPlaceholder': '답변 입력…',
  'dialogs.omp.ask.note': '메모(선택)',
  'dialogs.omp.ask.chatAboutThis': '이에 대해 이야기하기',
  'dialogs.omp.ask.next': '다음',
  'dialogs.omp.ask.submit': '제출',
  'dialogs.omp.ask.respondFailed': '응답 실패',
  'dialogs.omp.queue.moreWaiting': '{count}개 더 대기 중',
  'dialogs.omp.select.title': '옵션 선택',
  'dialogs.omp.confirm.yes': '예',
  'dialogs.omp.confirm.no': '아니요',
  'dialogs.omp.generic.cancel': '취소',
  'dialogs.omp.input.submit': '제출',
  'dialogs.omp.notify.backgroundTitle': '세션이 입력을 기다립니다',
  'dialogs.omp.notify.backgroundBody': '세션 {session}이(가) 답변을 기다립니다',
  'dialogs.omp.tray.approvalRow': '세션 {session} — 승인 필요',
  'dialogs.omp.tray.approvalRowWithTool': '세션 {session} — {tool} 승인 필요',
  'dialogs.omp.tray.askRow': '세션 {session} — 질문 대기 중',
  'dialogs.omp.workStatus.waitingAnswer': '응답을 기다리는 중',
  'dialogs.internalUri.dialogDescription': '내부 리소스 내용',
  'dialogs.internalUri.linkTitle': '내부 리소스 열기',
  'dialogs.internalUri.copyUrl': '링크 복사',
  'dialogs.internalUri.copied': '링크를 복사했습니다',
  'dialogs.internalUri.copyFailed': '링크를 복사할 수 없습니다',
  'dialogs.internalUri.loading': '리소스 확인 중…',
  'dialogs.internalUri.immutableBadge': '읽기 전용',
  'dialogs.internalUri.error.unavailable': '이 서버는 내부 리소스를 노출하지 않습니다.',
  'dialogs.internalUri.error.tooLarge': '리소스가 너무 커서 표시할 수 없습니다({size}).',
  'dialogs.internalUri.error.resolveFailed': '이 리소스를 확인할 수 없습니다.',
  'dialogs.internalUri.error.binaryFailed': '이 파일을 미리보기로 불러올 수 없습니다.',
  'contextPanel.localFiles.title': '세션 local 파일',
  'contextPanel.localFiles.description': '이 세션 전용 local:// 파일을 읽기 전용으로 탐색합니다.',
  'contextPanel.localFiles.noDirectory': '활성 프로젝트 디렉터리가 없습니다.',
  'contextPanel.localFiles.noSession': '선택된 세션이 없습니다.',
  'contextPanel.localFiles.filesLoading': '파일 불러오는 중…',
  'contextPanel.localFiles.filesError': '파일을 불러올 수 없습니다.',
  'contextPanel.localFiles.emptyFiles': '이 세션에는 local:// 파일이 없습니다.',
  'contextPanel.localFiles.openFile': '{ref} 열기',
  'contextPanel.localFiles.truncated': '목록이 잘렸습니다. 더 많은 파일이 있습니다.',
  'contextPanel.localFiles.backToFiles': '워크스페이스 파일',
  'contextPanel.localFiles.scopeAria': '파일 트리 범위 전환',
  'contextPanel.localFiles.browseHint': '이 세션의 트리에서 파일을 선택하세요.',
  'contextPanel.localFiles.previewFailed': '이 파일을 미리보기로 불러올 수 없습니다.',
  'contextPanel.mode.timeline': '타임라인',
  'contextRail.surface.timeline.description': '활성 세션의 구조화된 이벤트',
  'contextPanel.timeline.empty': '이벤트 없음',
  'contextPanel.timeline.emptyNoSession': '활성 세션 없음',
  'contextPanel.timeline.loading': '불러오는 중…',
  'contextPanel.timeline.kind.compaction': '압축',
  'contextPanel.timeline.kind.branch_summary': '브랜치',
  'contextPanel.timeline.kind.model_change': '모델 변경',
  'contextPanel.timeline.kind.mode_change': '모드 변경',
  'contextPanel.timeline.kind.ttsr_injection': '규칙 주입',
  'contextPanel.timeline.kind.retry_recovery': '재시도',
};
