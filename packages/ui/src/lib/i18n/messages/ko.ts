...
export const dict: Record<I18nKey, string> = {
  ...
  'aboutDialog.diagnosticsDescription': 'OMPChamber 상태, OpenCode 상태, 디렉터리 및 프로젝트를 포함합니다.',
...
'chat.modeSelector.conflict': '먼저 {mode} 모드를 종료하세요.',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'OMPChamber가 OpenCode를 자동으로 찾지 못하면 아래에 바이너리 경로를 설정하세요.',
  'onboarding.localSetup.intro': 'OpenCode는 OMPChamber의 심장입니다. 먼저 설치하고 시작하세요.',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'OMPChamber 설정에 저장하고 OpenCode 구성을 다시 로드합니다.',
