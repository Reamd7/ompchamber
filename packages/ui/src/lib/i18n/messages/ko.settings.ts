...
'settings.view.home.cards.plugins.description': 'OMP 플러그인 관리',
  ...
  'settings.openchamber.tunnel.tooltip.tokensSavedPath': '토큰은 ~/.config/ompchamber/cloudflare-managed-remote-tunnels.json에 저장됩니다.',
...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.openchamber.about.title': 'OMPChamber 정보',
  ...
  'settings.openchamber.desktopNetwork.field.launchAtLoginAria': '로그인 시 OMPChamber 시작',
  'settings.openchamber.desktopNetwork.field.launchAtLogin': '로그인 시 OMPChamber 시작',
  'settings.openchamber.desktopNetwork.field.launchAtLoginDescription': '창을 열지 않고 백그라운드에서 앱을 시작합니다. 데스크톱 상태 아이콘으로 열 수 있습니다.',
  'settings.openchamber.desktopNetwork.field.macMenuBarAria': 'macOS 메뉴 막대에 OMPChamber 표시',
  'settings.openchamber.desktopNetwork.field.macMenuBar': '메뉴 막대에 OMPChamber 표시',
  'settings.openchamber.desktopNetwork.field.macMenuBarDescription': '앱을 다시 시작해야 합니다. 끄면 OMPChamber가 메뉴 막대 항목을 만들지 않으며 세션, 승인 및 사용량 업데이트도 실행하지 않습니다.',
  'settings.openchamber.desktopNetwork.field.minimizeToTrayAria': 'OMPChamber를 시스템 트레이로 닫기',
  'settings.openchamber.desktopNetwork.field.minimizeToTray': '시스템 트레이로 닫기',
  'settings.openchamber.desktopNetwork.field.minimizeToTrayDescription': '메인 창을 닫아도 OMPChamber가 시스템 트레이에서 계속 실행됩니다. 최소화하면 창은 작업 표시줄에 남습니다.',
  'settings.openchamber.desktopNetwork.field.keepAwakeAria': 'OMPChamber가 실행되는 동안 컴퓨터 절전 방지',
  'settings.openchamber.desktopNetwork.field.keepAwake': 'OMPChamber가 실행되는 동안 컴퓨터 절전 방지',
  ...
  'settings.openchamber.desktopPassword.field.passwordDescription': 'OMPChamber는 다시 시작 후 비밀번호를 요청하고, 이후 로그인 세션이 만료되면 다시 요청합니다. 기본 12시간, 이 디바이스 신뢰 선택 시 7일입니다. 로그인을 끄려면 비워 두세요.',
  ...
  'settings.openchamber.tools.title': 'OMPChamber 도구',
  ...
  'settings.openchamber.tools.field.agentWebTool': 'OMPChamber Web 도구',
  'settings.openchamber.tools.field.agentWebToolAria': 'OMPChamber Web 도구 활성화',
  'settings.openchamber.tools.field.agentWebToolInfo': '에이전트가 OMPChamber 브라우저 패널에서 페이지를 확인하고 조작할 수 있습니다. URL 열기, 내용 읽기, 클릭, 입력, 스크롤, 모바일과 데스크톱 레이아웃 전환이 가능합니다. 각 세션에 작은 도구 설명이 추가됩니다. OpenCode를 다시 시작하면 적용됩니다.',
  ...
  'settings.remoteInstances.page.phase.installingOpenChamber': 'OMPChamber 설치 중',
  'settings.remoteInstances.page.phase.updatingOpenChamber': 'OMPChamber 업데이트 중',
  ...
  'settings.openchamber.visual.field.themeImportInfoTooltip': '~/.config/ompchamber/themes/에서 사용자 정의 테마를 가져옵니다',
