...
export const dict = {
  ...
  'terminalView.actions.takeControl': 'Take control of size',
  'terminalView.actions.releaseControl': 'Release size control',
  'terminalView.status.driving': 'Driving',
  'terminalView.status.following': 'Following',
  'terminalView.actions.zoomIn': 'Zoom terminal in',
  'terminalView.actions.zoomOut': 'Zoom terminal out',
  'terminalView.actions.zoomReset': 'Reset terminal zoom (100%)',
  'terminalView.driverState.idleHint': 'Size follows the smallest viewport — click to take control',
  'terminalView.driverState.drivingHint': 'You are driving the size ({cols}×{rows}) — click to release',
  'terminalView.driverState.followingHint': 'Another device is driving ({cols}×{rows}) — click to take over',
  'terminalView.actions.killSession': 'Close session (disconnects ALL devices)',
  'terminalView.actions.killSessionArmed': 'Click again to close for every device',
  ...
  'pwa.installPrompt.description': 'Install OMPChamber for quicker access',
  'pwa.installPrompt.action': 'Install',
  'pwa.installPrompt.dismiss': 'Dismiss',
  'pwa.installPrompt.started': 'Install started',
  'pwa.installPrompt.installed': 'OMPChamber installed',
  ...
  'layout.header.subagentsRunning': 'Running: {count}',
  'mobile.nav.aria': 'Mobile navigation',
  'mobile.connect.welcome.title': 'Connect to OMPChamber',
  ...
  'mobile.connect.password.placeholder': 'OMPChamber password',
  ...
  'mobile.connect.scan.invalid': 'That QR code is not an OMPChamber connection code.',
  ...
  'mobile.connect.error.unreachable': 'Could not reach that OMPChamber server.',
  ...
  'sessions.scheduledTasks.editor.persona.ariaLabel': 'Session persona',
  'sessions.scheduledTasks.editor.persona.standard': 'Standard',
  'sessions.scheduledTasks.editor.persona.unavailable': 'Unavailable',
  ...
  'sessions.sidebar.footer.actions.aboutOMPChamber': 'About OMPChamber',
  ...
  'sessions.sidebar.session.moveToWorktree.confirm.ownership': 'The engine tracks these changes by directory, not by session.',
  ...
  'sessions.sidebar.session.status.resident': 'Resident in memory',
  'sessions.sidebar.session.status.residentWithSize': 'Resident in memory · transcript ~{size}',
  'sessions.sidebar.session.status.residentShort': 'Resident in memory',
  ...
  'walkthrough.blocked.serverUnsupported.description': 'The OMPChamber server this app is connected to did not answer the walkthrough API, which means it is older than the app. Update the server to 1.18 or newer, then refresh.',
  ...
  'contextPanel.browser.tunnelFailedHint': '{url} runs on the machine OMPChamber is on, and the connection to it could not be opened. Nothing from your own machine is shown here.',
  ...
  'contextPanel.browser.devServers.remoteOnly': 'These run on the machine hosting OMPChamber. Opening them needs the desktop app.',
  ...
  'contextPanel.browser.trustNotice': 'Pages opened here run with full access to OMPChamber — needed for inspect and screenshots. Only open sites you trust: a malicious page could read your data or act on your behalf.',
  ...
  'filesView.editor.binaryFileDescription': 'This file is binary and cannot be edited in OMPChamber. Download it to open with another app.',
  ...
  'chat.sessionError.title': 'The engine stopped this reply',
  'chat.sessionError.noDetails': 'The engine reported no details. Open the status report (Ctrl/Cmd+Shift+L) to see recent errors.',
  'chat.sessionError.noReply': 'The engine did not start a reply to this message.',
  ...
  'terminalView.stream.reconnecting': 'Reconnecting…',
  ...
  'terminalView.tabs.unreadTitle': 'Unread command output',
  ...
  'directoryExplorerDialog.browse.permissionDenied': 'OMPChamber needs access to this folder.',
  ...
  'aboutDialog.diagnosticsDescription': 'Includes OMPChamber state, engine health, directories, and projects.',
  ...
  'helpDialog.description': 'Use these keyboard shortcuts to navigate OMPChamber efficiently',
  ...
  'header.actions.openAppMenu': 'OMPChamber menu',
  'header.actions.openAppMenuAria': 'Open OMPChamber menu',
  ...
  'chat.retry.supersededBadge': 'Superseded by retry',
  'chat.chat.ompDivider.compacted': 'compacted',
  'chat.chat.ompDivider.branchSummary': 'branch summary',
  ...
  'chat.chat.ompDivider.developerNote': 'injected note',
  'chat.omp.ttsrWarning.title': 'Steering rules triggered',
  'chat.omp.ttsrWarning.dismissAria': 'Dismiss warning',
  'chat.omp.strippedToolCalls.one': '{count} tool call elided, no result on this branch',
  'chat.omp.strippedToolCalls.many': '{count} tool calls elided, no result on this branch',
  'chat.omp.customCard.moreEntries': '+{count} more',
  'chat.omp.cacheMiss.label': 'cache miss',
  'chat.omp.cacheMiss.tokens': '{tokens} tokens',
  'toast.ompNotice.title.info': 'Notice',
  'toast.ompNotice.title.warning': 'Warning',
  ...
  'chat.emptyState.opencodeUnreachable': 'The engine is not reachable',
  ...
  'chat.statusRow.todo.status.blockedBy': 'Blocked by {reason}',
  'chat.statusRow.todo.status.blockedBare': 'Blocked',
  ...
  'chat.message.fallbackTag': 'fallback',
  ...
  'chat.toast.opencodeRestartInterrupted.description': 'The engine restarted while a response was still running. Send a message to continue.',
  ...
  'chat.commandAutocomplete.badge.ompOverride': 'overrides OMPChamber',
  ...
  'chat.chatInput.toast.debugRenamed': 'The engine owns /debug now. OMPChamber\\\'s guided debug command moved to /troubleshoot.',
  'chat.sessionTree.title': 'Session branches',
  'chat.sessionTree.description': 'Forks of this session. Select a branch to open its timeline.',
  'chat.sessionTree.loading': 'Loading branches…',
  'chat.sessionTree.error': 'Could not load the session tree.',
  'chat.sessionTree.empty': 'This session has no forks.',
  'chat.sessionTree.untitled': 'Untitled',
  'chat.sessionTree.current': 'current',
  'chat.sessionTree.leaf': 'latest',
  'chat.sessionTree.openBranch': 'Open branch {title}',
  ...
  'chat.toolPart.askNoSelection': 'No answer',
  'chat.toolPart.askCustomAnswer': 'Custom answer',
  'chat.toolPart.askNote': 'Note',
  'chat.toolPart.askAutoSelected': 'auto-selected after timeout — not a user choice',
  'chat.toolPart.askChatRedirect': 'User chose to chat about this instead of answering',
  'chat.toolPart.taskAgent.status.pending': 'Pending',
  'chat.toolPart.taskAgent.status.running': 'Running',
  'chat.toolPart.taskAgent.status.completed': 'Completed',
  'chat.toolPart.taskAgent.status.failed': 'Failed',
  'chat.toolPart.taskAgent.status.aborted': 'Aborted',
  'chat.toolPart.taskAgent.retrying': 'Retry {attempt}/{maxAttempts}',
  'chat.toolPart.taskAgent.retriesExhausted': 'Retries exhausted ({attempt})',
  'chat.toolPart.taskAgent.moreAgents': '+{count} more',
  ...
  'chat.modelControls.roles.sectionTitle': 'Model roles',
  'chat.modelControls.roles.notConfigured': 'Not configured',
  ...
  'chat.modelControls.setAsRole.failed': 'Could not assign the role',
  'chat.modelControls.setAsRole.rejected.role-already-configured': 'The role already has a configured model',
  'chat.modelControls.enabledWarning': 'Current model is not in enabledModels',
  'chat.modeSelector.label.default': 'Default',
  'chat.modeSelector.label.plan': 'Plan',
  'chat.modeSelector.label.planPaused': 'Plan (paused)',
  'chat.modeSelector.label.goal': 'Goal',
  'chat.modeSelector.label.goalPaused': 'Goal (paused)',
  'chat.modeSelector.label.vibe': 'Vibe',
  'chat.modeSelector.label.loop': 'Loop',
  'chat.modeSelector.ariaLabel': 'Session mode',
  'chat.modeSelector.title': 'Mode',
  'chat.modeSelector.requiresSession': 'Start the session to change its mode',
  ...
  'chat.goalIndicator.title': 'Goal',
  'chat.goalIndicator.status.active': 'Active',
  'chat.goalIndicator.status.paused': 'Paused',
  'chat.goalIndicator.status.complete': 'Complete',
  'chat.goalIndicator.status.budgetLimited': 'Budget limited',
  'chat.goalIndicator.status.dropped': 'Dropped',
  'chat.goalIndicator.noObjective': 'No objective recorded',
  ...
  'commandPalette.item.showOpenCodeStatus': 'Show engine status',
  'commandPalette.item.toggleMemoryDebug': 'Toggle debug panel',
  ...
  'openCodeStatusDialog.description': 'Inspect current engine status and diagnostics.',
  ...
  'openCodeStatusDialog.memory.title': 'Engine memory',
  'openCodeStatusDialog.memory.refreshNote': 'refreshes every 5s while open',
  'openCodeStatusDialog.memory.loading': 'Loading…',
  'openCodeStatusDialog.memory.unavailable': 'Memory diagnostics are not supported by this engine build.',
  'openCodeStatusDialog.memory.error': 'Failed to load memory diagnostics.',
  'openCodeStatusDialog.memory.processHeap': 'Process heap',
  'openCodeStatusDialog.memory.processRss': 'Process RSS',
  'openCodeStatusDialog.memory.processExternal': 'External + buffers',
  'openCodeStatusDialog.memory.residentEstimate': 'Resident sessions (est.)',
  'openCodeStatusDialog.memory.sessionsTitle': 'Resident sessions: {live} live · {total} total',
  'openCodeStatusDialog.memory.sessionsStates': 'materializing {materializing} · evicting {evicting} · failed {failed}',
  'openCodeStatusDialog.memory.noResident': 'No resident sessions.',
  'openCodeStatusDialog.memory.truncated': 'List truncated — showing the largest resident sessions.',
  'openCodeStatusDialog.memory.colSession': 'Session',
  'openCodeStatusDialog.memory.colDirectory': 'Directory',
  'openCodeStatusDialog.memory.colState': 'State',
  'openCodeStatusDialog.memory.colSize': '~Size',
  'openCodeStatusDialog.memory.colIdle': 'Idle',
  'openCodeStatusDialog.memory.wireBus': 'Wire event buffer',
  'openCodeStatusDialog.memory.ompBus': 'OMP event buffer',
  'openCodeStatusDialog.memory.busValue': '{entries} entries · {size} (cap {capacity})',
  'openCodeStatusDialog.memory.wireIdEchoes': 'Wire-ID echoes',
  'openCodeStatusDialog.memory.inFlightUnderflow': 'inFlight underflows',
  'openCodeStatusDialog.memory.estimateNote': 'Session sizes are transcript-size estimates (~1.3× resident heap), not measured per-session attribution.',
  'openCodeStatusDialog.monitor.tabOverview': 'Overview',
  'openCodeStatusDialog.monitor.tabSessions': 'Sessions',
  'openCodeStatusDialog.monitor.residentCount': '{total} resident',
  'openCodeStatusDialog.monitor.catSessions': 'Resident sessions (est.)',
  'openCodeStatusDialog.monitor.catBuffers': 'Event buffers',
  'openCodeStatusDialog.monitor.catUnattributed': 'Unattributed engine',
  'openCodeStatusDialog.monitor.processMonitor': 'Process monitor',
  'openCodeStatusDialog.monitor.processMonitorValue': '{live} live · {windows} open calls · {failures} failed samples',
  'openCodeStatusDialog.monitor.stateLive': 'live',
  'openCodeStatusDialog.monitor.stateMaterializing': 'loading',
  'openCodeStatusDialog.monitor.stateEvicting': 'evicting',
  'openCodeStatusDialog.monitor.stateFailed': 'failed',
  'openCodeStatusDialog.monitor.largeOnly': 'Only ≥10 MB',
  'openCodeStatusDialog.monitor.noLarge': 'No resident sessions ≥10 MB.',
  'openCodeStatusDialog.monitor.colAction': 'Action',
  'openCodeStatusDialog.monitor.release': 'Release',
  'openCodeStatusDialog.monitor.releaseHint': 'Evict from memory — the transcript stays on disk',
  'openCodeStatusDialog.monitor.releaseBusy': 'Session is still active — cannot release it.',
  'openCodeStatusDialog.monitor.releaseFailed': 'Failed to release the session.',
  ...
  'sessionAuth.error.networkDescription': 'We could not verify the UI session. If you\\\'re opening OMPChamber from another device on your local network, make sure Desktop Network Access is enabled on the desktop app and use the LAN address shown in Settings.',
  ...
  'sessionAuth.locked.unlockTitle': 'Unlock OMPChamber',
  ...
  'desktopHostSwitcher.description': 'Switch between Local and remote OMPChamber servers',
  ...
  'multiRun.window.description': 'OMPChamber Multi-Run window.',
  ...
  'onboarding.remoteConnection.description': 'Enter the address of an OMPChamber server to connect to.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'Suggestions: Verify the URL points to an OMPChamber server, or contact the server administrator.',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': 'This instance is running a different OMPChamber version. You can connect, but update both apps if something does not work.',
  'onboarding.remoteConnection.probe.incompatibleMessage': 'Server is running OMPChamber but is not compatible with this app version. Update OMPChamber on the server, then try again.',
  'onboarding.remoteConnection.probe.wrongServiceMessage': 'Server responded but is not running OMPChamber. Verify the address points to an OMPChamber server.',
  ...
  'onboarding.desktopRecovery.localUnavailable.title': 'Local Engine Unavailable',
  'onboarding.desktopRecovery.localUnavailable.description': 'The local engine could not be started. Retry the launch or connect to a remote server instead.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': 'The server at "{host}" is not running OMPChamber. Verify the address points to an OMPChamber server.',
  'onboarding.desktopRecovery.remoteIncompatible.title': 'Server Update Required',
  'onboarding.desktopRecovery.remoteIncompatible.description': 'The OMPChamber server at "{host}" is not compatible with this app version. Update OMPChamber on the server, then try again.',
  ...
  'startup.initRecovery.description': 'OMPChamber could not finish initialization. Check that the server is running, then retry.',
  ...
  'updateDialog.header.updating': 'Updating OMPChamber...',
  ...
  'updateDialog.error.takingLonger': 'Update is taking longer than expected. Wait a bit and refresh, or run: ompchamber update',
  'updateDialog.error.signatureRejected': 'The downloaded update was rejected: its code signature does not match this installation. This usually means the running copy was not installed from an official signed release. Install OMPChamber from an official release, then update again.',
  'updateDialog.error.updaterDisabled': 'The updater stopped after a failed install. Quit OMPChamber, open it again, and retry the update.',
  'updateDialog.error.restartFailed': 'Could not restart to install the update.',
  'updateDialog.error.restartUnavailable': 'Installing the update requires the OMPChamber desktop app.',
  'mobileUpdate.toast.available.title': 'OMPChamber update available',
  ...
  'memoryDebugPanel.resizeHandle': 'Drag to resize panel width',
  'memoryDebugPanel.metricName.sidebarScrollAnchorAdjustment': 'Sidebar scroll anchor adjustment',
  'memoryDebugPanel.metricName.sidebarSessionNodeRender': 'Sidebar session row render',
  'memoryDebugPanel.metricName.sidebarSessionNodePropsChanged': 'Sidebar session props changed',
  'memoryDebugPanel.metricName.globalSessionsEventUpdateDeferred': 'Session event update deferred',
  'memoryDebugPanel.metricName.globalSessionsEventUpdateImmediate': 'Session event update immediate',
  'memoryDebugPanel.metricName.globalSessionsEventUpdatePublication': 'Session event update publication',
  'memoryDebugPanel.metricName.sidebarProjectSectionReused': 'Project sections reused',
  'memoryDebugPanel.metricName.sidebarProjectSectionRebuilt': 'Project sections rebuilt',
  'memoryDebugPanel.metricName.sidebarProjectSectionRebuiltReason': 'Project section rebuild reason',
  'memoryDebugPanel.metricName.sidebarProjectsListRender': 'Projects list render',
  'memoryDebugPanel.metricName.sessionSidebarRender': 'Session sidebar render',
  'memoryDebugPanel.metricName.sessionSidebarSource': 'Session sidebar source',
  'memoryDebugPanel.metricName.headerRender': 'Header render',
  'memoryDebugPanel.metricName.assistantTextRender': 'Assistant text render',
  'memoryDebugPanel.metricName.assistantTextDisplayLen': 'Assistant text display length',
  'memoryDebugPanel.metricName.messageListEntryRender': 'Message list entry render',
  'memoryDebugPanel.metricName.messageListRender': 'Message list render',
  'memoryDebugPanel.metricName.messageListBaseDisplayMs': 'Message list base display (ms)',
  'memoryDebugPanel.metricName.messageListRetryOverlayMs': 'Message list retry overlay (ms)',
  'memoryDebugPanel.metricName.messageListRenderEntriesMs': 'Message list render entries (ms)',
  'memoryDebugPanel.metricName.markdownRender': 'Markdown render',
  'memoryDebugPanel.metricName.markdownContentLen': 'Markdown content length',
  'memoryDebugPanel.metricName.markdownDomCache': 'Markdown DOM cache',
  'memoryDebugPanel.metricName.markdownSettledPaintReused': 'Markdown settled paint reused',
  'memoryDebugPanel.metricName.chatMessageRender': 'Chat message render',
  'memoryDebugPanel.metricName.turnsProjectionMs': 'Turn projection (ms)',
  ...
  'memoryDebugPanel.metricName.vscodeWebviewSseEnd': 'Webview SSE end',
  ...
  'chat.workStatus.section.processes': 'Processes',
  'chat.workStatus.processes.running': 'running',
  'chat.workStatus.processes.exited': 'exited',
  'chat.workStatus.processes.killed': 'killed',
  'chat.workStatus.processes.failed': 'failed',
  'chat.workStatus.processes.uncertain': 'uncertain attribution',
  'chat.workStatus.processes.kill': 'Kill',
  'chat.workStatus.processes.killAll': 'Kill all',
  'chat.workStatus.processes.killConfirm': 'Sure?',
  'chat.workStatus.processes.view': 'View {command}',
  'chat.workStatus.processes.viewAll': 'View all processes',
  'chat.workStatus.processes.output': 'Output',
  'chat.workStatus.processes.command': 'Command',
  'chat.workStatus.processes.cpu': 'CPU',
  'chat.workStatus.processes.memory': 'Memory',
  'chat.workStatus.processes.liveCount': '{count} live',
  'chat.workStatus.processes.endedCount': '{count} ended',
  'chat.workStatus.processes.statsStale': 'stale stats',
  ...
  'chat.workStatus.subagent.parked': 'parked',
  'chat.workStatus.subagent.aborted': 'aborted',
  'chat.workStatus.goal.status.active': 'active',
  'chat.workStatus.goal.status.paused': 'paused',
  'chat.workStatus.goal.status.complete': 'complete',
  ...
  'dialogs.omp.approval.title': 'Approval required',
  'dialogs.omp.planReview.choice.approveExecute': 'Approve and execute',
  'dialogs.omp.planReview.choice.approveCompact': 'Approve and compact context',
  'dialogs.omp.planReview.choice.approveKeep': 'Approve and keep context',
  'dialogs.omp.planReview.choice.refine': 'Refine plan',
  'dialogs.omp.planReview.planReady': 'Plan ready for review.',
  'dialogs.omp.planReview.planMissing': 'Plan file not found. You can still review the proposal.',
  'dialogs.omp.planReview.loadingPlan': 'Loading the plan…',
  'dialogs.omp.planReview.contentUnavailable': 'Plan content is unavailable. You can still decide.',
  'dialogs.omp.planReview.editMode': 'Edit plan',
  'dialogs.omp.planReview.previewMode': 'Preview',
  'dialogs.omp.planReview.editAreaLabel': 'Edited plan content',
  'dialogs.omp.planReview.feedbackLabel': 'Refinement feedback',
  'dialogs.omp.planReview.feedbackPlaceholder': 'What should change in the plan?',
  'dialogs.omp.planReview.refineCancel': 'Cancel',
  'dialogs.omp.planReview.refineSubmit': 'Send feedback',
  'dialogs.omp.planReview.refineSubmitted': 'Feedback sent. The plan will be revised.',
  'dialogs.omp.planReview.submitting': 'Working…',
  'dialogs.omp.planReview.decisionFailed': 'Could not submit the review decision.',
  'dialogs.omp.planReview.unavailable': 'Plan review is not available.',
  'dialogs.omp.approval.bodyAria': 'Tool approval request',
  'dialogs.omp.approval.approve': 'Approve',
  'dialogs.omp.approval.deny': 'Deny',
  'dialogs.omp.approval.alwaysAllow': 'Always allow this tool (writes settings) and approve',
  'dialogs.omp.approval.alwaysAllowConfirm': 'Write setting and approve',
  'dialogs.omp.approval.alwaysAllowConfirmBody': 'Writes tools.approval.{tool} = allow to your global omp settings, then approves this request.',
  'dialogs.omp.approval.alwaysAllowCancel': 'Back',
  'dialogs.omp.approval.alwaysAllowFailed': 'Could not write the setting. Nothing was approved — the dialog stays open.',
  'dialogs.omp.approval.respondFailed': 'Answer failed',
  'dialogs.omp.ask.title': 'Questions',
  'dialogs.omp.ask.summaryTab': 'Summary',
  'dialogs.omp.ask.noAnswer': 'No answer',
  'dialogs.omp.ask.recommended': 'Recommended',
  'dialogs.omp.ask.other': 'Other (type your own)',
  'dialogs.omp.ask.otherPlaceholder': 'Type your answer…',
  'dialogs.omp.ask.note': 'Note (optional)',
  'dialogs.omp.ask.chatAboutThis': 'Chat about this',
  'dialogs.omp.ask.next': 'Next',
  'dialogs.omp.ask.submit': 'Submit',
  'dialogs.omp.ask.respondFailed': 'Answer failed',
  'dialogs.omp.queue.moreWaiting': '{count} more waiting',
  'dialogs.omp.select.title': 'Choose an option',
  'dialogs.omp.confirm.yes': 'Yes',
  'dialogs.omp.confirm.no': 'No',
  'dialogs.omp.generic.cancel': 'Cancel',
  'dialogs.omp.input.submit': 'Submit',
  'dialogs.omp.notify.backgroundTitle': 'Session needs your input',
  'dialogs.omp.notify.backgroundBody': 'Session {session} is waiting for an answer',
  'dialogs.omp.tray.approvalRow': 'Session {session} — approval needed',
  'dialogs.omp.tray.approvalRowWithTool': 'Session {session} — {tool} needs approval',
  'dialogs.omp.tray.askRow': 'Session {session} — questions waiting',
  'dialogs.omp.workStatus.waitingAnswer': 'waiting for your answer',
  'dialogs.internalUri.dialogDescription': 'Internal resource content',
  'dialogs.internalUri.linkTitle': 'Open internal resource',
  'dialogs.internalUri.copyUrl': 'Copy link',
  'dialogs.internalUri.copied': 'Link copied',
  'dialogs.internalUri.copyFailed': 'Could not copy the link',
  'dialogs.internalUri.loading': 'Resolving resource…',
  'dialogs.internalUri.immutableBadge': 'Read-only',
