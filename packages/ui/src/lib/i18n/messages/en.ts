...
export const dict = {
  ...
  'aboutDialog.diagnosticsDescription': 'Includes OMPChamber state, OpenCode health, directories, and projects.',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'If OMPChamber does not detect OpenCode automatically, set the binary path below.',
  'onboarding.localSetup.intro': 'OpenCode is the heart of OMPChamber — install it to get started.',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'Saves to OMPChamber settings and reloads OpenCode configuration.',
