...
export const dict = {
  ...
  'chat.commandAutocomplete.badge.ompOverride': 'overrides OpenChamber',
  ...
  'chat.chatInput.toast.debugRenamed': 'The engine owns /debug now. OpenChamber\'s guided debug command moved to /troubleshoot.',
