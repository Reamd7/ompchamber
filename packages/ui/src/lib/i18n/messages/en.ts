...
export const dict = {
  ...
  'contextPanel.mode.agentRun': 'Agent run',
  'contextRail.surface.agentRun.description': 'Read-only transcript of one subagent run',
  'contextPanel.agentRun.loading': 'Loading…',
  'contextPanel.agentRun.empty': 'No conversation recorded for this run',
  'contextPanel.agentRun.openArtifact': 'Open output artifact',
  'contextPanel.agentRun.artifactFailed': 'Could not open the artifact',
