...
export const dict = {
  ...
  'onboarding.chooser.title': 'Welcome to OMPChamber',
  ...
  'onboarding.localSetup.title': 'Setting Up OMPChamber',
  'onboarding.localSetup.description': 'Install the ompchamber CLI to continue.',
  'onboarding.localSetup.dialog.selectOpencodeBinary': 'Select ompchamber binary',
  'onboarding.localSetup.errors.cliNotReady': 'The ompchamber CLI is not ready yet. Please confirm installation is complete and try again.',
  'onboarding.localSetup.errors.detectionFailed': 'Detection failed',
  'onboarding.localSetup.windows.title': 'Windows setup',
  'onboarding.localSetup.windows.stepInstallWsl': 'Install ompchamber with the command below.',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'If OMPChamber does not detect ompchamber automatically, set the binary path below.',
  'onboarding.localSetup.intro': 'The ompchamber CLI starts your local engine — install it to get started.',
  'onboarding.localSetup.docs.windows': 'OMPChamber on GitHub',
  'onboarding.localSetup.docs.default': 'OMPChamber on GitHub',
  ...
  'onboarding.localSetup.helper.checkAndContinue': 'Click to check if the ompchamber CLI is available. If successful, you\'ll automatically enter the main screen.',
  'onboarding.localSetup.status.watching': 'Waiting for the engine',
  'onboarding.localSetup.status.autoContinue': "We'll continue automatically once it's detected.",
  'onboarding.localSetup.field.alreadyInstalled': 'Already installed? Set the ompchamber CLI path:',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'Saves to OMPChamber settings and reloads engine configuration.',
  ...
  'onboarding.localSetup.windows.hintInstallInWsl': 'On Windows, install and run ompchamber natively.',
  'onboarding.localSetup.windows.hintDetectionFailed': 'If detection fails, set a native path such as ompchamber.cmd or ompchamber.exe.',
  'onboarding.localSetup.hint.ensurePath': 'Already installed? Make sure ompchamber is in your PATH.',
