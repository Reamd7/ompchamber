...
export const dict: Record<I18nKey, string> = {
  ...
  'contextPanel.mode.agentRun': '子代理运行',
  'contextRail.surface.agentRun.description': '单条子代理运行的只读对话记录',
  'contextPanel.agentRun.loading': '加载中…',
  'contextPanel.agentRun.empty': '该运行没有记录对话',
  'contextPanel.agentRun.openArtifact': '打开输出产物',
  'contextPanel.agentRun.artifactFailed': '无法打开产物',
