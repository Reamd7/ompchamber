...
export const dict: Record<I18nKey, string> = {
  ...
  'terminalView.actions.takeControl': '接管尺寸控制',
  'terminalView.actions.releaseControl': '释放尺寸控制',
  'terminalView.status.driving': '控制中',
  'terminalView.status.following': '跟随中',
  'terminalView.actions.zoomIn': '放大终端',
  'terminalView.actions.zoomOut': '缩小终端',
  'terminalView.actions.zoomReset': '重置终端缩放 (100%)',
  'terminalView.driverState.idleHint': '尺寸跟随最小窗口 — 点击接管控制',
  'terminalView.driverState.drivingHint': '你正在控制尺寸（{cols}×{rows}）— 点击释放',
  'terminalView.driverState.followingHint': '其他设备正在控制（{cols}×{rows}）— 点击抢占',
  'terminalView.actions.killSession': '关闭会话（断开所有设备）',
  'terminalView.actions.killSessionArmed': '再点一次将对所有设备关闭',
  ...
  'pwa.installPrompt.description': '安装 OMPChamber 以便更快访问',
  'pwa.installPrompt.action': '安装',
  'pwa.installPrompt.dismiss': '忽略',
  'pwa.installPrompt.started': '已开始安装',
  'pwa.installPrompt.installed': 'OMPChamber 已安装',
  ...
  'mobile.connect.password.placeholder': 'OMPChamber 密码',
  ...
  'mobile.connect.error.unreachable': '无法连接到该 OMPChamber 服务器。',
  ...
  'sessions.scheduledTasks.editor.persona.label': '化身',
  'sessions.scheduledTasks.editor.persona.ariaLabel': '会话化身',
  'sessions.scheduledTasks.editor.persona.standard': '标准',
  'sessions.scheduledTasks.editor.persona.unavailable': '不可用',
  ...
  'sessions.sidebar.footer.actions.aboutOMPChamber': '关于 OMPChamber',
  ...
  'sessions.sidebar.session.moveToWorktree.confirm.ownership': '引擎按目录而非会话跟踪这些更改。',
  ...
  'sessions.sidebar.session.status.resident': '驻留内存',
  'sessions.sidebar.session.status.residentWithSize': '驻留内存 · transcript ~{size}',
  'sessions.sidebar.session.status.residentShort': '驻留内存',
  ...
  'walkthrough.blocked.serverUnsupported.description': '此应用连接的 OMPChamber 服务器没有响应 walkthrough API，说明它比应用更旧。请将服务器升级到 1.18 或更高版本后刷新。',
  ...
  'contextPanel.browser.tunnelFailedHint': '{url} 运行在 OMPChamber 所在的机器上，无法与其建立连接。这里不会显示你本机上的任何内容。',
  ...
  'contextPanel.browser.devServers.remoteOnly': '它们运行在托管 OMPChamber 的那台机器上。要打开它们需要桌面应用。',
  ...
  'contextPanel.browser.trustNotice': '在此打开的页面以对 OMPChamber 的完全访问权限运行 — 检查和截图需要此权限。仅打开你信任的站点：恶意页面可能读取你的数据或以你的身份执行操作。',
  ...
  'filesView.editor.binaryFileDescription': '此文件为二进制文件，无法在 OMPChamber 中编辑。请下载后使用其他应用打开。',
  ...
  'chat.recap.label': '回顾：',
  'chat.sessionError.title': '引擎停止了本次回复',
  'chat.sessionError.noDetails': '引擎未报告任何详情。打开状态报告（Ctrl/Cmd+Shift+L）查看最近的错误。',
  'chat.sessionError.noReply': '引擎没有开始回复这条消息。',
  ...
  'terminalView.stream.reconnecting': '重连中…',
  ...
  'terminalView.tabs.unreadTitle': '未读的命令输出',
  ...
  'directoryExplorerDialog.browse.permissionDenied': 'OMPChamber 需要访问此文件夹。',
  ...
  'aboutDialog.openChamberVersionLabel': 'OMPChamber 版本 {version}',
  'aboutDialog.openCodeVersionLabel': '引擎版本 {version}',
  ...
  'aboutDialog.diagnosticsDescription': '包含 OMPChamber 状态、引擎健康信息、目录和项目。',
  ...
  'helpDialog.description': '使用这些快捷键可更高效地导航 OMPChamber',
  ...
  'header.actions.openAppMenu': 'OMPChamber 菜单',
  'header.actions.openAppMenuAria': '打开 OMPChamber 菜单',
  ...
  'chat.retry.supersededBadge': '已被重试取代',
  'chat.chat.ompDivider.compacted': '已压缩',
  ...
  'chat.chat.ompDivider.developerNote': '注入备注',
  'chat.omp.ttsrWarning.title': '已触发纠偏规则',
  'chat.omp.ttsrWarning.dismissAria': '关闭提醒',
  'chat.omp.strippedToolCalls.one': '本分支省略了 {count} 个工具调用，无结果',
  'chat.omp.strippedToolCalls.many': '本分支省略了 {count} 个工具调用，无结果',
  'chat.omp.customCard.moreEntries': '还有 {count} 个',
  'chat.omp.cacheMiss.label': '缓存未命中',
  'chat.omp.cacheMiss.tokens': '{tokens} 令牌',
  'toast.ompNotice.title.info': '提示',
  'toast.ompNotice.title.warning': '警告',
  'toast.ompNotice.title.error': '错误',
  ...
  'chat.emptyState.opencodeUnreachable': '无法连接引擎',
  ...
  'chat.statusRow.todo.status.blockedBy': '被 {reason} 阻塞',
  'chat.statusRow.todo.status.blockedBare': '已阻塞',
  ...
  'chat.revert.toast.undoPrefilled': '已回退。该消息已回到输入框。',
  'chat.commandAutocomplete.command.treeDescription': '浏览此会话的分支树',
  'chat.commandAutocomplete.command.forkDescription': '将此对话分叉为新会话',
  'chat.commandAutocomplete.command.branchDescription': '从之前的消息分支',
  'chat.workStatus.subagent.parked': '已驻留',
  'chat.workStatus.subagent.aborted': '已中止',
  'chat.workStatus.goal.status.active': '进行中',
  'chat.workStatus.goal.status.paused': '已暂停',
  'chat.workStatus.goal.status.complete': '已完成',
  'chat.workStatus.goal.status.budgetLimited': '已达预算',
  'chat.workStatus.goal.status.dropped': '已放弃',
  'chat.revert.toast.redo': '已重做',
  'chat.revert.toast.restored': '已恢复全部消息',
  'chat.toast.opencodeRestartInterrupted.title': '聊天已中断',
  'chat.toast.opencodeRestartInterrupted.description': '引擎在回复仍在生成时重启了。发送一条消息以继续。',
  ...
  'chat.commandAutocomplete.badge.ompOverride': '覆盖 OMPChamber',
  'chat.chatInput.toast.debugRenamed': '引擎现已占用 /debug。OMPChamber 的引导式调试命令已迁移到 /troubleshoot。',
  'chat.sessionTree.title': '会话分支',
  'chat.sessionTree.description': '此会话的分叉。选择一个分支即可打开其时间线。',
  'chat.sessionTree.loading': '正在加载分支…',
  'chat.sessionTree.error': '无法加载会话树。',
  'chat.sessionTree.empty': '此会话没有任何分叉。',
  'chat.sessionTree.untitled': '未命名',
  'chat.sessionTree.current': '当前',
  'chat.sessionTree.leaf': '最新',
  'chat.sessionTree.openBranch': '打开分支 {title}',
  ...
  'chat.toolPart.askQuestionsCount': '{count} 个问题',
  'chat.toolPart.askNoSelection': '未作答',
  'chat.toolPart.askCustomAnswer': '自定义回答',
  'chat.toolPart.askNote': '备注',
  'chat.toolPart.askAutoSelected': '超时后自动选择——并非用户选择',
  'chat.toolPart.askChatRedirect': '用户选择改为在对话中讨论，而非作答',
  'chat.toolPart.taskAgent.status.pending': '等待中',
  'chat.toolPart.taskAgent.status.running': '运行中',
  'chat.toolPart.taskAgent.status.completed': '已完成',
  'chat.toolPart.taskAgent.status.failed': '失败',
  'chat.toolPart.taskAgent.status.aborted': '已中止',
  'chat.toolPart.taskAgent.retrying': '重试 {attempt}/{maxAttempts}',
  'chat.toolPart.taskAgent.retriesExhausted': '重试已耗尽（{attempt}）',
  'chat.toolPart.taskAgent.moreAgents': '还有 {count} 个',
  'chat.todo.total': '总计',
  ...
  'chat.modelControls.roles.sectionTitle': '模型角色',
  'chat.modelControls.roles.notConfigured': '未配置',
  ...
  'chat.modelControls.setAsRole.failed': '无法分配角色',
  'chat.modelControls.setAsRole.rejected.role-already-configured': '该角色已配置模型',
  'chat.modelControls.enabledWarning': '当前模型不在 enabledModels 中',
  'chat.modeSelector.label.default': '默认',
  'chat.modeSelector.label.plan': '规划',
  'chat.modeSelector.label.planPaused': '规划（已暂停）',
  'chat.modeSelector.label.goal': '目标',
  'chat.modeSelector.label.goalPaused': '目标（已暂停）',
  'chat.modeSelector.label.vibe': '随性',
  'chat.modeSelector.label.loop': '循环',
  'chat.modeSelector.ariaLabel': '会话模式',
  'chat.modeSelector.title': '模式',
  'chat.modeSelector.requiresSession': '开始会话后才能切换模式',
  ...
  'chat.goalIndicator.title': '目标',
  'chat.goalIndicator.status.active': '进行中',
  'chat.goalIndicator.status.paused': '已暂停',
  'chat.goalIndicator.status.complete': '已完成',
  'chat.goalIndicator.status.budgetLimited': '预算已到限',
  'chat.goalIndicator.status.dropped': '已放弃',
  'chat.goalIndicator.noObjective': '未记录目标内容',
  ...
  'commandPalette.item.showOpenCodeStatus': '显示引擎状态',
  'commandPalette.item.toggleMemoryDebug': '切换调试面板',
  ...
  'openCodeStatusDialog.title': '引擎状态',
  'openCodeStatusDialog.description': '查看当前引擎状态与诊断信息。',
  ...
  'openCodeStatusDialog.memory.title': '引擎内存',
  'openCodeStatusDialog.memory.refreshNote': '打开期间每 5 秒刷新',
  'openCodeStatusDialog.memory.loading': '加载中…',
  'openCodeStatusDialog.memory.unavailable': '当前引擎版本不支持内存诊断。',
  'openCodeStatusDialog.memory.error': '内存诊断加载失败。',
  'openCodeStatusDialog.memory.processHeap': '进程堆内存',
  'openCodeStatusDialog.memory.processRss': '进程 RSS',
  'openCodeStatusDialog.memory.processExternal': '外部内存 + 缓冲',
  'openCodeStatusDialog.memory.residentEstimate': '驻留会话（估算）',
  'openCodeStatusDialog.memory.sessionsTitle': '驻留会话：{live} 个活跃 · 共 {total} 个',
  'openCodeStatusDialog.memory.sessionsStates': '加载中 {materializing} · 驱逐中 {evicting} · 失败 {failed}',
  'openCodeStatusDialog.memory.noResident': '没有驻留内存的会话。',
  'openCodeStatusDialog.memory.truncated': '列表已截断 — 仅显示最大的驻留会话。',
  'openCodeStatusDialog.memory.colSession': '会话',
  'openCodeStatusDialog.memory.colDirectory': '目录',
  'openCodeStatusDialog.memory.colState': '状态',
  'openCodeStatusDialog.memory.colSize': '~大小',
  'openCodeStatusDialog.memory.colIdle': '空闲',
  'openCodeStatusDialog.memory.wireBus': 'Wire 事件缓冲',
  'openCodeStatusDialog.memory.ompBus': 'OMP 事件缓冲',
  'openCodeStatusDialog.memory.busValue': '{entries} 条 · {size}（上限 {capacity}）',
  'openCodeStatusDialog.memory.wireIdEchoes': 'Wire-ID 回声',
  'openCodeStatusDialog.memory.inFlightUnderflow': 'inFlight 下溢',
  'openCodeStatusDialog.memory.estimateNote': '会话大小为 transcript 体积估算值（约为驻留堆的 1.3 倍），不是逐会话实测归因。',
  'openCodeStatusDialog.monitor.tabOverview': '概览',
  'openCodeStatusDialog.monitor.tabSessions': '会话',
  'openCodeStatusDialog.monitor.residentCount': '{total} 个驻留',
  'openCodeStatusDialog.monitor.catSessions': '驻留会话（估算）',
  'openCodeStatusDialog.monitor.catBuffers': '事件缓冲',
  'openCodeStatusDialog.monitor.catUnattributed': '未归因引擎内存',
  'openCodeStatusDialog.monitor.processMonitor': '进程监控',
  'openCodeStatusDialog.monitor.processMonitorValue': '{live} 个存活 · {windows} 个调用 · {failures} 次采样失败',
  'openCodeStatusDialog.monitor.stateLive': '驻留',
  'openCodeStatusDialog.monitor.stateMaterializing': '加载中',
  'openCodeStatusDialog.monitor.stateEvicting': '驱逐中',
  'openCodeStatusDialog.monitor.stateFailed': '失败',
  'openCodeStatusDialog.monitor.largeOnly': '仅显示 ≥10MB',
  'openCodeStatusDialog.monitor.noLarge': '没有 ≥10MB 的驻留会话。',
  'openCodeStatusDialog.monitor.colAction': '操作',
  'openCodeStatusDialog.monitor.release': '释放',
  'openCodeStatusDialog.monitor.releaseHint': '从内存驱逐 — transcript 保留在磁盘上',
  'openCodeStatusDialog.monitor.releaseBusy': '会话仍在活动 — 无法释放。',
  'openCodeStatusDialog.monitor.releaseFailed': '释放会话失败。',
  ...
  'sessionAuth.error.networkDescription': '无法验证 UI 会话。如果你是从本地网络中的另一台设备打开 OMPChamber，请在桌面端应用中启用 Desktop Network Access，并使用设置中显示的 LAN 地址。',
  ...
  'sessionAuth.locked.unlockTitle': '解锁 OMPChamber',
  ...
  'desktopHostSwitcher.description': '在 Local 与远程 OMPChamber 服务器之间切换',
  ...
  'multiRun.window.description': 'OMPChamber 多运行窗口。',
  ...
  'onboarding.remoteConnection.description': '输入要连接的 OMPChamber 服务器地址。',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': '建议：确认 URL 指向 OMPChamber 服务器，或联系服务器管理员。',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': '此实例正在运行不同版本的 OMPChamber。你可以连接；如果功能异常，请更新两端应用。',
  'onboarding.remoteConnection.probe.incompatibleMessage': '服务器正在运行 OMPChamber，但与此应用版本不兼容。请更新服务器上的 OMPChamber 后重试。',
  'onboarding.remoteConnection.probe.wrongServiceMessage': '服务器有响应，但未运行 OMPChamber。请确认地址是否指向 OMPChamber 服务器。',
  'onboarding.remoteConnection.probe.unreachableMessage': '服务器不可达。请检查网络连接并确认服务器地址。',
  'onboarding.desktopRecovery.localUnavailable.title': '本地引擎不可用',
  'onboarding.desktopRecovery.localUnavailable.description': '本地引擎无法启动。请重试启动，或改为连接远程服务器。',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': '“{host}” 上的服务器未运行 OMPChamber。请确认地址是否指向 OMPChamber 服务器。',
  'onboarding.desktopRecovery.remoteIncompatible.title': '需要更新服务器',
  'onboarding.desktopRecovery.remoteIncompatible.description': '“{host}” 上的 OMPChamber 服务器与此应用版本不兼容。请更新服务器上的 OMPChamber 后重试。',
  ...
  'startup.initRecovery.description': 'OMPChamber 未能完成初始化。请检查服务器是否正在运行，然后重试。',
  ...
  'updateDialog.header.updating': '正在更新 OMPChamber...',
  ...
  'updateDialog.error.takingLonger': '更新耗时超出预期。请稍等后刷新，或运行：ompchamber update',
  'updateDialog.error.signatureRejected': '下载的更新被拒绝：其代码签名与当前安装不匹配。这通常说明正在运行的副本不是从官方签名版本安装的。请从官方版本安装 OMPChamber，然后再次更新。',
  'updateDialog.error.updaterDisabled': '一次安装失败后，更新程序已停止。请退出 OMPChamber，重新打开后再试一次更新。',
  'updateDialog.error.restartFailed': '无法重启以安装更新。',
  'updateDialog.error.restartUnavailable': '安装更新需要 OMPChamber 桌面应用。',
  'mobileUpdate.toast.available.title': 'OMPChamber 更新可用',
  ...
  'memoryDebugPanel.tabs.memory': 'UI 内存',
  'memoryDebugPanel.tabs.engine': '引擎',
  'memoryDebugPanel.tabs.streaming': '流式',
  'memoryDebugPanel.tabs.requests': '请求',
  'memoryDebugPanel.section.sessionsInMemory': 'UI 内存中的会话',
  ...
  'memoryDebugPanel.resizeHandle': '拖拽调整面板宽度',
  'memoryDebugPanel.metricName.sidebarScrollAnchorAdjustment': '侧栏滚动锚点调整',
  'memoryDebugPanel.metricName.sidebarSessionNodeRender': '侧栏会话行渲染',
  'memoryDebugPanel.metricName.sidebarSessionNodePropsChanged': '侧栏会话属性变更',
  'memoryDebugPanel.metricName.globalSessionsEventUpdateDeferred': '会话事件更新延迟',
  'memoryDebugPanel.metricName.globalSessionsEventUpdateImmediate': '会话事件立即更新',
  'memoryDebugPanel.metricName.globalSessionsEventUpdatePublication': '会话事件更新发布',
  'memoryDebugPanel.metricName.sidebarProjectSectionReused': '项目分区复用',
  'memoryDebugPanel.metricName.sidebarProjectSectionRebuilt': '项目分区重建',
  'memoryDebugPanel.metricName.sidebarProjectSectionRebuiltReason': '项目分区重建原因',
  'memoryDebugPanel.metricName.sidebarProjectsListRender': '项目列表渲染',
  'memoryDebugPanel.metricName.sessionSidebarRender': '会话侧栏渲染',
  'memoryDebugPanel.metricName.sessionSidebarSource': '会话侧栏来源',
  'memoryDebugPanel.metricName.headerRender': '头部渲染',
  'memoryDebugPanel.metricName.assistantTextRender': '助手文本渲染',
  'memoryDebugPanel.metricName.assistantTextDisplayLen': '助手文本显示长度',
  'memoryDebugPanel.metricName.messageListEntryRender': '消息列表条目渲染',
  'memoryDebugPanel.metricName.messageListRender': '消息列表渲染',
  'memoryDebugPanel.metricName.messageListBaseDisplayMs': '消息列表基础显示（ms）',
  'memoryDebugPanel.metricName.messageListRetryOverlayMs': '消息列表重试遮罩（ms）',
  'memoryDebugPanel.metricName.messageListRenderEntriesMs': '消息列表条目渲染（ms）',
  'memoryDebugPanel.metricName.markdownRender': 'Markdown 渲染',
  'memoryDebugPanel.metricName.markdownContentLen': 'Markdown 内容长度',
  'memoryDebugPanel.metricName.markdownDomCache': 'Markdown DOM 缓存',
  'memoryDebugPanel.metricName.markdownSettledPaintReused': 'Markdown 稳定绘制复用',
  'memoryDebugPanel.metricName.chatMessageRender': '聊天消息渲染',
  'memoryDebugPanel.metricName.turnsProjectionMs': '回合投影（ms）',
  'memoryDebugPanel.metricName.vscodeWebviewSseChunk': 'Webview SSE 分块',
  'memoryDebugPanel.metricName.vscodeWebviewSseChunkBytes': 'Webview SSE 分块字节',
  'memoryDebugPanel.metricName.vscodeWebviewSseEnd': 'Webview SSE 结束',
  'memoryDebugPanel.metricName.vscodeWebviewSseStartMs': 'Webview SSE 启动（ms）',
  ...
  'openChamberLogo.aria.logo': 'OMPChamber 标志',
  ...
  'chat.workStatus.section.processes': '进程',
  'chat.workStatus.processes.running': '运行中',
  'chat.workStatus.processes.exited': '已退出',
  'chat.workStatus.processes.killed': '已终止',
  'chat.workStatus.processes.failed': '失败',
  'chat.workStatus.processes.uncertain': '归属不确定',
  'chat.workStatus.processes.kill': '终止',
  'chat.workStatus.processes.killAll': '全部终止',
  'chat.workStatus.processes.killConfirm': '确定？',
  'chat.workStatus.processes.view': '查看 {command}',
  'chat.workStatus.processes.viewAll': '查看全部进程',
  'chat.workStatus.processes.output': '输出',
  'chat.workStatus.processes.command': '命令',
  'chat.workStatus.processes.cpu': 'CPU',
  'chat.workStatus.processes.memory': '内存',
  'chat.workStatus.processes.liveCount': '{count} 个存活',
  'chat.workStatus.processes.endedCount': '{count} 个已结束',
  'chat.workStatus.processes.statsStale': '统计已过期',
  ...
  'chat.workStatus.section.localFiles': '会话 local 文件',
  ...
  'chat.workStatus.action.openAgentRun': '打开运行 {name}',
  'chat.toolPart.taskAgent.openArtifact': '打开输出产物',
  'chat.toolPart.taskAgent.openRun': '打开运行',
  ...
  'dialogs.omp.approval.title': '需要审批',
  'dialogs.omp.planReview.choice.approveExecute': '批准并执行',
  'dialogs.omp.planReview.choice.approveCompact': '批准并压缩上下文',
  'dialogs.omp.planReview.choice.approveKeep': '批准并保留上下文',
  'dialogs.omp.planReview.choice.refine': '完善计划',
  'dialogs.omp.planReview.planReady': '计划已就绪,等待审阅。',
  'dialogs.omp.planReview.planMissing': '未找到计划文件。仍可审阅该提案。',
  'dialogs.omp.planReview.loadingPlan': '正在加载计划…',
  'dialogs.omp.planReview.contentUnavailable': '计划内容暂不可用。你仍可以做出决定。',
  'dialogs.omp.planReview.editMode': '编辑计划',
  'dialogs.omp.planReview.previewMode': '预览',
  'dialogs.omp.planReview.editAreaLabel': '编辑后的计划内容',
  'dialogs.omp.planReview.feedbackLabel': '完善反馈',
  'dialogs.omp.planReview.feedbackPlaceholder': '计划需要修改哪些内容?',
  'dialogs.omp.planReview.refineCancel': '取消',
  'dialogs.omp.planReview.refineSubmit': '发送反馈',
  'dialogs.omp.planReview.refineSubmitted': '反馈已发送,计划将被完善。',
  'dialogs.omp.planReview.submitting': '处理中…',
  'dialogs.omp.planReview.decisionFailed': '无法提交审阅决定。',
  'dialogs.omp.planReview.unavailable': '计划审阅当前不可用。',
  'dialogs.omp.approval.bodyAria': '工具审批请求',
  'dialogs.omp.approval.approve': '批准',
  'dialogs.omp.approval.deny': '拒绝',
  'dialogs.omp.approval.alwaysAllow': '始终允许此工具(写入设置)并批准',
  'dialogs.omp.approval.alwaysAllowConfirm': '写入设置并批准',
  'dialogs.omp.approval.alwaysAllowConfirmBody': '将 tools.approval.{tool} = allow 写入全局 omp 设置,然后批准本次请求。',
  'dialogs.omp.approval.alwaysAllowCancel': '返回',
  'dialogs.omp.approval.alwaysAllowFailed': '设置写入失败。未批准任何操作,对话框保持打开。',
  'dialogs.omp.approval.respondFailed': '应答失败',
  'dialogs.omp.ask.title': '提问',
  'dialogs.omp.ask.summaryTab': '概览',
  'dialogs.omp.ask.noAnswer': '未作答',
  'dialogs.omp.ask.recommended': '推荐',
  'dialogs.omp.ask.other': '其他(自定义输入)',
  'dialogs.omp.ask.otherPlaceholder': '输入你的回答…',
  'dialogs.omp.ask.note': '备注(可选)',
  'dialogs.omp.ask.chatAboutThis': '转而讨论',
  'dialogs.omp.ask.next': '下一题',
  'dialogs.omp.ask.submit': '提交',
  'dialogs.omp.ask.respondFailed': '应答失败',
  'dialogs.omp.queue.moreWaiting': '还有 {count} 个等待中',
  'dialogs.omp.select.title': '选择一个选项',
  'dialogs.omp.confirm.yes': '是',
  'dialogs.omp.confirm.no': '否',
  'dialogs.omp.generic.cancel': '取消',
  'dialogs.omp.input.submit': '提交',
  'dialogs.omp.notify.backgroundTitle': '会话等待你的输入',
  'dialogs.omp.notify.backgroundBody': '会话 {session} 正在等待应答',
  'dialogs.omp.tray.approvalRow': '会话 {session} — 等待批准',
  'dialogs.omp.tray.approvalRowWithTool': '会话 {session} — {tool} 等待批准',
  'dialogs.omp.tray.askRow': '会话 {session} — 有问题待答',
  'dialogs.omp.workStatus.waitingAnswer': '正在等待应答',
  'dialogs.internalUri.dialogDescription': '内部资源内容',
  'dialogs.internalUri.linkTitle': '打开内部资源',
  'dialogs.internalUri.copyUrl': '复制链接',
  'dialogs.internalUri.copied': '链接已复制',
  'dialogs.internalUri.copyFailed': '复制链接失败',
  'dialogs.internalUri.loading': '正在解析资源…',
  'dialogs.internalUri.immutableBadge': '只读',
  'dialogs.internalUri.error.unavailable': '此服务器未开放内部资源。',
  'dialogs.internalUri.error.tooLarge': '资源过大，无法显示（{size}）。',
  'dialogs.internalUri.error.resolveFailed': '无法解析此资源。',
  'dialogs.internalUri.error.binaryFailed': '无法加载此文件进行预览。',
  'contextPanel.localFiles.title': '会话 local 文件',
  'contextPanel.localFiles.description': '只读浏览当前会话私有的 local:// 文件。',
  'contextPanel.localFiles.noDirectory': '当前没有激活的项目目录。',
  'contextPanel.localFiles.noSession': '未选择会话。',
  'contextPanel.localFiles.filesLoading': '正在加载文件…',
  'contextPanel.localFiles.filesError': '无法加载文件。',
  'contextPanel.localFiles.emptyFiles': '此会话没有 local:// 文件。',
  'contextPanel.localFiles.openFile': '打开 {ref}',
  'contextPanel.localFiles.truncated': '列表已截断，还有更多文件。',
  'contextPanel.localFiles.backToFiles': '工作区文件',
  'contextPanel.localFiles.scopeAria': '切换文件树范围',
  'contextPanel.localFiles.browseHint': '从该会话的文件树中选择一个文件。',
  'contextPanel.localFiles.previewFailed': '无法加载此文件进行预览。',
  'contextPanel.mode.timeline': '时间线',
  'contextRail.surface.timeline.description': '当前会话的结构化事件',
  'contextPanel.timeline.empty': '暂无事件',
  'contextPanel.timeline.emptyNoSession': '无活动会话',
  'contextPanel.timeline.loading': '加载时间线…',
  'contextPanel.timeline.kind.compaction': '压缩',
  'contextPanel.timeline.kind.branch_summary': '分支',
  'contextPanel.timeline.kind.model_change': '模型切换',
  'contextPanel.timeline.kind.mode_change': '模式切换',
  'contextPanel.timeline.kind.ttsr_injection': '规则注入',
  'contextPanel.timeline.kind.retry_recovery': '重试',
};
