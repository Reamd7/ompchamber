...
'chat.modeSelector.conflict': '请先退出 {mode} 模式。',
  ...
  'onboarding.chooser.title': '欢迎使用 OMPChamber',
  ...
  'onboarding.localSetup.title': '设置 OMPChamber',
  'onboarding.localSetup.description': '安装 ompchamber CLI 以继续。',
  'onboarding.localSetup.dialog.selectOpencodeBinary': '选择 ompchamber 可执行文件',
  'onboarding.localSetup.errors.cliNotReady': 'ompchamber CLI 尚未就绪。请确认安装完成后重试。',
  'onboarding.localSetup.errors.detectionFailed': '检测失败',
  'onboarding.localSetup.windows.title': 'Windows 设置',
  'onboarding.localSetup.windows.stepInstallWsl': '使用下方命令安装 ompchamber。',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': '如果 OMPChamber 未自动检测到 ompchamber，请在下方设置可执行文件路径。',
  'onboarding.localSetup.intro': 'ompchamber CLI 会启动你的本地引擎——先安装它即可开始。',
  ...
  'onboarding.localSetup.helper.checkAndContinue': '点击检测 ompchamber CLI 是否可用。成功后将自动进入主界面。',
  'onboarding.localSetup.status.watching': '正在等待引擎',
  'onboarding.localSetup.status.autoContinue': '检测到后将自动继续。',
  'onboarding.localSetup.field.alreadyInstalled': '已安装？设置 ompchamber CLI 路径：',
  ...
  'onboarding.localSetup.helper.saveAndReload': '将保存到 OMPChamber 设置并重新加载引擎配置。',
  'onboarding.localSetup.remotePreference': '更希望使用远程服务器？',
  'onboarding.localSetup.actions.connectRemoteServer': '连接远程服务器 →',
  'onboarding.localSetup.windows.hintInstallInWsl': '在 Windows 上，请原生安装并运行 ompchamber。',
  'onboarding.localSetup.windows.hintDetectionFailed': '若检测失败，请设置原生路径，例如 ompchamber.cmd 或 ompchamber.exe。',
  'onboarding.localSetup.hint.ensurePath': '已安装？请确认 ompchamber 在你的 PATH 中。',
