...
export const dict: Record<I18nKey, string> = {
  ...
  'aboutDialog.diagnosticsDescription': '包含 OMPChamber 状态、OpenCode 健康信息、目录和项目。',
...
'chat.modeSelector.conflict': '请先退出 {mode} 模式。',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': '如果 OMPChamber 未自动检测到 OpenCode，请在下方设置可执行文件路径。',
  'onboarding.localSetup.intro': 'OpenCode 是 OMPChamber 的核心，先安装它即可开始。',
  ...
  'onboarding.localSetup.helper.saveAndReload': '将保存到 OMPChamber 设置并重新加载 OpenCode 配置。',
