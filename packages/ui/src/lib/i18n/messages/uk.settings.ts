...
'settings.view.home.cards.plugins.description': 'Керувати плагінами OMP',
  ...
  "settings.openchamber.tunnel.tooltip.tokensSavedPath": "Токени зберігаються в ~/.config/ompchamber/cloudflare-managed-remote-tunnels.json.",
...
"settings.remoteInstances.clientAuth.actions.addDevice": "Додати пристрій",
  ...
  "settings.openchamber.about.title": "Про OMPChamber",
  ...
  "settings.openchamber.desktopNetwork.field.launchAtLoginAria": "Запускати OMPChamber під час входу в систему",
  "settings.openchamber.desktopNetwork.field.launchAtLogin": "Запускати OMPChamber під час входу в систему",
  ...
  "settings.openchamber.desktopNetwork.field.macMenuBarAria": "Показувати OMPChamber у смузі меню macOS",
  "settings.openchamber.desktopNetwork.field.macMenuBar": "Показувати OMPChamber у смузі меню",
  "settings.openchamber.desktopNetwork.field.macMenuBarDescription": "Потребує перезапуску застосунку. Якщо вимкнено, OMPChamber не створює елемент смуги меню та не запускає пов’язані оновлення сесій, запитів на підтвердження й використання.",
  "settings.openchamber.desktopNetwork.field.minimizeToTrayAria": "Закривати OMPChamber у системний трей",
  "settings.openchamber.desktopNetwork.field.minimizeToTray": "Закривати в системний трей",
  "settings.openchamber.desktopNetwork.field.minimizeToTrayDescription": "Залишає OMPChamber запущеним у системному треї, коли головне вікно закрито. Під час згортання вікно залишається на панелі завдань.",
  "settings.openchamber.desktopNetwork.field.keepAwakeAria": "Не давати комп’ютеру засинати, поки OMPChamber запущено",
  "settings.openchamber.desktopNetwork.field.keepAwake": "Не давати комп’ютеру засинати, поки OMPChamber запущено",
  ...
  "settings.openchamber.desktopPassword.field.passwordDescription": "OMPChamber попросить пароль після перезапуску, а потім коли сесія логіну спливе: через 12 годин або через 7 днів із «Довіряти цьому пристрою». Залиште порожнім, щоб вимкнути логін.",
  ...
  "settings.openchamber.tools.title": "Інструменти OMPChamber",
  ...
  "settings.openchamber.tools.field.agentWebTool": "Інструмент OMPChamber Web",
  "settings.openchamber.tools.field.agentWebToolAria": "Увімкнути інструмент OMPChamber Web",
  ...
  "settings.remoteInstances.page.phase.installingOpenChamber": "Встановлення OMPChamber",
  "settings.remoteInstances.page.phase.updatingOpenChamber": "Оновлення OMPChamber",
  ...
  "settings.openchamber.visual.field.themeImportInfoTooltip": "Імпорт спеціальних тем із ~/.config/ompchamber/themes/",
