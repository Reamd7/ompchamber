...
export const thirdPartyIntegrationI18n = {
  en: {
    ...
    'settings.page.integrations.description': 'Add third-party subscriptions to use as OMPChamber providers.',
    ...
    'settings.integrations.thirdParty.info': 'Install a provider plugin, then set up your subscription so OMPChamber can use it.',
    ...
    'settings.integrations.thirdParty.status.restartRequired': 'Restart the engine before setting up this provider.',
    'settings.integrations.thirdParty.status.registryUnavailable': 'Could not check npm right now.',
    'settings.integrations.thirdParty.status.providerUnavailable': 'The provider is not available yet. Restart the engine and try again.',
    'settings.integrations.thirdParty.dialog.remove.title': 'Remove integration',
    'settings.integrations.thirdParty.dialog.remove.description': 'Remove {name} from your user-wide engine configuration? The provider will no longer load after the engine refreshes.',
    ...
    'settings.integrations.thirdParty.toast.restartRequired': 'Restart the engine for changes to take effect',
    ...
    'settings.integrations.thirdParty.opencodeCursorOauth.description': 'Cursor’s generous in-house model limits, now in OMPChamber.',
  },
  de: {
    'settings.page.integrations.title': 'Integrationen',
    'settings.page.integrations.description': 'Füge Drittanbieter-Abonnements hinzu, um sie als OMPChamber-Provider zu nutzen.',
    ...
    'settings.integrations.thirdParty.info': 'Installiere ein Provider-Plugin und richte dein Abonnement ein, damit OMPChamber es nutzen kann.',
    ...
    'settings.integrations.thirdParty.status.restartRequired': 'Starte die Engine neu, bevor du diesen Provider einrichtest.',
    'settings.integrations.thirdParty.status.registryUnavailable': 'npm konnte gerade nicht geprüft werden.',
    'settings.integrations.thirdParty.status.providerUnavailable': 'Der Provider ist noch nicht verfügbar. Starte die Engine neu und versuche es erneut.',
    'settings.integrations.thirdParty.dialog.remove.title': 'Integration entfernen',
    'settings.integrations.thirdParty.dialog.remove.description': '{name} aus deiner benutzerweiten Engine-Konfiguration entfernen? Der Provider wird nach der Aktualisierung der Engine nicht mehr geladen.',
    ...
    'settings.integrations.thirdParty.toast.restartRequired': 'Starte die Engine neu, damit die Änderungen wirksam werden',
    'settings.integrations.thirdParty.opencodeClaude.name': 'Claude Code',
    ...
    'settings.integrations.thirdParty.opencodeCursorOauth.name': 'Cursor',
    'settings.integrations.thirdParty.opencodeCursorOauth.description': 'Die großzügigen Limits der Cursor-eigenen Modelle jetzt in OMPChamber.',
  },
  fr: {
    'settings.page.integrations.title': 'Intégrations',
    'settings.page.integrations.description': 'Ajoutez des abonnements tiers à utiliser comme fournisseurs OMPChamber.',
    ...
    'settings.integrations.thirdParty.info': 'Installez un plugin de fournisseur, puis configurez votre abonnement pour qu’OMPChamber puisse l’utiliser.',
    ...
    'settings.integrations.thirdParty.status.restartRequired': 'Redémarrez le moteur avant de configurer ce fournisseur.',
    'settings.integrations.thirdParty.status.registryUnavailable': 'Impossible de vérifier npm pour le moment.',
    'settings.integrations.thirdParty.status.providerUnavailable': 'Le fournisseur n’est pas encore disponible. Redémarrez le moteur et réessayez.',
    'settings.integrations.thirdParty.dialog.remove.title': 'Supprimer l’intégration',
    'settings.integrations.thirdParty.dialog.remove.description': 'Supprimer {name} de votre configuration globale du moteur ? Le fournisseur ne sera plus chargé après l’actualisation du moteur.',
    ...
    'settings.integrations.thirdParty.toast.restartRequired': 'Redémarrez le moteur pour que les modifications prennent effet',
    'settings.integrations.thirdParty.opencodeClaude.name': 'Claude Code',
    ...
    'settings.integrations.thirdParty.opencodeCursorOauth.name': 'Cursor',
    'settings.integrations.thirdParty.opencodeCursorOauth.description': 'Les généreuses limites des modèles internes Cursor, désormais dans OMPChamber.',
  },
  es: {
    'settings.page.integrations.title': 'Integraciones',
    'settings.page.integrations.description': 'Añade suscripciones de terceros para usarlas como proveedores de OMPChamber.',
    ...
    'settings.integrations.thirdParty.info': 'Instala un plugin de proveedor y configura tu suscripción para que OMPChamber pueda usarla.',
    ...
    'settings.integrations.thirdParty.status.restartRequired': 'Reinicia el motor antes de configurar este proveedor.',
    'settings.integrations.thirdParty.status.registryUnavailable': 'No se pudo comprobar npm ahora mismo.',
    'settings.integrations.thirdParty.status.providerUnavailable': 'El proveedor todavía no está disponible. Reinicia el motor e inténtalo de nuevo.',
    'settings.integrations.thirdParty.dialog.remove.title': 'Quitar integración',
    'settings.integrations.thirdParty.dialog.remove.description': '¿Quitar {name} de tu configuración global del motor? El proveedor dejará de cargarse después de actualizar el motor.',
    ...
    'settings.integrations.thirdParty.toast.restartRequired': 'Reinicia el motor para que los cambios surtan efecto',
    'settings.integrations.thirdParty.opencodeClaude.name': 'Claude Code',
    'settings.integrations.thirdParty.opencodeClaude.description': 'Usa tu plan Claude Pro/Max: sin claves API ni apps de Claude.',
    'settings.integrations.thirdParty.opencodeCursorOauth.name': 'Cursor',
    'settings.integrations.thirdParty.opencodeCursorOauth.description': 'Los generosos límites de los modelos internos de Cursor, ahora en OMPChamber.',
  },
  ja: {
    'settings.page.integrations.title': '連携',
    'settings.page.integrations.description': 'サードパーティのサブスクリプションを追加して、OMPChamber のプロバイダーとして使います。',
    ...
    'settings.integrations.thirdParty.info': 'プロバイダープラグインをインストールし、サブスクリプションを設定して OMPChamber で使えるようにします。',
    ...
    'settings.integrations.thirdParty.status.restartRequired': 'このプロバイダーを設定する前にエンジンを再起動してください。',
    'settings.integrations.thirdParty.status.registryUnavailable': '現在 npm を確認できません。',
    'settings.integrations.thirdParty.status.providerUnavailable': 'プロバイダーはまだ利用できません。エンジンを再起動して再試行してください。',
    'settings.integrations.thirdParty.dialog.remove.title': '連携を削除',
    'settings.integrations.thirdParty.dialog.remove.description': '{name} をユーザー全体のエンジン設定から削除しますか？エンジンの更新後、このプロバイダーは読み込まれなくなります。',
    ...
    'settings.integrations.thirdParty.toast.restartRequired': '変更を反映するにはエンジンを再起動してください',
    'settings.integrations.thirdParty.opencodeClaude.name': 'Claude Code',
    'settings.integrations.thirdParty.opencodeClaude.description': 'Claude Pro/Max プランを利用 — API キーも Claude アプリも不要。',
    'settings.integrations.thirdParty.opencodeCursorOauth.name': 'Cursor',
    'settings.integrations.thirdParty.opencodeCursorOauth.description': 'Cursor 内蔵モデルの余裕ある制限が、OMPChamber で使えます。',
  },
  ko: {
    'settings.page.integrations.title': '통합',
    'settings.page.integrations.description': '타사 구독을 추가해 OMPChamber 프로바이더로 사용하세요.',
    ...
    'settings.integrations.thirdParty.info': '프로바이더 플러그인을 설치한 뒤 구독을 설정하면 OMPChamber에서 사용할 수 있습니다.',
    ...
    'settings.integrations.thirdParty.status.restartRequired': '이 프로바이더를 설정하기 전에 엔진을 다시 시작하세요.',
    'settings.integrations.thirdParty.status.registryUnavailable': '지금은 npm을 확인할 수 없습니다.',
    'settings.integrations.thirdParty.status.providerUnavailable': '프로바이더를 아직 사용할 수 없습니다. 엔진을 다시 시작한 후 재시도하세요.',
    'settings.integrations.thirdParty.dialog.remove.title': '통합 제거',
    'settings.integrations.thirdParty.dialog.remove.description': '사용자 전체 엔진 구성에서 {name}을(를) 제거할까요? 엔진이 새로 고쳐진 후 프로바이더가 더 이상 로드되지 않습니다.',
    ...
    'settings.integrations.thirdParty.toast.restartRequired': '변경 사항을 적용하려면 엔진을 다시 시작하세요',
    'settings.integrations.thirdParty.opencodeClaude.name': 'Claude Code',
    'settings.integrations.thirdParty.opencodeClaude.description': 'Claude Pro/Max 요금제를 사용하세요. API 키와 Claude 앱은 필요 없습니다.',
    'settings.integrations.thirdParty.opencodeCursorOauth.name': 'Cursor',
    'settings.integrations.thirdParty.opencodeCursorOauth.description': 'Cursor 자체 모델의 넉넉한 한도를 이제 OMPChamber에서.',
  },
  pl: {
    'settings.page.integrations.title': 'Integracje',
    'settings.page.integrations.description': 'Dodaj subskrypcje zewnętrzne, aby używać ich jako dostawców OMPChamber.',
    ...
    'settings.integrations.thirdParty.info': 'Zainstaluj wtyczkę dostawcy, a następnie skonfiguruj subskrypcję, aby OMPChamber mógł z niej korzystać.',
    ...
    'settings.integrations.thirdParty.status.restartRequired': 'Uruchom ponownie silnik przed konfiguracją tego dostawcy.',
    'settings.integrations.thirdParty.status.registryUnavailable': 'Nie można teraz sprawdzić npm.',
    'settings.integrations.thirdParty.status.providerUnavailable': 'Dostawca nie jest jeszcze dostępny. Uruchom ponownie silnik i spróbuj ponownie.',
    'settings.integrations.thirdParty.dialog.remove.title': 'Usuń integrację',
    'settings.integrations.thirdParty.dialog.remove.description': 'Usunąć {name} z globalnej konfiguracji silnika? Dostawca przestanie być ładowany po odświeżeniu silnika.',
    ...
    'settings.integrations.thirdParty.toast.restartRequired': 'Uruchom ponownie silnik, aby zastosować zmiany',
    'settings.integrations.thirdParty.opencodeClaude.name': 'Claude Code',
    ...
    'settings.integrations.thirdParty.opencodeCursorOauth.name': 'Cursor',
    'settings.integrations.thirdParty.opencodeCursorOauth.description': 'Hojne limity wewnętrznych modeli Cursor teraz w OMPChamber.',
  },
  'pt-BR': {
    'settings.page.integrations.title': 'Integrações',
    'settings.page.integrations.description': 'Adicione assinaturas de terceiros para usar como provedores do OMPChamber.',
    ...
    'settings.integrations.thirdParty.info': 'Instale um plugin de provedor e configure sua assinatura para o OMPChamber poder usá-la.',
    'settings.integrations.thirdParty.actions.install': 'Instalar',
    ...
    'settings.integrations.thirdParty.status.restartRequired': 'Reinicie o motor antes de configurar este provedor.',
    'settings.integrations.thirdParty.status.registryUnavailable': 'Não foi possível verificar o npm agora.',
    'settings.integrations.thirdParty.status.providerUnavailable': 'O provedor ainda não está disponível. Reinicie o motor e tente novamente.',
    'settings.integrations.thirdParty.dialog.remove.title': 'Remover integração',
    'settings.integrations.thirdParty.dialog.remove.description': 'Remover {name} da sua configuração global do motor? O provedor deixará de ser carregado após a atualização do motor.',
    'settings.integrations.thirdParty.toast.installed': '{name} instalado',
    ...
    'settings.integrations.thirdParty.toast.restartRequired': 'Reinicie o motor para que as alterações entrem em vigor',
    'settings.integrations.thirdParty.opencodeClaude.name': 'Claude Code',
    ...
    'settings.integrations.thirdParty.opencodeCursorOauth.name': 'Cursor',
    'settings.integrations.thirdParty.opencodeCursorOauth.description': 'Os limites generosos dos modelos internos do Cursor, agora no OMPChamber.',
  },
  uk: {
    'settings.page.integrations.title': 'Інтеграції',
    'settings.page.integrations.description': 'Додайте сторонні підписки, щоб використовувати їх як провайдери OMPChamber.',
    ...
    'settings.integrations.thirdParty.info': 'Установіть плагін провайдера, а потім налаштуйте підписку, щоб OMPChamber міг її використовувати.',
    ...
    'settings.integrations.thirdParty.status.restartRequired': 'Перезапустіть рушій перед налаштуванням цього провайдера.',
    'settings.integrations.thirdParty.status.registryUnavailable': 'Зараз не вдалося перевірити npm.',
    'settings.integrations.thirdParty.status.providerUnavailable': 'Провайдер ще недоступний. Перезапустіть рушій і спробуйте знову.',
    'settings.integrations.thirdParty.dialog.remove.title': 'Видалити інтеграцію',
    'settings.integrations.thirdParty.dialog.remove.description': 'Видалити {name} з вашої глобальної конфігурації рушія? Після оновлення рушія провайдер більше не завантажуватиметься.',
    ...
    'settings.integrations.thirdParty.toast.restartRequired': 'Перезапустіть рушій, щоб застосувати зміни',
    'settings.integrations.thirdParty.opencodeClaude.name': 'Claude Code',
    ...
    'settings.integrations.thirdParty.opencodeCursorOauth.name': 'Cursor',
    'settings.integrations.thirdParty.opencodeCursorOauth.description': 'Щедрі ліміти внутрішніх моделей Cursor — тепер в OMPChamber.',
  },
  'zh-CN': {
    'settings.page.integrations.title': '集成',
    'settings.page.integrations.description': '添加第三方订阅，将其用作 OMPChamber 提供商。',
    ...
    'settings.integrations.thirdParty.info': '安装提供商插件并设置订阅，以便 OMPChamber 可以使用它。',
    ...
    'settings.integrations.thirdParty.status.restartRequired': '请先重启引擎，再设置此提供商。',
    'settings.integrations.thirdParty.status.registryUnavailable': '当前无法检查 npm。',
    'settings.integrations.thirdParty.status.providerUnavailable': '该提供商尚不可用。请重启引擎后重试。',
    'settings.integrations.thirdParty.dialog.remove.title': '移除集成',
    'settings.integrations.thirdParty.dialog.remove.description': '要从用户级引擎配置中移除 {name} 吗？引擎刷新后将不再加载该提供商。',
    ...
    'settings.integrations.thirdParty.toast.restartRequired': '请重启引擎以使更改生效',
    'settings.integrations.thirdParty.opencodeClaude.name': 'Claude Code',
    'settings.integrations.thirdParty.opencodeClaude.description': '使用 Claude Pro/Max 套餐——无需 API 密钥，也无需 Claude 应用。',
    'settings.integrations.thirdParty.opencodeCursorOauth.name': 'Cursor',
    'settings.integrations.thirdParty.opencodeCursorOauth.description': 'Cursor 内部模型的充足额度，现已可用于 OMPChamber。',
  },
  'zh-TW': {
    'settings.page.integrations.title': '整合',
    'settings.page.integrations.description': '新增第三方訂閱，將其用作 OMPChamber 供應商。',
    ...
    'settings.integrations.thirdParty.info': '安裝供應商外掛並設定訂閱，以便 OMPChamber 可以使用它。',
    ...
    'settings.integrations.thirdParty.status.restartRequired': '請先重新啟動引擎，再設定此供應商。',
    'settings.integrations.thirdParty.status.registryUnavailable': '目前無法檢查 npm。',
    'settings.integrations.thirdParty.status.providerUnavailable': '供應商尚不可用。請重新啟動引擎後再試一次。',
    'settings.integrations.thirdParty.dialog.remove.title': '移除整合',
    'settings.integrations.thirdParty.dialog.remove.description': '要從使用者層級引擎設定中移除 {name} 嗎？引擎重新整理後將不再載入此供應商。',
    ...
    'settings.integrations.thirdParty.toast.restartRequired': '請重新啟動引擎以使變更生效',
    'settings.integrations.thirdParty.opencodeClaude.name': 'Claude Code',
    'settings.integrations.thirdParty.opencodeClaude.description': '使用 Claude Pro/Max 方案——無需 API 金鑰，也無需 Claude 應用程式。',
    'settings.integrations.thirdParty.opencodeCursorOauth.name': 'Cursor',
    'settings.integrations.thirdParty.opencodeCursorOauth.description': 'Cursor 內部模型的充足額度，現已可用於 OMPChamber。',
  },
} as const;
