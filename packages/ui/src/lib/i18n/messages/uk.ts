...
export const dict: Record<I18nKey, string> = {
  ...
  'contextPanel.mode.agentRun': 'Запуск агента',
  'contextRail.surface.agentRun.description': 'Транскрипт лише для читання одного запуску субагента',
  'contextPanel.agentRun.loading': 'Завантаження…',
  'contextPanel.agentRun.empty': 'Немає записаної розмови для цього запуску',
  'contextPanel.agentRun.openArtifact': 'Відкрити вихідний артефакт',
  'contextPanel.agentRun.artifactFailed': 'Не вдалося відкрити артефакт',
