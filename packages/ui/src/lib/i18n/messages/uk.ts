...
export const dict: Record<I18nKey, string> = {
  ...
  "aboutDialog.diagnosticsDescription": "Містить стан OMPChamber, стан OpenCode, каталоги та проєкти.",
...
"chat.modeSelector.conflict": "Спочатку завершіть режим {mode}.",
  ...
  "onboarding.localSetup.windows.stepSetBinaryPath": "Якщо OMPChamber не визначає OpenCode автоматично, укажіть шлях до виконуваного файла нижче.",
  "onboarding.localSetup.intro": "OpenCode — серце OMPChamber. Встановіть його, щоб почати.",
  ...
  "onboarding.localSetup.helper.saveAndReload": "Зберігає налаштування в OMPChamber і перезавантажує конфігурацію OpenCode.",
