...
export const dict: Record<I18nKey, string> = {
  ...
  'terminalView.actions.takeControl': 'Перейняти контроль розміру',
  'terminalView.actions.releaseControl': 'Звільнити контроль розміру',
  'terminalView.status.driving': 'Керування',
  'terminalView.status.following': 'Слідування',
  'terminalView.actions.zoomIn': 'Збільшити термінал',
  'terminalView.actions.zoomOut': 'Зменшити термінал',
  'terminalView.actions.zoomReset': 'Скинути масштаб термінала (100%)',
  'terminalView.driverState.idleHint': 'Розмір відповідає найменшому вікну — клацніть, щоб перейняти контроль',
  'terminalView.driverState.drivingHint': 'Ви керуєте розміром ({cols}×{rows}) — клацніть, щоб відпустити',
  'terminalView.driverState.followingHint': 'Інший пристрій керує ({cols}×{rows}) — клацніть, щоб перейняти',
  'terminalView.actions.killSession': 'Закрити сесію (відключає ВСІ пристрої)',
  'terminalView.actions.killSessionArmed': 'Натисніть ще раз, щоб закрити всюди',
  ...
  'pwa.installPrompt.description': 'Установіть OMPChamber для швидшого доступу',
  'pwa.installPrompt.action': 'Установити',
  'pwa.installPrompt.dismiss': 'Сховати',
  'pwa.installPrompt.started': 'Установлення розпочато',
  'pwa.installPrompt.installed': 'OMPChamber встановлено',
  ...
  'mobile.connect.password.placeholder': 'Пароль OMPChamber',
  ...
  'mobile.connect.scan.invalid': 'Це не QR-код підключення OMPChamber.',
  ...
  'mobile.connect.relay.badge': 'через OMPChamber Relay',
  ...
  'mobile.connect.error.unreachable': 'Не вдалося достукатись до цього OMPChamber сервера.',
  ...
  'sessions.scheduledTasks.editor.persona.label': 'Персона',
  'sessions.scheduledTasks.editor.persona.ariaLabel': 'Персона сесії',
  'sessions.scheduledTasks.editor.persona.standard': 'Стандартна',
  'sessions.scheduledTasks.editor.persona.unavailable': 'Недоступна',
  ...
  'sessions.sidebar.footer.actions.aboutOMPChamber': 'Про OMPChamber',
  ...
  'sessions.sidebar.session.status.resident': 'У пам\'яті',
  'sessions.sidebar.session.status.residentWithSize': 'У пам\'яті · транскрипт ~{size}',
  'sessions.sidebar.session.status.residentShort': 'У пам\'яті',
  ...
  'walkthrough.blocked.serverUnsupported.description': 'Сервер OMPChamber, до якого підключено застосунок, не відповів на walkthrough API — отже, він старіший за застосунок. Оновіть сервер до 1.18 або новішої версії та оновіть панель.',
  ...
  'contextPanel.browser.tunnelFailedHint': '{url} працює на машині, де запущено OMPChamber, і зʼєднання з ним відкрити не вдалося. Нічого зі своєї машини тут не показано.',
  ...
  'contextPanel.browser.devServers.remoteOnly': 'Вони працюють на машині, де запущено OMPChamber. Щоб їх відкрити, потрібен десктопний застосунок.',
  ...
  'contextPanel.browser.trustNotice': 'Сторінки, відкриті тут, працюють із повним доступом до OMPChamber — це потрібно для inspect і скріншотів. Відкривайте лише сайти, яким довіряєте: шкідлива сторінка може прочитати ваші дані чи діяти від вашого імені.',
  ...
  'filesView.editor.binaryFileDescription': 'Цей файл є бінарним і його не можна редагувати в OMPChamber. Завантажте його, щоб відкрити в іншій програмі.',
  ...
  'terminalView.tabs.unreadTitle': 'Непрочитаний вивід команд',
  ...
  'directoryExplorerDialog.browse.permissionDenied': 'OMPChamber потрібен доступ до цієї папки.',
  ...
  'aboutDialog.openChamberVersionLabel': 'Версія OMPChamber {version}',
  'aboutDialog.openCodeVersionLabel': 'Версія рушія {version}',
  ...
  'aboutDialog.diagnosticsDescription': 'Містить стан OMPChamber, стан рушія, каталоги та проєкти.',
  ...
  'helpDialog.description': 'Використовуйте ці комбінації клавіш для ефективної навігації OMPChamber',
  ...
  'header.actions.openAppMenu': 'Меню OMPChamber',
  'header.actions.openAppMenuAria': 'Відкрити меню OMPChamber',
  ...
  'chat.retry.supersededBadge': 'Замінено повторною спробою',
  ...
  'chat.chat.ompDivider.modelChange.role': 'Перемкнено через роль: {role}',
  'chat.chat.ompDivider.modelChange.fallback': 'Резервна модель після повтору',
  ...
  'chat.chat.ompDivider.developerNote': 'вставлена примітка',
  'chat.omp.ttsrWarning.title': 'Спрацювали правила утримання курсу',
  'chat.omp.ttsrWarning.dismissAria': 'Закрити попередження',
  'chat.omp.strippedToolCalls.one': '{count} виклик інструменту пропущено в цій гілці, без результату',
  'chat.omp.strippedToolCalls.many': '{count} викликів інструментів пропущено в цій гілці, без результату',
  'chat.omp.customCard.moreEntries': '+{count} ще',
  'chat.omp.cacheMiss.label': 'промах кешу',
  'chat.omp.cacheMiss.tokens': '{tokens} токенів',
  'toast.ompNotice.title.info': 'Повідомлення',
  'toast.ompNotice.title.warning': 'Попередження',
  'toast.ompNotice.title.error': 'Помилка',
  ...
  'chat.emptyState.opencodeUnreachable': 'Рушій недоступний',
  ...
  'chat.message.fallbackTag': 'резерв',
  'chat.statusRow.compacting': 'Стиснення контексту…',
  ...
  'chat.workStatus.goal.status.paused': 'призупинена',
  'chat.workStatus.goal.status.complete': 'завершена',
  'chat.workStatus.goal.status.budgetLimited': 'ліміт бюджету',
  'chat.workStatus.goal.status.dropped': 'покинута',
  ...
  'chat.toast.opencodeRestartInterrupted.description': 'Рушій перезапустився, поки відповідь ще формувалася. Надішліть повідомлення, щоб продовжити.',
  ...
  'chat.commandAutocomplete.badge.ompOverride': 'замінює OMPChamber',
  'chat.chatInput.toast.debugRenamed': 'Тепер рушій займає /debug. Керована команда налагодження OMPChamber переїхала на /troubleshoot.',
  'chat.sessionTree.title': 'Гілки сесії',
  'chat.sessionTree.description': 'Форки цієї сесії. Виберіть гілку, щоб відкрити її журнал.',
  'chat.sessionTree.loading': 'Завантаження гілок…',
  'chat.sessionTree.error': 'Не вдалося завантажити дерево сесії.',
  'chat.sessionTree.empty': 'Ця сесія не має форків.',
  'chat.sessionTree.untitled': 'Без назви',
  'chat.sessionTree.current': 'поточна',
  'chat.sessionTree.leaf': 'найновіша',
  'chat.sessionTree.openBranch': 'Відкрити гілку {title}',
  ...
  'chat.toolPart.askQuestionsCount': 'Питань: {count}',
  'chat.toolPart.askNoSelection': 'Без відповіді',
  'chat.toolPart.askCustomAnswer': 'Відповідь власним текстом',
  'chat.toolPart.askNote': 'Примітка',
  'chat.toolPart.askAutoSelected': 'вибрано автоматично після часу очікування — це не вибір користувача',
  'chat.toolPart.askChatRedirect': 'Користувач вирішив обговорити це в чаті замість відповіді',
  'chat.toolPart.taskAgent.status.pending': 'Очікує',
  'chat.toolPart.taskAgent.status.running': 'Виконується',
  'chat.toolPart.taskAgent.status.completed': 'Завершено',
  'chat.toolPart.taskAgent.status.failed': 'Помилка',
  'chat.toolPart.taskAgent.status.aborted': 'Перервано',
  'chat.toolPart.taskAgent.retrying': 'Повторна спроба {attempt}/{maxAttempts}',
  'chat.toolPart.taskAgent.retriesExhausted': 'Спроби вичерпано ({attempt})',
  'chat.toolPart.taskAgent.moreAgents': '+ще {count}',
  ...
  'chat.modelControls.roles.sectionTitle': 'Ролі моделей',
  'chat.modelControls.roles.notConfigured': 'Не налаштовано',
  ...
  'chat.modelControls.setAsRole.failed': 'Не вдалося призначити роль',
  'chat.modelControls.setAsRole.rejected.role-already-configured': 'Роль уже має налаштовану модель',
  'chat.modelControls.enabledWarning': 'Поточна модель відсутня в enabledModels',
  'chat.modeSelector.label.default': 'Типовий',
  'chat.modeSelector.label.plan': 'План',
  'chat.modeSelector.label.planPaused': 'План (призупинено)',
  'chat.modeSelector.label.goal': 'Ціль',
  'chat.modeSelector.label.goalPaused': 'Ціль (призупинено)',
  'chat.modeSelector.label.vibe': 'Віб',
  'chat.modeSelector.label.loop': 'Цикл',
  'chat.modeSelector.ariaLabel': 'Режим сеансу',
  'chat.modeSelector.title': 'Режим',
  'chat.modeSelector.requiresSession': 'Почніть сеанс, щоб змінити його режим',
  ...
  'chat.goalIndicator.title': 'Мета',
  'chat.goalIndicator.status.active': 'Активна',
  'chat.goalIndicator.status.paused': 'Призупинена',
  'chat.goalIndicator.status.complete': 'Завершена',
  'chat.goalIndicator.status.budgetLimited': 'Досягнуто ліміту бюджету',
  'chat.goalIndicator.status.dropped': 'Відкинута',
  'chat.goalIndicator.noObjective': 'Мета не записана',
  'chat.goalIndicator.budget': '{used}/{budget} токенів',
  'chat.goalIndicator.tokensUsed': '{used} токенів',
  ...
  'commandPalette.item.toggleMemoryDebug': 'Показати/сховати панель налагодження',
  ...
  'openCodeStatusDialog.title': 'Статус рушія',
  'openCodeStatusDialog.description': 'Перегляньте поточний стан рушія та діагностику.',
  ...
  'openCodeStatusDialog.memory.title': 'Пам\'ять рушія',
  'openCodeStatusDialog.memory.refreshNote': 'оновлюється кожні 5 с, поки відкрито',
  'openCodeStatusDialog.memory.loading': 'Завантаження…',
  'openCodeStatusDialog.memory.unavailable': 'Діагностика пам\'яті не підтримується цією збіркою рушія.',
  'openCodeStatusDialog.memory.error': 'Не вдалося завантажити діагностику пам\'яті.',
  'openCodeStatusDialog.memory.processHeap': 'Купа процесу',
  'openCodeStatusDialog.memory.processRss': 'RSS процесу',
  'openCodeStatusDialog.memory.processExternal': 'Зовнішня + буфери',
  'openCodeStatusDialog.memory.residentEstimate': 'Резидентні сесії (оцінка)',
  'openCodeStatusDialog.memory.sessionsTitle': 'Резидентні сесії: {live} активних · {total} усього',
  'openCodeStatusDialog.memory.sessionsStates': 'завантаження {materializing} · витіснення {evicting} · помилка {failed}',
  'openCodeStatusDialog.memory.noResident': 'Немає резидентних сесій.',
  'openCodeStatusDialog.memory.truncated': 'Список обрізано — показано найбільші резидентні сесії.',
  'openCodeStatusDialog.memory.colSession': 'Сесія',
  'openCodeStatusDialog.memory.colDirectory': 'Тека',
  'openCodeStatusDialog.memory.colState': 'Стан',
  'openCodeStatusDialog.memory.colSize': '~Розмір',
  'openCodeStatusDialog.memory.colIdle': 'Простій',
  'openCodeStatusDialog.memory.wireBus': 'Буфер подій wire',
  'openCodeStatusDialog.memory.ompBus': 'Буфер подій OMP',
  'openCodeStatusDialog.memory.busValue': '{entries} записів · {size} (межа {capacity})',
  'openCodeStatusDialog.memory.wireIdEchoes': 'Відлуння Wire-ID',
  'openCodeStatusDialog.memory.inFlightUnderflow': 'Переповнення inFlight знизу',
  'openCodeStatusDialog.memory.estimateNote': 'Розміри сесій — оцінки за розміром транскрипту (~1,3× резидентної купи), а не виміряна атрибуція за сесією.',
  'openCodeStatusDialog.monitor.tabOverview': 'Огляд',
  'openCodeStatusDialog.monitor.tabSessions': 'Сесії',
  'openCodeStatusDialog.monitor.residentCount': '{total} резидентних',
  'openCodeStatusDialog.monitor.catSessions': 'Резидентні сесії (оцінка)',
  'openCodeStatusDialog.monitor.catBuffers': 'Буфери подій',
  'openCodeStatusDialog.monitor.catUnattributed': 'Неприписаний рушій',
  'openCodeStatusDialog.monitor.processMonitor': 'Монітор процесів',
  'openCodeStatusDialog.monitor.processMonitorValue': '{live} живих · {windows} викликів · {failures} невдалих зчитувань',
  'openCodeStatusDialog.monitor.stateLive': 'активна',
  'openCodeStatusDialog.monitor.stateMaterializing': 'завантаження',
  'openCodeStatusDialog.monitor.stateEvicting': 'витіснення',
  'openCodeStatusDialog.monitor.stateFailed': 'помилка',
  'openCodeStatusDialog.monitor.largeOnly': 'Лише ≥10 МБ',
  'openCodeStatusDialog.monitor.noLarge': 'Немає резидентних сесій ≥10 МБ.',
  'openCodeStatusDialog.monitor.colAction': 'Дія',
  'openCodeStatusDialog.monitor.release': 'Звільнити',
  'openCodeStatusDialog.monitor.releaseHint': 'Витіснити з пам’яті — транскрипт лишається на диску',
  'openCodeStatusDialog.monitor.releaseBusy': 'Сесія ще активна — звільнити не можна.',
  'openCodeStatusDialog.monitor.releaseFailed': 'Не вдалося звільнити сесію.',
  ...
  'sessionAuth.error.networkDescription': 'Нам не вдалося перевірити сесію інтерфейсу. Якщо ви відкриваєте OMPChamber з іншого пристрою у локальній мережі, увімкніть Desktop Network Access у настільному застосунку та використайте LAN-адресу, показану в налаштуваннях.',
  ...
  'sessionAuth.locked.unlockTitle': 'Розблокувати OMPChamber',
  ...
  'desktopHostSwitcher.description': 'Перемикання між Local і віддаленими OMPChamber серверами',
  ...
  'multiRun.window.description': 'Вікно мультизапуску OMPChamber.',
  ...
  'onboarding.remoteConnection.description': 'Введіть адресу сервера OMPChamber для підключення.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'Пропозиції: переконайтеся, що URL вказує на сервер OMPChamber або зверніться до адміністратора сервера.',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': 'Цей інстанс працює з іншою версією OMPChamber. Можна підключитися, але оновіть обидва застосунки, якщо щось не працюватиме.',
  'onboarding.remoteConnection.probe.incompatibleMessage': 'Сервер працює з OMPChamber, але несумісний із цією версією застосунку. Оновіть OMPChamber на сервері та повторіть спробу.',
  'onboarding.remoteConnection.probe.wrongServiceMessage': 'Сервер відповів, але не працює OMPChamber. Перевірте, чи адреса вказує на сервер OMPChamber.',
  ...
  'onboarding.desktopRecovery.localUnavailable.title': 'Локальний рушій недоступний',
  'onboarding.desktopRecovery.localUnavailable.description': 'Не вдалося запустити локальний рушій. Повторіть запуск або підключіться до віддаленого сервера.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': 'На сервері \\"{host}\\" не запущено OMPChamber. Перевірте, чи адреса вказує на сервер OMPChamber.',
  'onboarding.desktopRecovery.remoteIncompatible.title': 'Потрібне оновлення сервера',
  'onboarding.desktopRecovery.remoteIncompatible.description': 'Сервер OMPChamber на \\"{host}\\" несумісний із цією версією застосунку. Оновіть OMPChamber на сервері та повторіть спробу.',
  ...
  'startup.initRecovery.description': 'OMPChamber не зміг завершити ініціалізацію. Перевірте, що сервер запущений, і повторіть спробу.',
  ...
  'updateDialog.header.updating': 'Оновлення OMPChamber...',
  ...
  'updateDialog.error.takingLonger': 'Оновлення триває довше, ніж очікувалося. Зачекайте трохи та оновіть або запустіть: ompchamber update',
  'updateDialog.error.signatureRejected': 'Завантажене оновлення відхилено: його підпис коду не збігається з цією інсталяцією. Зазвичай це означає, що запущену копію встановлено не з офіційного підписаного релізу. Встановіть OMPChamber з офіційного релізу й оновіться ще раз.',
  'updateDialog.error.updaterDisabled': 'Оновлювач зупинився після невдалого встановлення. Закрийте OMPChamber, відкрийте його знову й повторіть оновлення.',
  'updateDialog.error.restartFailed': 'Не вдалося перезапустити, щоб встановити оновлення.',
  'updateDialog.error.restartUnavailable': 'Щоб встановити оновлення, потрібен застосунок OMPChamber для комп’ютера.',
  'mobileUpdate.toast.available.title': 'Доступне оновлення OMPChamber',
  ...
  'memoryDebugPanel.tabs.memory': 'Пам\'ять UI',
  'memoryDebugPanel.tabs.engine': 'Рушій',
  'memoryDebugPanel.tabs.streaming': 'Потокове передавання',
  'memoryDebugPanel.tabs.requests': 'Запити',
  'memoryDebugPanel.section.sessionsInMemory': 'Сесії в пам\'яті UI',
  ...
  'memoryDebugPanel.resizeHandle': 'Перетягніть, щоб змінити ширину панелі',
  'memoryDebugPanel.metricName.sidebarScrollAnchorAdjustment': 'Коригування якоря прокручування бічної панелі',
  'memoryDebugPanel.metricName.sidebarSessionNodeRender': 'Рендер рядка сесії бічної панелі',
  'memoryDebugPanel.metricName.sidebarSessionNodePropsChanged': 'Змінені props сесії бічної панелі',
  'memoryDebugPanel.metricName.globalSessionsEventUpdateDeferred': 'Відкладене оновлення події сесії',
  'memoryDebugPanel.metricName.globalSessionsEventUpdateImmediate': 'Миттєве оновлення події сесії',
  'memoryDebugPanel.metricName.globalSessionsEventUpdatePublication': 'Публікація оновлення події сесії',
  'memoryDebugPanel.metricName.sidebarProjectSectionReused': 'Повторно використані розділи проєкту',
  'memoryDebugPanel.metricName.sidebarProjectSectionRebuilt': 'Перебудовані розділи проєкту',
  'memoryDebugPanel.metricName.sidebarProjectSectionRebuiltReason': 'Причина перебудови розділу проєкту',
  'memoryDebugPanel.metricName.sidebarProjectsListRender': 'Рендер списку проєктів',
  'memoryDebugPanel.metricName.sessionSidebarRender': 'Рендер бічної панелі сесії',
  'memoryDebugPanel.metricName.sessionSidebarSource': 'Джерело бічної панелі сесії',
  'memoryDebugPanel.metricName.headerRender': 'Рендер заголовка',
  'memoryDebugPanel.metricName.assistantTextRender': 'Рендер тексту асистента',
  'memoryDebugPanel.metricName.assistantTextDisplayLen': 'Довжина відображуваного тексту асистента',
  'memoryDebugPanel.metricName.messageListEntryRender': 'Рендер запису списку повідомлень',
  'memoryDebugPanel.metricName.messageListRender': 'Рендер списку повідомлень',
  'memoryDebugPanel.metricName.messageListBaseDisplayMs': 'Базове відображення списку повідомлень (мс)',
  'memoryDebugPanel.metricName.messageListRetryOverlayMs': 'Оверлей повторної спроби списку повідомлень (мс)',
  'memoryDebugPanel.metricName.messageListRenderEntriesMs': 'Рендер записів списку повідомлень (мс)',
  'memoryDebugPanel.metricName.markdownRender': 'Рендер Markdown',
  'memoryDebugPanel.metricName.markdownContentLen': 'Довжина вмісту Markdown',
  'memoryDebugPanel.metricName.markdownDomCache': 'DOM-кеш Markdown',
  'memoryDebugPanel.metricName.markdownSettledPaintReused': 'Повторне використання стабільного рендеру Markdown',
  'memoryDebugPanel.metricName.chatMessageRender': 'Рендер повідомлення чату',
  'memoryDebugPanel.metricName.turnsProjectionMs': 'Проєкція туру (мс)',
  'memoryDebugPanel.metricName.vscodeWebviewSseChunk': 'SSE-фрагмент вебв\'ю',
  'memoryDebugPanel.metricName.vscodeWebviewSseChunkBytes': 'Байти SSE-фрагмента вебв\'ю',
  'memoryDebugPanel.metricName.vscodeWebviewSseEnd': 'Завершення SSE вебв\'ю',
  'memoryDebugPanel.metricName.vscodeWebviewSseStartMs': 'Запуск SSE вебв\'ю (мс)',
  ...
  'openChamberLogo.aria.logo': 'Логотип OMPChamber',
  ...
  'chat.workStatus.section.processes': 'Процеси',
  'chat.workStatus.processes.running': 'працює',
  'chat.workStatus.processes.exited': 'завершено',
  'chat.workStatus.processes.killed': 'знищено',
  'chat.workStatus.processes.failed': 'помилка',
  'chat.workStatus.processes.uncertain': 'атрибуція невизначена',
  'chat.workStatus.processes.kill': 'Завершити',
  'chat.workStatus.processes.killAll': 'Завершити всі',
  'chat.workStatus.processes.killConfirm': 'Точно?',
  'chat.workStatus.processes.view': 'Переглянути {command}',
  'chat.workStatus.processes.viewAll': 'Показати всі процеси',
  'chat.workStatus.processes.output': 'Вивід',
  'chat.workStatus.processes.command': 'Команда',
  'chat.workStatus.processes.cpu': 'CPU',
  'chat.workStatus.processes.memory': 'Пам’ять',
  'chat.workStatus.processes.liveCount': '{count} живих',
  'chat.workStatus.processes.endedCount': '{count} завершено',
  'chat.workStatus.processes.statsStale': 'застарілі дані',
  ...
  'chat.workStatus.section.localFiles': 'Локальні файли сесії',
  ...
  'dialogs.omp.approval.title': 'Потрібне підтвердження',
  'dialogs.omp.planReview.choice.approveExecute': 'Схвалити й виконати',
  'dialogs.omp.planReview.choice.approveCompact': 'Схвалити та стиснути контекст',
  'dialogs.omp.planReview.choice.approveKeep': 'Схвалити та зберегти контекст',
  'dialogs.omp.planReview.choice.refine': 'Доробити план',
  'dialogs.omp.planReview.planReady': 'План готовий до розгляду.',
  'dialogs.omp.planReview.planMissing': 'Файл плану не знайдено. Пропозицію все одно можна розглянути.',
  'dialogs.omp.planReview.loadingPlan': 'Завантаження плану…',
  'dialogs.omp.planReview.contentUnavailable': 'Вміст плану недоступний. Рішення все одно можна ухвалити.',
  'dialogs.omp.planReview.editMode': 'Редагувати план',
  'dialogs.omp.planReview.previewMode': 'Перегляд',
  'dialogs.omp.planReview.editAreaLabel': 'Відредагований вміст плану',
  'dialogs.omp.planReview.feedbackLabel': 'Зауваження до доробки',
  'dialogs.omp.planReview.feedbackPlaceholder': 'Що слід змінити у плані?',
  'dialogs.omp.planReview.refineCancel': 'Скасувати',
  'dialogs.omp.planReview.refineSubmit': 'Надіслати зауваження',
  'dialogs.omp.planReview.refineSubmitted': 'Зауваження надіслано. План буде доопрацьовано.',
  'dialogs.omp.planReview.submitting': 'Обробка…',
  'dialogs.omp.planReview.decisionFailed': 'Не вдалося надіслати рішення розгляду.',
  'dialogs.omp.planReview.unavailable': 'Розгляд плану недоступний.',
  'dialogs.omp.approval.bodyAria': 'Запит на підтвердження інструменту',
  'dialogs.omp.approval.approve': 'Підтвердити',
  'dialogs.omp.approval.deny': 'Відхилити',
  'dialogs.omp.approval.alwaysAllow': 'Завжди дозволяти цей інструмент (записує налаштування) і підтвердити',
  'dialogs.omp.approval.alwaysAllowConfirm': 'Записати налаштування та підтвердити',
  'dialogs.omp.approval.alwaysAllowConfirmBody': 'Записує tools.approval.{tool} = allow у ваші глобальні налаштування omp, а потім підтверджує цей запит.',
  'dialogs.omp.approval.alwaysAllowCancel': 'Назад',
  'dialogs.omp.approval.alwaysAllowFailed': 'Не вдалося записати налаштування. Нічого не підтверджено — діалог залишається відкритим.',
  'dialogs.omp.approval.respondFailed': 'Не вдалося відповісти',
  'dialogs.omp.ask.title': 'Питання',
  'dialogs.omp.ask.summaryTab': 'Підсумок',
  'dialogs.omp.ask.noAnswer': 'Без відповіді',
  'dialogs.omp.ask.recommended': 'Рекомендовано',
  'dialogs.omp.ask.other': 'Інше (введіть своє)',
  'dialogs.omp.ask.otherPlaceholder': 'Введіть відповідь…',
  'dialogs.omp.ask.note': 'Примітка (необов’язково)',
  'dialogs.omp.ask.chatAboutThis': 'Обговорити це',
  'dialogs.omp.ask.next': 'Далі',
  'dialogs.omp.ask.submit': 'Надіслати',
  'dialogs.omp.ask.respondFailed': 'Не вдалося відповісти',
  'dialogs.omp.queue.moreWaiting': 'Ще {count} у черзі',
  'dialogs.omp.select.title': 'Оберіть варіант',
  'dialogs.omp.confirm.yes': 'Так',
  'dialogs.omp.confirm.no': 'Ні',
  'dialogs.omp.generic.cancel': 'Скасувати',
  'dialogs.omp.input.submit': 'Надіслати',
  'dialogs.omp.notify.backgroundTitle': 'Сесія чекає на відповідь',
  'dialogs.omp.notify.backgroundBody': 'Сесія {session} очікує на відповідь',
  'dialogs.omp.tray.approvalRow': 'Сесія {session} — потрібне підтвердження',
  'dialogs.omp.tray.approvalRowWithTool': 'Сесія {session} — {tool} потребує підтвердження',
  'dialogs.omp.tray.askRow': 'Сесія {session} — є питання',
  'dialogs.omp.workStatus.waitingAnswer': 'чекає на вашу відповідь',
  'dialogs.internalUri.dialogDescription': 'Вміст внутрішнього ресурсу',
  'dialogs.internalUri.linkTitle': 'Відкрити внутрішній ресурс',
  'dialogs.internalUri.copyUrl': 'Копіювати посилання',
  'dialogs.internalUri.copied': 'Посилання скопійовано',
  'dialogs.internalUri.copyFailed': 'Не вдалося скопіювати посилання',
  'dialogs.internalUri.loading': 'Визначення ресурсу…',
  'dialogs.internalUri.immutableBadge': 'Лише для читання',
  'dialogs.internalUri.error.unavailable': 'Цей сервер не надає внутрішніх ресурсів.',
  'dialogs.internalUri.error.tooLarge': 'Ресурс занадто великий для показу ({size}).',
  'dialogs.internalUri.error.resolveFailed': 'Не вдалося визначити цей ресурс.',
  'dialogs.internalUri.error.binaryFailed': 'Не вдалося завантажити цей файл для перегляду.',
  'contextPanel.localFiles.title': 'Локальні файли сесії',
  'contextPanel.localFiles.description': 'Перегляд лише для читання приватних файлів local:// цієї сесії.',
  'contextPanel.localFiles.noDirectory': 'Немає активного каталогу проєкту.',
  'contextPanel.localFiles.noSession': 'Сесію не вибрано.',
  'contextPanel.localFiles.filesLoading': 'Завантаження файлів…',
  'contextPanel.localFiles.filesError': 'Не вдалося завантажити файли.',
  'contextPanel.localFiles.emptyFiles': 'Ця сесія не має файлів local://.',
  'contextPanel.localFiles.openFile': 'Відкрити {ref}',
  'contextPanel.localFiles.truncated': 'Список скорочено — є ще файли.',
  'contextPanel.localFiles.backToFiles': 'Файли робочої області',
  'contextPanel.localFiles.scopeAria': 'Переключити область дерева файлів',
  'contextPanel.localFiles.browseHint': 'Виберіть файл із дерева цієї сесії.',
  'contextPanel.localFiles.previewFailed': 'Не вдалося завантажити цей файл для перегляду.',
  'contextPanel.mode.timeline': 'Хронологія',
  'contextRail.surface.timeline.description': 'Структуровані події активної сесії',
  'contextPanel.timeline.empty': 'Подій немає',
  'contextPanel.timeline.emptyNoSession': 'Немає активної сесії',
  'contextPanel.timeline.loading': 'Завантаження…',
  'contextPanel.timeline.kind.compaction': 'Стиснення',
  'contextPanel.timeline.kind.branch_summary': 'Гілка',
  'contextPanel.timeline.kind.model_change': 'Зміна моделі',
  'contextPanel.timeline.kind.mode_change': 'Зміна режиму',
  'contextPanel.timeline.kind.ttsr_injection': 'Вставка правил',
  'contextPanel.timeline.kind.retry_recovery': 'Повтор',
};
