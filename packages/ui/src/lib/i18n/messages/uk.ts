...
export const dict: Record<I18nKey, string> = {
  ...
  'terminalView.actions.zoomIn': 'Збільшити шрифт термінала',
  'terminalView.actions.zoomOut': 'Зменшити шрифт термінала',
  'terminalView.actions.zoomReset': 'Скинути шрифт термінала (14px)',
