...
export const dict: Record<I18nKey, string> = {
  ...
  "chat.commandAutocomplete.badge.ompOverride": "замінює OpenChamber",
  "chat.chatInput.toast.debugRenamed": "Тепер рушій займає /debug. Керована команда налагодження OpenChamber переїхала на /troubleshoot.",
