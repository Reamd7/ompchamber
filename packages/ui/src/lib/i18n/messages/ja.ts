...
export const dict: Record<I18nKey, string> = {
  ...
  'contextPanel.mode.agentRun': 'エージェント実行',
  'contextRail.surface.agentRun.description': 'サブエージェント実行の読み取り専用トランスクリプト',
  'contextPanel.agentRun.loading': '読み込み中…',
  'contextPanel.agentRun.empty': 'この実行には記録された会話がありません',
  'contextPanel.agentRun.openArtifact': '出力アーティファクトを開く',
  'contextPanel.agentRun.artifactFailed': 'アーティファクトを開けませんでした',
