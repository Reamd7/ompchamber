...
export const dict: Record<I18nKey, string> = {
  ...
  'aboutDialog.diagnosticsDescription': 'OMPChamberの状態、OpenCodeの状態、ディレクトリ、プロジェクトが含まれます。',
...
'chat.modeSelector.conflict': '先に{mode}モードを終了してください。',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'OMPChamberがOpenCodeを自動検出しない場合、以下のパスを手動で設定します。',
  'onboarding.localSetup.intro': 'OpenCodeはOMPChamberの中核です — インストールして開始しましょう。',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'OMPChamber設定に保存し、OpenCode設定を再読み込みします。',
