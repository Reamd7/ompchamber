...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.commandAutocomplete.badge.ompOverride': 'OpenChamberを上書き',
  'chat.chatInput.toast.debugRenamed': 'エンジンが /debug を使用するようになりました。OpenChamberのガイド付きデバッグコマンドは /troubleshoot に移動しました。',
