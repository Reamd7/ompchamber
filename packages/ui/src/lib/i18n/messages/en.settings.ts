...
'settings.view.home.cards.plugins.description': 'Manage OMP plugins',
  ...
  'settings.openchamber.tunnel.tooltip.tokensSavedPath': 'Tokens are saved in ~/.config/ompchamber/cloudflare-managed-remote-tunnels.json.',
  ...
  'settings.openchamber.about.title': 'About OMPChamber',
  ...
  'settings.openchamber.desktopNetwork.field.launchAtLoginAria': 'Start OMPChamber at login',
  'settings.openchamber.desktopNetwork.field.launchAtLogin': 'Start OMPChamber when you log in',
  ...
  'settings.openchamber.desktopNetwork.field.macMenuBarAria': 'Show OMPChamber in the macOS menu bar',
  'settings.openchamber.desktopNetwork.field.macMenuBar': 'Show OMPChamber in the menu bar',
  'settings.openchamber.desktopNetwork.field.macMenuBarDescription': 'Requires an app restart. When off, OMPChamber does not create the menu bar item or run its session, approval, and usage updates.',
  'settings.openchamber.desktopNetwork.field.minimizeToTrayAria': 'Close OMPChamber to the system tray',
  'settings.openchamber.desktopNetwork.field.minimizeToTray': 'Close to the system tray',
  'settings.openchamber.desktopNetwork.field.minimizeToTrayDescription': 'Keeps OMPChamber running in the system tray when the main window is closed. Minimizing still leaves the window in the taskbar.',
  'settings.openchamber.desktopNetwork.field.keepAwakeAria': 'Keep computer awake while OMPChamber is running',
  'settings.openchamber.desktopNetwork.field.keepAwake': 'Keep computer awake while OMPChamber is running',
  ...
  'settings.openchamber.desktopPassword.field.passwordDescription': 'OMPChamber asks after restart, then when the login session expires: after 12 hours, or 7 days with Trust this device. Leave empty to disable login.',
  ...
  'settings.openchamber.tools.title': 'OMPChamber Tools',
  ...
  'settings.openchamber.tools.field.agentWebTool': 'OMPChamber Web tool',
  'settings.openchamber.tools.field.agentWebToolAria': 'Enable the OMPChamber Web tool',
  'settings.openchamber.tools.field.agentWebToolInfo': 'Let agents look at and interact with the page in OMPChamber\'s browser panel: open a URL, read the page, click, type, scroll, and switch between mobile and desktop layouts. Adds a small tool description to each session. Applies after OpenCode restarts.',
  ...
  'settings.remoteInstances.page.phase.installingOpenChamber': 'Installing OMPChamber',
  'settings.remoteInstances.page.phase.updatingOpenChamber': 'Updating OMPChamber',
  ...
  'settings.openchamber.visual.field.themeImportInfoTooltip': 'Import custom themes from ~/.config/ompchamber/themes/',
