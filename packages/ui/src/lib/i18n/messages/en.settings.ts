...
'settings.view.home.cards.plugins.description': 'Manage OMP plugins',
  ...
  'settings.ompchamber.opencodeCli.tooltipPrefix': 'Optional absolute path to the',
  'settings.ompchamber.opencodeCli.tooltipSuffix': 'binary.',
  'settings.ompchamber.opencodeCli.field.binaryPath': 'OpenCode Binary Path',
  'settings.ompchamber.opencodeCli.field.binaryPathPlaceholder': '/Users/you/.bun/bin/opencode',
  'settings.ompchamber.opencodeCli.actions.browseAria': 'Browse for OpenCode binary path',
  'settings.ompchamber.opencodeCli.actions.browse': 'Browse',
  'settings.ompchamber.opencodeCli.actions.saveAndReload': 'Save + Reload',
  'settings.ompchamber.opencodeCli.actions.restartingOpenCode': 'Restarting OpenCode…',
  'settings.ompchamber.opencodeCli.dialog.selectBinaryTitle': 'Select opencode binary',
  'settings.ompchamber.opencodeCli.tipPrefix': 'Tip: you can also use',
  'settings.ompchamber.opencodeCli.tipMiddle': 'env var, but this setting persists in',
  ...
  'settings.ompchamber.keyboardShortcuts.warning.riskyBrowserShortcut': 'This shortcut can conflict with browser defaults. It is still saved.',
  ...
  'settings.voice.page.tooltip.localTts': 'On-device synthesis on the OMPChamber server (Kokoro, English). The model downloads automatically; no API key needed.',
