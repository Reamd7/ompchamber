...
export const settingsDict = {
  ...
  'settings.providers.page.openCodeGo.help': 'Copy the workspace ID from the dashboard URL and the auth cookie from your browser developer tools. OMPChamber never scans browser cookie storage.',
  ...
  'settings.window.description': 'OMPChamber settings window.',
  ...
  'settings.view.home.cards.plugins.description': 'Manage OMP plugins',
  ...
  'settings.view.actions.reloadOpenCode': 'Reload engine',
  'settings.view.actions.reloadOpenCodeTooltip': 'Restart the engine and reload its configuration.',
  'settings.view.actions.applyAndRestartOpenCode': 'Apply & Restart',
  'settings.view.actions.applyAndRestartOpenCodeTooltipSingle': 'Apply 1 pending configuration change and restart the engine.',
  'settings.view.actions.applyAndRestartOpenCodeTooltipPlural': 'Apply {count} pending configuration changes and restart the engine.',
  'settings.view.pendingRestart.applying': 'Restarting...',
  'settings.view.pendingRestart.applied': 'The engine restarted with pending configuration changes.',
  'settings.view.pendingRestart.applyFailed': 'Failed to apply configuration changes.',
  'settings.view.pendingRestart.manualRestartRequired': 'Saved on disk. Restart your connected server to apply the changes.',
  'settings.view.pendingRestart.saved': 'Saved. Restart the engine to apply.',
  'settings.view.pendingRestart.confirm.title': 'Apply & restart?',
  'settings.view.pendingRestart.confirm.description': 'Restarting the engine will stop any running chats. Your saved configuration changes will take effect after the restart.',
  ...
  'settings.page.appearance.description': 'Customize how OMPChamber looks and feels.',
  ...
  'settings.ompchamber.tunnel.title': 'External Tunnel',
  'settings.ompchamber.tunnel.description': 'Configure secure remote access with quick links or your own managed remote Cloudflare tunnel.',
  'settings.ompchamber.tunnel.note.serverSideEnforced': 'Secure tunnel access is enforced server-side.',
  'settings.ompchamber.tunnel.note.connectLinksOneTime': 'Connect links are one-time and are revoked when tunnel stops or connect-link TTL expires.',
  'settings.ompchamber.tunnel.note.cloudflareConnectorTarget': 'Cloudflare connector target:',
  'settings.ompchamber.tunnel.note.cloudflareConnectorTargetUse': 'For Cloudflare connector target, use',
  'settings.ompchamber.tunnel.note.tokensSavedPerTunnel': 'Tokens are saved per tunnel and reused from disk.',
  'settings.ompchamber.tunnel.note.customConfigUsed': 'Custom config file will be used when starting the tunnel.',
  'settings.ompchamber.tunnel.note.defaultConfigUsed': 'When empty, cloudflared uses its default config (~/.cloudflared/config.yml).',
  'settings.ompchamber.tunnel.note.managedRemoteRequiresDomain': 'Managed remote tunnels require a purchased domain in your Cloudflare account.',
  'settings.ompchamber.tunnel.note.managedLocalUsesConfig': 'Managed local tunnels use your local cloudflared configuration file.',
  'settings.ompchamber.tunnel.note.startModeAndGenerateLink': 'Start a {mode} tunnel and generate a one-time connect link. Do not close the app while this tunnel is in use.',
  'settings.ompchamber.tunnel.note.scanQrToConnect': 'Scan with your phone to connect.',
  'settings.ompchamber.tunnel.section.redeemedAccessLinks': 'Redeemed access links',
  'settings.ompchamber.tunnel.section.savedManagedRemoteTunnels': 'Saved managed remote tunnels',
  'settings.ompchamber.tunnel.notAvailable.cloudflaredNotFound': 'cloudflared not found',
  'settings.ompchamber.tunnel.notAvailable.dependencyNotFound': '{dependency} was not found.',
  'settings.ompchamber.tunnel.notAvailable.installHint': 'Install it to enable remote tunnel access:',
  'settings.ompchamber.tunnel.field.provider': 'Provider',
  'settings.ompchamber.tunnel.field.providerPlaceholder': 'Select provider',
  'settings.ompchamber.tunnel.field.tunnelType': 'Tunnel type',
  'settings.ompchamber.tunnel.field.connectLinkTtl': 'Connect link TTL',
  ...
  'settings.ompchamber.tunnel.field.savedTokenAvailablePlaceholder': 'Saved token available (optional to replace)',
  'settings.ompchamber.tunnel.field.pasteTokenPlaceholder': 'Paste token for this tunnel',
  'settings.ompchamber.tunnel.field.newPresetNamePlaceholder': 'Tunnel name (e.g. Production)',
  'settings.ompchamber.tunnel.field.newPresetHostnamePlaceholder': 'Hostname (e.g. oc.example.com)',
  'settings.ompchamber.tunnel.field.newPresetTokenPlaceholder': 'Token',
  'settings.ompchamber.tunnel.field.managedRemoteTokenInfoAria': 'Managed remote tunnel token info',
  'settings.ompchamber.tunnel.field.configurationFile': 'Configuration file',
  'settings.ompchamber.tunnel.field.configurationFilePlaceholder': 'Using default cloudflared config',
  'settings.ompchamber.tunnel.field.managedRemoteTunnelToConnect': 'Managed remote tunnel to connect',
  'settings.ompchamber.tunnel.field.selectSavedTunnelPlaceholder': 'Select saved tunnel',
  'settings.ompchamber.tunnel.field.publicUrlHint': 'Public URL (not accessible without a token)',
  'settings.ompchamber.tunnel.field.connectLink': 'Connect link',
  'settings.ompchamber.tunnel.field.expires': 'Expires',
  'settings.ompchamber.tunnel.field.connectQrAlt': 'Tunnel connect QR code',
  'settings.ompchamber.tunnel.actions.removePresetAria': 'Remove {name}',
  'settings.ompchamber.tunnel.actions.saveToken': 'Save token',
  'settings.ompchamber.tunnel.actions.browseConfigFileAria': 'Browse config file',
  'settings.ompchamber.tunnel.actions.clearConfigFileAria': 'Clear config file',
  'settings.ompchamber.tunnel.actions.openManagedRemoteDocs': 'Check documentation on how to configure a managed remote tunnel',
  'settings.ompchamber.tunnel.actions.openManagedLocalDocs': 'Check documentation on managed local tunnel configuration',
  'settings.ompchamber.tunnel.actions.startTunnel': 'Start Tunnel',
  'settings.ompchamber.tunnel.actions.startingTunnel': 'Starting tunnel...',
  'settings.ompchamber.tunnel.actions.stopTunnel': 'Stop Tunnel',
  'settings.ompchamber.tunnel.actions.stopping': 'Stopping...',
  'settings.ompchamber.tunnel.actions.newConnectLink': 'New connect link',
  'settings.ompchamber.tunnel.actions.copied': 'Copied',
  'settings.ompchamber.tunnel.actions.retry': 'Retry',
  'settings.ompchamber.tunnel.option.moreProvidersSoon': 'More providers coming soon',
  'settings.ompchamber.tunnel.option.mode.quick.label': 'Quick',
  'settings.ompchamber.tunnel.option.mode.quick.tooltip': 'Quick Tunnel is best effort and uptime is not guaranteed.',
  'settings.ompchamber.tunnel.option.mode.managedRemote.label': 'Managed Remote',
  'settings.ompchamber.tunnel.option.mode.managedRemote.tooltip': 'Managed Remote uses your Cloudflare account and hostname for long-lived access.',
  'settings.ompchamber.tunnel.option.mode.managedLocal.label': 'Managed Local',
  'settings.ompchamber.tunnel.option.mode.managedLocal.tooltip': 'Managed Local uses your local cloudflared configuration file.',
  'settings.ompchamber.tunnel.warning.quickModeReliability': 'For more reliable long-lived access, switch to Managed Remote or Managed Local tunnel mode.',
  'settings.ompchamber.tunnel.warning.replacesActiveTunnel': 'Starting this tunnel replaces the active tunnel and revokes existing connect links and remote sessions.',
  ...
  'settings.ompchamber.tunnel.state.loading': 'Loading',
  'settings.ompchamber.tunnel.state.expired': 'Expired',
  'settings.ompchamber.tunnel.state.revoked': 'Revoked',
  'settings.ompchamber.tunnel.state.inactive': 'Inactive',
  'settings.ompchamber.tunnel.state.noExpiry': 'No expiry',
  'settings.ompchamber.tunnel.state.never': 'Never',
  'settings.ompchamber.tunnel.state.tunnelReady': 'Tunnel ready',
  'settings.ompchamber.tunnel.session.redeemedAt': 'Redeemed {time}',
  'settings.ompchamber.tunnel.session.expiresIn': 'Expires in {remaining}',
  'settings.ompchamber.tunnel.session.inactiveWithReason': 'Inactive ({reason})',
  'settings.ompchamber.tunnel.error.invalidConfigExtension': 'Config file must use .yml, .yaml, or .json extension.',
  'settings.ompchamber.tunnel.tooltip.tokensSavedPath': 'Tokens are saved in ~/.config/ompchamber/cloudflare-managed-remote-tunnels.json.',
  'settings.ompchamber.tunnel.empty.noManagedRemoteTunnels': 'No managed remote tunnels saved yet.',
  'settings.ompchamber.tunnel.toast.checkAvailabilityFailed': 'Failed to check tunnel availability',
  'settings.ompchamber.tunnel.toast.saveSettingsFailed': 'Failed to save tunnel settings',
  'settings.ompchamber.tunnel.toast.saveTtlFailed': 'Failed to save tunnel TTL settings',
  'settings.ompchamber.tunnel.toast.saveTokenFailed': 'Failed to save managed remote tunnel token',
  'settings.ompchamber.tunnel.toast.selectOrAddManagedRemoteFirst': 'Select or add a managed remote tunnel first',
  'settings.ompchamber.tunnel.toast.managedRemoteTokenRequiredBeforeStarting': 'Managed remote tunnel token is required before starting',
  'settings.ompchamber.tunnel.toast.addManagedRemoteTokenBeforeStarting': 'Add a managed remote tunnel token before starting',
  'settings.ompchamber.tunnel.toast.startFailed': 'Failed to start tunnel',
  'settings.ompchamber.tunnel.toast.startedButNoPublicUrl': 'Tunnel started but no public URL was returned',
  'settings.ompchamber.tunnel.toast.replacedTunnelSingleSingle': 'Replaced previous tunnel: revoked 1 link, invalidated 1 session.',
  'settings.ompchamber.tunnel.toast.replacedTunnelSingleManySessions': 'Replaced previous tunnel: revoked 1 link, invalidated {invalidatedSessionCount} sessions.',
  'settings.ompchamber.tunnel.toast.replacedTunnelManyLinksSingleSession': 'Replaced previous tunnel: revoked {revokedBootstrapCount} links, invalidated 1 session.',
  'settings.ompchamber.tunnel.toast.replacedTunnelManyMany': 'Replaced previous tunnel: revoked {revokedBootstrapCount} links, invalidated {invalidatedSessionCount} sessions.',
  'settings.ompchamber.tunnel.toast.linkReady': 'Tunnel link ready',
  'settings.ompchamber.tunnel.toast.stopped': 'Tunnel stopped',
  'settings.ompchamber.tunnel.toast.stopFailed': 'Failed to stop tunnel',
  'settings.ompchamber.tunnel.toast.connectLinkCopied': 'Connect link copied',
  'settings.ompchamber.tunnel.toast.copyUrlFailed': 'Failed to copy URL',
  'settings.ompchamber.tunnel.toast.saveSelectedManagedRemoteFailed': 'Failed to save selected managed remote tunnel',
  'settings.ompchamber.tunnel.toast.tunnelNameRequired': 'Tunnel name is required',
  'settings.ompchamber.tunnel.toast.managedRemoteHostnameRequired': 'Managed remote tunnel hostname is required',
  'settings.ompchamber.tunnel.toast.managedRemoteTokenRequired': 'Managed remote tunnel token is required',
  'settings.ompchamber.tunnel.toast.hostnameAlreadyExists': 'This hostname already exists',
  'settings.ompchamber.tunnel.toast.managedRemoteSaved': 'Managed remote tunnel saved',
  'settings.ompchamber.tunnel.toast.managedRemoteRemoved': 'Managed remote tunnel removed',
  ...
  'settings.remoteInstances.direct.title': 'Other OMPChamber servers',
  ...
  'settings.remoteInstances.direct.addDialog.description': 'Add another OMPChamber server by URL. Use this when the server is already running and you have a connection token.',
  ...
  'settings.remoteInstances.direct.import.description': 'Paste a connection link from another OMPChamber server.',
  ...
  'settings.remoteInstances.direct.error.invalidConnectLink': 'Invalid OMPChamber connection link.',
  ...
  'settings.remoteInstances.clientAuth.description': 'Create a secure link or token so OMPChamber Desktop can connect to this server.',
  ...
  'settings.remoteInstances.clientAuth.qrScanHint': 'Scan this with the OMPChamber app on your other device. It is single-use and expires.',
  ...
  'settings.remoteInstances.clientAuth.addDevice.transport.relayHint': 'Works at home and away. Away traffic goes through OMPChamber Private Relay — an end-to-end encrypted tunnel. No setup needed.',
  ...
  'settings.remoteInstances.relay.pair.qrDialogDescription': 'Scan this QR code with the OMPChamber app on your other device.',
  ...
  'settings.remoteInstances.page.field.modeHint': 'Choose whether OMPChamber should start the server for you, or connect to one that is already running.',
  ...
  'settings.remoteInstances.page.field.preferredRemotePortHint': 'Port OMPChamber uses on the remote machine. Leave empty to choose one automatically.',
  ...
  'settings.ompchamber.appLinks.title': 'Trusted app links',
  'settings.ompchamber.appLinks.info': 'Links listed here open without asking again on this device. Other app links always ask before opening.',
  'settings.ompchamber.appLinks.empty': 'No trusted app links on this device. Choose "Trust and open" when opening a link to add it here.',
  'settings.ompchamber.appLinks.removeAria': 'Remove trusted {scheme} links',
  ...
  'settings.ompchamber.about.title': 'About OMPChamber',
  'settings.ompchamber.about.field.version': 'Version',
  'settings.ompchamber.about.field.openCodeVersion': 'Engine version',
  'settings.ompchamber.about.field.instanceUrls': 'Instance URLs',
  'settings.ompchamber.about.field.applicationUrl': 'Application',
  'settings.ompchamber.about.field.tunnelUrl': 'Tunnel',
  'settings.ompchamber.about.state.checking': 'Checking...',
  'settings.ompchamber.about.state.upToDate': 'Up to date',
  'settings.ompchamber.about.state.unknown': 'unknown',
  'settings.ompchamber.about.actions.checkUpdates': 'Check updates',
  'settings.ompchamber.about.actions.update': 'Update',
  'settings.ompchamber.about.actions.updateToVersion': 'Update to {version}',
  'settings.ompchamber.about.actions.checkForUpdates': 'Check for updates',
  'settings.ompchamber.about.toast.latestVersion': 'You are on the latest version',
  'settings.agents.sidebar.title': 'Agents',
  'settings.common.infoHintDocs': 'Open documentation',
  'settings.agents.page.actions.reveal': 'Open in file manager',
  'settings.agents.page.toast.revealFailed': 'Could not open the definition file location',
  ...
  'settings.agents.sidebar.section.project': 'Project Agents',
  'settings.agents.sidebar.section.user': 'User Agents',
  'settings.agents.sidebar.section.bundled': 'Bundled Agents',
  ...
  'settings.agents.sidebar.badge.project': 'project',
  'settings.agents.sidebar.badge.global': 'global',
  'settings.agents.page.field.tools': 'Tools',
  'settings.agents.page.field.toolsPlaceholder': 'read, bash, edit',
  'settings.agents.page.field.toolsHint': 'Comma-separated tool names. Leave empty to allow all tools.',
  'settings.agents.page.overrides.title': 'Task overrides',
  'settings.agents.page.overrides.hint': 'Settings-level overrides applied when this agent is dispatched by the task tool. Stored in the engine’s global config.',
  'settings.agents.page.overrides.loading': 'Loading overrides…',
  'settings.agents.page.overrides.unavailable': 'Overrides are unavailable right now.',
  'settings.agents.page.overrides.saveFailed': 'Could not save the override.',
  'settings.agents.page.overrides.quarantined': 'The engine config was invalid and got quarantined. Check the server logs before changing overrides.',
  'settings.agents.page.overrides.rejected': '{key} was rejected by the engine.',
  'settings.agents.page.overrides.rejectedWithReason': '{key} was rejected: {reason}',
  'settings.agents.page.overrides.disabled.label': 'Disabled',
  'settings.agents.page.overrides.disabled.hint': 'Stop the task tool from dispatching this agent.',
  'settings.agents.page.overrides.disabled.on': 'Disabled',
  'settings.agents.page.overrides.disabled.off': 'Enabled',
  'settings.agents.page.overrides.model.label': 'Model override',
  'settings.agents.page.overrides.model.hint': 'Model pattern override, e.g. @smol or provider/*:high. Leave empty for the definition default.',
  'settings.agents.page.overrides.model.placeholder': '@smol, provider/*:high',
  'settings.agents.page.overrides.prewalk.label': 'Prewalk override',
  'settings.agents.page.overrides.prewalk.hint': 'Prewalk override: a model pattern, or empty to clear.',
  'settings.agents.page.overrides.prewalk.placeholder': 'model pattern',
  'settings.agents.page.overrides.advisor.label': 'Advisor override',
  'settings.agents.page.overrides.advisor.hint': 'Advisor override: a model pattern, or empty to clear.',
  'settings.agents.page.overrides.advisor.placeholder': 'model pattern',
  'settings.agents.page.toast.promptRequired': 'A system prompt is required',
  ...
  'settings.agents.page.toast.savedManualRestart': 'Saved to disk. Restart your connected server to apply the changes.',
  ...
  'settings.agents.page.section.workerBehavior': 'Worker Behavior',
  'settings.agents.page.subtitle.newWorker': 'Define a worker agent dispatched by the task tool',
  'settings.agents.page.readonly.bundled': 'Bundled agent — read-only. Duplicate it into your user scope to customize (a same-name copy shadows the bundled one).',
  'settings.agents.page.toast.descriptionRequired': 'A description is required',
  'settings.agents.page.field.source': 'Source',
  'settings.agents.page.field.systemPrompt': 'System Prompt',
  'settings.agents.page.field.modelPatterns': 'Model patterns',
  'settings.agents.page.field.modelPatternsPlaceholder': '@smol, anthropic/*:high',
  'settings.agents.page.field.modelPatternsHint': 'Comma-separated model patterns. A role like @smol, a provider wildcard, with an optional :level suffix.',
  'settings.agents.page.field.thinkingLevel': 'Thinking level',
  'settings.agents.page.field.thinkingLevelDefault': 'Default',
  'settings.agents.page.field.thinkingLevelHint': 'Fixed effort for this worker; "auto" resolves per turn.',
  'settings.agents.page.field.spawns': 'Spawns',
  'settings.agents.page.field.spawnsPlaceholder': 'task, scout, or *',
  'settings.agents.page.field.spawnsHint': 'Agents this worker may dispatch. "*" allows any.',
  'settings.agents.page.field.prewalk.label': 'Prewalk',
  'settings.agents.page.field.prewalk.hint': 'Hand the session to a cheaper model at the first edit. "Default" uses the prewalk target from settings.',
  'settings.agents.page.field.advisor.label': 'Advisor',
  'settings.agents.page.field.advisor.hint': 'A second model reviews each turn. "Default" uses the advisor role model.',
  'settings.agents.page.field.pattern.off': 'Off',
  'settings.agents.page.field.pattern.default': 'Default',
  'settings.agents.page.field.pattern.custom': 'Custom',
  'settings.agents.page.field.pattern.placeholder': 'model pattern',
  'settings.agents.page.field.readSummarize.label': 'Summarize reads',
  'settings.agents.page.field.readSummarize.hint': 'Return structural summaries from the read tool instead of verbatim file content.',
  ...
  'settings.agents.page.permissionsEditor.toast.savedRestartRequired': 'Permissions saved — restart the engine to apply',
  ...
  'settings.behavior.page.warning.description': 'Changes made here update the global AGENTS.md file. The agent also includes any project-level AGENTS.md rules when they exist.',
  'settings.behavior.page.legacyNotice.shadowed': 'Legacy rules at {path} are still read by the engine, but the file above takes precedence while it exists.',
  'settings.behavior.page.legacyNotice.active': 'Rules from the legacy file at {path} still apply. Saving content above overrides them at user scope.',
  ...
  'settings.skills.catalog.add.descriptionPrefix': 'Add a Git repository as a new catalog source. OMPChamber will scan it for folders containing',
  ...
  'settings.ompchamber.passkeys.field.currentDevice': 'Current device',
  'settings.ompchamber.passkeys.actions.add': 'Add passkey',
  'settings.ompchamber.passkeys.actions.cancelSetup': 'Cancel passkey setup',
  'settings.ompchamber.passkeys.actions.signOutEverywhere': 'Sign out everywhere',
  'settings.ompchamber.passkeys.actions.signingOut': 'Signing out…',
  'settings.ompchamber.passkeys.actions.removing': 'Removing…',
  'settings.ompchamber.passkeys.state.uiPasswordRequired': 'Passkeys are available only when the UI password lock is enabled.',
  'settings.ompchamber.passkeys.state.loading': 'Loading passkeys…',
  'settings.ompchamber.passkeys.state.noneSaved': 'No passkeys saved for this host yet.',
  'settings.ompchamber.passkeys.item.lastUsed': 'Last used {time}',
  'settings.ompchamber.passkeys.item.added': 'Added {time}',
  'settings.ompchamber.passkeys.time.neverUsed': 'Never used',
  'settings.ompchamber.passkeys.toast.loadFailed': 'Could not load passkeys.',
  'settings.ompchamber.passkeys.toast.enableUiPasswordFirst': 'Enable the UI password lock before adding passkeys.',
  'settings.ompchamber.passkeys.toast.added': 'Passkey added',
  'settings.ompchamber.passkeys.toast.setupCanceled': 'Passkey setup canceled',
  'settings.ompchamber.passkeys.toast.addFailed': 'Could not add passkey.',
  'settings.ompchamber.passkeys.toast.removed': 'Passkey removed',
  'settings.ompchamber.passkeys.toast.removeFailed': 'Could not remove passkey.',
  'settings.ompchamber.passkeys.toast.clearAuthFailed': 'Could not clear saved authentication.',
  'settings.ompchamber.sessionRetention.title': 'Session Retention',
  'settings.ompchamber.sessionRetention.tooltip': 'Automatically archive or delete inactive sessions based on last activity. Keeps the 5 most recent sessions.',
  'settings.ompchamber.sessionRetention.field.enableAutoCleanupAria': 'Enable auto-cleanup',
  'settings.ompchamber.sessionRetention.field.enableAutoCleanup': 'Enable Auto-Cleanup',
  'settings.ompchamber.sessionRetention.field.retentionPeriod': 'Retention Period',
  'settings.ompchamber.sessionRetention.field.retentionPeriodAria': 'Retention period in days',
  'settings.ompchamber.sessionRetention.field.days': 'days',
  'settings.ompchamber.sessionRetention.field.whenSessionsExpire': 'When sessions expire',
  'settings.ompchamber.sessionRetention.actions.resetRetentionAria': 'Reset retention period',
  'settings.ompchamber.sessionRetention.actions.runCleanupNow': 'Run cleanup now',
  'settings.ompchamber.sessionRetention.actions.cleaningUp': 'Cleaning up...',
  'settings.ompchamber.sessionRetention.action.archive': 'Archive',
  'settings.ompchamber.sessionRetention.action.delete': 'Delete',
  'settings.ompchamber.sessionRetention.manualCleanup.title': 'Manual Cleanup',
  'settings.ompchamber.sessionRetention.manualCleanup.eligibleArchiveNow': 'Eligible for archiving right now: {count}',
  'settings.ompchamber.sessionRetention.manualCleanup.eligibleDeleteNow': 'Eligible for deletion right now: {count}',
  'settings.ompchamber.sessionRetention.toast.noneEligibleArchive': 'No sessions eligible for archiving',
  'settings.ompchamber.sessionRetention.toast.noneEligibleDelete': 'No sessions eligible for deletion',
  'settings.ompchamber.sessionRetention.toast.archivedCount': 'Archived {count} session(s)',
  'settings.ompchamber.sessionRetention.toast.deletedCount': 'Deleted {count} session(s)',
  'settings.ompchamber.sessionRetention.toast.failedArchiveCount': 'Failed to archive {count} session(s)',
  'settings.ompchamber.sessionRetention.toast.failedDeleteCount': 'Failed to delete {count} session(s)',
  'settings.ompchamber.desktopNetwork.title': 'Desktop Network Access',
  'settings.ompchamber.desktopNetwork.field.windowControlsPosition': 'Window controls position',
  'settings.ompchamber.desktopNetwork.field.windowControlsPositionDescription': 'Choose where minimize, maximize, and close buttons appear. Defaults to the right.',
  'settings.ompchamber.desktopNetwork.field.windowControlsPositionAria': 'Window controls position',
  'settings.ompchamber.desktopNetwork.option.windowControlsLeft': 'Left',
  'settings.ompchamber.desktopNetwork.option.windowControlsRight': 'Right',
  'settings.ompchamber.desktopNetwork.field.windowControls': 'Window controls',
  'settings.ompchamber.desktopNetwork.field.windowControlsStyle': 'Style',
  'settings.ompchamber.desktopNetwork.field.windowControlsStyleAria': 'Window controls style',
  'settings.ompchamber.desktopNetwork.option.windowControlsClassic': 'Classic',
  'settings.ompchamber.desktopNetwork.option.windowControlsTrafficLights': 'Traffic lights',
  'settings.ompchamber.desktopNetwork.field.launchAtLoginAria': 'Start OMPChamber at login',
  'settings.ompchamber.desktopNetwork.field.launchAtLogin': 'Start OMPChamber when you log in',
  'settings.ompchamber.desktopNetwork.field.launchAtLoginDescription': 'Starts the app in the background without opening a window. Use the desktop status icon to open it.',
  'settings.ompchamber.desktopNetwork.field.macMenuBarAria': 'Show OMPChamber in the macOS menu bar',
  'settings.ompchamber.desktopNetwork.field.macMenuBar': 'Show OMPChamber in the menu bar',
  'settings.ompchamber.desktopNetwork.field.macMenuBarDescription': 'Requires an app restart. When off, OMPChamber does not create the menu bar item or run its session, approval, and usage updates.',
  'settings.ompchamber.desktopNetwork.field.minimizeToTrayAria': 'Close OMPChamber to the system tray',
  'settings.ompchamber.desktopNetwork.field.minimizeToTray': 'Close to the system tray',
  'settings.ompchamber.desktopNetwork.field.minimizeToTrayDescription': 'Keeps OMPChamber running in the system tray when the main window is closed. Minimizing still leaves the window in the taskbar.',
  'settings.ompchamber.desktopNetwork.field.keepAwakeAria': 'Keep computer awake while OMPChamber is running',
  'settings.ompchamber.desktopNetwork.field.keepAwake': 'Keep computer awake while OMPChamber is running',
  'settings.ompchamber.desktopNetwork.field.keepAwakeDescription': 'Prevents system sleep so phones can keep reaching this app. The screen can still turn off.',
  'settings.ompchamber.desktopNetwork.field.allowLanAccessAria': 'Allow LAN access to desktop sidecar',
  'settings.ompchamber.desktopNetwork.field.allowLanAccess': 'Let other devices on your local network open this app',
  'settings.ompchamber.desktopNetwork.field.allowLanAccessDescription': 'Restarts the app so phones, tablets, and other computers on your Wi-Fi can open it.',
  'settings.ompchamber.desktopNetwork.field.warning': 'Warning: while enabled, the app is reachable by anyone on the same local network.',
  'settings.ompchamber.desktopNetwork.field.passwordRequiredWarning': 'LAN access requires a Desktop UI Password. Until one is set, the desktop app starts local-only.',
  'settings.ompchamber.desktopPassword.actions.showPassword': 'Show password',
  'settings.ompchamber.desktopPassword.actions.hidePassword': 'Hide password',
  'settings.ompchamber.desktopPassword.field.password': 'Desktop UI Password',
  'settings.ompchamber.desktopPassword.field.passwordPlaceholder': 'No password required',
  'settings.ompchamber.desktopPassword.field.passwordDescription': 'OMPChamber asks after restart, then when the login session expires: after 12 hours, or 7 days with Trust this device. Leave empty to disable login.',
  'settings.ompchamber.desktopNetwork.hint.openAfterRestart': 'After restart, open from another device: ',
  'settings.ompchamber.desktopNetwork.hint.openNow': 'Open from another device: ',
  'settings.ompchamber.desktopNetwork.actions.saveAndRestart': 'Save + Restart',
  'settings.ompchamber.desktopNetwork.error.loadFailed': 'Failed to load desktop settings',
  'settings.ompchamber.desktopNetwork.error.saveFailed': 'Failed to save desktop settings',
  'settings.ompchamber.desktopNetwork.error.savedRestartFailed': 'Saved, but failed to restart app',
  'settings.ompchamber.desktopNetwork.error.launchAtLoginUnsupported': 'Launch at login is not supported on this system',
  'settings.ompchamber.desktopNetwork.error.launchAtLoginSaveFailed': 'Failed to update launch at login setting',
  'settings.ompchamber.desktopNetwork.error.minimizeToTrayUnsupported': 'System tray background mode is not supported on this system',
  'settings.ompchamber.desktopNetwork.error.minimizeToTraySaveFailed': 'Failed to update system tray setting',
  'settings.ompchamber.desktopNetwork.error.keepAwakeUnsupported': 'Preventing sleep is not supported on this system',
  'settings.ompchamber.desktopNetwork.error.keepAwakeSaveFailed': 'Failed to update keep awake setting',
  'settings.ompchamber.tools.title': 'OMPChamber Tools',
  'settings.ompchamber.tools.field.agentControlTool': 'Agent control tool',
  'settings.ompchamber.tools.field.agentControlToolAria': 'Enable the agent control tool',
  'settings.ompchamber.tools.field.agentControlToolInfo': 'Let agents orchestrate your work from chat: spin up sessions and worktrees, delegate prompts to other agents, and manage scheduled tasks. Adds a small tool description to each session. Applies after OpenCode restarts.',
  'settings.ompchamber.tools.field.agentWebTool': 'OMPChamber Web tool',
  'settings.ompchamber.tools.field.agentWebToolAria': 'Enable the OMPChamber Web tool',
  'settings.ompchamber.tools.field.agentWebToolInfo': 'Let agents look at and interact with the page in OMPChamber\\\'s browser panel: open a URL, read the page, click, type, scroll, and switch between mobile and desktop layouts. Adds a small tool description to each session. Applies after OpenCode restarts.',
  'settings.ompchamber.tools.field.agentMemoryTool': 'Agent memory tool',
  'settings.ompchamber.tools.field.agentMemoryToolAria': 'Agent memory tool',
  'settings.ompchamber.tools.field.agentMemoryToolInfo': 'Let agents keep what they learn across sessions, in two stores: what is true about you, and what is true about each project. Sessions are given the stored titles so the agent can read an entry when it is relevant. Turning this off removes the tool, the Memory tab, and the session index. Applies after OpenCode restarts.',
  ...
  'settings.plugins.sidebar.empty.packages': 'No package plugins installed',
  ...
  'settings.plugins.actions.reveal': 'Open in file manager',
  'settings.plugins.page.applied.title': 'Applied in sessions',
  'settings.plugins.page.applied.empty': 'Not bound to any live session',
  'settings.plugins.page.applied.since': 'since {time}',
  'settings.plugins.page.applied.refreshSession': 'Refresh this session',
  'settings.plugins.actions.reload': 'Reload plugins',
  'settings.plugins.toast.reloaded': 'Plugins reloaded ({count} sessions refreshed)',
  ...
  'settings.plugins.page.field.spec.placeholder': 'plugin@marketplace, npm-package, or /path',
  ...
  'settings.ompchamber.keyboardShortcuts.action.switch_session_tab.label': 'Switch session tab',
  ...
  'settings.ompchamber.keyboardShortcuts.action.switch_session_previous.label': 'Previous session',
  'settings.openchamber.keyboardShortcuts.action.switch_session_next.label': 'Next session',
  'settings.ompchamber.keyboardShortcuts.action.switch_session_next.label': 'Next session',
  'settings.openchamber.keyboardShortcuts.action.rename_current_session.label': 'Rename current session',
  'settings.ompchamber.keyboardShortcuts.action.rename_current_session.label': 'Rename current session',
  'settings.openchamber.keyboardShortcuts.action.toggle_permission_auto_accept.label': 'Toggle permission auto-accept',
  'settings.ompchamber.keyboardShortcuts.action.toggle_permission_auto_accept.label': 'Toggle permission auto-accept',
  'settings.openchamber.keyboardShortcuts.action.close_session_tab.label': 'Close session tab',
  'settings.ompchamber.keyboardShortcuts.action.close_session_tab.label': 'Close session tab',
  ...
  'settings.ompchamber.keyboardShortcuts.warning.contextualPrefix': 'This sequence shares a contextual prefix with {action}. That action takes priority while its context is active.',
  'settings.openchamber.keyboardShortcuts.category.session': 'Session Controls',
  'settings.ompchamber.keyboardShortcuts.category.session': 'Session Controls',
  'settings.openchamber.keyboardShortcuts.category.models': 'Models & Agents',
  'settings.ompchamber.keyboardShortcuts.category.models': 'Models & Agents',
  'settings.openchamber.keyboardShortcuts.category.panels': 'Panels & Tools',
  'settings.ompchamber.keyboardShortcuts.category.panels': 'Panels & Tools',
  ...
  'settings.ompchamber.keyboardShortcuts.actions.edit': 'Edit',
  'settings.openchamber.keyboardShortcuts.actions.confirm': 'Confirm',
  'settings.ompchamber.keyboardShortcuts.actions.confirm': 'Confirm',
  'settings.openchamber.keyboardShortcuts.dialog.title': 'Edit {action}',
  'settings.ompchamber.keyboardShortcuts.dialog.title': 'Edit {action}',
  ...
  'settings.ompchamber.keyboardShortcuts.dialog.instructions': 'Press up to two key combinations, with at most three keys each. After the first, wait up to 3 seconds for a second combination. Use Confirm to apply or Cancel to discard. Backspace removes the last one.',
  'settings.openchamber.keyboardShortcuts.dialog.firstChord': 'First combination',
  'settings.ompchamber.keyboardShortcuts.dialog.firstChord': 'First combination',
  'settings.openchamber.keyboardShortcuts.dialog.secondChord': 'Second combination',
  'settings.ompchamber.keyboardShortcuts.dialog.secondChord': 'Second combination',
  'settings.openchamber.keyboardShortcuts.dialog.recording': 'Press keys…',
  'settings.ompchamber.keyboardShortcuts.dialog.recording': 'Press keys…',
  'settings.openchamber.keyboardShortcuts.unassigned': 'Unassigned',
  'settings.ompchamber.keyboardShortcuts.unassigned': 'Unassigned',
  ...
  'settings.ompchamber.keyboardShortcuts.error.prefixConflict': 'This conflicts with the sequence used by {action}. Choose a different combination.',
  'settings.openchamber.keyboardShortcuts.error.exactConflict': 'This combination is already used by {action}.',
  'settings.ompchamber.keyboardShortcuts.error.exactConflict': 'This combination is already used by {action}.',
  ...
  'settings.ompchamber.keyboardShortcuts.error.internalConflict': 'This combination conflicts with a built-in shortcut, which cannot be replaced.',
  'settings.openchamber.keyboardShortcuts.action.open_draft_project_picker.label': 'Open draft project picker',
  'settings.ompchamber.keyboardShortcuts.action.open_draft_project_picker.label': 'Open draft project picker',
  'settings.openchamber.keyboardShortcuts.action.open_draft_worktree_picker.label': 'Open draft worktree picker',
  'settings.ompchamber.keyboardShortcuts.action.open_draft_worktree_picker.label': 'Open draft worktree picker',
  'settings.openchamber.keyboardShortcuts.action.open_session_list.label': 'Open recent sessions',
  'settings.ompchamber.keyboardShortcuts.action.open_session_list.label': 'Open recent sessions',
  'settings.openchamber.keyboardShortcuts.action.toggle_dictation.label': 'Voice input',
  'settings.ompchamber.keyboardShortcuts.action.toggle_dictation.label': 'Voice input',
  'settings.ompchamber.keyboardShortcuts.title': 'Keyboard Shortcuts',
  'settings.ompchamber.keyboardShortcuts.actions.resetAll': 'Reset All',
  'settings.ompchamber.keyboardShortcuts.actions.overwrite': 'Overwrite',
  'settings.ompchamber.keyboardShortcuts.tooltip': 'Capture a new key combo, save it, and bindings will update immediately.',
  'settings.ompchamber.keyboardShortcuts.overwritePrompt': 'This combo is already used by another shortcut. Overwrite and clear that other mapping?',
  'settings.ompchamber.keyboardShortcuts.field.pressKeys': 'Press keys...',
  'settings.ompchamber.keyboardShortcuts.error.captureFirst': 'Capture a shortcut first.',
  'settings.ompchamber.keyboardShortcuts.warning.riskyBrowserShortcut': 'This shortcut can conflict with browser defaults. You can still save it.',
  'settings.ompchamber.keyboardShortcuts.action.open_go_to_line.label': 'Go to line (files editor)',
  'settings.ompchamber.keyboardShortcuts.action.open_command_palette.label': 'Open command palette',
  'settings.ompchamber.keyboardShortcuts.action.focus_input.label': 'Focus input',
  'settings.ompchamber.keyboardShortcuts.action.open_settings.label': 'Open settings',
  'settings.ompchamber.keyboardShortcuts.action.toggle_terminal.label': 'Toggle terminal dock',
  'settings.ompchamber.keyboardShortcuts.action.toggle_terminal_expanded.label': 'Toggle terminal expanded',
  'settings.ompchamber.keyboardShortcuts.action.add_selection_to_chat.label': 'Add selection to chat',
  'settings.ompchamber.keyboardShortcuts.action.toggle_sidebar.label': 'Toggle sidebar',
  'settings.ompchamber.keyboardShortcuts.action.toggle_right_sidebar.label': 'Toggle context panel',
  'settings.ompchamber.keyboardShortcuts.action.open_right_sidebar_git.label': 'Open Git surface',
  'settings.ompchamber.keyboardShortcuts.action.open_right_sidebar_files.label': 'Open Files surface',
  'settings.ompchamber.keyboardShortcuts.action.switch_context_surface.label': 'Switch context panel surface',
  'settings.ompchamber.keyboardShortcuts.action.switch_context_surface.suffix': ' + 1…0',
  'settings.ompchamber.keyboardShortcuts.action.new_chat.label': 'New session',
  'settings.ompchamber.keyboardShortcuts.action.new_chat_worktree.label': 'New worktree draft',
  'settings.ompchamber.keyboardShortcuts.action.new_mini_chat.label': 'New Mini Chat window',
  'settings.ompchamber.keyboardShortcuts.action.open_help.label': 'Open keyboard shortcuts',
  'settings.ompchamber.keyboardShortcuts.action.toggle_context_plan.label': 'Toggle plan context panel',
  'settings.ompchamber.keyboardShortcuts.action.toggle_services_menu.label': 'Toggle services menu',
  'settings.ompchamber.keyboardShortcuts.action.cycle_services_tab.label': 'Cycle services tab',
  'settings.ompchamber.keyboardShortcuts.action.cycle_theme.label': 'Cycle theme',
  'settings.ompchamber.keyboardShortcuts.action.cycle_agent.label': 'Cycle agent',
  'settings.ompchamber.keyboardShortcuts.action.cycle_favorite_model_forward.label': 'Cycle favorite model forward',
  'settings.ompchamber.keyboardShortcuts.action.cycle_favorite_model_backward.label': 'Cycle favorite model backward',
  'settings.ompchamber.keyboardShortcuts.action.open_model_selector.label': 'Open model selector',
  'settings.ompchamber.keyboardShortcuts.action.expand_input.label': 'Expand input',
  'settings.ompchamber.keyboardShortcuts.action.open_timeline_dialog.label': 'Open conversation timeline',
  'settings.ompchamber.keyboardShortcuts.action.toggle_prompt_navigator.label': 'Toggle prompt navigator',
  ...
  'settings.remoteInstances.page.description': 'Connect to another machine over SSH and open OMPChamber there.',
  ...
  'settings.remoteInstances.page.section.remoteServer': 'OMPChamber on the remote machine',
  'settings.remoteInstances.page.section.remoteServerDescription': 'Choose how OMPChamber should run after SSH connects.',
  'settings.remoteInstances.page.section.mainTunnel': 'Access from this computer',
  'settings.remoteInstances.page.section.mainTunnelDescription': 'OMPChamber runs on the remote machine. These settings only control the address on this computer that forwards to it through the SSH tunnel.',
  'settings.remoteInstances.page.section.authentication': 'Authentication',
  'settings.remoteInstances.page.section.authenticationDescription': 'Optional credentials for SSH and the remote OMPChamber UI.',
  ...
  'settings.remoteInstances.page.field.installMethodHint': 'How OMPChamber should be placed on the remote machine when this app starts it for you.',
  ...
  'settings.remoteInstances.page.validation.externalPortRequired': 'Set a remote port first. In "Already running" mode OMPChamber needs to know which port the server listens on.',
  ...
  'settings.remoteInstances.page.field.remoteLanAccessHint': 'Also let other devices on the remote machine’s network open this OMPChamber directly, without the SSH tunnel. A UI password is required.',
  'settings.remoteInstances.page.field.remoteLanAccessWarning': 'Anyone on that network can reach the remote OMPChamber. It is protected only by the UI password below.',
  'settings.remoteInstances.page.validation.remoteLanNeedsPassword': 'Set a UI password first. Publishing the remote OMPChamber to its network without one would leave it open to every device there.',
  ...
  'settings.remoteInstances.page.field.uiPasswordHintManaged': 'Password to protect the remote OMPChamber UI. OMPChamber sets it on the server it starts for you.',
  'settings.remoteInstances.page.field.uiPasswordHintExternal': 'Password of the OMPChamber server already running on the remote machine, used to sign in to it.',
  ...
  'settings.remoteInstances.page.phase.installingOMPChamber': 'Installing OMPChamber',
  'settings.remoteInstances.page.phase.updatingOMPChamber': 'Updating OMPChamber',
  ...
  'settings.ompchamber.worktrees.state.selectProject': 'Select a project to manage worktrees.',
  'settings.ompchamber.worktrees.state.gitOnly': 'Worktree settings are only available for Git repositories.',
  'settings.ompchamber.worktrees.setup.title': 'Setup commands',
  'settings.ompchamber.worktrees.setup.tooltipPrefix': 'Run automatically inside the new worktree directory when a worktree is created. Use',
  'settings.ompchamber.worktrees.setup.tooltipSuffix': 'for the project root.',
  'settings.ompchamber.worktrees.setup.loading': 'Loading...',
  'settings.ompchamber.worktrees.setup.commandPlaceholder': 'e.g., bun install',
  'settings.ompchamber.worktrees.setup.removeCommandAria': 'Remove command',
  'settings.ompchamber.worktrees.setup.addCommand': 'Add command',
  'settings.ompchamber.worktrees.setup.waitForCommands': 'Wait for setup commands before creating or sending a session',
  'settings.ompchamber.worktrees.setup.waitForCommandsAria': 'Wait for Worktree setup commands before creating or sending a session',
  'settings.ompchamber.worktrees.setup.toast.saveFailed': 'Failed to save worktree setup commands',
  'settings.ompchamber.worktrees.list.title': 'Existing worktrees',
  'settings.ompchamber.worktrees.list.tooltip': 'Deleting a worktree also removes its linked sessions.',
  'settings.ompchamber.worktrees.list.loading': 'Loading worktrees...',
  'settings.ompchamber.worktrees.list.empty': 'No worktrees found for this project',
  'settings.ompchamber.worktrees.list.detachedHead': 'Detached HEAD',
  'settings.ompchamber.worktrees.list.deleteWorktreeAria': 'Delete worktree {name}',
  ...
  'settings.providers.page.custom.field.apiKey.info': 'Stored in OpenCode auth, not by OMPChamber. Use {env:VAR_NAME} to read a key from the environment instead.',
  ...
  'settings.providers.page.auth.apiKeyTooltip': 'Keys are sent directly to OpenCode and never stored by OMPChamber.',
  ...
  'settings.providers.page.connectionDetails.source.engineConfig': 'omp engine config',
  'settings.providers.page.connectionDetails.engineManagedHint': 'This provider is defined and authenticated in the omp engine configuration (~/.omp/agent). Manage it there or with the omp CLI.',
  'settings.providers.page.auth.engineManagedHint': 'Credentials are managed by the omp engine credential store (~/.omp/agent). The engine reports this provider as connected.',
  'settings.providers.omp.title.create': 'Add engine provider',
  'settings.providers.omp.title.edit': 'Edit provider',
  'settings.providers.omp.description': 'Writes the omp engine provider file (~/.omp/agent/models.yml) and refreshes the engine registry. Fields this form does not show (thinking blocks, compat, cost) are preserved.',
  'settings.providers.omp.field.id': 'Provider ID',
  'settings.providers.omp.field.id.placeholder': 'my-gateway',
  'settings.providers.omp.field.id.info': 'Lowercase letters, digits, - and _. Models appear as provider/model in selectors.',
  'settings.providers.omp.field.baseUrl': 'Base URL',
  'settings.providers.omp.field.baseUrl.placeholder': 'https://api.example.com/v1',
  'settings.providers.omp.field.api': 'API protocol',
  'settings.providers.omp.field.api.info': 'Wire protocol the gateway speaks. OpenAI-compatible gateways usually use openai-responses or openai-completions.',
  'settings.providers.omp.field.apiKey': 'API key',
  'settings.providers.omp.field.apiKey.placeholder': 'sk-…',
  'settings.providers.omp.field.apiKey.keepPlaceholder': 'Unchanged',
  'settings.providers.omp.field.apiKey.info': 'Stored in the engine provider file, exactly like a hand-edited models.yml. Empty keeps the existing key when editing.',
  'settings.providers.omp.field.authHeader': 'Send key as Authorization header',
  'settings.providers.omp.field.authHeader.info': 'Some gateways expect the bearer token in the Authorization header instead of a provider-specific parameter.',
  'settings.providers.omp.models.title': 'Models',
  'settings.providers.omp.models.add': 'Add model',
  'settings.providers.omp.models.id': 'Model ID',
  'settings.providers.omp.models.id.placeholder': 'my-model',
  'settings.providers.omp.models.name': 'Display name',
  'settings.providers.omp.models.name.placeholder': 'My Model',
  'settings.providers.omp.models.reasoning': 'Reasoning',
  'settings.providers.omp.models.context': 'Context window',
  'settings.providers.omp.models.maxTokens': 'Max output',
  'settings.providers.omp.models.remove': 'Remove model',
  'settings.providers.omp.actions.save': 'Save provider',
  'settings.providers.omp.actions.saving': 'Saving…',
  'settings.providers.omp.actions.cancel': 'Cancel',
  'settings.providers.omp.actions.editProvider': 'Edit',
  'settings.providers.omp.actions.deleteProvider': 'Delete',
  'settings.providers.omp.toast.saved': 'Provider saved',
  'settings.providers.omp.toast.saveFailed': 'Saving the provider failed',
  'settings.providers.omp.toast.deleted': 'Provider deleted',
  'settings.providers.omp.toast.deleteFailed': 'Deleting the provider failed',
  'settings.providers.omp.error.id': 'Provider ID must use lowercase letters, digits, - or _',
  'settings.providers.omp.error.exists': 'Provider {provider} already exists',
  'settings.providers.omp.error.baseUrl': 'Base URL must start with http:// or https://',
  'settings.providers.omp.error.modelId': 'Every model needs an ID',
  'settings.providers.omp.error.unavailable': 'Engine provider management is unavailable on this runtime',
  'settings.providers.omp.confirmDelete.title': 'Delete provider',
  'settings.providers.omp.confirmDelete.body': 'Delete {provider} from the engine provider file? Roles using its models will fall back to other models.',
  'settings.providers.omp.confirmDelete.cancel': 'Cancel',
  'settings.providers.omp.confirmDelete.confirm': 'Delete',
  'settings.providers.omp.actions.back': 'Back',
  'settings.providers.omp.confirmClose.title': 'Discard changes?',
  'settings.providers.omp.confirmClose.body': 'The provider draft has unsaved changes. Closing the editor discards them.',
  'settings.providers.omp.confirmClose.cancel': 'Keep editing',
  'settings.providers.omp.confirmClose.confirm': 'Discard',
  'settings.providers.omp.section.connection': 'Connection',
  'settings.providers.omp.actions.showKey': 'Show key',
  'settings.providers.omp.actions.hideKey': 'Hide key',
  'settings.providers.omp.actions.fetch': 'Fetch models',
  'settings.providers.omp.actions.fetching': 'Fetching…',
  'settings.providers.omp.error.fetchFailed': 'Fetching the model list failed',
  'settings.providers.omp.error.apiKeyRequired': 'An API key is required for a new provider',
  'settings.providers.omp.toast.fetched': 'Added {count} models from the gateway',
  'settings.providers.omp.toast.fetchNoNew': 'No new models ({count} already present)',
  'settings.providers.omp.field.apiKey.plaintextWarning': 'The key is stored in plain text in the engine provider file.',
  'settings.providers.omp.field.authHeaderShort.info': 'Send as Authorization header',
  'settings.providers.omp.models.removeDisabled': 'At least one model is required',
  'settings.providers.omp.models.reasoningShort': 'Reas.',
  'settings.providers.omp.models.contextShort': 'Ctx',
  'settings.providers.omp.modelDialog.title.edit': 'Edit model',
  'settings.providers.omp.modelDialog.title.add': 'Add model',
  'settings.providers.omp.modelDialog.description': 'Applies to the draft; save the provider to persist.',
  'settings.providers.omp.modelDialog.thinking': 'Thinking levels',
  'settings.providers.omp.modelDialog.thinking.info': 'Effort vocabulary the model accepts (models.yml thinking.efforts). Empty removes the block; hand-authored blocks are kept unless edited here.',
  'settings.providers.omp.modelDialog.thinkingDefault': 'Default level',
  'settings.providers.omp.modelDialog.thinkingDefault.placeholder': 'None',
  'settings.providers.omp.modelDialog.thinkingEmpty': 'No thinking levels selected — the block will be removed on save.',
  'settings.providers.omp.modelDialog.save': 'Apply',
  'settings.providers.omp.modelDialog.imageInput': 'Image input',
  'settings.providers.omp.modelDialog.reasoningToggle': 'Reasoning',
  'settings.providers.omp.modelDialog.toolsSupport': 'Tool calling',
  'settings.providers.omp.modelDialog.toolsAuto': 'Auto (default)',
  'settings.providers.omp.modelDialog.toolsNative': 'Native tool calling',
  'settings.providers.omp.modelDialog.toolsXml': 'No native tools (XML dialect)',
  'settings.providers.omp.modelDialog.cost': 'Cost per 1M tokens (USD)',
  'settings.providers.omp.modelDialog.cost.info': 'Empty keeps the file value; 0 means free. Drives usage cost accounting.',
  'settings.providers.omp.modelDialog.cost.input': 'Input',
  'settings.providers.omp.modelDialog.cost.output': 'Output',
  'settings.providers.omp.modelDialog.cost.cacheRead': 'Cache read',
  'settings.providers.omp.modelDialog.cost.cacheWrite': 'Cache write',
  'settings.providers.omp.modelDialog.advanced': 'Advanced',
  'settings.providers.omp.modelDialog.advanced.baseUrl': 'Endpoint URL override',
  'settings.providers.omp.modelDialog.advanced.baseUrl.info': 'Empty uses the provider base URL. Only for models behind a different endpoint.',
  'settings.providers.omp.modelDialog.advanced.apiInherit': 'Inherit from provider',
  'settings.providers.omp.modelDialog.advanced.omitMax': 'Omit max-output on the wire',
  'settings.providers.omp.modelDialog.advanced.omitMax.info': 'For proxies with unknown upstream output caps (e.g. Ollama); max output still budgets locally.',
  'settings.providers.omp.modelDialog.advanced.promotion': 'Context promotion target',
  'settings.providers.omp.modelDialog.advanced.promotion.info': 'Model to switch to when this model\\\'s context fills (provider/model or model).',
  'settings.providers.omp.modelDialog.advanced.compaction': 'Compaction model',
  'settings.providers.omp.modelDialog.advanced.compaction.info': 'Dedicated model for summarization/compaction (provider/model or model).',
  'settings.providers.omp.models.imageBadge': 'image',
  'settings.providers.omp.models.toolsBadge': 'xml',
  'settings.providers.omp.models.editModel': 'Edit model',
  'settings.providers.omp.models.empty': 'No models yet — fetch from the gateway or add one.',
  ...
  'settings.mcp.page.status.description.awaitingRestart': 'This server is saved but not applied yet. Use Apply & Restart to load it into the engine — connect and authorization become available after that.',
  'settings.mcp.page.status.description.connected': 'Connected and ready for the engine to discover tools and resources.',
  'settings.mcp.page.status.description.failedDefault': 'The engine could not reach this MCP server.',
  ...
  'settings.mcp.page.auth.waitingForOpenCode': 'Waiting for the engine to observe the completed browser authorization flow...',
  ...
  'settings.mcp.page.advanced.timeoutHint': 'Leave blank to use the engine\\\'s default MCP timeout.',
  ...
  'settings.mcp.page.advanced.oauthHint': 'Leave these fields blank to let the engine infer OAuth settings from the MCP server.',
  ...
  'settings.mcp.page.deleteDialog.descriptionSuffix': 'The engine will need to reload.',
  ...
  'settings.mcp.page.toast.serverCreatedReloadFailed': 'MCP server created, but the engine reload failed.',
  'settings.mcp.page.toast.savedReloadFailed': 'Saved, but the engine reload failed.',
  'settings.mcp.page.toast.retryRefreshHint': 'Retry refresh or reopen Settings before authorizing this server.',
  'settings.mcp.page.toast.serverCreatedReloading': 'MCP server created. Engine reloading…',
  'settings.mcp.page.toast.savedReloading': 'Saved. Engine reloading…',
  'settings.mcp.page.toast.saveFailed': 'Failed to save',
  'settings.mcp.page.toast.unexpectedError': 'An error occurred',
  'settings.mcp.page.toast.serverDeletedReloadFailed': '"{name}" deleted, but the engine reload failed',
  ...
  'settings.mcp.page.toast.openCodeReloadFailedAfterCallbackSave': 'Engine reload failed after saving the browser callback URL',
  ...
  'settings.ompchamber.defaults.field.defaultAgent': 'Default Agent',
  'settings.ompchamber.defaults.field.showDeletionDialogAria': 'Show deletion dialog',
  'settings.ompchamber.defaults.field.showDeletionDialog': 'Show Deletion Dialog',
  'settings.ompchamber.defaults.smallModel.title': 'Small Model',
  'settings.ompchamber.defaults.smallModel.description': 'A cheap model for quick utility tasks like short recaps and summaries.',
  'settings.ompchamber.defaults.smallModel.useDefault': 'Use default small model',
  'settings.ompchamber.defaults.smallModel.useDefaultAria': 'Use default small model',
  'settings.ompchamber.defaults.smallModel.overrideModel': 'Override model',
  'settings.ompchamber.defaults.walkthroughModel.title': 'Changes Walkthrough Model',
  ...
  'settings.ompchamber.defaults.walkthroughModel.overrideModel': 'Walkthrough model',
  'settings.ompchamber.defaults.walkthroughModel.usesSmallModel': 'Small model',
  'settings.ompchamber.defaults.field.openFilesPreviewAria': 'Open previewable files in preview mode',
  'settings.ompchamber.defaults.field.openFilesPreview': 'Open previewable files in preview mode',
  'settings.ompchamber.defaults.option.default': 'Default',
  'settings.ompchamber.defaults.option.defaultLowercase': 'default',
  'settings.page.engine.title': 'Engine Settings',
  'settings.page.engine.description': 'Model roles and engine configuration, served by the engine settings schema.',
  'settings.omp.roles.title': 'Model Roles',
  'settings.omp.roles.thinkingLevel': 'Default Thinking Level',
  'settings.omp.roles.storage': 'Role Storage',
  'settings.omp.roles.storageHint': 'Where new role assignments are saved.',
  'settings.omp.roles.source.global': 'Global',
  'settings.omp.roles.source.project': 'Project',
  'settings.omp.roles.notSet': 'No model',
  'settings.omp.roles.clearAria': 'Clear model for role {role}',
  'settings.omp.roles.unavailable': 'Model roles are unavailable right now.',
  'settings.omp.roles.saveFailed': 'Saving the role failed.',
  'settings.omp.surfaceUnavailable': 'Engine settings are unavailable right now.',
  'settings.omp.approvals.title': 'Approvals',
  'settings.omp.page.loadFailed': 'Engine settings could not be loaded.',
  'settings.omp.page.quarantined': 'The engine configuration file was quarantined after a read error. Restore it from the backup shown in the server logs, then reload.',
  'settings.omp.legacyImport.offerTitle': 'Legacy default model detected',
  'settings.omp.legacyImport.offerBody': 'Import "{model}" as the default model role?',
  'settings.omp.legacyImport.import': 'Import',
  'settings.omp.legacyImport.importing': 'Importing…',
  'settings.omp.legacyImport.importFailed': 'Import failed.',
  'settings.omp.legacyImport.comparison': 'Legacy OMPChamber default: {legacy} — current default role: {current}',
  'settings.omp.entry.selectPlaceholder': 'Select a value',
  'settings.omp.entry.rejected': 'Rejected: {reason}',
  'settings.omp.entry.credentialConfigured': 'Configured',
  'settings.omp.entry.credentialNotSet': 'Not set',
  'settings.omp.entry.clearCredentialAria': 'Clear {label}',
  'settings.omp.entry.readOnly': 'Read-only',
  'settings.ompchamber.git.title': 'Git Preferences',
  'settings.ompchamber.git.changesViewTitle': 'Changes View',
  'settings.ompchamber.git.changesViewAria': 'Git changes view mode',
  'settings.ompchamber.git.option.flatList': 'Flat List',
  'settings.ompchamber.git.option.treeView': 'Tree View',
  'settings.ompchamber.git.optionAria': 'Git changes view mode: {option}',
  'settings.ompchamber.git.enableGitmojiAria': 'Enable Gitmoji picker',
  'settings.ompchamber.git.enableGitmoji': 'Enable Gitmoji Picker',
  'settings.ompchamber.git.showGitignoredAria': 'Display gitignored files',
  'settings.ompchamber.git.showGitignored': 'Display Gitignored Files',
  ...
  'settings.github.page.flow.title': 'Authorize OMPChamber',
  ...
  'settings.github.page.ghCli.fallbackDescription': 'Available as fallback if OMPChamber auth is removed',
  ...
  'settings.notifications.page.testNotification.body': 'This is a test notification from OMPChamber.',
  ...
  'settings.voice.page.tooltip.sttLocal': 'On-device transcription on the OMPChamber server. Models download automatically; no API key needed.',
  'settings.voice.page.tooltip.localTts': 'On-device synthesis on the OMPChamber server (Kokoro for English; models for other languages download on first use). No API key needed.',
  ...
  'settings.ompchamber.visual.field.streamingAutoFollow': 'Follow new content while streaming',
  'settings.openchamber.visual.field.streamingAutoFollowAria': 'Automatically follow new content while a response streams',
  'settings.ompchamber.visual.field.streamingAutoFollowAria': 'Automatically follow new content while a response streams',
  ...
  'settings.ompchamber.visual.field.streamingAutoFollowInfo': 'While a reply streams in, the view keeps gliding to the newest content. Turn this off to keep the view still and scroll manually; sending a message while scrolled up then also leaves the view where it is.',
  ...
  'settings.ompchamber.visual.field.sessionTabsGroup': 'Session tabs',
  'settings.openchamber.visual.field.sessionTabs': 'Show sessions as tabs in the header',
  'settings.ompchamber.visual.field.sessionTabs': 'Show sessions as tabs in the header',
  'settings.openchamber.visual.field.sessionTabsAria': 'Toggle session tabs in the header',
  'settings.ompchamber.visual.field.sessionTabsAria': 'Toggle session tabs in the header',
  ...
  'settings.ompchamber.visual.field.sessionTabsInfo': 'Sessions you open line up as tabs in the header. Turning this off restores the plain session title.',
  ...
  'settings.ompchamber.visual.field.largeTextPaste': 'Large text paste',
  ...
  'settings.ompchamber.visual.field.largeTextPasteHint': 'When pasting more than about 2,000 characters or 25 lines, choose whether to attach the text as a file, paste it inline, or ask each time.',
  'settings.openchamber.visual.field.largeTextPasteAria': 'Large text paste behavior',
  'settings.ompchamber.visual.field.largeTextPasteAria': 'Large text paste behavior',
  'settings.openchamber.visual.field.largeTextPasteOptionAria': 'Large text paste: {option}',
  'settings.ompchamber.visual.field.largeTextPasteOptionAria': 'Large text paste: {option}',
  'settings.openchamber.visual.option.largeTextPaste.ask.label': 'Ask each time',
  'settings.ompchamber.visual.option.largeTextPaste.ask.label': 'Ask each time',
  'settings.openchamber.visual.option.largeTextPaste.attach.label': 'Attach as file',
  'settings.ompchamber.visual.option.largeTextPaste.attach.label': 'Attach as file',
  'settings.openchamber.visual.option.largeTextPaste.inline.label': 'Paste inline',
  'settings.ompchamber.visual.option.largeTextPaste.inline.label': 'Paste inline',
  'settings.ompchamber.visual.section.colorMode': 'Color Mode',
  'settings.ompchamber.visual.section.colorModeAndTheme': 'Color mode & Theme',
  'settings.ompchamber.visual.section.mobileLayout': 'Mobile Layout',
  'settings.ompchamber.visual.option.mobileLayout.default': 'Old',
  'settings.ompchamber.visual.option.mobileLayout.new': 'New',
  'settings.ompchamber.visual.section.localization': 'Localization',
  'settings.ompchamber.visual.section.spacingAndLayout': 'Spacing & Layout',
  'settings.ompchamber.visual.section.densityAndType': 'Density & type',
  'settings.ompchamber.visual.section.appInstall': 'App install',
  'settings.ompchamber.visual.section.navigation': 'Navigation',
  'settings.ompchamber.visual.section.chatRenderMode': 'Chat Render Mode',
  'settings.ompchamber.visual.section.chatRenderModeAria': 'Chat render mode',
  'settings.ompchamber.visual.section.chatDisplay': 'Display',
  'settings.ompchamber.visual.section.chatMessageOptions': 'Message options',
  'settings.ompchamber.visual.section.chatFeatures': 'Features',
  'settings.ompchamber.visual.section.messageStreamTransport': 'Message Stream Transport',
  'settings.ompchamber.visual.section.activityDefault': 'Activity Default',
  'settings.ompchamber.visual.section.activityDefaultAria': 'Activity default mode',
  'settings.ompchamber.visual.section.showToolsOpenedByDefault': 'Show tools opened by default',
  'settings.ompchamber.visual.section.sessionAssistance': 'Session Assistance',
  'settings.ompchamber.visual.section.reasoning': 'Reasoning',
  'settings.ompchamber.visual.section.messageAppearance': 'Message Appearance',
  'settings.ompchamber.visual.section.toolsAndFiles': 'Tools & Files',
  'settings.ompchamber.visual.section.composer': 'Composer',
  'settings.ompchamber.visual.section.userMessageRendering': 'User Message Rendering',
  'settings.ompchamber.visual.section.userMessageRenderingAria': 'User message rendering mode',
  'settings.ompchamber.visual.section.mermaidRendering': 'Mermaid Rendering',
  'settings.ompchamber.visual.section.mermaidRenderingAria': 'Mermaid rendering mode',
  'settings.ompchamber.visual.section.diffLayout': 'Diff Layout',
  'settings.ompchamber.visual.section.diffLayoutAria': 'Diff layout',
  'settings.ompchamber.visual.section.privacy': 'Privacy',
  'settings.ompchamber.visual.field.lightTheme': 'Light Theme',
  'settings.ompchamber.visual.field.darkTheme': 'Dark Theme',
  'settings.ompchamber.visual.field.selectLightThemeAria': 'Select light theme',
  'settings.ompchamber.visual.field.selectDarkThemeAria': 'Select dark theme',
  'settings.ompchamber.visual.field.selectThemePlaceholder': 'Select theme',
  'settings.ompchamber.visual.field.timeFormat': 'Time Format',
  'settings.ompchamber.visual.field.weekStartsOn': 'Week Starts On',
  'settings.ompchamber.visual.field.selectTimeFormatAria': 'Select time format',
  'settings.ompchamber.visual.field.selectWeekStartAria': 'Select week start',
  'settings.ompchamber.visual.actions.reloadThemes': 'Reload themes',
  'settings.ompchamber.visual.actions.reloadingThemes': 'Reloading themes...',
  'settings.ompchamber.visual.field.dockBadge': 'Dock badge',
  'settings.ompchamber.visual.field.dockBadgeHint': 'Show a count of chats with unseen activity on the macOS dock icon.',
  'settings.ompchamber.visual.actions.saveAndRestart': 'Save & restart',
  'settings.ompchamber.visual.actions.restarting': 'Restarting…',
  'settings.ompchamber.visual.field.themeImportInfoAria': 'Theme import info',
  'settings.ompchamber.visual.field.themeImportInfoTooltip': 'Import custom themes from ~/.config/ompchamber/themes/',
  'settings.ompchamber.visual.field.installAppName': 'Install App Name',
  'settings.ompchamber.visual.field.installAppNameHint': 'Used by PWA installation process.',
  'settings.ompchamber.visual.field.pwaInstallAppNameAria': 'PWA install app name',
  'settings.ompchamber.visual.actions.resetInstallAppNameAria': 'Reset install app name',
  'settings.ompchamber.visual.field.installOrientation': 'Install Orientation',
  'settings.ompchamber.visual.field.installOrientationHint': 'Used by the installed web app. Reinstall the PWA after changing this.',
  'settings.ompchamber.visual.field.pwaInstallOrientationAria': 'PWA install orientation',
  'settings.ompchamber.visual.field.selectOrientationPlaceholder': 'Select orientation',
  'settings.ompchamber.visual.actions.resetInstallOrientationAria': 'Reset install orientation',
  'settings.ompchamber.visual.field.mobileKeyboardMode': 'Mobile Keyboard Behavior',
  'settings.ompchamber.visual.field.mobileKeyboardModeHint': 'Default browser behavior is safest. Resize content asks supported browsers to shrink the app when the on-screen keyboard opens.',
  'settings.ompchamber.visual.field.mobileKeyboardModeAria': 'Mobile keyboard behavior',
  'settings.ompchamber.visual.field.selectMobileKeyboardModePlaceholder': 'Select keyboard behavior',
  'settings.ompchamber.visual.actions.resetMobileKeyboardModeAria': 'Reset mobile keyboard behavior',
  'settings.ompchamber.visual.field.interfaceFontSize': 'Interface Font Size',
  'settings.ompchamber.visual.field.interfaceFont': 'Interface Font',
  'settings.ompchamber.visual.field.selectInterfaceFontAria': 'Select interface font',
  'settings.ompchamber.visual.actions.resetInterfaceFontAria': 'Reset interface font',
  'settings.ompchamber.visual.field.fontSizePercentageAria': 'Font size percentage',
  'settings.ompchamber.visual.actions.resetFontSizeAria': 'Reset font size',
  'settings.ompchamber.visual.field.terminalFontSize': 'Terminal Font Size',
  'settings.ompchamber.visual.field.terminalShell': 'Terminal Shell',
  'settings.ompchamber.visual.field.terminalShellAria': 'Select terminal shell',
  'settings.ompchamber.visual.field.terminalShellHint': 'Restart the terminal to apply this change to the current session.',
  'settings.ompchamber.visual.field.terminalLoginShell': 'Start as login shell',
  'settings.ompchamber.visual.option.terminalShell.auto': 'Auto',
  'settings.ompchamber.visual.field.editorFontSize': 'Editor Font Size',
  'settings.ompchamber.visual.field.codeFont': 'Code Font',
  'settings.ompchamber.visual.field.selectCodeFontAria': 'Select code font',
  'settings.ompchamber.visual.actions.resetCodeFontAria': 'Reset code font',
  'settings.ompchamber.visual.actions.resetTerminalFontSizeAria': 'Reset terminal font size',
  'settings.ompchamber.visual.actions.resetEditorFontSizeAria': 'Reset editor font size',
  'settings.ompchamber.visual.field.spacingDensity': 'Spacing Density',
  'settings.ompchamber.visual.actions.resetSpacingAria': 'Reset spacing',
  'settings.ompchamber.visual.field.inputBarOffset': 'Input Bar Offset',
  'settings.ompchamber.visual.field.inputBarOffsetTooltip': 'Raise input bar to avoid OS-level screen obstructions like home bars.',
  'settings.ompchamber.visual.actions.resetInputBarOffsetAria': 'Reset input bar offset',
  'settings.ompchamber.visual.field.terminalQuickKeysAria': 'Terminal quick keys',
  'settings.ompchamber.visual.field.terminalQuickKeys': 'Terminal Quick Keys',
  'settings.ompchamber.visual.field.terminalQuickKeysTooltip': 'Show Esc, Ctrl, Arrows in terminal view',
  'settings.ompchamber.visual.field.fileEditorKeymap': 'File editor keymap',
  'settings.ompchamber.visual.option.fileEditorKeymap.default': 'Default',
  'settings.ompchamber.visual.option.fileEditorKeymap.vim': 'Vim',
  'settings.ompchamber.visual.field.activityDefaultModeAria': 'Activity default mode: {option}',
  'settings.ompchamber.visual.field.showExpandedBashToolsAria': 'Show expanded bash tools',
  'settings.ompchamber.visual.field.showExpandedEditToolsAria': 'Show expanded edit tools',
  'settings.ompchamber.visual.field.bash': 'Bash',
  'settings.ompchamber.visual.field.editTools': 'Edit tools',
  'settings.ompchamber.visual.field.userMessageRenderingAria': 'User message rendering: {option}',
  ...
  'settings.ompchamber.visual.field.sessionRecap': 'Generate Session Recap',
  'settings.ompchamber.visual.field.sessionRecapAria': 'Generate a recap after the agent finishes',
  'settings.ompchamber.visual.field.sessionSuggestion': 'Generate Next User Message Suggestion',
  'settings.ompchamber.visual.field.sessionSuggestionAria': 'Generate a suggested next user message after the agent finishes',
  'settings.ompchamber.visual.field.sessionGoal': 'Enable Session Goals',
  'settings.ompchamber.visual.field.sessionGoalAria': 'Keep the session working toward a goal automatically',
  'settings.ompchamber.visual.goal.sectionTitle': 'Goal',
  'settings.ompchamber.visual.goal.budgetLabel': 'Default token budget',
  'settings.ompchamber.visual.goal.budgetAria': 'Apply a default token budget to new goals',
  'settings.ompchamber.visual.goal.description': 'Arm the target button in the composer and the next message becomes a goal: the agent keeps working toward it automatically, audited by the small model, even while you are away.',
  'settings.ompchamber.visual.field.showReasoningTracesAria': 'Show reasoning traces',
  'settings.ompchamber.visual.field.showReasoningTraces': 'Show Reasoning Traces',
  'settings.ompchamber.visual.field.collapsibleThinkingBlocksAria': 'Enable collapsible reasoning blocks',
  'settings.ompchamber.visual.field.collapsibleThinkingBlocks': 'Enable Collapsible Reasoning Blocks',
  'settings.ompchamber.visual.field.collapsibleUserMessagesAria': 'Collapse long user messages',
  'settings.ompchamber.visual.field.collapsibleUserMessages': 'Collapse Long User Messages',
  'settings.ompchamber.visual.field.stickyUserHeaderAria': 'Sticky user header',
  'settings.ompchamber.visual.field.stickyUserHeader': 'Sticky User Header',
  ...
  'settings.ompchamber.visual.field.autoSaveEnabledAria': 'Auto-save files',
  'settings.ompchamber.visual.field.autoSaveEnabled': 'Auto-save files',
  'settings.ompchamber.visual.field.autoSaveEnabledInfo': 'Automatically save file edits after you stop typing. Disable to require manual save.',
  'settings.ompchamber.visual.field.wideChatLayoutAria': 'Wide chat layout',
  'settings.ompchamber.visual.field.wideChatLayout': 'Wide Chat Layout',
  'settings.ompchamber.visual.field.codeBlockLineWrapAria': 'Wrap code block lines',
  'settings.ompchamber.visual.field.codeBlockLineWrap': 'Wrap Code Block Lines',
  'settings.ompchamber.visual.field.showSplitAssistantMessageActionsAria': 'Inline assistant actions',
  'settings.ompchamber.visual.field.showSplitAssistantMessageActions': 'Inline Assistant Actions',
  'settings.ompchamber.visual.field.showSplitAssistantMessageActionsTooltip': 'Show Copy Answer, Save as image, and Read aloud on assistant text blocks that appear before later tool calls in the same response.',
  'settings.ompchamber.visual.field.allowPromptingSubagentSessionsAria': 'Allow prompting subagent sessions',
  'settings.ompchamber.visual.field.allowPromptingSubagentSessions': 'Allow Prompting Subagent Sessions',
  'settings.ompchamber.visual.field.draftStartersVisible': 'Show Starters on New Session Screen',
  'settings.ompchamber.visual.field.draftStartersVisibleAria': 'Show starters on the new session screen',
  'settings.ompchamber.visual.field.showToolFileIconsAria': 'Show tool file icons',
  'settings.ompchamber.visual.field.showToolFileIcons': 'Show Tool File Icons',
  'settings.ompchamber.visual.field.showTurnChangedFilesAria': 'Show changed files for completed turns',
  'settings.ompchamber.visual.field.showTurnChangedFiles': 'Show Changed Files for Completed Turns',
  'settings.ompchamber.visual.field.showDotfilesAria': 'Show dotfiles',
  'settings.ompchamber.visual.field.showDotfiles': 'Show Dotfiles',
  'settings.ompchamber.visual.field.queueMessagesByDefaultAria': 'Queue messages by default',
  'settings.ompchamber.visual.field.queueMessagesByDefault': 'Queue Messages by Default',
  'settings.ompchamber.visual.field.queueMessagesByDefaultTooltip': 'When enabled, Enter queues messages. Use {modifier}+Enter to send.',
  'settings.ompchamber.visual.field.persistDraftMessagesAria': 'Persist draft messages',
  'settings.ompchamber.visual.field.persistDraftMessages': 'Persist Draft Messages',
  'settings.ompchamber.visual.field.enableSpellcheckInTextInputsAria': 'Enable spellcheck in text inputs',
  'settings.ompchamber.visual.field.enableSpellcheckInTextInputs': 'Enable Spellcheck in Text Inputs',
  'settings.ompchamber.visual.field.sendAnonymousUsageReportsAria': 'Send anonymous usage reports',
  'settings.ompchamber.visual.field.sendAnonymousUsageReports': 'Send anonymous usage reports',
  'settings.ompchamber.visual.field.sendAnonymousUsageReportsHint': 'Helps us understand which app versions are actively used so we can prioritize improvements. Only app version, platform, and runtime are collected - no personal data or code.',
  'settings.ompchamber.visual.option.themeMode.system': 'System',
  'settings.ompchamber.visual.option.themeMode.system.description': 'Follow system setting',
  'settings.ompchamber.visual.option.themeMode.light': 'Light',
  'settings.ompchamber.visual.option.themeMode.light.description': 'Always use light appearance',
  'settings.ompchamber.visual.option.themeMode.dark': 'Dark',
  'settings.ompchamber.visual.option.themeMode.dark.description': 'Always use dark appearance',
  'settings.ompchamber.visual.option.diffLayout.dynamic.label': 'Dynamic',
  'settings.ompchamber.visual.option.diffLayout.dynamic.description': 'New inline, modified side-by-side.',
  'settings.ompchamber.visual.option.diffLayout.inline.label': 'Always inline',
  'settings.ompchamber.visual.option.diffLayout.inline.description': 'Show as a single unified view.',
  'settings.ompchamber.visual.option.diffLayout.sideBySide.label': 'Always side-by-side',
  'settings.ompchamber.visual.option.diffLayout.sideBySide.description': 'Compare original and modified files.',
  'settings.ompchamber.visual.option.mermaidRendering.svg.label': 'SVG',
  'settings.ompchamber.visual.option.mermaidRendering.svg.description': 'Render diagrams as scalable graphics.',
  'settings.ompchamber.visual.option.mermaidRendering.ascii.label': 'ASCII',
  'settings.ompchamber.visual.option.mermaidRendering.ascii.description': 'Render diagrams as text blocks.',
  'settings.ompchamber.visual.option.pwaOrientation.system.label': 'Follow system',
  'settings.ompchamber.visual.option.pwaOrientation.system.description': 'Respect the device rotation setting.',
  'settings.ompchamber.visual.option.pwaOrientation.portrait.label': 'Portrait lock',
  'settings.ompchamber.visual.option.pwaOrientation.portrait.description': 'Install the app locked to portrait.',
  'settings.ompchamber.visual.option.pwaOrientation.landscape.label': 'Landscape lock',
  'settings.ompchamber.visual.option.pwaOrientation.landscape.description': 'Install the app locked to landscape.',
  'settings.ompchamber.visual.option.mobileKeyboardMode.native.label': 'Follow browser',
  'settings.ompchamber.visual.option.mobileKeyboardMode.native.description': 'Use the browser default for panning and viewport changes when the keyboard opens.',
  'settings.ompchamber.visual.option.mobileKeyboardMode.resizeContent.label': 'Resize content',
  'settings.ompchamber.visual.option.mobileKeyboardMode.resizeContent.description': 'Ask supported browsers to shrink the app layout instead of relying only on panning.',
  'settings.ompchamber.visual.option.userMessageRendering.markdown.label': 'Markdown',
  'settings.ompchamber.visual.option.userMessageRendering.markdown.description': 'Render user text with markdown formatting.',
  'settings.ompchamber.visual.option.userMessageRendering.plain.label': 'Plain text',
  'settings.ompchamber.visual.option.userMessageRendering.plain.description': 'Render user text with preserved whitespace and links.',
  'chat.message.userText.collapseAria': 'Collapse user message',
  'settings.ompchamber.visual.option.chatRenderMode.sorted.label': 'Sorted',
  'settings.ompchamber.visual.option.chatRenderMode.sorted.description': 'Render completed assistant messages without live streaming.',
  'settings.ompchamber.visual.option.chatRenderMode.live.label': 'Live',
  'settings.ompchamber.visual.option.chatRenderMode.live.description': 'Stream assistant text and tools as they arrive.',
  'settings.ompchamber.visual.option.messageTransport.auto.label': 'Auto',
  'settings.ompchamber.visual.option.messageTransport.auto.description': 'Prefer WebSocket and fall back to SSE if needed.',
  'settings.ompchamber.visual.option.messageTransport.ws.label': 'WebSocket',
  'settings.ompchamber.visual.option.messageTransport.ws.description': 'Use WebSocket for message streaming.',
  'settings.ompchamber.visual.option.messageTransport.sse.label': 'SSE',
  'settings.ompchamber.visual.option.messageTransport.sse.description': 'Use Server-Sent Events for message streaming.',
  'settings.ompchamber.visual.option.activityRenderMode.collapsed.label': 'Collapsed',
  'settings.ompchamber.visual.option.activityRenderMode.collapsed.description': 'Keep Activity collapsed by default.',
  'settings.ompchamber.visual.option.activityRenderMode.summary.label': 'Expanded',
  'settings.ompchamber.visual.option.activityRenderMode.summary.description': 'Expand Activity by default.',
  'settings.ompchamber.visual.option.timeFormat.auto.label': 'Auto',
  'settings.ompchamber.visual.option.timeFormat.auto.description': 'Use system locale preference.',
  'settings.ompchamber.visual.option.timeFormat.24h.label': '24-hour',
  'settings.ompchamber.visual.option.timeFormat.24h.description': 'Show time as 14:15.',
  'settings.ompchamber.visual.option.timeFormat.12h.label': '12-hour',
  'settings.ompchamber.visual.option.timeFormat.12h.description': 'Show time as 02:15 PM.',
  'settings.ompchamber.visual.option.weekStart.auto.label': 'Auto',
  'settings.ompchamber.visual.option.weekStart.auto.description': 'Use locale week start.',
  'settings.ompchamber.visual.option.weekStart.monday.label': 'Monday',
  'settings.ompchamber.visual.option.weekStart.sunday.label': 'Sunday',
