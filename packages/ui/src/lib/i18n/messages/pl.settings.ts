...
export const settingsDict = {
  ...
  'settings.openchamber.about.title': 'O OMPChamber',
  ...
  'settings.openchamber.desktopNetwork.field.launchAtLogin': 'Uruchamiaj OMPChamber przy logowaniu',
  'settings.openchamber.desktopNetwork.field.launchAtLoginAria': 'Uruchamiaj OMPChamber przy logowaniu',
  ...
  'settings.openchamber.desktopNetwork.field.macMenuBarAria': 'Pokazuj OMPChamber na pasku menu macOS',
  'settings.openchamber.desktopNetwork.field.macMenuBar': 'Pokazuj OMPChamber na pasku menu',
  'settings.openchamber.desktopNetwork.field.macMenuBarDescription': 'Wymaga ponownego uruchomienia aplikacji. Po wyłączeniu OMPChamber nie tworzy elementu paska menu ani nie uruchamia aktualizacji sesji, zatwierdzeń i użycia.',
  'settings.openchamber.desktopNetwork.field.minimizeToTrayAria': 'Zamykaj OMPChamber do zasobnika systemowego',
  'settings.openchamber.desktopNetwork.field.minimizeToTray': 'Zamykaj do zasobnika systemowego',
  'settings.openchamber.desktopNetwork.field.minimizeToTrayDescription': 'Utrzymuje OMPChamber w zasobniku systemowym, gdy główne okno zostanie zamknięte. Minimalizacja pozostawia okno na pasku zadań.',
  'settings.openchamber.desktopNetwork.field.keepAwakeAria': 'Utrzymuj komputer aktywny, gdy OMPChamber jest uruchomiony',
  'settings.openchamber.desktopNetwork.field.keepAwake': 'Utrzymuj komputer aktywny, gdy OMPChamber jest uruchomiony',
  ...
  'settings.openchamber.desktopPassword.field.passwordDescription': 'OMPChamber pyta po restarcie, a potem po wygaśnięciu sesji logowania: po 12 godzinach albo po 7 dniach z opcją Zaufaj temu urządzeniu. Zostaw puste, aby wyłączyć logowanie.',
  ...
  'settings.openchamber.tools.title': 'Narzędzia OMPChamber',
  ...
  'settings.openchamber.tools.field.agentWebTool': 'Narzędzie OMPChamber Web',
  'settings.openchamber.tools.field.agentWebToolAria': 'Włącz narzędzie OMPChamber Web',
  ...
  'settings.openchamber.tunnel.tooltip.tokensSavedPath': 'Tokeny są zapisywane w ~/.config/ompchamber/cloudflare-managed-remote-tunnels.json.',
  ...
  'settings.openchamber.visual.field.themeImportInfoTooltip': 'Importuj własne motywy z ~/.config/ompchamber/themes/',
  ...
  'settings.remoteInstances.page.phase.installingOpenChamber': 'Instalowanie OMPChamber',
  ...
  'settings.remoteInstances.page.phase.updatingOpenChamber': 'Aktualizowanie OMPChamber',
