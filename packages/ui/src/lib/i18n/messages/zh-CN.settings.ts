...
'settings.view.home.cards.plugins.description': '管理 OMP 插件',
  ...
  'settings.openchamber.tunnel.tooltip.tokensSavedPath': 'Token 保存在 ~/.config/ompchamber/cloudflare-managed-remote-tunnels.json。',
...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.openchamber.about.title': '关于 OMPChamber',
  ...
  'settings.openchamber.desktopNetwork.field.launchAtLoginAria': '登录时启动 OMPChamber',
  'settings.openchamber.desktopNetwork.field.launchAtLogin': '登录时启动 OMPChamber',
  'settings.openchamber.desktopNetwork.field.launchAtLoginDescription': '在后台启动应用且不打开窗口。可通过桌面状态图标打开。',
  'settings.openchamber.desktopNetwork.field.macMenuBarAria': '在 macOS 菜单栏中显示 OMPChamber',
  'settings.openchamber.desktopNetwork.field.macMenuBar': '在菜单栏中显示 OMPChamber',
  'settings.openchamber.desktopNetwork.field.macMenuBarDescription': '需要重启应用。关闭后，OMPChamber 不会创建菜单栏项目，也不会运行相关的会话、审批和用量更新。',
  'settings.openchamber.desktopNetwork.field.minimizeToTrayAria': '将 OMPChamber 关闭到系统托盘',
  'settings.openchamber.desktopNetwork.field.minimizeToTray': '关闭到系统托盘',
  'settings.openchamber.desktopNetwork.field.minimizeToTrayDescription': '关闭主窗口时，让 OMPChamber 继续在系统托盘中运行；最小化仍会将窗口保留在任务栏。',
  'settings.openchamber.desktopNetwork.field.keepAwakeAria': 'OMPChamber 运行时保持电脑唤醒',
  'settings.openchamber.desktopNetwork.field.keepAwake': 'OMPChamber 运行时保持电脑唤醒',
  ...
  'settings.openchamber.desktopPassword.field.passwordDescription': 'OMPChamber 会在重启后要求输入密码，之后在登录会话过期时再次要求：12 小时后，或选择“信任此设备”后 7 天。留空可关闭登录。',
  ...
  'settings.openchamber.tools.title': 'OMPChamber 工具',
  ...
  'settings.openchamber.tools.field.agentWebTool': 'OMPChamber Web 工具',
  'settings.openchamber.tools.field.agentWebToolAria': '启用 OMPChamber Web 工具',
  'settings.openchamber.tools.field.agentWebToolInfo': '让智能体在 OMPChamber 浏览器面板中查看并操作页面：打开网址、读取内容、点击、输入、滚动，以及在移动端与桌面端布局之间切换。会为每个会话添加少量工具说明。在 OpenCode 重启后生效。',
  ...
  'settings.remoteInstances.page.phase.installingOpenChamber': '正在安装 OMPChamber',
  'settings.remoteInstances.page.phase.updatingOpenChamber': '正在更新 OMPChamber',
  ...
  'settings.openchamber.visual.field.themeImportInfoTooltip': '从 ~/.config/ompchamber/themes/ 导入自定义主题',
