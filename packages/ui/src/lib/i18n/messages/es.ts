...
export const dict: Record<I18nKey, string> = {
  ...
  'terminalView.actions.takeControl': 'Tomar el control del tamaño',
  'terminalView.actions.releaseControl': 'Liberar el control del tamaño',
  'terminalView.status.driving': 'Controlando',
  'terminalView.status.following': 'Siguiendo',
  'terminalView.actions.zoomIn': 'Acercar la terminal',
  'terminalView.actions.zoomOut': 'Alejar la terminal',
  'terminalView.actions.zoomReset': 'Restablecer el zoom de la terminal (100%)',
  'terminalView.driverState.idleHint': 'El tamaño sigue a la ventana más pequeña — clic para tomar el control',
  'terminalView.driverState.drivingHint': 'Estás controlando el tamaño ({cols}×{rows}) — clic para liberar',
  'terminalView.driverState.followingHint': 'Otro dispositivo está controlando ({cols}×{rows}) — clic para tomar el control',
  'terminalView.actions.killSession': 'Cerrar sesión (desconecta TODOS los dispositivos)',
  'terminalView.actions.killSessionArmed': 'Haz clic de nuevo para cerrar en todos',
  ...
  'pwa.installPrompt.description': 'Instala OMPChamber para acceder más rápido',
  'pwa.installPrompt.action': 'Instalar',
  'pwa.installPrompt.dismiss': 'Descartar',
  'pwa.installPrompt.started': 'Instalación iniciada',
  'pwa.installPrompt.installed': 'OMPChamber se instaló',
  ...
  "layout.header.subagentsRunning": "En curso: {count}",
  'mobile.nav.aria': 'Navegación móvil',
  'mobile.connect.welcome.title': 'Conéctate a OMPChamber',
  ...
  'mobile.connect.password.placeholder': 'Contraseña de OMPChamber',
  ...
  'mobile.connect.scan.invalid': 'Ese código QR no es un código de conexión de OMPChamber.',
  ...
  'mobile.connect.relay.badge': 'a través de OMPChamber Relay',
  ...
  'mobile.connect.error.unreachable': 'No se pudo conectar con ese servidor de OMPChamber.',
  ...
  'sessions.scheduledTasks.editor.persona.ariaLabel': 'Persona de la sesión',
  'sessions.scheduledTasks.editor.persona.standard': 'Estándar',
  'sessions.scheduledTasks.editor.persona.unavailable': 'No disponible',
  ...
  'sessions.sidebar.session.status.resident': 'Residente en memoria',
  'sessions.sidebar.session.status.residentWithSize': 'Residente en memoria · transcript ~{size}',
  'sessions.sidebar.session.status.residentShort': 'Residente en memoria',
  ...
  'walkthrough.blocked.serverUnsupported.description': 'El servidor de OMPChamber al que está conectada esta app no respondió a la API de walkthrough, así que es más antiguo que la app. Actualiza el servidor a 1.18 o posterior y vuelve a intentarlo.',
  ...
  'contextPanel.browser.tunnelFailedHint': '{url} se ejecuta en la máquina donde está OMPChamber y no se pudo abrir la conexión con ella. Aquí no se muestra nada de tu propia máquina.',
  ...
  'contextPanel.browser.devServers.remoteOnly': 'Se ejecutan en la máquina que aloja OMPChamber. Abrirlos requiere la aplicación de escritorio.',
  ...
  'contextPanel.browser.trustNotice': 'Las páginas que abras aquí se ejecutan con acceso completo a OMPChamber: necesario para la inspección y las capturas. Abre solo sitios de confianza: una página maliciosa podría leer tus datos o actuar en tu nombre.',
  ...
  'filesView.editor.binaryFileDescription': 'Este archivo es binario y no se puede editar en OMPChamber. Descárgalo para abrirlo con otra aplicación.',
  ...
  'terminalView.tabs.unreadTitle': 'Salida de comandos sin leer',
  ...
  'directoryExplorerDialog.browse.permissionDenied': 'OMPChamber necesita acceso a esta carpeta.',
  ...
  'aboutDialog.openChamberVersionLabel': 'Versión de OMPChamber {version}',
  'aboutDialog.openCodeVersionLabel': 'Versión del motor {version}',
  ...
  'aboutDialog.diagnosticsDescription': 'Incluye el estado de OMPChamber, el estado del motor, directorios y proyectos.',
  ...
  'helpDialog.description': 'Usa estos atajos de teclado para navegar por OMPChamber de manera eficiente',
  ...
  'header.actions.openAppMenu': 'Menú de OMPChamber',
  'header.actions.openAppMenuAria': 'Abrir menú de OMPChamber',
  ...
  'chat.retry.supersededBadge': 'Sustituido por un reintento',
  ...
  'chat.chat.ompDivider.developerNote': 'nota inyectada',
  'chat.omp.ttsrWarning.title': 'Reglas de seguimiento activadas',
  'chat.omp.ttsrWarning.dismissAria': 'Descartar aviso',
  'chat.omp.strippedToolCalls.one': '{count} llamada de herramienta omitida en esta rama, sin resultado',
  'chat.omp.strippedToolCalls.many': '{count} llamadas de herramienta omitidas en esta rama, sin resultado',
  'chat.omp.customCard.moreEntries': '+{count} más',
  'chat.omp.cacheMiss.label': 'fallo de caché',
  'chat.omp.cacheMiss.tokens': '{tokens} tokens',
  'toast.ompNotice.title.info': 'Aviso',
  'toast.ompNotice.title.warning': 'Advertencia',
  'toast.ompNotice.title.error': 'Error',
  ...
  'chat.emptyState.opencodeUnreachable': 'El motor no es accesible',
  ...
  'chat.message.fallbackTag': 'sustitución',
  'chat.statusRow.compacting': 'Compactando el contexto…',
  ...
  'chat.workStatus.goal.status.paused': 'en pausa',
  'chat.workStatus.goal.status.complete': 'completado',
  'chat.workStatus.goal.status.budgetLimited': 'límite de presupuesto',
  ...
  'chat.toast.opencodeRestartInterrupted.description': 'El motor se reinició mientras aún se estaba generando una respuesta. Envía un mensaje para continuar.',
  ...
  'chat.commandAutocomplete.badge.ompOverride': 'reemplaza a OMPChamber',
  'chat.chatInput.toast.debugRenamed': 'El motor ahora usa /debug. El comando de depuración guiada de OMPChamber pasó a /troubleshoot.',
  'chat.sessionTree.title': 'Ramas de la sesión',
  'chat.sessionTree.description': 'Bifurcaciones de esta sesión. Selecciona una rama para abrir su cronología.',
  'chat.sessionTree.loading': 'Cargando ramas…',
  'chat.sessionTree.error': 'No se pudo cargar el árbol de la sesión.',
  'chat.sessionTree.empty': 'Esta sesión no tiene bifurcaciones.',
  'chat.sessionTree.untitled': 'Sin título',
  'chat.sessionTree.current': 'actual',
  'chat.sessionTree.leaf': 'más reciente',
  'chat.sessionTree.openBranch': 'Abrir rama {title}',
  ...
  'chat.toolPart.askQuestionsCount': '{count} preguntas',
  'chat.toolPart.askNoSelection': 'Sin respuesta',
  'chat.toolPart.askCustomAnswer': 'Respuesta personalizada',
  'chat.toolPart.askNote': 'Nota',
  'chat.toolPart.askAutoSelected': 'seleccionado automáticamente tras agotarse el tiempo — no es una elección del usuario',
  'chat.toolPart.askChatRedirect': 'El usuario eligió hablar de esto en el chat en lugar de responder',
  'chat.toolPart.taskAgent.status.pending': 'Pendiente',
  'chat.toolPart.taskAgent.status.running': 'En curso',
  'chat.toolPart.taskAgent.status.completed': 'Completado',
  'chat.toolPart.taskAgent.status.failed': 'Fallido',
  'chat.toolPart.taskAgent.status.aborted': 'Abortado',
  'chat.toolPart.taskAgent.retrying': 'Reintento {attempt}/{maxAttempts}',
  'chat.toolPart.taskAgent.retriesExhausted': 'Reintentos agotados ({attempt})',
  'chat.toolPart.taskAgent.moreAgents': '+{count} más',
  ...
  'chat.modelControls.roles.sectionTitle': 'Roles de modelo',
  'chat.modelControls.roles.notConfigured': 'Sin configurar',
  ...
  'chat.modelControls.setAsRole.failed': 'No se pudo asignar el rol',
  'chat.modelControls.setAsRole.rejected.role-already-configured': 'El rol ya tiene un modelo configurado',
  'chat.modelControls.enabledWarning': 'El modelo actual no está en enabledModels',
  'chat.modeSelector.label.default': 'Predeterminado',
  'chat.modeSelector.label.plan': 'Plan',
  'chat.modeSelector.label.planPaused': 'Plan (en pausa)',
  'chat.modeSelector.label.goal': 'Objetivo',
  'chat.modeSelector.label.goalPaused': 'Objetivo (en pausa)',
  'chat.modeSelector.label.vibe': 'Vibe',
  'chat.modeSelector.label.loop': 'Bucle',
  'chat.modeSelector.ariaLabel': 'Modo de sesión',
  'chat.modeSelector.title': 'Modo',
  'chat.modeSelector.requiresSession': 'Inicia la sesión para cambiar su modo',
  'chat.modeSelector.changeFailed': 'No se pudo cambiar el modo de la sesión.',
  'chat.modeSelector.conflict': 'Sal primero del modo {mode}.',
  'chat.personaSelector.ariaLabel': 'Persona de la sesión',
  'chat.extensionWidgets.ariaLabel': 'Widgets de extensiones',
  'chat.personaSelector.title': 'Persona',
  'chat.personaSelector.standard': 'Estándar',
  'chat.personaSelector.sectionTitle': 'Persona de la sesión',
  'chat.goalIndicator.title': 'Objetivo',
  'chat.goalIndicator.status.active': 'Activo',
  'chat.goalIndicator.status.paused': 'En pausa',
  'chat.goalIndicator.status.complete': 'Completado',
  'chat.goalIndicator.status.budgetLimited': 'Límite de presupuesto',
  'chat.goalIndicator.status.dropped': 'Abandonado',
  'chat.goalIndicator.noObjective': 'Sin objetivo registrado',
  ...
  'commandPalette.item.toggleMemoryDebug': 'Alternar panel de depuración',
  ...
  'openCodeStatusDialog.title': 'Estado del motor',
  'openCodeStatusDialog.description': 'Inspecciona el estado actual del motor y los diagnósticos.',
  ...
  'openCodeStatusDialog.memory.title': 'Memoria del motor',
  'openCodeStatusDialog.memory.refreshNote': 'se actualiza cada 5 s mientras está abierto',
  'openCodeStatusDialog.memory.loading': 'Cargando…',
  'openCodeStatusDialog.memory.unavailable': 'Este motor no admite diagnósticos de memoria.',
  'openCodeStatusDialog.memory.error': 'No se pudieron cargar los diagnósticos de memoria.',
  'openCodeStatusDialog.memory.processHeap': 'Heap del proceso',
  'openCodeStatusDialog.memory.processRss': 'RSS del proceso',
  'openCodeStatusDialog.memory.processExternal': 'Externa + búferes',
  'openCodeStatusDialog.memory.residentEstimate': 'Sesiones residentes (est.)',
  'openCodeStatusDialog.memory.sessionsTitle': 'Sesiones residentes: {live} activas · {total} en total',
  'openCodeStatusDialog.memory.sessionsStates': 'materializando {materializing} · desalojando {evicting} · con error {failed}',
  'openCodeStatusDialog.memory.noResident': 'No hay sesiones residentes.',
  'openCodeStatusDialog.memory.truncated': 'Lista truncada: se muestran las sesiones residentes más grandes.',
  'openCodeStatusDialog.memory.colSession': 'Sesión',
  'openCodeStatusDialog.memory.colDirectory': 'Directorio',
  'openCodeStatusDialog.memory.colState': 'Estado',
  'openCodeStatusDialog.memory.colSize': '~Tamaño',
  'openCodeStatusDialog.memory.colIdle': 'Inactiva',
  'openCodeStatusDialog.memory.wireBus': 'Búfer de eventos wire',
  'openCodeStatusDialog.memory.ompBus': 'Búfer de eventos OMP',
  'openCodeStatusDialog.memory.busValue': '{entries} entradas · {size} (límite {capacity})',
  'openCodeStatusDialog.memory.wireIdEchoes': 'Ecos de Wire-ID',
  'openCodeStatusDialog.memory.inFlightUnderflow': 'Subdesbordes de inFlight',
  'openCodeStatusDialog.memory.estimateNote': 'Los tamaños de sesión son estimaciones según el tamaño del transcript (~1,3× el heap residente), no una atribución medida por sesión.',
  'openCodeStatusDialog.monitor.tabOverview': 'Resumen',
  'openCodeStatusDialog.monitor.tabSessions': 'Sesiones',
  'openCodeStatusDialog.monitor.residentCount': '{total} residentes',
  'openCodeStatusDialog.monitor.catSessions': 'Sesiones residentes (est.)',
  'openCodeStatusDialog.monitor.catBuffers': 'Búferes de eventos',
  'openCodeStatusDialog.monitor.catUnattributed': 'Motor no atribuido',
  'openCodeStatusDialog.monitor.processMonitor': 'Monitor de procesos',
  'openCodeStatusDialog.monitor.processMonitorValue': '{live} activos · {windows} llamadas · {failures} muestras fallidas',
  'openCodeStatusDialog.monitor.stateLive': 'activa',
  'openCodeStatusDialog.monitor.stateMaterializing': 'cargando',
  'openCodeStatusDialog.monitor.stateEvicting': 'desalojando',
  'openCodeStatusDialog.monitor.stateFailed': 'con error',
  'openCodeStatusDialog.monitor.largeOnly': 'Solo ≥10 MB',
  'openCodeStatusDialog.monitor.noLarge': 'No hay sesiones residentes ≥10 MB.',
  'openCodeStatusDialog.monitor.colAction': 'Acción',
  'openCodeStatusDialog.monitor.release': 'Liberar',
  'openCodeStatusDialog.monitor.releaseHint': 'Desalojar de la memoria — el transcript permanece en disco',
  'openCodeStatusDialog.monitor.releaseBusy': 'La sesión sigue activa — no se puede liberar.',
  'openCodeStatusDialog.monitor.releaseFailed': 'No se pudo liberar la sesión.',
  ...
  'sessionAuth.error.networkDescription': 'No pudimos verificar la sesión de la UI. Si abres OMPChamber desde otro dispositivo en tu red local, activa Desktop Network Access en la app de escritorio y usa la dirección LAN que aparece en Ajustes.',
  ...
  'desktopHostSwitcher.description': 'Cambia entre Local y el servidor remoto de OMPChamber',
  ...
  'multiRun.window.description': 'Ventana de OMPChamber Multi-Run.',
  ...
  'onboarding.remoteConnection.description': 'Introduce la dirección de un servidor de OMPChamber para conectar.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'Sugerencias: Verifica que la URL apunte a un servidor OMPChamber o contacta al administrador del servidor.',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': 'Esta instancia ejecuta una versión diferente de OMPChamber. Puedes conectarte, pero actualiza ambas apps si algo no funciona.',
  'onboarding.remoteConnection.probe.incompatibleMessage': 'El servidor ejecuta OMPChamber pero no es compatible con esta versión de la app. Actualiza OMPChamber en el servidor y vuelve a intentarlo.',
  'onboarding.remoteConnection.probe.wrongServiceMessage': 'El servidor respondió pero no está ejecutando OMPChamber. Verifica que la dirección apunte a un servidor OMPChamber.',
  ...
  'onboarding.desktopRecovery.localUnavailable.title': 'Motor local no disponible',
  'onboarding.desktopRecovery.localUnavailable.description': 'El motor local no pudo iniciarse. Reintenta el inicio o conéctate a un servidor remoto en su lugar.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': 'El servidor en \\"{host}\\" no está ejecutando OMPChamber. Verifica que la dirección apunte a un servidor OMPChamber.',
  'onboarding.desktopRecovery.remoteIncompatible.title': 'Actualización del servidor requerida',
  'onboarding.desktopRecovery.remoteIncompatible.description': 'El servidor OMPChamber en \\"{host}\\" no es compatible con esta versión de la app. Actualiza OMPChamber en el servidor y vuelve a intentarlo.',
  ...
  'startup.initRecovery.description': 'OMPChamber no pudo completar la inicialización. Comprueba que el servidor esté en ejecución y vuelve a intentarlo.',
  ...
  'updateDialog.header.updating': 'Actualizando OMPChamber...',
  ...
  'updateDialog.error.takingLonger': 'La actualización está tardando más de lo esperado. Espera un poco y refresca, o ejecuta: ompchamber update',
  'updateDialog.error.signatureRejected': 'La actualización descargada fue rechazada: su firma de código no coincide con esta instalación. Normalmente significa que la copia en ejecución no se instaló desde una versión oficial firmada. Instala OMPChamber desde una versión oficial y vuelve a actualizar.',
  'updateDialog.error.updaterDisabled': 'El actualizador se detuvo tras una instalación fallida. Cierra OMPChamber, ábrelo de nuevo y reintenta la actualización.',
  'updateDialog.error.restartFailed': 'No se pudo reiniciar para instalar la actualización.',
  'updateDialog.error.restartUnavailable': 'Instalar la actualización requiere la aplicación de escritorio de OMPChamber.',
  'mobileUpdate.toast.available.title': 'Actualización de OMPChamber disponible',
  ...
  'memoryDebugPanel.resizeHandle': 'Arrastrar para ajustar el ancho del panel',
  'memoryDebugPanel.metricName.sidebarScrollAnchorAdjustment': 'Ajuste de anclaje de desplazamiento de barra lateral',
  'memoryDebugPanel.metricName.sidebarSessionNodeRender': 'Renderizado de fila de sesión de barra lateral',
  'memoryDebugPanel.metricName.sidebarSessionNodePropsChanged': 'Props de sesión de barra lateral modificadas',
  'memoryDebugPanel.metricName.globalSessionsEventUpdateDeferred': 'Actualización de evento de sesión diferida',
  'memoryDebugPanel.metricName.globalSessionsEventUpdateImmediate': 'Actualización de evento de sesión inmediata',
  'memoryDebugPanel.metricName.globalSessionsEventUpdatePublication': 'Publicación de actualización de evento de sesión',
  'memoryDebugPanel.metricName.sidebarProjectSectionReused': 'Secciones de proyecto reutilizadas',
  'memoryDebugPanel.metricName.sidebarProjectSectionRebuilt': 'Secciones de proyecto reconstruidas',
  'memoryDebugPanel.metricName.sidebarProjectSectionRebuiltReason': 'Motivo de reconstrucción de sección de proyecto',
  'memoryDebugPanel.metricName.sidebarProjectsListRender': 'Renderizado de lista de proyectos',
  'memoryDebugPanel.metricName.sessionSidebarRender': 'Renderizado de barra lateral de sesión',
  'memoryDebugPanel.metricName.sessionSidebarSource': 'Origen de barra lateral de sesión',
  'memoryDebugPanel.metricName.headerRender': 'Renderizado de cabecera',
  'memoryDebugPanel.metricName.assistantTextRender': 'Renderizado de texto del asistente',
  'memoryDebugPanel.metricName.assistantTextDisplayLen': 'Longitud de texto del asistente mostrado',
  'memoryDebugPanel.metricName.messageListEntryRender': 'Renderizado de entrada de lista de mensajes',
  'memoryDebugPanel.metricName.messageListRender': 'Renderizado de lista de mensajes',
  'memoryDebugPanel.metricName.messageListBaseDisplayMs': 'Visualización base de lista de mensajes (ms)',
  'memoryDebugPanel.metricName.messageListRetryOverlayMs': 'Overlay de reintento de lista de mensajes (ms)',
  'memoryDebugPanel.metricName.messageListRenderEntriesMs': 'Renderizado de entradas de lista de mensajes (ms)',
  'memoryDebugPanel.metricName.markdownRender': 'Renderizado de Markdown',
  'memoryDebugPanel.metricName.markdownContentLen': 'Longitud de contenido Markdown',
  'memoryDebugPanel.metricName.markdownDomCache': 'Caché DOM de Markdown',
  'memoryDebugPanel.metricName.markdownSettledPaintReused': 'Pintura estable de Markdown reutilizada',
  'memoryDebugPanel.metricName.chatMessageRender': 'Renderizado de mensaje de chat',
  'memoryDebugPanel.metricName.turnsProjectionMs': 'Proyección de turno (ms)',
  'memoryDebugPanel.metricName.vscodeWebviewSseChunk': 'Fragmento SSE del webview',
  'memoryDebugPanel.metricName.vscodeWebviewSseChunkBytes': 'Bytes de fragmento SSE del webview',
  'memoryDebugPanel.metricName.vscodeWebviewSseEnd': 'Fin de SSE del webview',
  'memoryDebugPanel.metricName.vscodeWebviewSseStartMs': 'Inicio de SSE del webview (ms)',
  ...
  'openChamberLogo.aria.logo': 'Logo de OMPChamber',
  ...
  'chat.workStatus.section.processes': 'Procesos',
  'chat.workStatus.processes.running': 'en ejecución',
  'chat.workStatus.processes.exited': 'finalizado',
  'chat.workStatus.processes.killed': 'terminado',
  'chat.workStatus.processes.failed': 'fallido',
  'chat.workStatus.processes.uncertain': 'atribución incierta',
  'chat.workStatus.processes.kill': 'Matar',
  'chat.workStatus.processes.killAll': 'Matar todos',
  'chat.workStatus.processes.killConfirm': '¿Seguro?',
  'chat.workStatus.processes.view': 'Ver {command}',
  'chat.workStatus.processes.viewAll': 'Ver todos los procesos',
  'chat.workStatus.processes.output': 'Salida',
  'chat.workStatus.processes.command': 'Comando',
  'chat.workStatus.processes.cpu': 'CPU',
  'chat.workStatus.processes.memory': 'Memoria',
  'chat.workStatus.processes.liveCount': '{count} vivos',
  'chat.workStatus.processes.endedCount': '{count} finalizados',
  'chat.workStatus.processes.statsStale': 'datos obsoletos',
  ...
  'chat.workStatus.section.localFiles': 'Archivos locales de sesión',
  ...
  'chat.workStatus.action.openAgentRun': 'Abrir ejecución {name}',
  'chat.toolPart.taskAgent.openArtifact': 'Abrir artefacto de salida',
  'chat.toolPart.taskAgent.openRun': 'Abrir ejecución',
  ...
  'dialogs.omp.approval.title': 'Aprobación necesaria',
  'dialogs.omp.planReview.choice.approveExecute': 'Aprobar y ejecutar',
  'dialogs.omp.planReview.choice.approveCompact': 'Aprobar y compactar el contexto',
  'dialogs.omp.planReview.choice.approveKeep': 'Aprobar y conservar el contexto',
  'dialogs.omp.planReview.choice.refine': 'Refinar el plan',
  'dialogs.omp.planReview.planReady': 'Plan listo para revisión.',
  'dialogs.omp.planReview.planMissing': 'No se encontró el archivo del plan. Puedes revisar la propuesta de todos modos.',
  'dialogs.omp.planReview.loadingPlan': 'Cargando el plan…',
  'dialogs.omp.planReview.contentUnavailable': 'El contenido del plan no está disponible. Puedes decidir de todos modos.',
  'dialogs.omp.planReview.editMode': 'Editar el plan',
  'dialogs.omp.planReview.previewMode': 'Vista previa',
  'dialogs.omp.planReview.editAreaLabel': 'Contenido editado del plan',
  'dialogs.omp.planReview.feedbackLabel': 'Comentarios de refinamiento',
  'dialogs.omp.planReview.feedbackPlaceholder': '¿Qué debería cambiar en el plan?',
  'dialogs.omp.planReview.refineCancel': 'Cancelar',
  'dialogs.omp.planReview.refineSubmit': 'Enviar comentarios',
  'dialogs.omp.planReview.refineSubmitted': 'Comentarios enviados. El plan se revisará.',
  'dialogs.omp.planReview.submitting': 'Trabajando…',
  'dialogs.omp.planReview.decisionFailed': 'No se pudo enviar la decisión de revisión.',
  'dialogs.omp.planReview.unavailable': 'La revisión del plan no está disponible.',
  'dialogs.omp.approval.bodyAria': 'Solicitud de aprobación de herramienta',
  'dialogs.omp.approval.approve': 'Aprobar',
  'dialogs.omp.approval.deny': 'Denegar',
  'dialogs.omp.approval.alwaysAllow': 'Permitir siempre esta herramienta (guarda ajustes) y aprobar',
  'dialogs.omp.approval.alwaysAllowConfirm': 'Guardar ajuste y aprobar',
  'dialogs.omp.approval.alwaysAllowConfirmBody': 'Escribe tools.approval.{tool} = allow en tus ajustes globales de omp y luego aprueba esta solicitud.',
  'dialogs.omp.approval.alwaysAllowCancel': 'Volver',
  'dialogs.omp.approval.alwaysAllowFailed': 'No se pudo guardar el ajuste. No se aprobó nada; el diálogo permanece abierto.',
  'dialogs.omp.approval.respondFailed': 'Error al responder',
  'dialogs.omp.ask.title': 'Preguntas',
  'dialogs.omp.ask.summaryTab': 'Resumen',
  'dialogs.omp.ask.noAnswer': 'Sin respuesta',
  'dialogs.omp.ask.recommended': 'Recomendado',
  'dialogs.omp.ask.other': 'Otro (escribe el tuyo)',
  'dialogs.omp.ask.otherPlaceholder': 'Escribe tu respuesta…',
  'dialogs.omp.ask.note': 'Nota (opcional)',
  'dialogs.omp.ask.chatAboutThis': 'Hablar de esto',
  'dialogs.omp.ask.next': 'Siguiente',
  'dialogs.omp.ask.submit': 'Enviar',
  'dialogs.omp.ask.respondFailed': 'Error al responder',
  'dialogs.omp.queue.moreWaiting': '{count} más en espera',
  'dialogs.omp.select.title': 'Elige una opción',
  'dialogs.omp.confirm.yes': 'Sí',
  'dialogs.omp.confirm.no': 'No',
  'dialogs.omp.generic.cancel': 'Cancelar',
  'dialogs.omp.input.submit': 'Enviar',
  'dialogs.omp.notify.backgroundTitle': 'La sesión necesita tu respuesta',
  'dialogs.omp.notify.backgroundBody': 'La sesión {session} espera una respuesta',
  'dialogs.omp.tray.approvalRow': 'Sesión {session} — requiere aprobación',
  'dialogs.omp.tray.approvalRowWithTool': 'Sesión {session} — {tool} requiere aprobación',
  'dialogs.omp.tray.askRow': 'Sesión {session} — preguntas pendientes',
  'dialogs.omp.workStatus.waitingAnswer': 'esperando tu respuesta',
  'dialogs.internalUri.dialogDescription': 'Contenido del recurso interno',
  'dialogs.internalUri.linkTitle': 'Abrir recurso interno',
  'dialogs.internalUri.copyUrl': 'Copiar enlace',
  'dialogs.internalUri.copied': 'Enlace copiado',
  'dialogs.internalUri.copyFailed': 'No se pudo copiar el enlace',
  'dialogs.internalUri.loading': 'Resolviendo recurso…',
  'dialogs.internalUri.immutableBadge': 'Solo lectura',
  'dialogs.internalUri.error.unavailable': 'Este servidor no expone recursos internos.',
  'dialogs.internalUri.error.tooLarge': 'El recurso es demasiado grande para mostrarlo ({size}).',
  'dialogs.internalUri.error.resolveFailed': 'No se pudo resolver este recurso.',
  'dialogs.internalUri.error.binaryFailed': 'No se pudo cargar este archivo para la vista previa.',
  'contextPanel.localFiles.title': 'Archivos locales de sesión',
  'contextPanel.localFiles.description': 'Exploración de solo lectura de los archivos local:// privados de esta sesión.',
  'contextPanel.localFiles.noDirectory': 'No hay ningún directorio de proyecto activo.',
  'contextPanel.localFiles.noSession': 'Ninguna sesión seleccionada.',
  'contextPanel.localFiles.filesLoading': 'Cargando archivos…',
  'contextPanel.localFiles.filesError': 'No se pudieron cargar los archivos.',
  'contextPanel.localFiles.emptyFiles': 'Esta sesión no tiene archivos local://.',
  'contextPanel.localFiles.openFile': 'Abrir {ref}',
  'contextPanel.localFiles.truncated': 'Lista truncada: hay más archivos.',
  'contextPanel.localFiles.backToFiles': 'Archivos del espacio de trabajo',
  'contextPanel.localFiles.scopeAria': 'Cambiar ámbito del árbol de archivos',
  'contextPanel.localFiles.browseHint': 'Elige un archivo del árbol de esta sesión.',
  'contextPanel.localFiles.previewFailed': 'No se pudo cargar este archivo para la vista previa.',
  'contextPanel.mode.timeline': 'Cronología',
  'contextRail.surface.timeline.description': 'Eventos estructurados de la sesión activa',
  'contextPanel.timeline.empty': 'Sin eventos',
  'contextPanel.timeline.emptyNoSession': 'Sin sesión activa',
  'contextPanel.timeline.loading': 'Cargando cronología…',
  'contextPanel.timeline.kind.compaction': 'Compacción',
  'contextPanel.timeline.kind.branch_summary': 'Rama',
  'contextPanel.timeline.kind.model_change': 'Cambio de modelo',
  'contextPanel.timeline.kind.mode_change': 'Cambio de modo',
  'contextPanel.timeline.kind.ttsr_injection': 'Inyección de reglas',
  'contextPanel.timeline.kind.retry_recovery': 'Reintento',
};
