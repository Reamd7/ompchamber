...
export const dict: Record<I18nKey, string> = {
  ...
  'contextPanel.mode.agentRun': 'Ejecución de agente',
  'contextRail.surface.agentRun.description': 'Transcripción de solo lectura de una ejecución de subagente',
  'contextPanel.agentRun.loading': 'Cargando…',
  'contextPanel.agentRun.empty': 'No hay conversación registrada para esta ejecución',
  'contextPanel.agentRun.openArtifact': 'Abrir artefacto de salida',
  'contextPanel.agentRun.artifactFailed': 'No se pudo abrir el artefacto',
