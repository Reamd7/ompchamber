...
export const dict: Record<I18nKey, string> = {
  ...
  "aboutDialog.diagnosticsDescription": "Incluye el estado de OMPChamber, el estado de OpenCode, directorios y proyectos.",
...
"chat.modeSelector.conflict": "Sal primero del modo {mode}.",
  ...
  "onboarding.localSetup.windows.stepSetBinaryPath": "Si OMPChamber no detecta OpenCode automáticamente, establece la ruta del ejecutable a continuación.",
  "onboarding.localSetup.intro": "OpenCode es el corazón de OMPChamber. Instálalo para empezar.",
  ...
  "onboarding.localSetup.helper.saveAndReload": "Guarda en la configuración de OMPChamber y recarga la configuración de OpenCode.",
