...
const SETTINGS_SEARCH_ITEMS: readonly SettingsSearchItem[] = [
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.ompchamber.visual.field.timeFormat',
    keywords: ['clock', '12h', '24h'],
  },
  {
    id: 'appearance.week-start',
    page: 'appearance',
    titleKey: 'settings.ompchamber.visual.field.weekStartsOn',
    keywords: ['calendar', 'monday', 'sunday'],
  },
  {
    id: 'appearance.light-theme',
    page: 'appearance',
    titleKey: 'settings.ompchamber.visual.field.lightTheme',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.ompchamber.visual.field.darkTheme',
  ...
  },
  {
    ...
    descriptionKey: 'settings.ompchamber.visual.field.dockBadgeHint',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.ompchamber.visual.field.installAppName',
    descriptionKey: 'settings.ompchamber.visual.field.installAppNameHint',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.ompchamber.visual.field.installOrientation',
    descriptionKey: 'settings.ompchamber.visual.field.installOrientationHint',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.ompchamber.visual.field.mobileKeyboardMode',
    descriptionKey: 'settings.ompchamber.visual.field.mobileKeyboardModeHint',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.ompchamber.visual.field.interfaceFontSize',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.ompchamber.visual.field.terminalFontSize',
    keywords: ['terminal', 'font', 'text size'],
  },
  {
    id: 'appearance.terminal-shell',
    page: 'general',
    titleKey: 'settings.ompchamber.visual.field.terminalShell',
    descriptionKey: 'settings.ompchamber.visual.field.terminalShellHint',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.ompchamber.visual.field.editorFontSize',
    keywords: ['editor', 'font', 'text size', 'code'],
  },
  {
    id: 'appearance.spacing-density',
    page: 'appearance',
    titleKey: 'settings.ompchamber.visual.field.spacingDensity',
    keywords: ['density', 'compact', 'comfortable', 'spacing'],
  },
  {
    id: 'appearance.input-bar-offset',
    page: 'appearance',
    titleKey: 'settings.ompchamber.visual.field.inputBarOffset',
    descriptionKey: 'settings.ompchamber.visual.field.inputBarOffsetTooltip',
  ...
  },
  {
    ...
    page: 'general',
    titleKey: 'settings.ompchamber.visual.field.autoSaveEnabled',
    descriptionKey: 'settings.ompchamber.visual.field.autoSaveEnabledInfo',
  ...
  },
  {
    ...
    page: 'general',
    titleKey: 'settings.ompchamber.visual.field.fileEditorKeymap',
    keywords: ['editor', 'vim', 'keymap'],
  },
  {
    id: 'appearance.session-tabs',
    page: 'general',
    titleKey: 'settings.ompchamber.visual.field.sessionTabsGroup',
    descriptionKey: 'settings.ompchamber.visual.field.sessionTabsInfo',
  ...
  },
  {
    ...
    page: 'general',
    titleKey: 'settings.ompchamber.visual.field.terminalQuickKeys',
    descriptionKey: 'settings.ompchamber.visual.field.terminalQuickKeysTooltip',
  ...
  },
  {
    ...
    page: 'general',
    titleKey: 'settings.ompchamber.visual.field.sendAnonymousUsageReports',
    descriptionKey: 'settings.ompchamber.visual.field.sendAnonymousUsageReportsHint',
    keywords: ['telemetry', 'analytics'],
  },
  {
    id: 'general.app-links',
    page: 'general',
    titleKey: 'settings.ompchamber.appLinks.title',
    descriptionKey: 'settings.ompchamber.appLinks.info',
    keywords: ['security', 'app link', 'deep link', 'scheme', 'protocol', 'obsidian', 'notion'],
  },
  {
    id: 'chat.render-mode',
    page: 'chat',
    titleKey: 'settings.ompchamber.visual.section.chatRenderMode',
    keywords: ['messages', 'conversation', 'rendering'],
  },
  {
    id: 'chat.message-transport',
    page: 'general',
    titleKey: 'settings.ompchamber.visual.section.messageStreamTransport',
    keywords: ['streaming', 'sse', 'websocket'],
  },
  {
    id: 'chat.session-recap',
    page: 'chat',
    titleKey: 'settings.ompchamber.visual.field.sessionRecap',
    keywords: ['recap', 'assist', 'small model', 'summary'],
  },
  {
    id: 'chat.session-assistance',
    page: 'chat',
    titleKey: 'settings.ompchamber.visual.section.sessionAssistance',
    keywords: ['recap', 'suggestion', 'subagent'],
  },
  {
    id: 'chat.session-suggestion',
    page: 'chat',
    titleKey: 'settings.ompchamber.visual.field.sessionSuggestion',
    keywords: ['suggestion', 'assist', 'small model', 'follow up'],
  },
  {
    id: 'chat.session-goal',
    page: 'chat',
    titleKey: 'settings.ompchamber.visual.field.sessionGoal',
  ...
  },
  {
    ...
    page: 'chat',
    titleKey: 'settings.ompchamber.visual.goal.budgetLabel',
  ...
  },
  {
    ...
    page: 'chat',
    titleKey: 'settings.ompchamber.visual.field.showReasoningTraces',
    keywords: ['thinking', 'reasoning'],
  },
  {
    id: 'chat.reasoning',
    page: 'chat',
    titleKey: 'settings.ompchamber.visual.section.reasoning',
    keywords: ['thinking', 'traces'],
  },
  {
    id: 'chat.streaming',
    page: 'chat',
    titleKey: 'settings.ompchamber.visual.section.streaming',
    keywords: ['stream', 'scroll'],
  },
  {
    id: 'chat.streaming-auto-follow',
    page: 'chat',
    titleKey: 'settings.ompchamber.visual.field.streamingAutoFollow',
    descriptionKey: 'settings.ompchamber.visual.field.streamingAutoFollowInfo',
    keywords: ['autoscroll', 'auto-scroll', 'follow', 'stick to bottom', 'streaming'],
  },
  {
    id: 'chat.sticky-user-header',
    page: 'chat',
    titleKey: 'settings.ompchamber.visual.field.stickyUserHeader',
    keywords: ['messages', 'header'],
  },
  {
    id: 'chat.prompt-navigator',
    page: 'chat',
    titleKey: 'settings.ompchamber.visual.field.promptNavigatorEnabled',
  ...
  },
  {
    ...
    page: 'chat',
    titleKey: 'settings.ompchamber.visual.field.collapsibleUserMessages',
    keywords: ['collapse', 'expand', 'clamp', 'long messages', 'user messages'],
  },
  {
    id: 'chat.wide-layout',
    page: 'chat',
    titleKey: 'settings.ompchamber.visual.field.wideChatLayout',
    keywords: ['layout', 'wide', 'messages'],
  },
  {
    id: 'chat.message-appearance',
    page: 'chat',
    titleKey: 'settings.ompchamber.visual.section.messageAppearance',
    keywords: ['layout', 'messages', 'appearance'],
  },
  {
    id: 'chat.code-block-line-wrap',
    page: 'chat',
    titleKey: 'settings.ompchamber.visual.field.codeBlockLineWrap',
    keywords: ['code', 'wrap', 'line wrap', 'markdown'],
  },
  {
    id: 'chat.inline-assistant-actions',
    page: 'chat',
    titleKey: 'settings.ompchamber.visual.field.showSplitAssistantMessageActions',
    descriptionKey: 'settings.ompchamber.visual.field.showSplitAssistantMessageActionsTooltip',
    keywords: ['copy', 'save image', 'read aloud'],
  },
  {
    id: 'chat.draft-starters-visible',
    page: 'chat',
    titleKey: 'settings.ompchamber.visual.field.draftStartersVisible',
    keywords: ['starter', 'starters', 'new session', 'welcome', 'suggestions'],
  },
  {
    id: 'chat.subagent-read-only-banner',
    page: 'chat',
    titleKey: 'settings.ompchamber.visual.field.allowPromptingSubagentSessions',
    keywords: ['subagent', 'read only', 'prompt', 'banner'],
  },
  {
    id: 'chat.tool-file-icons',
    page: 'chat',
    titleKey: 'settings.ompchamber.visual.field.showToolFileIcons',
    keywords: ['tools', 'files', 'icons'],
  },
  {
    id: 'chat.tools-and-files',
    page: 'chat',
    titleKey: 'settings.ompchamber.visual.section.toolsAndFiles',
    keywords: ['tools', 'files', 'dotfiles'],
  },
  {
    id: 'chat.changed-files',
    page: 'chat',
    titleKey: 'settings.ompchamber.visual.field.showTurnChangedFiles',
    keywords: ['changed files', 'turns'],
  },
  {
    id: 'chat.dotfiles',
    page: 'chat',
    titleKey: 'settings.ompchamber.visual.field.showDotfiles',
  ...
  },
  {
    ...
    page: 'chat',
    titleKey: 'settings.ompchamber.visual.section.followUpBehavior',
    descriptionKey: 'settings.ompchamber.visual.field.followUpBehaviorDescription',
    keywords: ['follow up', 'queue', 'steer', 'send immediately'],
  },
  {
    id: 'chat.persist-drafts',
    page: 'chat',
    titleKey: 'settings.ompchamber.visual.field.persistDraftMessages',
    keywords: ['draft', 'message'],
  },
  {
    id: 'chat.composer',
    page: 'chat',
    titleKey: 'settings.ompchamber.visual.section.composer',
    keywords: ['input', 'draft', 'spellcheck', 'paste'],
  },
  {
    id: 'chat.spellcheck',
    page: 'chat',
    titleKey: 'settings.ompchamber.visual.field.enableSpellcheckInTextInputs',
  ...
  },
  {
    ...
    page: 'chat',
    titleKey: 'settings.ompchamber.visual.field.largeTextPaste',
    descriptionKey: 'settings.ompchamber.visual.field.largeTextPasteHint',
    keywords: ['paste', 'clipboard', 'attachment', 'large', 'text', 'file'],
  },
  {
    id: 'sessions.default-model',
    page: 'sessions',
    titleKey: 'settings.ompchamber.defaults.field.defaultModel',
    keywords: ['model', 'provider', 'new sessions'],
  },
  {
    id: 'sessions.default-thinking',
    page: 'sessions',
    titleKey: 'settings.ompchamber.defaults.field.defaultThinking',
    keywords: ['thinking', 'reasoning', 'variant'],
  },
  {
    id: 'sessions.default-agent',
    page: 'sessions',
    titleKey: 'settings.ompchamber.defaults.field.defaultAgent',
    keywords: ['agent', 'new sessions'],
  },
  {
    id: 'sessions.deletion-dialog',
    page: 'sessions',
    titleKey: 'settings.ompchamber.defaults.field.showDeletionDialog',
    keywords: ['delete', 'confirmation'],
  },
  {
    id: 'sessions.small-model',
    page: 'sessions',
    titleKey: 'settings.ompchamber.defaults.smallModel.title',
    descriptionKey: 'settings.ompchamber.defaults.smallModel.description',
    keywords: ['small model', 'utility', 'summary', 'recap', 'cheap', 'override'],
  },
  {
    id: 'sessions.walkthrough-model',
    page: 'sessions',
    titleKey: 'settings.ompchamber.defaults.walkthroughModel.title',
    descriptionKey: 'settings.ompchamber.defaults.walkthroughModel.description',
    keywords: ['walkthrough', 'diff', 'review', 'changes', 'structured output', 'model', 'override'],
  },
  {
    id: 'sessions.auto-cleanup',
    page: 'sessions',
    titleKey: 'settings.ompchamber.sessionRetention.field.enableAutoCleanup',
    descriptionKey: 'settings.ompchamber.sessionRetention.tooltip',
    keywords: ['retention', 'archive', 'delete'],
  },
  {
    id: 'sessions.retention-period',
    page: 'sessions',
    titleKey: 'settings.ompchamber.sessionRetention.field.retentionPeriod',
    keywords: ['days', 'cleanup', 'retention'],
  },
  {
    id: 'sessions.retention-action',
    page: 'sessions',
    titleKey: 'settings.ompchamber.sessionRetention.field.whenSessionsExpire',
    keywords: ['archive', 'delete', 'expire'],
  },
  {
    id: 'sessions.desktop-launch-at-login',
    page: 'general',
    titleKey: 'settings.ompchamber.desktopNetwork.field.launchAtLogin',
    descriptionKey: 'settings.ompchamber.desktopNetwork.field.launchAtLoginDescription',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.ompchamber.desktopNetwork.field.windowControlsPosition',
    descriptionKey: 'settings.ompchamber.desktopNetwork.field.windowControlsPositionDescription',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.ompchamber.desktopNetwork.field.windowControlsStyle',
  ...
  },
  {
    ...
    page: 'general',
    titleKey: 'settings.ompchamber.desktopNetwork.field.macMenuBar',
    descriptionKey: 'settings.ompchamber.desktopNetwork.field.macMenuBarDescription',
  ...
  },
  {
    ...
    page: 'general',
    titleKey: 'settings.ompchamber.desktopNetwork.field.minimizeToTray',
    descriptionKey: 'settings.ompchamber.desktopNetwork.field.minimizeToTrayDescription',
  ...
  },
  {
    ...
    page: 'general',
    titleKey: 'settings.ompchamber.desktopNetwork.field.keepAwake',
    descriptionKey: 'settings.ompchamber.desktopNetwork.field.keepAwakeDescription',
  ...
  },
  {
    ...
    page: 'general',
    titleKey: 'settings.ompchamber.desktopPassword.field.password',
    descriptionKey: 'settings.ompchamber.desktopPassword.field.passwordDescription',
  ...
  },
  {
    ...
    page: 'general',
    titleKey: 'settings.ompchamber.desktopNetwork.field.allowLanAccess',
    descriptionKey: 'settings.ompchamber.desktopNetwork.field.allowLanAccessDescription',
  ...
  },
  {
    ...
    descriptionKey: 'settings.ompchamber.tools.field.agentControlToolInfo',
    keywords: ['agent', 'tool', 'orchestration', 'ompchamber', 'sessions', 'schedule', 'control'],
    isAvailable: (ctx) => !ctx.isVSCode,
  },
  {
    id: 'sessions.agent-web-tool',
    page: 'general',
    titleKey: 'settings.ompchamber.tools.field.agentWebTool',
    descriptionKey: 'settings.ompchamber.tools.field.agentWebToolInfo',
    keywords: ['agent', 'tool', 'web', 'browser', 'page', 'preview', 'ompchamber'],
    isAvailable: (ctx) => !ctx.isVSCode,
  },
  {
    id: 'sessions.agent-memory-tool',
    page: 'general',
    titleKey: 'settings.ompchamber.tools.field.agentMemoryTool',
    descriptionKey: 'settings.ompchamber.tools.field.agentMemoryToolInfo',
    keywords: ['agent', 'tool', 'memory', 'remember', 'recall', 'preferences', 'ompchamber'],
  ...
  },
  {
    id: 'git.changes-view',
    page: 'git',
    titleKey: 'settings.ompchamber.git.changesViewTitle',
    keywords: ['changes', 'flat list', 'tree view'],
  },
  {
    id: 'git.gitmoji',
    page: 'git',
    titleKey: 'settings.ompchamber.git.enableGitmoji',
    keywords: ['commit', 'emoji'],
  },
  {
    id: 'git.gitignored-files',
    page: 'git',
    titleKey: 'settings.ompchamber.git.showGitignored',
  ...
  },
  {
    ...
    page: 'projects',
    titleKey: 'settings.ompchamber.worktrees.setup.waitForCommands',
  ...
  },
  {
    ...
    page: 'shortcuts',
    titleKey: 'settings.ompchamber.keyboardShortcuts.title',
    descriptionKey: 'settings.ompchamber.keyboardShortcuts.tooltip',
  ...
  },
  {
    id: 'tunnel.provider',
    page: 'tunnel',
    titleKey: 'settings.ompchamber.tunnel.field.provider',
    descriptionKey: 'settings.ompchamber.tunnel.description',
  ...
  },
  {
    id: 'tunnel.type',
    page: 'tunnel',
    titleKey: 'settings.ompchamber.tunnel.field.tunnelType',
  ...
  },
  {
    id: 'tunnel.ttl',
    page: 'tunnel',
    titleKey: 'settings.ompchamber.tunnel.field.connectLinkTtl',
    descriptionKey: 'settings.ompchamber.tunnel.field.tunnelSessionTtl',
  ...
  },
  {
    ...
    page: 'tunnel',
    titleKey: 'settings.ompchamber.tunnel.section.savedManagedRemoteTunnels',
  ...
  },
  {
    ...
    page: 'tunnel',
    titleKey: 'settings.ompchamber.tunnel.field.configurationFile',
    descriptionKey: 'settings.ompchamber.tunnel.note.managedLocalUsesConfig',
  ...
  },
  {
    id: 'tunnel.start',
    page: 'tunnel',
    titleKey: 'settings.ompchamber.tunnel.actions.startTunnel',
    descriptionKey: 'settings.ompchamber.tunnel.note.connectLinksOneTime',
