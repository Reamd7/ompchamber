...
describe('resolveLinearSessionOrigin', () => {
  ...
  test('uses the desktop loopback origin instead of the packaged UI scheme', () => {
    Object.defineProperty(globalThis, 'window', {
      configurable: true,
      value: {
        location: { origin: 'ompchamber-ui://app' },
        __OMPCHAMBER_ELECTRON__: { runtime: 'electron' },
        __OMPCHAMBER_LOCAL_ORIGIN__: 'http://127.0.0.1:3001',
      },
    });
  ...
  test('reports no origin when the desktop shell has no http loopback', () => {
    Object.defineProperty(globalThis, 'window', {
      ...
      value: {
        location: { origin: 'ompchamber-ui://app' },
        __OMPCHAMBER_ELECTRON__: { runtime: 'electron' },
        __OMPCHAMBER_LOCAL_ORIGIN__: 'ompchamber-ui://app',
      },
    });
