 ...
 * it as `window.__OMPCHAMBER_DESKTOP_BOOT_OUTCOME__`. This module provides
...
export function getInjectedBootOutcome(): DesktopBootOutcome | null {
  ...
  const raw = (window as { __OMPCHAMBER_DESKTOP_BOOT_OUTCOME__?: unknown })
    .__OMPCHAMBER_DESKTOP_BOOT_OUTCOME__;
