...
mock.module('./markdown/markdownCore', () => ({
    ...
    readCachedMarkdownBlocks: () => cachedRendererBlocks,
...
mock.module('@/hooks/useOmpFeatureEnabled', () => ({ useOmpFeatureEnabled: () => false }));
mock.module('@/stores/useInternalUriViewerStore', () => ({ openInternalUriViewer: () => undefined }));
