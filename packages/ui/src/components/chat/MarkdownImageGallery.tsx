...
const MarkdownImageThumbnail: React.FC<{
  ...
  return (
    <button
      ...
      onClick={openPreview}
      data-ompchamber-markdown-image-action="true"
      data-ompchamber-markdown-image-source={candidate.source}
      data-ompchamber-markdown-image-filename={candidate.filename}
    >
      <span className="flex h-[72px] w-[100px] items-center justify-center overflow-hidden rounded-lg border border-border/40 bg-muted/10">
        {image.url && image.status !== 'error' ? (
          <img
            ...
            data-ompchamber-markdown-image="true"
            data-ompchamber-markdown-image-thumbnail="true"
            data-ompchamber-markdown-image-state={image.status}
          />
        ) : (
      ...
      <span
        ...
        title={candidate.filename}
        data-ompchamber-markdown-image-caption="true"
      >
...
export const MarkdownImageGallery: React.FC<{
  ...
  return (
    <div
      ...
      data-ompchamber-markdown-image-gallery="true"
    >
