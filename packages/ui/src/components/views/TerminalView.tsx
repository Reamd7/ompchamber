            ...
            if (!terminalId) {
                ...
                try {
                    ...
                    if (terminal.listSessions) {
                        const running = await terminal.listSessions(directory);
                        ...
                        if (match) {
                            ...
                            // the attach below adopts the current viewport.
                            session = { sessionId: match.sessionId, cols: initialSize.cols, rows: initialSize.rows, status: match.status };
                        }
                    }
                    if (!session) {
