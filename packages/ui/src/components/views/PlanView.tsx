...
export const PlanView: React.FC<PlanViewProps> = ({ targetPath = null, savedProjectPlan = null, onNavigatedToChat }) => {
  ...
  const handleConfirmPlanSend = React.useCallback(
    ...
    [canCreateWorktree, content, createSession, currentProjectRef, initializeNewOMPChamberSession, isManagedChatPlan, pendingPlanSend, resolvedPath, routeToChat, savedPlanProjectRef, sendMessage, sendPromptTitle, setCurrentSession]
  );
