  ...
  switch (variant) {
    case 'local-unavailable':
      return {
        ...
        description: 'The local engine could not be started. Retry the launch or connect to a remote server instead.',
    ...
    case 'remote-wrong-service': {
      ...
      return {
        ...
        description: `The server at "${host || 'unknown'}" is not running OMPChamber. Verify the address points to an OMPChamber server.`,
    ...
    case 'remote-incompatible': {
      ...
      return {
        ...
        description: `The OMPChamber server at "${host || 'unknown'}" is not compatible with this app version. Update OMPChamber on the server, then try again.`,
