...
export const ProvidersPage: React.FC = () => {
  ...
  // the OpenCode source probe cannot see. Respect an explicit Hide.
  React.useEffect(() => {
  ...
  }, [selectedProviderId, providerSources, providers, ompEngineProviders, authPanelDismissedForId]);
  ...
  const showModelsSection = ompEngineProviders
