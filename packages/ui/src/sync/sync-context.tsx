...
import type { Event, Message, Part } from '@/lib/opencode/wire'
...
import type { SessionStatus } from '@/lib/opencode/wire'
...
const SYNC_RUNTIME_CONTEXT_GLOBAL_KEY = "__ompchamber_sync_runtime_context__"
...
export function handleEvent(
  ...
  if (payload.type === "session.idle") {
    ...
    // The reducer already wrote the idle status into `draft`; finalize
