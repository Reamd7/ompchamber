import type { OpencodeClient, PermissionRequest, Project, QuestionRequest } from '@/lib/opencode/wire'
...
export async function bootstrapGlobal(
  ...
  // If ALL requests failed, OpenCode is likely down — fetch the OMPChamber
